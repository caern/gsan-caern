...
<script language="JavaScript">
		...
		if (validateInserirEmpresaActionForm(form)){
			...
			if (form.indicadorEmpresaCobranca[0].checked){
				...
				alert('Informe Data de Início do Contrato.\nInforme Percentual do Pagamento das Contas Cobradas.');	
					...
					submeterFormulario = false;
				} else if (form.dataEncerramentoContratoCobranca.value == "" 
					...
					submeterFormulario = false;
					alert('Informe Data de encerramento de contrato de cobrança.');
				}
	...
	function bloqueiaDadosEmpresaCobranca(){
		...
		if(form.indicadorEmpresaCobranca[0].checked){
			...
			form.dataEncerramentoContratoCobranca.style.color = "#000000";
			form.dataEncerramentoContratoCobranca.style.background = "white";
			form.dataEncerramentoContratoCobranca.disabled = false;
			...
			if (form.percentualDaFaixaInformado.value != null
					...
					&& form.percentualDaFaixaInformado.value != 'SIM') {
				form.quantidadeMesValidoPagamento.style.color = "#000000";
				form.quantidadeMesValidoPagamento.style.background = "white";
				...
				<td width="625" valign="top" class="centercoltext">
					...
					<table width="100%" border="0">
						...
						<tr>
							...
							<td colspan="2"><strong> <html:text
									...
									href="javascript:abrirCalendario('InserirEmpresaActionForm', 'dataInicioContratoCobranca');">
										...
										tabindex="11" /> </a> (dd/mm/aaaa) </strong>
							</td>
						</tr>
						...
						<logic:notPresent name="colecaoEmpresaCobrancaFaixa">
							<tr>
								...
								<td colspan="2"><span class="style2"> <html:text
											...
											onkeypress="return isCampoNumerico(event);"
											onchange="bloqueiaCampos();"
											onkeyup="formataValorMonetario(this, 5);" tabindex="12" /> </span>
								</td>
								<td>&nbsp;</td>
							</tr>
						</logic:notPresent>
						<tr>
							...
							<td colspan="2"><span class="style2"> <html:text
										...
										onchange="bloqueiaCampos();"
										onkeypress="return isCampoNumerico(event);" tabindex="13" />
							</span>
							</td>
							<td>&nbsp;</td>
						</tr>
						...
						<tr>
							...
							<td colspan="2"><span class="style2"> <html:text
										...
										onkeypress="return isCampoNumerico(event);"
										onchange="bloqueiaCampos();"
										onkeyup="formataValorMonetario(this, 5);" tabindex="14" /> </span>
							</td>
							<td>&nbsp;</td>
							<td><input type="button" name="adicionarFaixa"
					...
					<table width="100%" cellpadding="0" cellspacing="0">
						...
						<tr bordercolor="#000000">
							...
							<td bgcolor="#90c7fc" width="45%"><strong>Quantidade
									mínima de contas</strong>
							</td>
							<td bgcolor="#90c7fc" width="45%"><strong>Percentual
									da Faixa</strong>
							</td>
						</tr>
						<logic:present name="colecaoEmpresaCobrancaFaixa">
