...
<html:javascript staticJavascript="false"
	formName="EfetuarRestabelecimentoLigacaoAguaComInstalacaoHidrometroActionForm"
	dynamicJavascript="true" />

<script language="JavaScript">
	
	function validaForm() {
		var form = document.EfetuarRestabelecimentoLigacaoAguaComInstalacaoHidrometroActionForm;
		if (validateEfetuarRestabelecimentoLigacaoAguaComInstalacaoHidrometroActionForm(form) && validaDebito()){
	...
	function limparForm() {
		...
		form.action = 'exibirEfetuarRestabelecimentoLigacaoAguaComInstalacaoHidrometroAction.do?desfazer=sim';
		form.submit();
	 }
	...
	function recuperarDadosPopup(codigoRegistro, descricaoRegistro, tipoConsulta) {
		...
		if (tipoConsulta == 'hidrometro') {
	      	...
	      	form.action='exibirEfetuarRestabelecimentoLigacaoAguaComInstalacaoHidrometroAction.do?objetoConsulta=1';
	      	form.submit();
      		
    	} else if (tipoConsulta == 'ordemServico') {

	    	form.idOrdemServico.value = codigoRegistro;
	      	form.action='exibirEfetuarRestabelecimentoLigacaoAguaComInstalacaoHidrometroAction.do';
	...
	function calcularValores(){
		...
		var form = document.EfetuarRestabelecimentoLigacaoAguaComInstalacaoHidrometroActionForm;
	   	if (validateEfetuarRestabelecimentoLigacaoAguaComInstalacaoHidrometroActionForm(form) && validaDebito()){
	   		...
	   		form.action='exibirEfetuarRestabelecimentoLigacaoAguaComInstalacaoHidrometroAction.do?calculaValores=S';
	      	form.submit();
		}
	}
...
<html:form action="/efetuarRestabelecimentoLigacaoAguaComInstalacaoHidrometroAction.do"
						...
						<tr>
							...
							<table width="100%" border="0" align="center" cellpadding="0"
								...
								<tr>
									...
									<td class="parabg">Efetuar Restabelecimento Ligação Água com Instalação de
									Hidrômetro</td>
									<td width="11"><img border="0"
									...
									<table width="100%" border="0" align="center">
										...
										<tr>
											...
											<td><span class="style2"> <html:text
												...
												onkeypress="validaEnterComMensagem(event, 'exibirEfetuarRestabelecimentoLigacaoAguaComInstalacaoHidrometroAction.do', 'idOrdemServico','Ordem de Serviço');"
													...
													<table border="0" width="100%">
														<tr>
															...
															<td width="58%"><html:text property="numeroHidrometro"
																...
																onkeypress="validaEnterString(event, 'exibirEfetuarRestabelecimentoLigacaoAguaComInstalacaoHidrometroAction.do?objetoConsulta=1', 'numeroHidrometro','Número do Hidrômetro');" />
															<a
																href="javascript:pesquisarHidrometro()"><img
													...
													<tr bgcolor="#cbe5fe">
														...
														<table border="0" width="100%">
															...
															<!-- Colocado por Raphael Rossiter em 19/04/2007 -->
																<logic:notEqual name="EfetuarRestabelecimentoLigacaoAguaComInstalacaoHidrometroActionForm" property="alteracaoValor" value="OK">
																	<tr>
																...
																<logic:equal name="EfetuarRestabelecimentoLigacaoAguaComInstalacaoHidrometroActionForm" property="alteracaoValor" value="OK">
																	<tr>
																		<td><strong>Valor do Débito:</strong></td>
																		<td colspan="2">
																			<html:text property="valorDebito" 
