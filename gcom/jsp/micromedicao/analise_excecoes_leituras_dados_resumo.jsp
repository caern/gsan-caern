...
var bCancel = false;
    ...
    function caracteresespeciais () {
     ...
     this.ah = new Array("observacao", "Observação possui caracteres especiais.", new Function ("varName", " return this[varName];"));
...
//Recebe os dados do(s) popup(s)
	...
	function verificarValorGerarOS() {
		...
		if ( form.indicadorOSFiscalizacaoAnalise != null && form.indicadorOSFiscalizacaoAnalise.value != null &&
				form.indicadorOSFiscalizacaoAnalise.value == "inativo" ) {
	...
	function gerarOSFiscalizacao(){
		...
		if ( validaCampoTexto("observacao", "Observação") ) {
	...
	function validaOSFiscalizacao() {
		var form = document.forms[0];

		if ( form.indicadorOSFiscalizacaoAnalise != null && form.indicadorOSFiscalizacaoAnalise.value != null &&
				form.indicadorOSFiscalizacaoAnalise.value == "ativo" ) {

			form.observacao.disabled = false;
			form.gerarOS.value = '';
			form.gerarOS.checked = false;
			form.gerarOS.disabled = true;
	...
	function atualizarObservacao() {
		...
		if(form.observacao.value != null && form.observacao.value != ""){

			if( validateCaracterEspecial(form) ) {
				$.ajax({
					type: "POST",
						   url: "atualizarObservacaoRegistroAtendimentoOrdemServicoAjaxAction.do?observacaoAjax=" + form.observacao.value,
						   data: "",
	...
	function validaCampoTexto(nomeCampoForm,nomeCampoMSG) {
...
<body leftmargin="5" topmargin="5"
	onload="javascript:validaOSFiscalizacao();setarFoco('${requestScope.nomeCampo}');checkAnalisado('${sessionScope.analisado}');verificarValorAnalisado();checkGerarAviso('${sessionScope.gerarAviso}');verificarValorGerarAviso();checkGerarOS('${sessionScope.gerarOS}');verificarValorGerarOS();;checkGerarRelatorio('${sessionScope.gerarRelatorio}');verificarValorGerarRelatorio();desabilitaCampos('${habilitaCampos}','${requestScope.desabilitaAtualizarImovel}');verificaLeituraAnteriorPositiva();exibirMensagemReleituraRealizada();">
<html:form action="/atualizarConsumoResumoAction.do"
	...
	<html:hidden property="indicadorOSFiscalizacaoAnalise" />	
	<html:hidden property="observacaoHidden" />	
											...
											<table width="100%" align="center" bgcolor="#cbe5fe"
												...
												<tr bgcolor="#cbe5fe">
													...
													<td width="50"><html:text
														...
														style="font-size:xx-small" size="9" maxlength="8"
												...
												<tr>
													...
													<td colspan="5"><span class="style2"> <strong> <html:textarea
														...
														onkeyup="limitTextArea(document.forms[0].observacao, 450, document.getElementById('utilizado'), document.getElementById('limite'));" /><br>

														<strong> <span id="utilizado">0</span>/<span id="limite">450</span>
														</strong> </strong> </span>
													</td>
													...
													<td colspan="2">
														<div align="left">
															<input style="width: 140px" 
																	type="button"
																	name="ButtonObservacao" 
																	class="bottonRightCol" 
																	value="Atualizar Observação"
																	onclick="atualizarObservacao();" 
																	id="botaoObservacao">
														</div>
													</td>
													<td colspan="2">
														<logic:present name="IndicadorOSFiscalizacaoAnalise">
															<font color="red">Imóvel com OS aberta.</font>
														</logic:present>
													</td>
												</tr>
