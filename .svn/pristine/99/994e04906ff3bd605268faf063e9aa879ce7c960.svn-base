...
public class Cliente extends ObjetoTransacao {
    ...
    @ControleAlteracao(funcionalidade={ATRIBUTOS_CLIENTE_INSERIR, ATRIBUTOS_CLIENTE_ATUALIZAR, ATRIBUTOS_ATUALIZAR_DADOS_CLIENTE_PROMAIS,OPERACAO_ATUALIZAR_DADOS_IMOVEL_ATUALIZACAO_CADASTRAL,OPERACAO_CONSULTAR_DADOS_DA_OS_DE_VISITA})
    private String nome;
    ...
    /** nullable persistent field */
    @ControleAlteracao(funcionalidade={ATRIBUTOS_CLIENTE_INSERIR, ATRIBUTOS_CLIENTE_ATUALIZAR,OPERACAO_CONSULTAR_DADOS_DA_OS_DE_VISITA})
    private String rg;
...
//    		funcionalidade={ATRIBUTOS_CLIENTE_INSERIR, ATRIBUTOS_CLIENTE_ATUALIZAR})
    ...
    @ControleAlteracao(funcionalidade={ATRIBUTOS_CLIENTE_INSERIR, ATRIBUTOS_CLIENTE_ATUALIZAR, OPERACAO_ATUALIZAR_INDICADOR_CPF_CNPJ_POPUP})
	...
	public Cliente(Cliente clienteCadastrado) {
		...
		this.indicadorNegativacaoPeriodo = ConstantesSistema.NAO;
		this.indicadorValidaCpfCnpj = ConstantesSistema.NAO.intValue();
	}
	...
	/**
	 * Construtor para Contrato de Demanda Condomínios Residenciais
	 * 
	 * @param id
	 */
