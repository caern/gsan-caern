...
<body leftmargin="5" topmargin="5"
	onload="javascript:setarFoco('${requestScope.nomeCampo}');bloqueiaDados();validarAnoFabricacao();">
				...
				<tr>
					<td colspan="2">
						<strong> <span class="style1">
							...
							<html:radio property="indicadorMacromedidor"
								value="2" onchange="bloqueiaDados();redirecionarSubmit('exibirInserirHidrometroAction.do');"/> Micromedidor </span>
					</strong>
					</td>
				</tr>
