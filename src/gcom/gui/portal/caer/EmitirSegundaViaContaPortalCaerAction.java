...
/**
 * Classe Responsavel pela emissao da segunda via da conta no portal da CAER
 * 
 * @author Anderson Cabral
 * @date 05/09/20112
 */
public class EmitirSegundaViaContaPortalCaerAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		try {
			...
			EmitirSegundaViaContaPortalCaerActionForm form = (EmitirSegundaViaContaPortalCaerActionForm) actionForm;
			...
			if (form.getMatricula() != null && !form.getMatricula().equals("")) {
				...
				if (colecaoContasValores == null || colecaoContasValores.isEmpty()) {
					...
					retorno = actionMapping.findForward("emitirSegundaViaContaPortalCaerAction");
