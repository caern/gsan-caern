...
//		 1.2.2.10 - Consumo 06
	...
	public Collection verificarImoveisParaSerGerados(Collection objetosImoveis) {
		...
		while (imovelIterator.hasNext()) {
			...
			// seleciona.
			/*
			 * - Erivan Sousa - 25/04/2012
			 * - Correção para que ficasse de acordo com o
			 * caso-de-uso
			 * 
			 * Caso o imóvel possua algum tipo de situação especial de
			 * faturamento e este tipo de situação especial indique que não deve ser realizada
			 * leitura (FTST_ICLEITURAPARALISACAO=1 na tabela
			 * FATURAMENTO_SITUACAO_TIPO), não selecionar o imóvel.
			 */
		if (imovel.getFaturamentoSituacaoTipo() == null ||(
				imovel.getFaturamentoSituacaoTipo() != null && !imovel
