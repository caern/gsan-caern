...
<script>
	...
	function IntegerValidations () {
		...
		this.al = new Array("qtdeContasRetificadas", "Qtde de Contas Retificadas deve somente conter números positivos.", new Function ("varName", " return this[varName];"));
	...
	function required () {
    	...
    	this.am = new Array("percentualBonusSocial", "Informe o percentual de Bônus Social.", new Function ("varName", " return this[varName];"));
