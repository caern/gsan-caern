    ...
    public Integer inserirContratoParcelamentoPorCliente(ContratoParcelamento contrato, Usuario usuarioLogado, 
        ...
        try{
            ...
            for (int i = 1; i < listaDeParcelas.size(); i++) {
                ...
                //Se o mês passado foi de fevereiro, o dia máximo é de 28. Caso tenha acontecido, voltar ao dia de vencimento escolhido(Ex: Dia 30).
...
//			------------ REGISTRAR TRANSAÇÃO ----------------
	...
	public List<RelatorioEmitirContratoParcelamentoPorClienteBean> pesquisarDadosRelatorioContratoParcelamentoPorCliente(
		...
		try {
			...
			// 1.2.2. Código de Débito Automático
	...
	public String excluirDebitoAutomaticoParcelamentoPorCliente(Integer idContratoParcelamento,
		...
		try {
			...
			if (idContratoParcelamento == null || !repositorioContratoParcelamento
				...
				descricaoOcorrencia = "IDENTIFICAÇÃO DE CONTRATO DE PARCELAMENTO NÃO CADASTRADA";
			} else {
				...
				if (existeBanco == null) {
					...
					if (existeAgencia == null) {
						...
						if (!repositorioContratoParcelamento
							...
							descricaoOcorrencia = "CONTRATO PARCELAMENTO NÃO É DÉBITO AUTOMÁTICO";
						} else {
							...
							if (!repositorioContratoParcelamento
								...
								descricaoOcorrencia = "CONTRATO PARCELAMENTO É DÉBITO AUTOMÁTICO DE OUTRO BANCO/AGÊNCIA";
							} else {
								...
								if (repositorioContratoParcelamento
									...
									descricaoOcorrencia = "CONTRATO PARCELAMENTO JÁ É DÉBITO AUTOMÁTICO";
								} else {
									// 2. O sistema efetua a exclusão [FS0006 - Verificar sucesso da transação]
									...
									// 2.3.	Atualiza o indicador de débito automático da tabela CONTATO_PARCEL para NAO 
									repositorioContratoParcelamento
	...
	public String inserirDebitoAutomaticoParcelamentoPorCliente(Integer idContratoParcelamento,
		...
		try {
			...
			if (dataOpcao.after(dataAtual.getTime())) {
				descricaoOcorrencia = "DATA OPÇÃO MAIOR QUE A DATA ATUAL";//TODO UC
			} else {
				// [FS0001] - Verificar existência de contrato de parcelamento
					...
					if (existeBanco == null) {
						...
						if (existeAgencia == null) {
							...
							// [FS0006] - Verificar data de opção já excluída
								...
								descricaoOcorrencia = "CONTRATO PARCELAMENTO JÁ FOI EXCLUÍDO DO DÉBITO AUTOMÁTICO COM A DATA DE OPÇÃO";
								
							} else {
								// 2.1.	Caso o contrato já seja débito automático
								if (this.repositorioContratoParcelamento
									.verificarDebitoAutomaticoContratoParcelamento(idContratoParcelamento)) {
									
									// atualizar a data da exclusão com a data corrente 
									this.repositorioContratoParcelamento
										.atualizarDataExclusaoDebitoAutomaticoContratoParcelamento(
											idContratoParcelamento);
								...
								// 2.2.	Inclui o débito automático na tabela DEBITO_AUT_PARC_CLIENTE 
								...
								// 2.3.	Inclui, para cada parcela do contrato, os movimentos de débito automático 
								...
								if (colecaoPrestacoes != null
									...
									while(iteratorPrestacao.hasNext()) {
										Object[] dadosPrestacao = (Object[]) iteratorPrestacao.next();
										...
										// 2.4.	Atualiza o indicador de débito automático da tabela CONTATO_PARCEL para SIM
										repositorioContratoParcelamento
											.atualizarIndicadorDebitoAutomaticoContratoParcelamento(
