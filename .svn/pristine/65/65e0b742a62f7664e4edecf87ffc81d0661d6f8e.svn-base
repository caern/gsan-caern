...
public class AcaoCobrancaAtualizarActionForm extends ValidatorActionForm {
    ...
    private String indicadorExibeEventual;    
    
    public String getIndicadorExibeEventual() {
		return indicadorExibeEventual;
	}

	public void setIndicadorExibeEventual(String indicadorExibeEventual) {
		this.indicadorExibeEventual = indicadorExibeEventual;
	}

	public String getNumeroDiasMinimoCobranca() {
		return numeroDiasMinimoCobranca;
	}

	public void setNumeroDiasMinimoCobranca(String numeroDiasMinimoCobranca) {
		this.numeroDiasMinimoCobranca = numeroDiasMinimoCobranca;
	}

	public String getNumeroDiasMaximoCobranca() {
		return numeroDiasMaximoCobranca;
	}

	public void setNumeroDiasMaximoCobranca(String numeroDiasMaximoCobranca) {
		this.numeroDiasMaximoCobranca = numeroDiasMaximoCobranca;
	}

	private String numeroDiasMinimoCobranca;
    
    private String numeroDiasMaximoCobranca;
