...
<%@ page import="gcom.gui.portal.caer.LojaAtendimentoCaerHelper"%>
	...
	<head>
		...
		<style type="text/css">
			...
			#lista-informacoes li {
				background: url("/gsan/imagens/portal/caer/general/arrow-link.gif") no-repeat;
				float: left;
				height: 39px;
				margin-bottom: 5px;
				position: relative;
			...
			#lista-informacoes li.localSelecionado {
				background: url("/gsan/imagens/portal/caer/general/arrow-link-hover.gif") no-repeat;
			}
	        ...
	        <div id="content">
				...
				<div class="serv-int" style="width:880px;">
		        	...
		        	<div style="width:100%;margin-bottom:35px;">
						...
						<a href="http://get.adobe.com/br/reader/" title="Faça o download do Adobe Reader" class="adobe-reader" target="_blank"><img src="/gsan/imagens/portal/caer/general/adobe-reader.gif" alt="Download do Adobe Reader" /></a>
					...
					<p>&nbsp;</p>
					<p class="paragrafo">
						Para melhor atender você, a CAER mantem lojas de atendimento em vários pontos da cidade
					</p>
					<p>&nbsp;</p>
					...
					<ul style="width:100%;margin-top:25px;">
						<li style="width:100%;float:left;">
							<div class="box">
								...
								<br /><br />
								Todas as lojas de atendimento da CAER funcionam de segunda a sexta-feira das 07:30 às 17:00 horas 
							</div>
						</li>
					</ul>
	        		...
	        		<ul id="lista-informacoes">
		        		<li class="link">
		            		<a href="exibirLojasAtendimentoPresencialPortalCaerAction.do?local=regiaoMetropolitana" class="regiaoMetropolitana">
								<span>Boa Vista</span>
							</a>
		                </li>
		        		<li class="link">
		            		<a href="exibirLojasAtendimentoPresencialPortalCaerAction.do?local=interior" class="interior">
		        	...
		        	<div id="solicitacao-serv">
			        	...
			        	<html:form action="/exibirLojasAtendimentoPresencialPortalCaerAction.do"
								name="ExibirLojasAtendimentoPresencialPortalCaerActionForm"
								type="gcom.gui.portal.caer.ExibirLojasAtendimentoPresencialPortalCaerActionForm" method="post" >
			        	...
			        	<div id="details">
		        			<div id="lojas" style="width: 370px; float: left; margin-left: 2px; margin-top: 16px; min-height:370px;">
		        				<ul id="lista-informacoes">
		        					<logic:present name="colecaoLojas">
			        					<logic:iterate name="colecaoLojas" id="loja" scope="request" type="LojaAtendimentoCaerHelper">
				        					<li class="lista-loja">
		        			...
		        			<div class="detshow" style="background: url(/gsan/imagens/portal/caer/general/info-servico-top.gif) no-repeat 0 0 #f5f6f6; width: 470px; float: left; margin-left: 2px; margin-top: 16px; min-height:370px;">
		        				<div id="content-detalhe"></div> 
	        				</div>
        					<span class="detshow" style="background: url(/gsan/imagens/portal/caer/general/info-servico-bottom.gif) no-repeat scroll 0 0 transparent; float: left; height: 10px; width: 470px; margin-left:375px; ">&nbsp;</span>
		        		</div>
		        	</div>
	        	</div>
	       </div>
