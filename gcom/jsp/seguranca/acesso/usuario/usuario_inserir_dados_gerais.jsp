		 			...
		 			if(form.indicadorFuncionario.value == form.indicadorFuncionarioSIM.value){
		   				if (trim(form.idFuncionario.value) == '') {
			 				...
			 				achou = false;
		   					...
		   					alert('Informe Período de Cadastramento Final.');
			       			achou = false;
		   				}
		   				else if (trim(form.dataInicial.value) == '' && trim(form.dataFinal.value) != ''){
		   					alert('Informe Período de Cadastramento Inicial.');
			       			achou = false;
		   				}
		 			}
	   			}
	...
	<table width="770" border="0" cellspacing="5" cellpadding="0">
		<tr>
			...
			<table border="0" width="100%">
				...
				<tr>
					<td width="26%"><strong>Período de Cadastramento:<font
				...
				<tr>
					...
					<td width="74%"><html:text property="login" size="11"
						maxlength="11" style="text-transform: none;" />(matrícula do
					funcionário ou cpf do prestador de serviço)</td>
				</tr>
				<tr>
				...
				<tr>
					<td width="26%"><strong>Indicador de usuário para rotina batch:<font
						color="#ff0000">*</font></strong></td>
					<td width="74%">Sim <html:radio property="indicadorUsuarioBatch"
						value="1" onchange="javascript:desabilitaCPFeNasc();" /> Não <html:radio
						property="indicadorUsuarioBatch" value="2"
						onchange="javascript:desabilitaCPFeNasc();" /></td>
				</tr>

				<tr>
					<td width="26%"><strong>Indicador de usuário para internet:<font
						color="#ff0000">*</font></strong></td>
