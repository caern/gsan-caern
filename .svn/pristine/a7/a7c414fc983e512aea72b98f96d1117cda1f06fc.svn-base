...
<script language="JavaScript">
	...
	function validarExtraviado(){
		...
		var hidrometroExtraviado = form.hidrometroExtraviado.value;
		var hidrometroLocalArmazenagem = form.hidrometroLocalArmazenagem.value;

		/* 
		 * -Erivan Sousa- 03/08/2012
		 * Verifica se o indicador de extravio da situação informada
		 * obriga que seja informado um local de armazenagem
		 */
		if(hidrometroExtraviado == 'nao' && (hidrometroLocalArmazenagem == null ||
				hidrometroLocalArmazenagem == '-1')){
 ...
 function verificaSituacaoHidrometro(){
	 ...
	 /*
	  * -Erivan Sousa- 03/08/2012
	  * Envia solicitação para verificar o indicador 
	  * de extravio da situação informada
	  */
	 form.action='exibirEfetuarRetiradaHidrometroAction.do?verificarExtravio=sim';
     form.submit();
 }	
												...
												<tr bgcolor="#cbe5fe">
													...
													<table border="0" width="100%">
														...
														<tr>
															...
															<td>
															<logic:equal name="EfetuarRetiradaHidrometroActionForm" property="hidrometroExtraviado" value="sim">
																<html:select property="hidrometroLocalArmazenagem"
																	tabindex="4" styleId="localArmazenagemHidrometro" disabled="true">
															...
															<logic:notEqual name="EfetuarRetiradaHidrometroActionForm" property="hidrometroExtraviado" value="sim">
																<html:select property="hidrometroLocalArmazenagem"
