...
<script language="JavaScript" src="<bean:message key="caminho.js"/>validacao/regras_validator.js"></script><html:javascript staticJavascript="false" 
	formName="GerarRelatorioResumoSolicitacoesRAPorUnidadeActionForm" staticJavascript="false" dynamicJavascript="true"/>
...
<script language="JavaScript">
	...
	function reload() {
		...
		form.action = '/gsan/exibirGerarRelatorioResumoSolicitacoesRAPorUnidadeAction.do?onchange=true';
		form.submit();
	}
...
<html:form 
	action="/gerarRelatorioResumoSolicitacoesRAPorUnidadeAction" method="post"
	name="GerarRelatorioResumoSolicitacoesRAPorUnidadeActionForm"
	type="gcom.gui.atendimentopublico.registroatendimento.GerarRelatorioResumoSolicitacoesRAPorUnidadeActionForm">
		...
		<tr>
			...
			<table width="100%" border="0">
                ...
                <td colspan="6"><span class="style2"><strong>
					<html:select property="solicitacaoTipo" style="width: 350px; height:100px;" multiple="true" onchange="javascript:reload();habilitaEspecificacao();">
              ...
              <tr> 
				...
				<tr>
					...
					<td>
						<html:text property="idUnidade" maxlength="4" size="4"
							onkeypress="limparUnidadeSuperior(); validaEnterComMensagem(event, 'exibirGerarRelatorioResumoSolicitacoesRAPorUnidadeAction.do?objetoConsulta=1','idUnidade','Unidade Organizacional');" />
						...
						<logic:present name="unidadeEncontrada" scope="session">
							<html:text property="nomeUnidade" size="40" maxlength="40" readonly="true" style="background-color:#EFEFEF; border:0; color: #000000" />
						</logic:present>
						
						<logic:notPresent name="unidadeEncontrada" scope="session">
							<html:text property="nomeUnidade" size="40" maxlength="40" readonly="true" style="background-color:#EFEFEF; border:0; color: red" />
						</logic:notPresent>
				...
				<tr>
					...
					<td>
						<html:text property="idUnidadeSuperior" maxlength="4" size="4"
							onkeypress="limparUnidade(); validaEnterComMensagem(event, 'exibirGerarRelatorioResumoSolicitacoesRAPorUnidadeAction.do?objetoConsulta=2','idUnidadeSuperior','Unidade Superior');" />
						...
						<logic:present name="unidadeSuperiorEncontrada" scope="session">
							<html:text property="nomeUnidadeSuperior" size="40" maxlength="40" readonly="true" style="background-color:#EFEFEF; border:0; color: #000000" />
						</logic:present>
						
						<logic:notPresent name="unidadeSuperiorEncontrada" scope="session">
							<html:text property="nomeUnidadeSuperior" size="40" maxlength="40" readonly="true" style="background-color:#EFEFEF; border:0; color: red" />
						</logic:notPresent>
				...
				<tr>
					...
					<td>
						<html:text property="idMunicipio" maxlength="4" size="4"
							onkeypress="validaEnterComMensagem(event, 'exibirGerarRelatorioResumoSolicitacoesRAPorUnidadeAction.do?objetoConsulta=3','idMunicipio','Municipio');" />
						...
						<img width="23" height="21" border="0" src="<bean:message key="caminho.imagens"/>pesquisa.gif" title="Pesquisar Municipio" /></a> 
						
						<logic:present name="municipioEncontrado" scope="session">
							<html:text property="nomeMunicipio" size="40" maxlength="40" readonly="true" style="background-color:#EFEFEF; border:0; color: #000000" />
						</logic:present>
						
						<logic:notPresent name="municipioEncontrado" scope="session">
							<html:text property="nomeMunicipio" size="40" maxlength="40" readonly="true" style="background-color:#EFEFEF; border:0; color: red" />
						</logic:notPresent>
				...
				<tr>
					...
					<td>
						<html:text property="idBairro" maxlength="4" size="4"
							onkeypress="return validaEnterDependencia(event, 'exibirGerarRelatorioResumoSolicitacoesRAPorUnidadeAction.do?objetoConsulta=4', this, document.forms[0].idMunicipio.value, 'Município');" />
						
						<!-- 
						onkeypress="validaEnterComMensagem(event, 'exibirGerarRelatorioResumoSolicitacoesRAPorUnidadeAction.do?objetoConsulta=4','idBairro','Bairro');" />
						 -->
				...
				<tr>
					<td height="24"><input type="button" class="bottonRightCol"
						value="Limpar"
						onclick="window.location.href='/gsan/exibirGerarRelatorioResumoSolicitacoesRAPorUnidadeAction.do?menu=sim';" />
					</td>
	...
	<jsp:include
		page="/jsp/relatorio/escolher_tipo_relatorio.jsp?relatorio=gerarRelatorioResumoSolicitacoesRAPorUnidadeAction.do" />
