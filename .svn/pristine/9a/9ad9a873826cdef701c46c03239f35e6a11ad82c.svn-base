...
public class GerenciadorExecucaoTarefaRelatorio {
	...
	public static int obterProcessoRelatorio(String nomeRelatorio) {
		...
		} else if(nomeRelatorio.equals(ConstantesRelatorios.RELATORIO_ACOMPANHAMENTO_CLIENTES_NEGATIVADOS_PDF) || 
				  nomeRelatorio.equals(ConstantesRelatorios.RELATORIO_ACOMPANHAMENTO_CLIENTES_NEGATIVADOS_EXCEL)) {
    	...
    	} else if (nomeRelatorio.equals(ConstantesRelatorios.RELATORIO_ACOMPANHAMENTO_CLIENTES_NEGATIVADOS_SINTETICO_EXCEL) ||
    			   nomeRelatorio.equals(ConstantesRelatorios.RELATORIO_ACOMPANHAMENTO_CLIENTES_NEGATIVADOS_SINTETICO_PDF)) {
    	...
    	}  else if (nomeRelatorio.equals(ConstantesRelatorios.RELATORIO_ACOMPANHAMENTO_COMANDOS_COBRANCA)) {
            
            retornoCodigoProcesso = Processo.GERAR_RELATORIO_ACOMPANHAMENTO_COMANDOS_COBRANCA;
            
    	}  else if (nomeRelatorio.equals(ConstantesRelatorios.RELATORIO_IMOVEIS_CONTAS_RETIRADOS_EMPRESAS_COBRANCA)) {
            
            retornoCodigoProcesso = Processo.GERAR_RELATORIO_IMOVEIS_CONTAS_RETIRADOS_EMPRESAS_COBRANCA;
            
    	}    else if (nomeRelatorio.equals(ConstantesRelatorios.RELATORIO_COBRANCA_ATIVIDADE_MANTER)) {
            
            retornoCodigoProcesso = Processo.GERAR_RELATORIO_COBRANCA_ATIVIDADE_MANTER;
    	
    	}  else if (nomeRelatorio.equals(ConstantesRelatorios.RELATORIO_FILTRAR_DOCUMENTO_COBRANCA)) {
    		
    		retornoCodigoProcesso = Processo.GERAR_RELATORIO_DOCUMENTO_COBRANCA;
    		
    	}  else if(nomeRelatorio.equals(ConstantesRelatorios.RELATORIO_IMPOSTOS_POR_CLIENTE_RESPONSAVEL)){
    		
    		retornoCodigoProcesso =  Processo.GERAR_RELATORIO_IMPOSTOS_POR_CLIENTE_RESPONSAVEL;
    		
    	}  else if(nomeRelatorio.equals(ConstantesRelatorios.RELATORIO_IMPOSTOS_POR_CLIENTE_RESPONSAVEL_ANALITICO_ARRECADACAO)){
    		
    		retornoCodigoProcesso =  Processo.GERAR_RELATORIO_IMPOSTOS_POR_CLIENTE_RESPONSAVEL;
    		
    	} /*else if(nomeRelatorio.equals(ConstantesRelatorios.RELATORIO_CONTAS)){
    		
    		retornoCodigoProcesso =  Processo.GERAR_RELATORIO_CONTAS;
