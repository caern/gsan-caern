		...
		<table width="100%" border="0">
			...
			<logic:present name="colecaoDebitoACobrarConsultar" scope="session">
				<tr>
					...
					<!-- Parâmetros de fiscalização de débitos a cobrar -->
					<logic:present name="fiscalizarParametroCalculoDebito" scope="session">
						...
						<table>
							...
							<logic:notEmpty name="fiscalizarParametroCalculoDebito"
								...
								<tr>
									<td><strong>Número meses fatura:</strong></td>
									<td colspan="2" align="right">
										<div align="left">
												<html:text name="fiscalizarParametroCalculoDebito"
													property="numeroMesesFatura"
							...
							<logic:notEmpty name="fiscalizarParametroCalculoDebito"
								...
								<tr>
									<td><strong>Número máximo meses sanções:</strong></td>
									<td colspan="2" align="right">
										<div align="left">
												<html:text name="fiscalizarParametroCalculoDebito"
													property="numeroMaximoMesesSancoes"
							...
							<logic:notEmpty name="fiscalizarParametroCalculoDebito"
								property="dataCorte">
							<tr>
								<td><strong>Data do corte  ligação de água:</strong></td>
								<td colspan="2" align="right">
							...
							<tr>
								<td><strong>Data da supressão ligação água:</strong></td>
								<td colspan="2" align="right">
								<div align="left"><logic:notEmpty name="fiscalizarParametroCalculoDebito"
									property="dataSupressaoAgua">
									<input type="text" size="10" maxlength="10" readonly="true"
							...
							<tr>
								<td><strong>Data da geração do débito:</strong></td>
								<td colspan="2" align="right">
								<div align="left"><logic:notEmpty name="fiscalizarParametroCalculoDebito"
									property="dataGeracaoDebito">
									<input type="text" size="10" maxlength="10" readonly="true"
					...
					<logic:present name="demonstrativoFormulaCalculoHelper">
						<table width="100%" border="0">
							<tr align="center">
								<td align="center"><strong>DEMONSTRATIVO DA FÓRMULA DE CÁLCULO</strong></td>
							</tr>
							<tr>
								<td>&nbsp;</td>
							</tr>
						...
						<table>
							...
							<logic:notEmpty name="demonstrativoFormulaCalculoHelper"
								...
								<tr>
									<td colspan="2">
										<div align="left"> VALOR DA INFRAÇÃO: 
							...
							<logic:notEmpty name="demonstrativoFormulaCalculoHelper"
								...
								<tr>
									<td colspan="2">
										<div align="left"> NÚMERO DE MESES FATURA: 
										<html:text name="demonstrativoFormulaCalculoHelper"
													property="numeroMesesFatura"
													size="9" maxlength="9" readonly="true"
													style="background-color:#EFEFEF; border:0; text-align: right;" />									
							...
							<logic:notEmpty name="demonstrativoFormulaCalculoHelper"
								...
								<tr>
									<td colspan="2">
										<div align="left"> FATOR DE REINCIDÊNCIA: 
					...
					<!-- Final parâmetros de fiscalização de débitos a cobrar -->
					</div>
					</td>
				</tr>
			</logic:present>
