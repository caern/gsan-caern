 ...
 */
public class ResumoInstalacaoHidrometroHelper {
	...
	public ResumoInstalacaoHidrometroHelper(
			Integer idQuadra,
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof ResumoInstalacaoHidrometroHelper)) {
            return false;
        }
        ResumoInstalacaoHidrometroHelper castOther = (ResumoInstalacaoHidrometroHelper) other;
