...
function validarForm() {
	...
	if(validateInformarResumoSituacaoEspecialFaturamentoActionForm(form)){			
...
<html:form action="/informarResumoSituacaoEspecialFaturamentoAction.do"
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Consultar Resumo de Situação Especial de Faturamento</td>
					<td width="11"><img border="0"
			...
			<table border="0" width="100%">
				...
				<tr>
					<td><strong>Tipo de Relatório:</strong></td>
					<td colspan="3"><strong> <span class="style1"><strong> 
					<html:radio property="tipoRelatorio" value="<%=ConstantesSistema.ANALITICO.toString()%>" /> <strong> Analítico 
					<html:radio property="tipoRelatorio" value="<%=ConstantesSistema.SINTETICO.toString()%>"  /> Sintético
				...
				<tr>
					...
					<td><html:text maxlength="3"
						...
						onkeyup="javascript:limparLocalidadeInicialTecla(); validaEnter(event, 'exibirInformarResumoSituacaoEspecialFaturamentoAction.do', 'idLocalidadeInicial'); replicaDados(document.forms[0].idLocalidadeInicial, document.forms[0].idLocalidadeFinal);" />
					<a
				...
				<tr>
					...
					<td colspan="2" height="24"><html:text maxlength="3"
						...
						onkeyup="javascript:limparSetorComercialInicialTecla();replicaDados(document.forms[0].codigoSetorComercialInicial, document.forms[0].codigoSetorComercialFinal);return validaEnterDependencia(event, 'exibirInformarResumoSituacaoEspecialFaturamentoAction.do', this, document.forms[0].idLocalidadeInicial.value, 'Localidade');" /> <a
				...
				<tr>
					...
					<td><html:text maxlength="3"
						...
						onkeyup="javascript:limparLocalidadeFinalTecla(); validaEnter(event, 'exibirInformarResumoSituacaoEspecialFaturamentoAction.do', 'idLocalidadeFinal');" />
					<a
				...
				<tr>
					...
					<td colspan="2" height="24"><html:text maxlength="3"
						...
						onkeyup="javascript:limparSetorComercialFinalTecla();return validaEnterDependencia(event, 'exibirInformarResumoSituacaoEspecialFaturamentoAction.do', this, document.forms[0].idLocalidadeFinal.value, 'Localidade');" /> <a
				...
				<tr>
					...
					<div align="left"><html:select
						...
						<logic:present name="colecaoFatSitTipo">
							<html:option value="" />
							<html:options collection="colecaoFatSitTipo"
				...
				<td>
					...
					<div align="left"><html:select
						...
						multiple="mutiple" size="6">
						<logic:present name="colecaoFatSitMotivo">
							<html:option value="" />
							<html:options collection="colecaoFatSitMotivo"
								labelProperty="descricao" property="id" />
						</logic:present>
					</html:select></div>
					</td>
				...
				<tr>
					<td><input name="Submit22"
						...
						onclick="window.location.href='/gsan/exibirInformarResumoSituacaoEspecialFaturamentoAction.do?menu=sim';">
					</td>
