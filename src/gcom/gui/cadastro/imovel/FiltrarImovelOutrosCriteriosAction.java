...
public class FiltrarImovelOutrosCriteriosAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		filtrarImovelOutrosCriteriosHelper.setIndicadorNivelEsgoto(imovelLocalizacaoFiltrarActionForm.getIndicadorNivelEsgoto());
...
//		}
		...
		String indicadorNivelEsgoto = imovelLocalizacaoFiltrarActionForm.getIndicadorNivelEsgoto();
		...
		if(indicadorNivelEsgoto != null && !indicadorNivelEsgoto.equals("3")){
			peloMenosUmParametroInformado = true;
		}
