 ...
 * @since 10/10/2011
 */
public class ExibirFiltrarLogradouroMesmoNomeAction extends GcomAction {
    /**
    ...
    public ActionForward execute(ActionMapping actionMapping,
        ...
        ActionForward retorno = actionMapping.findForward("filtrarLogradouroMesmoNomeTela");
        ...
        Integer qtdLogradouro = fachada.pesquisarQuantidadeLogradouroMesmoNome(logradouroActionForm.getNome(),
        ...
        // 2º Passo - Chamar a função de Paginação passando o total de registros
     	retorno = this.controlarPaginacao(httpServletRequest, retorno,
     			qtdLogradouro.intValue());
        
     	// 3º Passo - Obter a coleção da consulta que aparecerá na tela passando o numero de paginas
     	// da pesquisa que está no request
        Collection<ExibirFiltrarLogradouroHelper> colecaoLogradouro = fachada.filtrarLogradouroMesmoNome(logradouroActionForm.getNome(), 
        		((Integer) httpServletRequest.getAttribute("numeroPaginasPesquisa")), new Integer(logradouroActionForm.getIdMunicipio()));
