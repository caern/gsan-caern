	...
	<table width="770" border="0" cellspacing="5" cellpadding="0">
		<tr>
			...
			<table width="100%" border="0">
				...
				<tr>
					<td><strong>Indicador Regra para o Cálculo de Consumo para Imóvel Condomínio: </strong></td>
					<td>
						<strong> 
						<html:radio property="indicadorRegraImovelCondominio" value="1" /> Sim 
						<html:radio property="indicadorRegraImovelCondominio" value="2" /> N&atilde;o 
						</strong>
					</td>
				</tr>
