<%@page import="gcom.gui.atualizacaocadastral.GerarRoteiroDispositivoMovelActionForm"%>
...
<%@ page import="gcom.atualizacaocadastral.bean.ImoveisRoteiroDispositivoMovelDMHelper"%>
			...
			<td width="620" valign="top" bgcolor="#003399" class="centercoltext">
				...
				<table width="100%" border="0">
		            ...
		            <tr>
						...
						<td>
							<strong> 
								<label><html:radio property="clienteUsuario" value="1" /> Com Documento Principal</label> 
								<label><html:radio property="clienteUsuario" value="2" /> Sem Documento Principal</label>
