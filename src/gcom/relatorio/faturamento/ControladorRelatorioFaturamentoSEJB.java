...
public class ControladorRelatorioFaturamentoSEJB implements SessionBean {
	...
	private Collection<EmitirHistogramaAguaEconomiaHelper> emitirHistogramaAguaEconomiaEstado(
		...
		List colecaoCategorias = new ArrayList(linkedHashMapConsumoFaixaCategoria.keySet());
		
		// ORDENA COLEÇÃO POR ID DA CATEGORIA
		Collections.sort(colecaoCategorias, new Comparator() {
			public int compare(Object left, Object right) {
				Integer leftKey = Integer.valueOf(String.valueOf(left));
				Integer rightKey = Integer.valueOf(String.valueOf(right));
		...
		while (itera.hasNext()) {
			...
			filtroCategoria.adicionarParametro(
				new ParametroSimples(FiltroCategoria.CODIGO, new Integer(idCategoria)));
			...
			if ( filtro.getIndicadorTarifaCategoria().intValue() == 1 ){
				...
				filtroSubcategoria.adicionarParametro( new ParametroSimples( FiltroSubCategoria.CATEGORIA_ID, new Integer(idCategoria) ) );
				...
				filtroSubcategoria.setCampoOrderBy( "codigo" );				
				Collection colSubcategoria = new ArrayList();
				
				if (filtro.getColecaoSubcategoria() != null && !filtro.getColecaoSubcategoria().isEmpty()){
					
					filtroSubcategoria.adicionarParametro( new ParametroSimplesIn( FiltroSubCategoria.ID, filtro.getColecaoSubcategoria() ) );
					...
					if (colSubcategoria == null || colSubcategoria.isEmpty()){
				...
				if (colSubcategoria != null && !colSubcategoria.isEmpty()){
					...
					while ( iteSubcategoria.hasNext() ){			
						...
						//SERÃO APRESENTADAS APENAS AS SUBCATEGORIAS QUE TIVERAM SIDO GERADAS NO HISTOGRAMA
						Collection<EmitirHistogramaAguaEconomiaDetalheHelper> colecaoDetalheParaVerificacao = new ArrayList();
						int quantidadeFaixaComValoresParaVerificacao = 0;
						...
						while (iteraFaixas.hasNext()) {
							...
							colecaoDetalheParaVerificacao.add(detalhe);
							
							if(detalhe.isExisteHistograma()){
								quantidadeFaixaComValoresParaVerificacao++;
							}
						}
						
						if (totalEconomiasMedidoSubcategoria.intValue() > 0 || totalLigacaoNaoMedidoSubcategoria.intValue() > 0){
							
							colecaoEmitirHistogramaAguaEconomiaDetalhe.addAll(colecaoDetalheParaVerificacao);
							quantidadeFaixaComValores = quantidadeFaixaComValores + quantidadeFaixaComValoresParaVerificacao;
							
							EmitirHistogramaAguaEconomiaDetalheHelper totalSubcategoria = new EmitirHistogramaAguaEconomiaDetalheHelper ();
	...
	private Collection<EmitirHistogramaAguaEconomiaHelper> emitirHistogramaAguaEconomiaGerenciaRegional(
		...
		if(hashMapTotalGeral != null && !hashMapTotalGeral.isEmpty()){
			...
			// ORDENA COLEÇÃO POR ID DE CATEGORIA
			Collections.sort(colecaoCategorias, new Comparator() {
				public int compare(Object left, Object right) {
					Integer leftKey = Integer.valueOf(String.valueOf(left));
					Integer rightKey = Integer.valueOf(String.valueOf(right));
			...
			while (iter.hasNext()) {
				...
				filtroGerencia.adicionarParametro(
					new ParametroSimples(FiltroGerenciaRegional.ID, new Integer(IdGerencia)));
						...
						if (colSubcategoria != null && !colSubcategoria.isEmpty()){
							...
							while ( iteSubcategoria.hasNext() ){			
								...
								while (iteraFaixas.hasNext()) {
									...
									//colecaoEmitirHistogramaAguaEconomiaDetalhe.add(detalhe); *************************************8
...
*/					
	...
	private Collection<EmitirHistogramaAguaEconomiaHelper> emitirHistogramaAguaEconomiaUnidadeNegocioGerenciaRegional(
		...
		if(hashMapTotalGeral != null && !hashMapTotalGeral.isEmpty()){
			...
			// ORDENA COLEÇÃO PELO ID DA CATEGORIA
			Collections.sort(colecaoCategorias, new Comparator() {
				public int compare(Object left, Object right) {
					Integer leftKey = Integer.valueOf(String.valueOf(left));
					Integer rightKey = Integer.valueOf(String.valueOf(right));
			...
			while (iter.hasNext()) {
				...
				filtroUnidadeNegocio.adicionarParametro(
					new ParametroSimples(FiltroUnidadeNegocio.ID, new Integer(arrayNumeracao[0])));
		...
		if(hashMapTotalGeral != null && !hashMapTotalGeral.isEmpty()){
			...
			while (iter.hasNext()) {
				...
				filtroLocalidade.adicionarParametro(
					new ParametroSimples(FiltroLocalidade.ID, new Integer(arrayNumeracao[0])));
	...
	private Collection<EmitirHistogramaAguaEconomiaHelper> emitirHistogramaAguaEconomiaUnidadeNegocio(
		...
		if(hashMapTotalGeral != null && !hashMapTotalGeral.isEmpty()){
			...
			while (iter.hasNext()) {
				...
				filtroUnidadeNegocio = new FiltroUnidadeNegocio();
				filtroUnidadeNegocio.adicionarParametro(
					new ParametroSimples(FiltroUnidadeNegocio.ID, new Integer(idUnidadeNegocio)));
				filtroUnidadeNegocio.adicionarCaminhoParaCarregamentoEntidade("gerenciaRegional");
	...
	private Collection<EmitirHistogramaAguaEconomiaHelper> emitirHistogramaAguaEconomiaEloPolo(
		...
		if(hashMapTotalGeral != null && !hashMapTotalGeral.isEmpty()){
			...
			while (iter.hasNext()) {
				...
				filtroLocalidade = new FiltroLocalidade();
				filtroLocalidade.adicionarParametro(
					new ParametroSimples(FiltroLocalidade.ID, new Integer(idEloPolo)));
		...
		if(hashMapTotalGeral != null && !hashMapTotalGeral.isEmpty()){
			...
			while (iter.hasNext()) {
				...
				filtroSetorComercial.adicionarParametro(
					new ParametroSimples(FiltroSetorComercial.CODIGO_SETOR_COMERCIAL, new Integer(arrayNumeracao[0])));
	...
	private Collection<EmitirHistogramaAguaEconomiaHelper> emitirHistogramaAguaEconomiaLocalidade(
		...
		if(hashMapTotalGeral != null && !hashMapTotalGeral.isEmpty()){
			...
			while (iter.hasNext()) {
				...
				filtroLocalidade = new FiltroLocalidade();
				filtroLocalidade.adicionarParametro(
					new ParametroSimples(FiltroLocalidade.ID, new Integer(idLocalidade)));
		...
		if(hashMapTotalGeral != null && !hashMapTotalGeral.isEmpty()){
			...
			while (iter.hasNext()) {
				...
				filtroQuadra.adicionarParametro(
					new ParametroSimples(FiltroQuadra.ID, new Integer(arrayNumeracao[0])));
	...
	private Collection<EmitirHistogramaAguaEconomiaHelper> emitirHistogramaAguaEconomiaSetorComercial(
		...
		if(hashMapTotalGeral != null && !hashMapTotalGeral.isEmpty()){
			...
			while (iter.hasNext()) {
				...
				filtroSetorComercial = new FiltroSetorComercial();
				filtroSetorComercial.adicionarParametro(
					new ParametroSimples(FiltroSetorComercial.ID, new Integer(idSetorComercial)));
...
*/					
	...
	private Collection<EmitirHistogramaAguaEconomiaHelper> emitirHistogramaAguaEconomiaQuadra(
		...
		if(hashMapTotalGeral != null && !hashMapTotalGeral.isEmpty()){
			...
			while (iter.hasNext()) {
				...
				filtroQuadra = new FiltroQuadra();
				filtroQuadra.adicionarParametro(new ParametroSimples(FiltroQuadra.ID, new Integer(idQuadra)));
	...
	private EmitirHistogramaAguaEconomiaDetalheHelper montarEmitirHistogramaAguaEconomiaDetalheHelper(
		...
		if(valoresSomatorio != null){
			...
			if(valoresSomatorio.length>9){
				if(filtro.getIndicadorSimulacao().equals(ConstantesSistema.SIM)){
					detalhe.setReceitaMedido((BigDecimal)valoresSomatorio[9]);
				}
			}
			
		}else{
			detalhe.setEconomiasMedido(0);
			detalhe.setVolumeConsumoFaixaMedido(0);
			detalhe.setVolumeFaturadoFaixaMedido(0);
			detalhe.setReceitaMedido(new BigDecimal(0.0));
			detalhe.setLigacoesMedido(0);
			
			detalhe.setConsumoMedioMedido(new BigDecimal(0.0));
			detalhe.setConsumoExcedenteMedido(new BigDecimal(0.0));
			detalhe.setReceitaMedido(new BigDecimal(0.0));
		}
		...
		if(valoresSomatorio != null){
			...
			if(valoresSomatorio.length>9){
				if(filtro.getIndicadorSimulacao().equals(ConstantesSistema.SIM)){
					detalhe.setReceitaNaoMedido((BigDecimal)valoresSomatorio[9]);
				}
				
			}
			
		}else{
			detalhe.setEconomiasNaoMedido(0);
			detalhe.setVolumeConsumoFaixaNaoMedido(0);
			detalhe.setVolumeFaturadoFaixaNaoMedido(0);
			detalhe.setReceitaNaoMedido(new BigDecimal(0.0));
			detalhe.setLigacoesNaoMedido(0);
			
			detalhe.setConsumoMedioNaoMedido(new BigDecimal(0.0));
			detalhe.setConsumoExcedenteNaoMedido(new BigDecimal(0.0));
			detalhe.setReceitaNaoMedido(new BigDecimal(0.0));
		}
			...
			if ( filtro.getIndicadorTarifaCategoria().intValue() == 1 ){
				...
				if (colSubcategoria != null && !colSubcategoria.isEmpty()){
					...
					while ( iteSubcategoria.hasNext() ){			
						...
						EmitirHistogramaEsgotoEconomiaDetalheHelper totalSubcategoria =
								new EmitirHistogramaEsgotoEconomiaDetalheHelper ();
						...
						colecaoEmitirHistogramaEsgotoEconomiaDetalhe.add(totalSubcategoria);
					}
				}
			}
