...
public class  RepositorioGerencialCadastroHBM implements
	 ...
	 * por imovel
	 * 
	 * @author Bruno Barrros, Ivan Sérgio
	...
	public List consultarResumoLigacoesEconomias(
		...
		// retorna a coleï¿½ï¿½o com os resultados da pesquisa
		return retorno;
	}
	...
	/**
	 * Verifica se o imï¿½vel possue hidrometro
	 * 
	 * @author Bruno Barros
	 * @date 23/05/2007
	 * 
	 * @param idImovel
	 *            id do imovel que terï¿½ seu consumo verificado *
	 * @return 1 se possuir hidrimetro, 2 senï¿½o
	 * @throws ErroRepositorioException
	 */
	  ...
	  throws ErroRepositorioException {
		...
		try {
			String hql = 
				...
				"   inner join ct.consumoTarifaVigencias ctv with( to_char(ctv.dataVigencia, 'yyyymm') <= (select sp.anoMesFaturamento from SistemaParametro sp) ) " +
	 ...
	 * por imovel
	 * 
	 * @author Marcio Roberto, Ivan Sérgio
	 * @date 20/09/2007, 30/07/2008
	 * @alteracao: Ivan Sérgio - 30/07/2008 - Adicionado o AnoMesFaturamento para agilizar o processo.
	 * 			   Ivan Sérgio - 22/09/2008 - CRC185 - Considerar somente os imóveis que foram faturados.
	 * 
	 * @param idSetor
	 *            id do Setor a ser pesquisado
	...
	public List getHistoricosColetaEsgoto(int idSetor, Integer anoMesFaturamento)
		...
		try {
			String hql = 
				...
				// 18 - Indicador de consumo mínimo
				"  case when ( leImo.consumoMinimo > 0 ) then \n" +
				"    1 \n" +
				"  else \n" +
				"    2 \n" +
				"  end, \n" +
				// 19 - Percentual da ligação de esgoto
...
//				"  ch.indicadorFaturamento = 1 "
			...
			// HQL ANTIGO, QUE NÃO LEVA A CONTA EM CONSIDERAÇÃO PARA SELEÇÃO DOS DADOS			
//			String hq2 = " select " +
//				 "    imovel.id, " +                                    // Imovel
...
//				 "     1 " +                                                           // 20 |
//				 "   else " +                                                          // 20 +- Existencia de Hidrometro no Poï¿½o
//				 "     2 " +                                                           // 20 |  
//				 "   end, " +                                                          // 20 ]
	...
	public void inserirResumoColetaEsgoto(Integer anoMesReferencia,
		...
		try {
			...
			insert = "insert into micromedicao.un_resumo_coleta_esgoto ("
					...
					// Ic medido de Agua deve ser zero, pois esse informação já está
					// gravada no ichidrometro
					+ "0,"														 // 28
      ...
      public void excluirResumoGerencial ( 
    	...
    	unidadeProcessamento = " and " + resumoCampoUnidadeProcessamento + " in ( " + idUnidadeProcessamento + " , null ) ";
 		...
 		try {
 			...
 			// levanta a excessao para a próxima camada
 			throw new ErroRepositorioException(e, "Erro no Hibernate");
 		} finally {
 			// fecha a sessão
 			HibernateUtil.closeSession(session);
 ...
 */
 ...
 public void excluirResumoGerencialC ( int anomesreferencia , String resumoGerencial, String resumoCampoAnoMes, String campoEspecifico, int idcampoespecifico) throws ErroRepositorioException{
	 ...
	 * @date 25/08/2008
 	...
 	/**
	 * Método que retona uma lista de objeto que representa o agrupamento
	 * id do imovel id gerencia regional id licalidade id do setor comercial
...
//				"  end, \n" +
				...
				"  coalesce( ch.referenciaFaturamento, 0 ), \n" +
				// 15 - Indicador de consumo mínimo
				"  case when ( leImo.consumoMinimo > 0 ) then \n" +
				"    1 \n" +
				"  else \n" +
				"    2 \n" +
				"  end, \n" +
				// 16 - Percentual da ligação de esgoto
				"  case when ( leImo.percentual > 0 ) then \n" +
				"    0.0 \n" +
				"  else \n" +
				"    coalesce( leImo.percentual, 0.0 ) \n" +
