...
public interface IRepositorioFaturamento {
	...
	public Collection consultarResumoFaturamentoRelatorioPorEstadoPorGerenciaRegional(
			int anoMesReferencia,String opcaoRelatorio) throws ErroRepositorioException;
	...
	public Collection consultarResumoFaturamentoRelatorioPorGerenciaRegional(
			int anoMesReferencia, Integer gerenciaRegional,String opcaoRelatorio)
			throws ErroRepositorioException;
...
//  retorna o anoMes do faturamento grupo do imóvel passado
	...
	public Collection consultarResumoFaturamentoRelatorioPorUnidadeNegocio(
			int anoMesReferencia, Integer unidadeNegocio,String opcaoRelatorio) throws ErroRepositorioException;
 ...
 */
	 ...
	 *
	 * Atualizar a conta que está sendo cancelada com o ra que está autorizando o cancelamento da mesma.
	 *
	 * @author Raphael Rossiter
	 * @date 17/06/2008
	 *
     ...
     * 
     * Verifica se esse grupo de Faturamento já está comandado para a atividade Gerar Arquivo de Leitura
     * 
...
//		throws ErroRepositorioException;
	 ...
	 * que estão em movimento conta pre faturada para
	 * um ano mes e rota
	 * 
	 * @param anoMesReferencia
	 * @param idRota
	...
	* [UC1166]  Gerar  txt para impressão de contas no formato braille
	 ...
	 * [UC0113] Faturar Grupo de Faturamento
	 *
	 * [RM5773] - Não colocar na tabela conta impressão as contas com anormalidade informada que 
	 *            tinha indicador de não imprimir conta (ltan_icnaoimprimirconta) igual a 1 (SIM).
	 * Analista: Sávio Cavalcante
	 * 
