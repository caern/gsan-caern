		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Filtrar Imóvel Perfil</td>
			...
			<table width="100%" border="0">
				<tr>
					<td colspan="2">Para filtrar o imóvel perfil, informe os dados
					abaixo:</td>					
			   ...
			   <tr>
				...
				<tr>
					...
					<html:radio property="indicadorUso" tabindex="3" value="2" /><strong>Não</strong>
				...
				<tr>
					...
					<html:radio property="indicadorGeracaoAutomatica" tabindex="3" value="2" /><strong>Não</strong>
				...
				<tr>
					...
					<html:radio property="indicadorInserirManterPerfil" tabindex="3" value="2" /><strong>Não</strong>
				...
				<tr>
					...
					<html:radio property="indicadorGerarDadosLeitura" tabindex="3" value="2" /><strong>Não</strong>
				...
				<tr>
					...
					<html:radio property="indicadorBloquearRetificacao" tabindex="3" value="2" /><strong>Não</strong>
				...
				<tr>
					...
					<html:radio property="indicadorGrandeConsumidor" tabindex="3" value="2" /><strong>Não</strong>
				...
				<tr>
					...
					<html:radio property="indicadorBloquearDadosSocial" tabindex="3" value="2" /><strong>Não</strong>
				...
				<tr>
					...
					<html:radio property="indicadorGeraDebitoSegundaViaConta" tabindex="3" value="2" /><strong>Não</strong>
				...
				<tr>
					...
					<html:radio property="indicadorNegativacaoDoCliente" tabindex="3" value="2" /><strong>Não</strong>
				...
				<tr>
					<td><strong>Indicador Corporativo:<font color="#FF0000"></font></strong></td>
					<td><html:radio property="indicadorCorporativo" tabindex="2" value="1" /><strong>Sim</strong>
					<html:radio property="indicadorCorporativo" tabindex="3" value="2" /><strong>Não</strong>
