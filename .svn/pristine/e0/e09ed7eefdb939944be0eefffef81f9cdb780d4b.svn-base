...
public class InserirComandoNegativacaoActionForm extends ValidatorActionForm {
	...
	private String tipo;
	private boolean alterarSoCPFCNPJValidos;
	private boolean habilitarDesabilitarCampos;
	...
	private String indicadorCpfCnpjValido;
	...
	public void reset(){
		...
		this.indicadorCpfCnpjValido = ConstantesSistema.NAO.toString();
	}
	...
	public String getIndicadorCpfCnpjValido() {
		return indicadorCpfCnpjValido;
	}

	public void setIndicadorCpfCnpjValido(String indicadorCpfCnpjValido) {
		this.indicadorCpfCnpjValido = indicadorCpfCnpjValido;
	}

	public boolean getAlterarSoCPFCNPJValidos() {
		return alterarSoCPFCNPJValidos;
	}

	public void setAlterarSoCPFCNPJValidos(boolean alterarSoCPFCNPJValidos) {
		this.alterarSoCPFCNPJValidos = alterarSoCPFCNPJValidos;
	}
