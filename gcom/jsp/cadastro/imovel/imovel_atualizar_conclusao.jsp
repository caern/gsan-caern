...
<!-- Begin
	...
	function validarUTM(){
		...
		var retorno = true;
	    var textX = form.cordenadasUtmX.value;
	    var textY = form.cordenadasUtmY.value;
	    ...
	    if( trim(textX).length > 0){
		    valor = parseFloat(textX);
	    	if ((!isNaN(valor))==false){
	        	alert("Cordenadas Utm X deve ser um número decimal.");
				return false;
	        }
		}else if(trim(textY).length > 0){
		    valor = parseFloat(textY);
	    	if ((!isNaN(valor))==false){
	        	alert("Cordenadas Utm Y deve ser um número decimal.");
				return false;
	        }
		}
    ...
    function validateManterImovelActionForm(form) {
   	...
   	function caracteresespeciais () {
    	...
    	this.aa = new Array("numeroPontos", "Número de Pontos deve somente conter números positivos.", new Function ("varName", " return this[varName];"));
     	this.ab = new Array("numeroMoradores", "Número de Moradores deve somente conter números positivos.", new Function ("varName", " return this[varName];"));
     	this.ac = new Array("numeroIptu", "Número de IPTU deve somente conter números positivos.", new Function ("varName", " return this[varName];"));
     	this.ad = new Array("numeroContratoCelpe", "Contrato Companhia de Energia deve somente conter números positivos.", new Function ("varName", " return this[varName];"));
     	this.ae = new Array("idImovel", "Imóvel Principal possui caracteres especiais.", new Function ("varName", " return this[varName];"));
     	this.af = new Array("sequencialRotaEntrega", "Sequencial da Rota de Entrega deve somente conter números positivos.", new Function ("varName", " return this[varName];"));
		this.ag = new Array("idFuncionario", "Funcionário deve somente conter números positivos.", new Function ("varName", " return this[varName];"));     	
		this.ah = new Array("informacoesComplementares", "Informações Complementares deve somente conter números positivos.", new Function ("varName", " return this[varName];"));
    }
			...
			<table width="100%" border="0">			    
				...
				<tr>
					...
					<a href="javascript:abrirPopup('exibirPesquisarInformarRotaLeituraAction.do?limparForm=sim', 400, 800);">
						...
						<img border="0" 
							...
							border="0"
							title="Código da Rota de Entrega"/></a> 
				...
				<tr>
					...
					<img border="0" 
						src="<bean:message key="caminho.imagens"/>pesquisa.gif" 
						border="0" 
						title="Código da Rota de Alternativa"/></a>
				...
				<tr>
					...
					<td><html:text maxlength="25" property="cordenadasUtmX"
						...
						onkeyup="javaScript:formataCoordenada(this,24);"
						onkeypress="return isNumericoComPontuacao(event)"/></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<a
						...
						title="Pesquisar Imóvel Principal"/></a>
