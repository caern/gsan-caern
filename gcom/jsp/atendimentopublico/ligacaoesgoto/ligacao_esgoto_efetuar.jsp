									...
									<logic:equal name="funcionalidade" value="comRA">
										...
										<tr>
											...
											<td><span class="style2"> <html:text
												...
												onkeypress="validaEnterComMensagem(event, 'exibirEfetuarLigacaoEsgotoAction.do', 'idOrdemServico','Ordem de Serviço'); return isAlfaNumerico(event);"
										...
										<tr>
											...
											<td><html:text
												...
												onkeypress="validaEnterComMensagem(event, 'exibirEfetuarLigacaoEsgotoAction.do', 'matriculaImovel','Matrícula do Imóvel'); return isAlfaNumerico(event);"
