...
public class ComandoEmpresaCobrancaContaExtensao extends ObjetoTransacao {
	...
	private Integer numeroDiasVencimentoContas;
	...
	public Integer getNumeroDiasVencimentoContas() {
		return numeroDiasVencimentoContas;
	}

	public void setNumeroDiasVencimentoContas(Integer numeroDiasVencimentoContas) {
		this.numeroDiasVencimentoContas = numeroDiasVencimentoContas;
	}
