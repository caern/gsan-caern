    ...
    <table height="100%">
      ...
      <table width="100%" border="0">
        <tr>
          ...
          <td width="86%" colspan="3"><html:text maxlength="3" property="idLocalidade" size="3" tabindex="1" onkeypress="return isCampoNumerico(event);" /></td>
        </tr>
        <tr>
          <td height="0"><strong>Descrição:</strong></td>
          <td colspan="3"><html:text maxlength="30" property="descricaoLocalidade" size="35" tabindex="2" onkeypress="return validacaoCaracteresEspeciais(event);" />
          </td>
        </tr>
        <tr>
			<td>&nbsp;</td>
