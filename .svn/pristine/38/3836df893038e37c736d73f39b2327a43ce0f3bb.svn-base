	...
	<td width="625" valign="top" class="centercoltext">
      ...
      <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          ...
          <td class="parabg"><font style="font-size: 9px;">ICN - Por Critério - Dados Gerais</font></td>
...
<script>
document.getElementsByName('avancar').onclick = function() { botaoAvancarTelaEspera('/gsan/inserirComandoNegativacaPorCriterioWizardAction.do?concluir=true&action=inserirComandoNegativacaoDadosGeraisAction'); }
</script>
