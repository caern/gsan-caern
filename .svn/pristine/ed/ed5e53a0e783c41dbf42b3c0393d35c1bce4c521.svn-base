...
//			imovelParametrosInicial.setNomeConta(nomeConta);
			...
			//Indicador de nível de esgotamento
			relatorioManterImovelOutrosCriterios.addParametro(
					"indicadorNivelEsgotamento", imovelOutrosCriteriosActionForm
							.getIndicadorNivelEsgoto());
			
			//Indicador CPF/CNPJ informado
			relatorioManterImovelOutrosCriterios.addParametro("indicadorCpfCnpjInformado", 
			...
			Collection imoveisLista = (Collection) sessao.getAttribute("imoveisLista");					
			...
			String cepCodigo = (String) sessao.getAttribute("cep");
			Integer numeroPaginas = (Integer) sessao.getAttribute("numeroPaginas");
			
			if(numeroPaginas == null){
				numeroPaginas = 0;
			}					
				
			//buscar imóveis do filtro
			imoveisLista = fachada.pesquisarImovelRelatorio(
				matricula, 
				idLocalidade, 
