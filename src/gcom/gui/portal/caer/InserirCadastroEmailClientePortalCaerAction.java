	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		if (httpServletRequest.getParameter("confirmar") == null || 
			...
			if (httpServletRequest.getParameter("enviarEmail") != null && 
				...
				mensagem = mensagem
					+ " - Você acessou o site da Caer para cadastrar seu email e/ou alterar os dados cadastrais ? Caso positivo clique no link abaixo:  \n \n \n"
					+ url
				...
				try {
					...
					httpServletRequest.setAttribute("erroEnvioEmail", "Não foi possível enviar o e-mail. Tente novamente mais tarde");
				}
