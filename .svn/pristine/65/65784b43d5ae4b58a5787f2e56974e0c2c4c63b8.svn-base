...
public class HistogramaEsgotoEconomiaHelper {
	...
	public HistogramaEsgotoEconomiaHelper(
	...
	public boolean equals( Object obj ){
		...
		if ( !( obj instanceof HistogramaEsgotoEconomiaHelper ) ){
			return false;			
		} else {
			HistogramaEsgotoEconomiaHelper resumoTemp = ( HistogramaEsgotoEconomiaHelper ) obj;
