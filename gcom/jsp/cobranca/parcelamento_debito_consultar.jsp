				...
				<tr>
					...
					<table width="100%" align="center" bgcolor="#99CCFF" border="0">
						<tr bordercolor="#90c7fc">
							...
							<td bgcolor="#90c7fc" align="center"><strong>Sobre Débito Total</strong></td>
							<td bgcolor="#90c7fc" align="center"><strong>Sobre Tipo Débito Total</strong></td>
						...
						<tr>
							<td colspan="3" align="right">
									...
									<logic:equal name="cobrancaCarne" value="SIM" scope="request">
										<input type="button" name="" value="Emitir Carnê" class="bottonRightCol" 
