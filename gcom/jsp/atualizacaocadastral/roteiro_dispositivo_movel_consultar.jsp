...
<link rel="stylesheet"
	...
	<%@ page import="gcom.atualizacaocadastral.bean.AtualizacaoCadastralArquivoTextoHelper "%>
...
<html:form action="/consultarRoteiroDispositivoMovelAction"
	...
	type="gcom.gui.cadastro.ConsultarRoteiroDispositivoMovelActionForm"
	method="post"
											...
											<td width="10%" align="center">
												<c:choose>
													<c:when test='${atualizacaoCadastralArquivoTextoHelper.idSituacaoArquivo != null 
														...
														<a href="/gsan/transmitirAtualizacaoCadastralArquivoTextoAction.do?idArquivo=${atualizacaoCadastralArquivoTextoHelper.id}&idSituacaoArquivo=${atualizacaoCadastralArquivoTextoHelper.idSituacaoArquivo}" > 
