...
public class InformarSistemaParametrosActionForm extends ValidatorActionForm {
	...
	private String indicadorValidaCpfCnpj;
	private String indicadorNomeClienteAtualConta;
	private String msgVencimentoGuiaEntradaParc;
	private String tamanhoMaximoAnexoRA;
	private String resolucaoImagem;
	private String indicadorAlterarNomeClienteCpfCnpjValidado;
	...
	private String indicadorUtilizaTarifaSimulacao;
	...
	private String numeroConvenioFichaCompensacao;
	private String valorMaximoBaixado;	
	private String diferencaMaximaBaixado;
	private String indicadorCarteira17;
	...
	private String indicadorCalcAcresImpontGuiaPagamento;
	private String indicadorExcluirNegativacaoAposPgmto;
	...
	private String indicadorCriticarConteudoRetornoMovimentoNegativacao; 
	private String indicadorCanceNegatContaVencAlter;
	private String indicadorTotalDebito;
	
	private String numeroDiasVencContaEntradaParcelamento;
	private String numeroDiasCancelamentoEntradaParcelamento;
	private String indicadorRateioAreaComumImovelNaoFat;
	
	private String indicadorAcaoPredecessoraImoveisArquivoTexto;
	private String indicadorPermissaoAlteracaoClienteNegativado;
	...
	private String qtdDiasGuardarOcorrenciasParalisacao;
	private String indicadorDocObrAtendimentoOperacional;
	private String indicadorDocObrAtendimentoComercial;
	private String indicadorDocObrInformacao;
	private String indicadorDocObrReiteracao;
	
	private String descricaoRegulamento;
	private FormFile arquivoRegulamento;
	...
	//RM 5759
	private String indicadorPermiteCancelarDebito="2";

	private String numeroDiasEnvioContaEmpresaCobranca; 
	private String numeroDiaRetiradaContaEmpresaCobraca;
	private String IndicadorIncluirContasForaVenCobranca; 
	private String indicadorBloquearFunUsuario;
	private String quantidadeDiasValidadeCerticaoNegativa;
	
	private String numeroTelefoneAtendimentoEsgoto;
	
	private String situacaoAguaExclusaoImovel;
	
	private String situacaoEsgotoExclusaoImovel;
	
	private String tamanhoMaximoMensagemSms;
	...
	public String getQuantidadeDiasValidadeCerticaoNegativa() {
		return quantidadeDiasValidadeCerticaoNegativa;
	}

	public void setQuantidadeDiasValidadeCerticaoNegativa(
			String quantidadeDiasValidadeCerticaoNegativa) {
	...
	public String getIndicadorUtilizaTarifaSimulacao() {
		return indicadorUtilizaTarifaSimulacao;
	}
	
	public void setIndicadorUtilizaTarifaSimulacao(String indicadorUtilizaTarifaSimulacao) {
	...
	public String getIndicadorCriticarConteudoRetornoMovimentoNegativacao() {
	...
	public void setIndicadorCriticarConteudoRetornoMovimentoNegativacao(
			String indicadorCriticarConteudoRetornoMovimentoNegativacao) {
		this.indicadorCriticarConteudoRetornoMovimentoNegativacao = indicadorCriticarConteudoRetornoMovimentoNegativacao;
	}

	
	public String getNumeroConvenioFichaCompensacao() {
		return numeroConvenioFichaCompensacao;
	}

	public void setNumeroConvenioFichaCompensacao(String numeroConvenioFichaCompensacao) {
		this.numeroConvenioFichaCompensacao = numeroConvenioFichaCompensacao;
	}
	
	public String getValorMaximoBaixado() {
		return valorMaximoBaixado;
	}

	public void setValorMaximoBaixado(String valorMaximoBaixado) {
		this.valorMaximoBaixado = valorMaximoBaixado;
	}
	
	public String getDiferencaMaximaBaixado() {
		return diferencaMaximaBaixado;
	}

	public void setDiferencaMaximaBaixado(String diferencaMaximaBaixado) {
		this.diferencaMaximaBaixado = diferencaMaximaBaixado;
	}	

	public String getIndicadorCarteira17() {
		return indicadorCarteira17;
	}

	public void setIndicadorCarteira17(String indicadorCarteira17) {
		this.indicadorCarteira17 = indicadorCarteira17;
	}

	public String getIndicadorCanceNegatContaVencAlter() {
		return indicadorCanceNegatContaVencAlter;
	}

	public void setIndicadorCanceNegatContaVencAlter(
			String indicadorCanceNegatContaVencAlter) {
		this.indicadorCanceNegatContaVencAlter = indicadorCanceNegatContaVencAlter;
	}

	public String getIndicadorTotalDebito() {
		return indicadorTotalDebito;
	}

	public void setIndicadorTotalDebito(String indicadorTotalDebito) {
		this.indicadorTotalDebito = indicadorTotalDebito;
	}	

	public String getNumeroDiaRetiradaContaEmpresaCobraca() {
		return numeroDiaRetiradaContaEmpresaCobraca;
	}

	public void setNumeroDiaRetiradaContaEmpresaCobraca(
			String numeroDiaRetiradaContaEmpresaCobraca) {
		this.numeroDiaRetiradaContaEmpresaCobraca = numeroDiaRetiradaContaEmpresaCobraca;
	}
	
	
	public String getIndicadorIncluirContasForaVenCobranca() {
		return IndicadorIncluirContasForaVenCobranca;
	}

	public void setIndicadorIncluirContasForaVenCobranca(
			String indicadorIncluirContasForaVenCobranca) {
		IndicadorIncluirContasForaVenCobranca = indicadorIncluirContasForaVenCobranca;
	}
	...
	public String getNumeroDiasEnvioContaEmpresaCobranca() {
		return numeroDiasEnvioContaEmpresaCobranca;
	}

	public void setNumeroDiasEnvioContaEmpresaCobranca(
			String numeroDiasEnvioContaEmpresaCobranca) {
		this.numeroDiasEnvioContaEmpresaCobranca = numeroDiasEnvioContaEmpresaCobranca;
	}

	public String getIndicadorBloquearFunUsuario() {
		return indicadorBloquearFunUsuario;
	}

	public void setIndicadorBloquearFunUsuario(String indicadorBloquearFunUsuario) {
	...
	public String getTamanhoMaximoAnexoRA() {
		return tamanhoMaximoAnexoRA;
	}

	public void setTamanhoMaximoAnexoRA(String tamanhoMaximoAnexoRA) {
	...
	public String getTamanhoMaximoMensagemSms() {
		return tamanhoMaximoMensagemSms;
	}

	public void setTamanhoMaximoMensagemSms(String tamanhoMaximoMensagemSms) {
		this.tamanhoMaximoMensagemSms = tamanhoMaximoMensagemSms;
	}

	public String getIndicadorAlterarNomeClienteCpfCnpjValidado() {
		return indicadorAlterarNomeClienteCpfCnpjValidado;
	}

	public void setIndicadorAlterarNomeClienteCpfCnpjValidado(String indicadorAlterarNomeClienteCpfCnpjValidado) {
