...
public interface IRepositorioSpcSerasa {
	 ...
	 * @date 07/01/2008
	 */
	public NegativacaoImovei consultarNegativacaoImoveiDoNegativadorMovimento(
	...
	public List consultarImovelCobrancaSituacao(Integer codigoImovel,
			Integer codigoCobrancaSituacao,Integer idCliente) throws ErroRepositorioException;
	...
	public Collection consultarImovelCobrancaSituacaoPorNegativador(
			Imovel imovel, Integer codigoNegativador,Integer idCliente)
			throws ErroRepositorioException;
	 ...
	 * @date 27/03/2008
	 */
	public Collection pesquisarNegativadorMovimentoRegInclusao(
	...
	public Date pesquisarDataExclusaoNegativacao(int idImovel,
			int idNegativacaoComando,Integer idCliente) throws ErroRepositorioException;
	 ...
	 * @throws ErroRepositorioException
	 */
	public void atualizarDataRetiradaSituacaoCartaEnviada(Date dataExlusao, Integer idImovel, Integer idCliente) throws ErroRepositorioException;
