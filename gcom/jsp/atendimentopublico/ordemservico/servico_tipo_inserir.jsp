	...
	function caracteresespeciais () {
  	...
  	function validaTodosRadioButton() {
		...
		if (!form.indicadorInformacoesBoletimMedicao[0].checked &&	!form.indicadorInformacoesBoletimMedicao[1].checked){
   			alert("Informe Indicador de Informações de Boletim de Medição.");		
			return false;
   		}
	   	...
	   	if (!form.indicadorEmpresaCobranca[0].checked && !form.indicadorEmpresaCobranca[1].checked){
	   		alert("Informe Indicador de liberação para empresa de cobrança gerar OS.");
	   		return false;
	   	}
	   	
	   	if (!form.indicadorInspecaoAnormalidade[0].checked && !form.indicadorInspecaoAnormalidade[1].checked){
	   		alert("Informe Indicador para gerar OS de inspeção por anormalidade. ");
	   		return false;
	   	}
   		...
   		if (!form.indicadorEncAutomaticoRAQndEncOS[0].checked && !form.indicadorEncAutomaticoRAQndEncOS[1].checked){
   			alert("Informe Indicador de Encerramento Automático do RA.");		
			return false;
   		}

   		if (!form.indicadorCorrecaoAnormalidade[0].checked && !form.indicadorCorrecaoAnormalidade[1].checked){
   			alert("Informe Indicador Correção d Anormalidade");		
			return false;
   		}
		...
		<tr>
			...
			<table width="100%" height="311" border="0">
				...
				<%-- <tr>
					...
					<td align="left">
						<label> 
							<html:radio property="pavimento" value="2" /><strong>Não</strong>
						</label>
					</td>
				</tr> --%>
				...
				<tr>
					...
					<td colspan="3"><span class="style2"> <html:text
						property="idTipoDebito" size="4" maxlength="4" 
						onkeyup="validaEnterComMensagem(event, 'exibirInserirServicoTipoAction.do', 'idTipoDebito', 'Tipo do Débito');" />
				...
				<tr>
					...
					<logic:notPresent name="servicoTipoReferencia">
						 <html:text
							...
							onkeyup="validaEnterComMensagem(event, 'exibirInserirServicoTipoAction.do', 'idTipoServicoReferencia', 'Tipo de Serviço de Referência');controlaTipoServicoReferenciaOnKeyUp();" />
				...
				<tr>
					...
					<td align="left"><label> 
						<html:radio property="indicadorOrdemSeletiva" value="2" /> <strong>Não</strong></label></td>
				</tr>
				
				<!-- Indicativo de Pavimento  -->
				<tr>
					<td><strong><span class="style2">Indicativo de Pavimento:<font color="#FF0000">*</font></span></strong></td>
					<td align="left" width="20%"><label> 
				...
				<tr>
					<td><strong><span class="style2">Indicativo de Reposição de Asfalto:<font color="#FF0000">*</font></span></strong></td>
					<td align="left" width="20%"><label> 
				...
				<tr>
					<td><strong><span class="style2">Indicativo de Reposição de Paralelo/Pedra Tosca:<font color="#FF0000">*</font></span></strong></td>
					<td align="left" width="20%"><label> 
				...
				<tr>
					<td><strong><span class="style2">Indicativo de Reposição de Calçada:<font color="#FF0000">*</font></span></strong></td>
					<td align="left" width="20%"><label> 
				...
				<tr>
					...
					<td align="left"><label> 
						<html:radio property="indicadorInspecaoAnormalidade" value="2" /> <strong>Não</strong></label></td>
				</tr>
				...
				<tr>
					<td><strong><span class="style2">Indicador de Obrigatoriedade de Informação da Atividade:<font color="#FF0000">*</font></span></strong></td>
					<td align="left" width="20%"><label> 
				...
				<tr>
					<td width="40%" align="left">
						<strong>Indicador de encerramento automático do RA no encerramento de sua última/única OS pendente :<font color="#FF0000">*</font></strong>
					</td>
				...
				<!-- Indicação Correção Anormalidade -->

				<tr>
					<td><strong><span class="style2">Indicador Corre&ccedil;&atilde;o da Anormalidade:<font
						color="#FF0000">*</font></span></strong></td>
					<td align="left" width="20%">
						<label> 
					...
					<table width="100%" id="tableAtividades" align="center"
						...
						<tr>
							...
							<c:forEach var="servicoTipoAtividade"
								...
								<td>
								<div align="center"><a
									href="javascript:if(confirm('Confirma remoção?')){removeRowTableAtividades('$${servicoTipoAtividade.atividade.id}$${servicoTipoAtividade.numeroExecucao}$');}">
					...
					<table width="100%" id="tableMateriais" align="center"
						...
						<tbody>
							...
							<c:forEach var="servicoTipoMaterial"
								...
								<td>
								<div align="center"><a
									href="javascript:if(confirm('Confirma remoção?')){removeRowTableMateriais('$${servicoTipoMaterial.material.id}$');}">
								<img src="imagens/Error.gif" width="14" height="14" border="0"
									title="Remover"> </a></div>
								</td>
								<td>
							...
							<tr>
								<logic:present name="motivosEncerramentoEscolhidos">
									<c:forEach var="motivoEncerramento"
										...
										<td>
										<div align="center"><a
											href="javascript:if(confirm('Confirma remoção?')){removeRowTableMotivoEncerramento('${motivoEncerramento.id}');}">
										<img src="imagens/Error.gif" width="14" height="14" border="0"
											title="Remover"> </a></div>
										</td>
										<td>
