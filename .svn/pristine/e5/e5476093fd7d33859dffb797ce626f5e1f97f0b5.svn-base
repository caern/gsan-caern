...
public class PessoaFisicaHelper {
	...
	public PessoaFisicaHelper(){};

	public PessoaFisicaHelper(String nomePessoaFisica,
			String situacaoCadastral, String dataConsulta, String horaConsulta,
			String comprovanteAutenticidade) {
		super();
