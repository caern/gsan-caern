...
public class ExibirInserirContratoNegativadorAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		if (httpServletRequest.getParameter("limpaSessao") != null
			...
			inserirContratoNegativadorActionForm.setIndicadorObriControSequeRetorno(ConstantesSistema.NAO);
			inserirContratoNegativadorActionForm.setNumeroEntidade("");
			inserirContratoNegativadorActionForm.setNumeroAssociado("");
