...
public class PesquisarOrdemServicoHelper {
	...
	private Integer codSetorComercial;
	...
	public Integer getCodSetorComercial() {
		return codSetorComercial;
	}

	public void setCodSetorComercial(Integer codSetorComercial) {
		this.codSetorComercial = codSetorComercial;
	}
	...
	public Integer getNumeroRota() {
		return numeroRota;
	}

	public void setNumeroRota(Integer numeroRota) {
