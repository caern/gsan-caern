...
public class RegistroAtendimentoAnexo implements Serializable{
	...
	private Short indicadorCompactado;
	...
	public boolean equals(Object other) {
		...
		return ((GcomAction.obterTimestampIdObjeto(this)) == (GcomAction.obterTimestampIdObjeto(castOther)));
	}
	...
	public Short getIndicadorCompactado() {
		return indicadorCompactado;
	}

	public void setIndicadorCompactado(Short indicadorCompactado) {
		this.indicadorCompactado = indicadorCompactado;
	}
}
