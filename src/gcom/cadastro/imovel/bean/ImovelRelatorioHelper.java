...
public class ImovelRelatorioHelper implements Serializable {
	...
	private String cpfClienteResponsavel;
	
	private String cnpjClienteResponsavel;
	
	private String tipoHabitacao;
	
	private String indicadorNivelEsgotamento;
	...
	public String getCpfClienteResponsavel() {
		return cpfClienteResponsavel;
	}

	public void setCpfClienteResponsavel(String cpfClienteResponsavel) {
		this.cpfClienteResponsavel = cpfClienteResponsavel;
	}

	public String getCnpjClienteResponsavel() {
		return cnpjClienteResponsavel;
	}

	public void setCnpjClienteResponsavel(String cnpjClienteResponsavel) {
		this.cnpjClienteResponsavel = cnpjClienteResponsavel;
	}
	...
	public String getIndicadorNivelEsgotamento() {
		return indicadorNivelEsgotamento;
	}

	public void setIndicadorNivelEsgotamento(String indicadorNivelEsgotamento) {
		this.indicadorNivelEsgotamento = indicadorNivelEsgotamento;
	}
}