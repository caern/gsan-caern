 ...
 * @author Sávio Luiz
 */
public class AtualizarLogradouroBairroGrauImportanciaAction extends GcomAction {
	/**
...
//      mensagem de erro quando o usuário tenta excluir sem ter selecionado
		...
		LogradouroBairro logradouro = null;
...
//						Logradouro.class.getName());
				...
				FiltroLogradouroBairro filtroLogradouro = new FiltroLogradouroBairro();
				...
				if (logradouroEncontrado != null && !logradouroEncontrado.isEmpty()) {
					logradouro = ((LogradouroBairro) ((List) logradouroEncontrado).get(0));
			...
			//fachada.atualizarGrauImportancia(logradouro.getId(), logradouro.getProgramaCalibragem().getId(),usuarioLogado);
		...
		String logradouroBairro = httpServletRequest.getParameter("logbairro");
		
		if (logradouroBairro != null && logradouroBairro.equals("sim")){
