...
public class ControladorFaturamentoCAERNSEJB extends ControladorFaturamento
	...
	public Collection<EmitirContaHelper> emitir2ViaContas(
		...
		while (iter.hasNext()) {
			...
			// Linha 6
			// --------------------------------------------------------------
			// instï¿½ncia um imovel com os dados da conta para recuperar a
			// inscriï¿½ï¿½o que estï¿½ no objeto imovel
			...
			// caso a coleï¿½ï¿½o de contas seja de entrega para o cliente
			// responsï¿½vel
			...
			// o tamanho da string que vem como resultado ï¿½ de 20 posiï¿½ï¿½es
			StringBuilder obterDadosConsumoMedicaoAnterior = null;

			// chama o [SB0003] -Obter Dados do Consumo e Mediï¿½ï¿½o Anterior
			// passando a quantidade de Meses Igual a 1
			// e o tipo de ligaï¿½ï¿½o e mediï¿½ï¿½o recuperados anteriormente
			...
			// recupera os parametros da mediï¿½ï¿½o historico do
			...
			if (!dataLeituraAnterior.equals("") && !dataLeituraAtual.equals("")) {
				// calcula a quantidade de dias de consumo que ï¿½ a
				// quantidade de dias
			...
			// recupera os parametros de consumo faturamento e consumo mï¿½dio
			// diï¿½rio
			...
			// [SB0007] - Obter Dados da Mediï¿½ï¿½o da Conta
			...
			// [SB0008] - Obter Dados da Mediï¿½ï¿½o da Conta
			...
			// Linha 16
			// --------------------------------------------------------------
			// chama o [SB0010] - Gerar Linhas da Descriï¿½ï¿½o dos Serviï¿½os e
			// Tarifas
			...
			//emite uma Ficha de Compensaï¿½ï¿½o(Boleto bancario)
			if (sistemaParametro.getValorContaFichaComp() != null 
				...
				//[SB0030 - Obter representaï¿½ï¿½o numï¿½rica do cï¿½digo de barras da Ficha de Compensaï¿½ï¿½o]				
                ...
                if(quantidadeContasDebitoCarteiraMovimento > 0){
                	numeroCarteira = ConstantesSistema.CARTEIRA_17_FICHA_COMPENSACAO;
                	
                	String nossoNumero17 = obterNossoNumeroFichaCompensacaoCart17("1", emitirContaHelper.getIdConta().toString()).toString();
                	nossoNumeroSemDV = nossoNumero17.toString().substring(0,17);
                	emitirContaHelper.setNossoNumero(nossoNumero17);
                	Date dataVencimentoMais15 = Util.adicionarNumeroDiasDeUmaData(new Date(), 15);
				...
				emitirContaHelper.setNumeroCarteira(numeroCarteira);
				...
				// Linha 23
				// --------------------------------------------------------------
				// Considerar as contas do tipo dï¿½bito automï¿½tico como tipo de conta normal
				...
				// Linha 24
				// Formata a representaï¿½ï¿½o nï¿½merica do cï¿½digo de barras
	 ...
	 * 
	 * Verifica se o imï¿½vel gera conta ou nï¿½o.
	 * 
	 * [SF0003] - Verificar Nï¿½o Geraï¿½ï¿½o da Conta
	 * 
	 ...
	 * @return <true> se for para gerar conta, <false> caso contrï¿½rio
	 * @throws ControladorException
	 */
	public boolean verificarNaoGeracaoConta(Imovel imovel,
		...
		//boolean valorAguaEsgotoZerado = false;		
		//boolean valorMenorIgualMinimoEmissaoConta = true;		
		//boolean imovelSemDebitoACobrar = true;		
		//boolean imovelSemDebitoACobrarGeracaoConta = true;
		...
		/*
		 * Nï¿½o existam dï¿½bitos a cobrar (nï¿½o existem dï¿½bitos na tabela
		 ...
		 * 
		 * [FS0005] - Verificar Dï¿½bitos a cobrar de parcelamento
		 * 
		 * OBS - O [FS0005] jï¿½ estï¿½ incorporado no mï¿½todo
		 * obterDebitoACobrarImovel
		 */
		if (colecaoDebitosACobrar == null || colecaoDebitosACobrar.isEmpty()) {
			//imovelSemDebitoACobrar = true;
			...
			/*
			 * ... ou, caso existam, nï¿½o existam crï¿½ditos a realizar (nï¿½o
			 * existem crï¿½ditos na tabela CREDITO_A_REALIZAR com IMOV_ID=IMOV_ID
			 * do imï¿½vel e DCST_IDATUAL com o valor correspondente a normal
			 * (valor=0)e (CRAR_NNPRESTACAOREALIZADAS menor que
			 * CRAR_NNPRESTACAOCREDITO ou CRAR_VLRESIDUALMESANTERIOR maior que
			 * zero))
			 * 
			 * [FS0006] - Verificar Crï¿½ditos a realizar de parcelamento
			 * 
			 * OBS - O [FS0006] jï¿½ estï¿½ incorporado no mï¿½todo
			...
			if (colecaoCreditosARealizar == null
				...
				/*
				 * e os dï¿½bitos a cobrar sejam todos correspondentes a tipo de
				 * debito com indicador de geraï¿½ï¿½o de conta igual a Nï¿½O
				...
				while (iteratorColecaoDebitosACobrar.hasNext()) {
					...
					// Calcula o valor da prestaï¿½ï¿½o
	                 ...
	                 * criaï¿½ï¿½o do bonus para parcelamento com RD especial
	                 */
					...
					// Acumula o valor da prestaï¿½ï¿½o no valor total dos debitos
					...
					if (debitoTipo.getIndicadorGeracaoConta().shortValue() != 2) {
						//imovelSemDebitoACobrarGeracaoConta = false;
		...
		/*if (valorAguaEsgotoZerado &&  imovelSemDebitoACobrar && imovelSemDebitoACobrarGeracaoConta && valorMenorIgualMinimoEmissaoConta) {
			retorno = false;
		}*/
		...
		/*
		 * Caso a situaï¿½ï¿½o do imovel seja SUPRIMIDO nï¿½o gera conta.
		 */
		...
		/*
		 * [RM1072] Cobranï¿½a de ï¿½gua real para imoveis cortados (Consi.
		 * Colocado por Raphael Rossiter em 22/11/2011
		 */
		else if (segundaCondicao && !imovel.getLigacaoEsgotoSituacao().getIndicadorFaturamentoSituacao()
				.equals(LigacaoEsgotoSituacao.FATURAMENTO_ATIVO) && imovel.getHidrometroInstalacaoHistorico() == null){
			
			if (imovel.getLigacaoAgua() != null && imovel.getLigacaoAgua().getId() != null){
				
				//Caso imovel tenha situacao da ligacao de agua com indicador de consumo real igual a 1
				LigacaoAguaSituacao ligacaoAguaSituacao = this.getControladorMicromedicao().obterDadosSituacaoLigacaoAgua(imovel);
				
				if (ligacaoAguaSituacao != null && ligacaoAguaSituacao.getIndicadorConsumoReal().equals(ConstantesSistema.SIM)){
					
					//Caso o numero de dias de corte da tabela da situacao da ligacao de agua do imovel seja diferente de null e maior que zero
					if (ligacaoAguaSituacao.getNumeroDiasCorte() != null && 
						...
						//Caso o imovel seja nï¿½o medido (nï¿½o tenha hidi_id em ligacao de agua)
						if (imovel.getLigacaoAgua().getHidrometroInstalacaoHistorico().getId() == null) {
							
							/*
							 * Caso a data do corte do imovel seja menor que 1 mes (30 dias)
							 * em relacao a data prevista da atividade de faturamento 
							 */
							
							// Obtendo a data do corte
							Object[] objetoLigacaoAgua = this.getControladorAtendimentoPublico().pesquisarDadosLigacaoAgua(imovel.getId());
							...
							//Obtendo a data prevista ou realizada do cronograma anterior para a atvividade EFETUAR LEITURA 
							Integer anoMesAnterior = Util.subtraiAteSeisMesesAnoMesReferencia(anoMesFaturamento,1);
							
							Object[] datasPrevistasERealizadas = null;
							
							try{
								
								datasPrevistasERealizadas = this.repositorioFaturamento.obterDataPrevistaRealizadaFaturamentoAtividadeCronograma(
							...
							/*
							 * Erivan Sousa - 23/01/2013
							 */
							Date dataPrevistaAtividadeLeitura;
							if (datasPrevistasERealizadas != null) {
								dataPrevistaAtividadeLeitura = (Date) datasPrevistasERealizadas[1];
								...
								Date datas[] = this.gerarPeriodoLeituraFaturamento(null, null, faturamentoGrupo, 
									anoMesFaturamento, Util.subtrairMesDoAnoMes(anoMesFaturamento, 1));

								if (datas[0] != null) {
									dataPrevistaAtividadeLeitura = datas[0];
								} else {
									dataPrevistaAtividadeLeitura = datas[1];
								}
							}
							...
							if (dataCorte != null && dataPrevistaAtividadeLeitura!= null){
								...
								/*
								 * Caso a diferenca entre as datas (data corte - dataLeituraAnteriorFaturada)
								 * for maior do que LAST_NNDIASCORTE da ligacao de ï¿½gua
								 */
								int numeroDiasDiferecaDatas = Util.obterQuantidadeDiasEntreDuasDatas(dataPrevistaAtividadeLeitura, dataCorte);
								
								if (numeroDiasDiferecaDatas > 0){
								...
								// Caso a diferenca de datas seja maior que 1 mes (30 dias)
								else {
	 ...
	 * 
	 * @author Sï¿½vio Luiz, Pedro Alexandre, Tiago Moreno
	...
	public void emitirContas(Integer anoMesReferenciaFaturamento,
		...
		try {
			...
			try {
				...
				// i=1;Coleï¿½ï¿½o de contas com baixo consumo
				// i=2;Coleï¿½ï¿½o de contas com dï¿½bito automï¿½tico
				// i=3;Coleï¿½ï¿½o de contas com entrega para o cliente
				// responsï¿½vel
				// i=4;Coleï¿½ï¿½o de contas com entrega para o cliente
				// responsï¿½vel
				// i=5;Coleï¿½ï¿½o de contas normais
							...
							if (mapContasDivididasOrdenada != null) {
								...
								while (countOrdem < mapContasDivididasOrdenada
									...
									while (iteratorConta.hasNext()) {
										...
										}// fim do laï¿½o que verifica as 2 contas
									}// fim laï¿½o while do iterator do objeto helper
									countOrdem++;
									mapContasDivididas = null;
								}// fim do while que pega os Map ordenados
							}// fim do laï¿½o que verifica se o Map estï¿½ nula
							// fim do laï¿½o que verifica se a coleï¿½ï¿½o ï¿½ nula
						} else {
							flagTerminou = true;
						}
...
//	                          formatarEmitirContasHelperOuFichaCompensacao(colecaoContaParmsFichaCompensacao, tipoConta);
						...
						if (colecaoConta != null && !colecaoConta.isEmpty()) {
							...
							if (mapContasDivididasOrdenada != null) {
								...
								while (countOrdem < mapContasDivididasOrdenada
									...
									while (iteratorConta.hasNext()) {
										...
										while (situacao < 2) {
											...
											// verifica
											// se o
											// helper ï¿½ diferente de
											// nulo

										}// fim do laï¿½o que verifica
										// as 2
										// contas
									}// fim laï¿½o while do iterator do
									// objeto
									// helper
									countOrdem++;
									mapContasDivididas = null;
								...
								// ordenados
							}// fim do laï¿½o que verifica se o Map
							// estï¿½
							// nula
							// fim do laï¿½o que verifica se a coleï¿½ï¿½o ï¿½
							// nula
						} else {
							flagTerminou = true;
						}
	...
	public String[] obterMensagemConta3Partes(
		...
		if(mensagemContaDivididas == null || mensagemContaDivididas.equals("")){
			...
			// caso entre em alguma condiï¿½ï¿½o entï¿½o nï¿½o entra mais nas outras
			boolean achou = false;
			try {
				...
				// caso nï¿½o tenha entrado em nenhuma das opï¿½ï¿½es acima
		...
		//RM3071 - Exibir na terceira linha da conta a mensagem de quitaï¿½ï¿½o dos dï¿½bitos
		...
		if(faturamentoGrupo!=null && faturamentoGrupo.getIndicadorMensagemQuitacao().intValue()==1){
			...
			if(extratoQuitacao!=null){
				...
				if(extratoQuitacaoItem != null){
					...
					mensagemContaDivididas[2] = "DECLARAMOS NÃO EXISTIR DÉBITOS DE FATURAS DE "+
							anoQuitacao + " - LEI 12007/09";
					
					if (mensagemContaDivididas[0] ==null)  mensagemContaDivididas[0]= "";
					if (mensagemContaDivididas[1] ==null)  mensagemContaDivididas[1]= "";
				}
			}
	...
	public StringBuilder obterConsumoAnterior(Integer idImovel, int anoMes,
		...
		// adiciona o mes/ano formatado com o traï¿½o

		// caso o tipo de ligaï¿½ï¿½o e mediï¿½ï¿½o seja diferente de nulo
		if (tipoLigacao != null && tipoMedicao != null) {
			...
			// senï¿½o completa com espaï¿½os em branco
	...
	public StringBuilder gerarLinhasDescricaoServicoTarifas(
		...
		if (emitirContaHelper.getValorEsgoto() != null
			...
			// caso a stringBuilder jï¿½ esteja preenchida
		...
		if (emitirContaHelper.getDebitos() != null
				&& emitirContaHelper.getDebitos().compareTo(
						new BigDecimal("0.00")) == 1) {
			// [SB0013] - Gerar Linhas de Dï¿½bitos Cobrados
		...
		// caso o valor de crï¿½ditos realizados seja maior que zero
		if (emitirContaHelper.getValorCreditos() != null
				&& emitirContaHelper.getValorCreditos().compareTo(
						new BigDecimal("0.00")) == 1) {
			// [SB0014] - Gerar Linhas de Crï¿½dito Realizado
	...
	protected StringBuilder gerarLinhasTarifaAgua(
		...
		if (colecaoContaCategoriaComFaixas != null
			...
			while (iteratorContaCategoriaComFaixas.hasNext()) {
				...
				// completa com espaï¿½os em branco
				...
				// completa com espaï¿½os em branco
				linhasTarifaAgua.append(" ");
				// caso nï¿½o existam dados de mediï¿½ï¿½o
				if (parmsMedicaoHistorico == null) {
					// Constante
					linhasTarifaAgua.append("TARIFA MíNIMA");

					// Valor da tarifa mï¿½nima de ï¿½gua para a categoria por
					// economia
					...
					// recupera a coleï¿½ï¿½o de conta categoria consumo faixa
					Collection colecaoContaCategoriaConsumoFaixa = null;
					try {
						colecaoContaCategoriaConsumoFaixa = repositorioFaturamento
					...
					if (colecaoContaCategoriaConsumoFaixa != null
						...
						// Constante
						linhasTarifaAgua.append(" ");
						// Consumo mï¿½nimo de ï¿½gua para a categoria por
						// economia
	 ...
	 *
	 * Totalizando os valores de ï¿½gua e esgoto por categoria ou subcategoria
	 *
	 * @author Raphael Rossiter
	 * @date 28/05/2008
	 *
	 ...
	 * impontualidade (multa, juros de mora e atualizaï¿½ï¿½o monetï¿½ria)
	 * 
	...
	/*public Collection gerarDebitosACobrarDeAcrescimosPorImpontualidade(
		...
		try {
			...
			// cria uma coleï¿½ï¿½o de imï¿½vel por rota
			...
			// recupera todos os imï¿½veis da coleï¿½ï¿½o de rotas
			...
			while (imovelPorRotaIterator.hasNext()) {
				...
				if (arrayImoveisPorRota[1] != null) {
					// instancia uma localidade para ser setado no imï¿½vel
				...
				if (arrayImoveisPorRota[3] != null) {
					// instancia uma quadra para ser setado no imï¿½vel
				...
				if (arrayImoveisPorRota[2] != null) {
					// instancia um setor comercial para ser setado no imï¿½vel
				...
				/**
				 * Item 5.1 [UC0306] - Obter Principal Categoria do Imï¿½vel
				 */
				...
				/**
				 * Item 5.2 Caso a principal categoria do imï¿½vel esteja
				 * indicando que nï¿½o deve ser gerado acrï¿½scimos por
				 * impontualidade para a categoria
				 * (catg_icgeracaoacrescimos=ENCERRAMENTO_ARRECADACAO) da
				 * principal categoria do imï¿½vel e esteja indicando que nï¿½o estï¿½
				 * sendo encerrada a arrecadaï¿½ï¿½o , passa para o prï¿½ximo imï¿½vel.
				 */
				...
				/**
				 * Item 5.4 Caso o imï¿½vel possua cliente responsï¿½vel, recupera o
				 * indicador de cobranï¿½a de acrï¿½cimos do cliente responsï¿½vel
				...
				/**
				 * Item 5.4.1 Caso esteja indicado que nï¿½o de ve ser gerado
				...
				if (!flagProximoImovel) {
					...
					// recupera todas as contas dos imï¿½veis da coleï¿½ï¿½o
					// de rotas
					...
					if (colecaoContaImovel != null
						...
						while (contasIterator.hasNext()) {
							...
							if (anoMes <= anoMesReferenciaArrecadacao) {
								...
								/*
								 * Colocado por Raphael Rossiter em 31/05/2007
								 * Sï¿½ irï¿½ calcular o acrï¿½scimo caso o imovel e o
								 * pagamento nï¿½o sejam dï¿½bito automï¿½tico
								 */
								/*if (idArrecadacaoForma == null
									...
									/**
									 * Item 5.6.3 Caso o indicador de geraï¿½ï¿½o de
									...
									/*if (indicadorGeracaoMulta.intValue() == ConstantesSistema.SIM
										...
										// Inseri o dï¿½bito a cobra geral e
										// recupera o id
										...
										colecaoDebitoACobrarCategoriaInserir
												.addAll(inserirDebitoACobrarCategoriaBatch(
														...
														debitoACobrar
																.getImovel()));
									}*/// if indicador de geraï¿½ï¿½o de multa

									/**
									 * Item 5.6.4 Caso o indicador de geraï¿½ï¿½o
									 ...
									 * nulo e ano/mï¿½s referï¿½ncia da arrecadaï¿½ï¿½o
									 * do pagamento seja menor ou igual ao
									 * ano/mï¿½s de arrecadaï¿½ï¿½o corente.
									 */
									...
									/*
									 * 5.6.5 Caso o indicador de geraï¿½ï¿½o de
									 * atualizaï¿½ï¿½o monetï¿½ria corresponda a
									 * sim(1) e o valor da atualizaï¿½ï¿½o monetï¿½ria
									 * seja maior que zero Gera o dï¿½bito a
									 * cobrar referente a atualizaï¿½ï¿½o monetï¿½ria
									 * e
									 */
					...
					// cria uma coleï¿½ï¿½o de guias do imovel
					...
					// recupera todas as guias dos imï¿½veis da coleï¿½ï¿½o de
					// rotas
					...
					if (colecaoGuiasPagamentoImovel != null
						...
						while (guiasPagamentoIterator.hasNext()) {
							...
							if (anoMes <= anoMesReferenciaArrecadacao) {
								...
								/*
								 * Item 5.8.3 Caso o indicador de geraï¿½ï¿½o de
								...
								/*
								 * Item 5.8.4 Caso o indicador de geraï¿½ï¿½o dos
								 ...
								 * situaï¿½ï¿½o atual igual a classificado. Gera o
								...
								/*
								 * Item 5.8.5 Caso o indicador de geraï¿½ï¿½o de
								 * atualizaï¿½ï¿½o monetï¿½ria corresponda a sim(1) e
								 * o valor da atualizaï¿½ï¿½o monetï¿½ria seja maior
								 * que zero e exista pagamento para a guia de
								 * pagamento com situaï¿½ï¿½o atual igual a
								 * classificado. Gera o dï¿½bito a cobrar
								 * referente a atualizaï¿½ï¿½o monetï¿½ria.
								 */
								/*if (indicadorGeracaoAtualizacao.intValue() == ConstantesSistema.SIM
										.intValue()
										&& calcularAcrescimoPorImpontualidade
	 ...
	 * 
	 * [SB00011] Gerar Linhas da Tarifa de ï¿½gua
	 * 
	 * @author Vivianne Sousa
	 * @date 25/04/2007
	 * 
			...
			while (iteratorContaCategoriaComFaixas.hasNext()) {
				...
				if (parmsMedicaoHistorico == null
					...
					if (colecaoContaCategoriaConsumoFaixa != null
						...
						// Consumo mï¿½nimo de ï¿½gua para a categoria por economia
						BigDecimal qtdEconomia = Util
								.formatarMoedaRealparaBigDecimal(""
										+ contaCategoria
												.getQuantidadeEconomia());
						...
						// Consumo mï¿½nimo de ï¿½gua para a categoria
						if (contaCategoria.getConsumoMinimoAgua() != null
								&& !contaCategoria.getConsumoMinimoAgua()
										.equals("")) {
							consumoFaixa3 = Util
						...
						// valor da tarifa mï¿½nima de agua para categoria
						String valorAguaCategoria = "";
						if (contaCategoria.getValorTarifaMinimaAgua() != null) {
							valorAguaCategoria = Util
									.formatarMoedaReal(contaCategoria
	 ...
	 * 
	 * A data de vencimento do grupo serï¿½ formatada com o mï¿½s de referï¿½ncia do
	 * grupo
	 * 
	 * @author Raphael Rossiter
	 * @date 05/05/2007
	...
	public void gerarDebitoACobrarTaxaEmissaoConta(Integer idImovel,
		...
		try {
			...
			// Instï¿½ncia a forma de cobranï¿½a para cobranï¿½a em conta
			CobrancaForma cobrancaForma = new CobrancaForma();
			cobrancaForma.setId(CobrancaForma.COBRANCA_EM_CONTA);

			// Instï¿½ncia a situaï¿½ï¿½o do dï¿½bito para normal
			DebitoCreditoSituacao debitoCreditoSituacao = new DebitoCreditoSituacao();
			debitoCreditoSituacao.setId(DebitoCreditoSituacao.NORMAL);

			// Recupera o tipo de dï¿½bito referente a despesa postal
			...
			// Verifica se jï¿½ existe dï¿½bito para este imï¿½vel
			...
			//
			// // Cria a variï¿½vel que vai armazenar o valor do dï¿½bito
			// BigDecimal valor = new BigDecimal("0");

			/*
			 * Caso o perfil do imï¿½vel seja tarifa social o valor vai ser o
			 * valor da tarifa social Caso contrï¿½rio o valor da tarifa vai ser o
			 * normal.
			 */
			if (!imovel.getImovelPerfil().getId().equals(
					ImovelPerfil.TARIFA_SOCIAL)) {
				// caso o imï¿½vel nï¿½o seja enquadrado em tarifa social

				// Obtï¿½m o valor da Tarifa Normal
				...
				// valor = valorMinimaTarifaNormal;
					...
					ImovelPerfil.TARIFA_SOCIAL)) {
				// caso o imï¿½vel seja enquadrado em tarifa social

				// Obtï¿½m o valor da Tarifa Social
			...
			// Cria uma instï¿½ncia de dï¿½bito a cobrar
			DebitoACobrar debitoACobrar = new DebitoACobrar();
			...
			// Seta ano/mï¿½s da conta emitida como 2 via
			debitoACobrar.setAnoMesReferenciaDebito(anoMesReferencia);

			// Seta Ano/Mï¿½s de Cobranï¿½a
			debitoACobrar.setAnoMesCobrancaDebito(sistema
					.getAnoMesArrecadacao());

			
			// Seta Ano/Mï¿½s Referï¿½ncia do Faturamento
			...
			// Seta Cï¿½digo do Setor Comercial
			...
			// Insere dï¿½bito a cobrar por categoria
	...
	public Collection<EmitirContaHelper> emitir2ViaContasHistorico(
		...
		while (iter.hasNext()) {
			...
			// Linha 23
			// --------------------------------------------------------------
			// Considerar as contas do tipo dï¿½bito automï¿½tico como tipo de conta
			// normal
			// [SB0018 - Gerar Linhas das DemaisContas]
			Integer digitoVerificadorConta = new Integer(""
					+ emitirContaHelper.getDigitoVerificadorConta());
...
//					String valorAgua = Util.formatarMoedaReal(contaCategoriaHistorico.getValorAgua());
	 ...
	 * [UC0113] - Faturar Grupo de Faturamento
	 * 
	 * Determina o tipo de conta que serï¿½ associado na impressï¿½o da conta, para
	 * caern nï¿½o tem o tipo de conta retida por BC ou retida por EC.
	 * 
	 * [SB0006 - ]
	 * 
	 * @author Raphael Rossiter,Sï¿½vio Luiz
...
//			
//			
//				// Variï¿½veis para controle das partes dos arquivos de 3000 em 3000 registros
//				// ========================================================================
//				int parte = 1;
...
//				
//				
//				// Variï¿½veis para a paginaï¿½ï¿½o da pesquisa
//				// ========================================================================
//				boolean flagTerminou = false;
...
//						
//							//[SB0001  Verificaï¿½ï¿½o para geraï¿½ï¿½o do TXT];
...
//			// qualquer exceï¿½ï¿½o que o processo batch
...
//	}
     ...
     * 
     * [SB0029] Gerar Arquivo TXT das fichas de Compensï¿½ï¿½o
     * 
     * @author Vivianne Sousa
     * @date 12/11/2007
     * 
...
//                                contaTxt.append(Util.completaString(enderecoImovel,50));
                            ...
                            System.out.println("EMITIR FICHA COMPENSAÇÃO ----> Seq: " + sequencialImpressao);
...
//                                contaTxt.append(Util.completaString(enderecoImovel,50));
    ...
    public StringBuilder obterNossoNumeroFichaCompensacao(String idDocumentoTipo, String idDocumentoEmitido)
        ...
        // ï¿½ o numero do convï¿½nio fornecido pelo Banco
        // nï¿½mero fixo e nï¿½o pode ser alterado
    ...
    public StringBuilder obterNossoNumeroFichaCompensacaoCart17(String idDocumentoTipo, String idDocumentoEmitido){
    	
    	StringBuilder nossoNumero = new StringBuilder();
    	
    	 // numero do convenio fornecido pelo Banco
        // numero fixo e nao pode ser alterado
        nossoNumero.append("2559658");
