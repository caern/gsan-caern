...
/*				if (hidrometroInstalacaoHistorico.getDataRetirada() != null) {
		...
		if(verificarExtravio != null && verificarExtravio.equals("sim")){
			 ...
			 * Verifica se a situação informada tem indicador de extravio ativo. 
			 * Caso o indicador de extravio da situação informada seja 
			 * igual a '1 (Sim)', o local de armazenágem não deve ser informado.
			 */
