...
public class MensagemAtualizacaoCadastralDM extends ObjetoGcom {
	...
	public static final Integer ALTERACAO_CLIENTE_NAO_AUTORIZADA = new Integer(1);
    ...
    public static final Integer ATUALIZACAO_PPENDENTE_POR_INSCRICAO = new Integer(9);
