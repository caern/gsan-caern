...
/**
 * Classe Responsável por exibir os Serviços do Loja Virtual da CAERN
 * 
 * @author Rafael Pinto
 *
 * @date 15/07/2013
 */
public class ExibirServicosPortalCaernAction extends GcomAction {

	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
			HttpServletResponse httpServletResponse) {

		String retorno = "exibirServicosPortalCaernAction";

		ExibirServicosPortalCaernActionForm form = (ExibirServicosPortalCaernActionForm) actionForm;
		...
		if (method != null) {
			if (method.equalsIgnoreCase("servicos")) {
							...
							if (isValidCpfOrCnpj) {
								...
								for (ClienteImovel clienteImovel : colecaoClienteImovel) {
									...
									if (form.getCpfCnpjSolicitante().equals(clienteImovel.getCliente().getCpf())
										...
										retorno = "servicosPortalCaernAction";
				...
				retorno = "servicoDeclaracaoAnualCaern";
	...
	private void pesquisarAnosImovel(Integer idImovel, HttpServletRequest httpServletRequest,
			ExibirServicosPortalCaernActionForm form) {
