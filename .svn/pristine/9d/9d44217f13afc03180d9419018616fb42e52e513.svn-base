...
public class RelatorioConsultarDebitosAcrescimosDetalhado extends TarefaRelatorio {
	private static final long serialVersionUID = 1L;

	public RelatorioConsultarDebitosAcrescimosDetalhado(Usuario usuario) {
		super(usuario, ConstantesRelatorios.RELATORIO_CONSULTAR_DEBITOS_ACRESCIMOS_DETALHADO);
	}

	@Deprecated
	public RelatorioConsultarDebitosAcrescimosDetalhado() {
		super(null, "");
	}

	private Collection<RelatorioConsultarDebitosAcrescimosDetalhadoBean> inicializarBeanRelatorio(
		...
		Collection<RelatorioConsultarDebitosAcrescimosDetalhadoBean> retorno = new ArrayList<RelatorioConsultarDebitosAcrescimosDetalhadoBean>();
		...
		if (colecaoContas != null && !colecaoContas.isEmpty()) {
			...
			BigDecimal valorTotalImpostosContas = new BigDecimal("0.00");
			BigDecimal valorTotalAcrescimosImpontualidadeContas = new BigDecimal(
					"0.00");
			BigDecimal valorTotalMultaContas = new BigDecimal(
					"0.00");
			BigDecimal valorTotalJurosMoraContas = new BigDecimal(
					"0.00");
			BigDecimal valorTotalAtualizacaoMonetariaContas = new BigDecimal(
					"0.00");
			...
			BigDecimal valorSubtotalImpostosContas = new BigDecimal("0.00");
			BigDecimal valorSubtotalAcrescimosImpontualidadeContas = new BigDecimal(
					"0.00");
			BigDecimal valorSubtotalMultaContas = new BigDecimal(
					"0.00");
			BigDecimal valorSubtotalJurosMoraContas = new BigDecimal(
					"0.00");
			BigDecimal valorSubtotalAtualizacaoMonetariaContas = new BigDecimal(
					"0.00");
			...
			while (colecaoContasIterator.hasNext()) {
				...
				if (contaValoresHelper.getConta().getValorImposto() != null) {
					valorImpostos = Util.formatarMoedaReal(contaValoresHelper
							.getConta().getValorImposto());
					valorTotalImpostosContas = valorTotalImpostosContas
							.add(contaValoresHelper.getConta()
									.getValorImposto());

					if (idImovelAnterior.equals(contaValoresHelper.getConta()
							.getImovel().getId())) {
						valorSubtotalImpostosContas = valorSubtotalImpostosContas
								.add(contaValoresHelper.getConta()
										.getValorImposto());
					}
				}
				...
				if (contaValoresHelper.getValorMulta() != null) {
					valorMulta = Util.formatarMoedaReal(contaValoresHelper
							.getValorMulta());
					valorTotalMultaContas = valorTotalMultaContas
							.add(contaValoresHelper.getValorMulta());

					if (idImovelAnterior.equals(contaValoresHelper.getConta()
							.getImovel().getId())) {
						valorSubtotalMultaContas = valorSubtotalMultaContas
								.add(contaValoresHelper
										.getValorMulta());
					}
				}
				...
				if (contaValoresHelper.getValorJurosMora() != null) {
					valorJurosMora = Util.formatarMoedaReal(contaValoresHelper
							.getValorJurosMora());
					valorTotalJurosMoraContas = valorTotalJurosMoraContas
							.add(contaValoresHelper.getValorJurosMora());

					if (idImovelAnterior.equals(contaValoresHelper.getConta()
							.getImovel().getId())) {
						valorSubtotalJurosMoraContas = valorSubtotalJurosMoraContas
								.add(contaValoresHelper
										.getValorJurosMora());
					}
				}
				...
				if (contaValoresHelper.getValorAtualizacaoMonetaria() != null) {
					valorAtualizacaoMonetaria = Util.formatarMoedaReal(contaValoresHelper
							.getValorAtualizacaoMonetaria());
					valorTotalAtualizacaoMonetariaContas = valorTotalAtualizacaoMonetariaContas
							.add(contaValoresHelper.getValorAtualizacaoMonetaria());

					if (idImovelAnterior.equals(contaValoresHelper.getConta()
							.getImovel().getId())) {
						valorSubtotalAtualizacaoMonetariaContas = valorSubtotalAtualizacaoMonetariaContas
								.add(contaValoresHelper
										.getValorAtualizacaoMonetaria());
					}
				}
				...
				RelatorioConsultarDebitosAcrescimosDetalhadoBean bean = null;
				...
				if (pesquisaCliente != null
					...
					if (!idImovelAnterior.equals(contaValoresHelper.getConta()
						...
						if (count > 1) {
							...
							if (contaValoresHelper.getConta()
								...
								valorSubtotalImpostosContas = contaValoresHelper
										.getConta().getValorImposto();
							} else {
								valorSubtotalImpostosContas = new BigDecimal(
										"0.00");
							}
							...
							if (contaValoresHelper.getValorMulta() != null) {
								valorSubtotalMultaContas = contaValoresHelper
										.getValorMulta();
							} else {
								valorSubtotalMultaContas = new BigDecimal(
										"0.00");
							}

							if (contaValoresHelper.getValorJurosMora() != null) {
								valorSubtotalJurosMoraContas = contaValoresHelper
										.getValorJurosMora();
							} else {
								valorSubtotalJurosMoraContas = new BigDecimal(
										"0.00");
							}

							if (contaValoresHelper.getValorAtualizacaoMonetaria() != null) {
								valorSubtotalAtualizacaoMonetariaContas = contaValoresHelper
										.getValorAtualizacaoMonetaria();
							} else {
								valorSubtotalAtualizacaoMonetariaContas = new BigDecimal(
										"0.00");
							}
						}
					} else {
					...
					// Cria o subtotal
					if (criarSubtotal) {
						bean = new RelatorioConsultarDebitosAcrescimosDetalhadoBean(
						...
						bean.setValorImpostos(Util
										.formatarMoedaReal(valorSubtotalImpostosContas));
						bean.setValorMulta(Util
										.formatarMoedaReal(valorSubtotalMultaContas));
						bean.setValorJurosMora(Util
										.formatarMoedaReal(valorSubtotalJurosMoraContas));
						bean.setValorAtualizacaoMonetaria(Util
										.formatarMoedaReal(valorSubtotalAtualizacaoMonetariaContas));
						retorno.add(bean);
						...
						if (contaValoresHelper.getConta().getValorImposto() != null) {
							...
							valorSubtotalImpostosContas = new BigDecimal("0.00");
						}
				...
				if (!colecaoContasIterator.hasNext()) {
					...
					bean.setValorImpostos(Util
									.formatarMoedaReal(valorTotalImpostosContas));
					bean.setValorMulta(Util
									.formatarMoedaReal(valorTotalMultaContas));
					bean.setValorJurosMora(Util
									.formatarMoedaReal(valorTotalJurosMoraContas));
					bean.setValorAtualizacaoMonetaria(Util
									.formatarMoedaReal(valorTotalAtualizacaoMonetariaContas));
		...
		if (valorTotalDebitos != null) {
			...
			RelatorioConsultarDebitosAcrescimosDetalhadoBean bean = new RelatorioConsultarDebitosAcrescimosDetalhadoBean(
	...
	public Object executar() throws TarefaException {
		...
		Collection<RelatorioConsultarDebitosAcrescimosDetalhadoBean> colecaoBean = this
		...
		retorno = this.gerarRelatorio(
				ConstantesRelatorios.RELATORIO_CONSULTAR_DEBITOS_ACRESCIMOS_DETALHADO,
