...
public class RelatorioDadosEconomiaImovel extends TarefaRelatorio {
	...
	public Object executar() throws TarefaException {
		...
		/*
		 * -Erivan- 14/08/2012 
		 * A ordenação feita aqui não estava organizando a
		 * coleção corretamente, causando problemas na quebra 
		 * de pagina do relatório, então foi retirada e a 
		 * ordenação foi incluida na query.
		 */
