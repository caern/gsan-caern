			...
			<table width="100%" border="0">
				...
				<tr>
					...
					<td><strong> <html:text property="consumoMinimoFaturamento"
						size="10" maxlength="10" onkeypress="return isCampoNumerico(event);" /> </strong></td>
				</tr>
				<tr>
				...
				<tr>
					<td><strong>Indicador de Análise de Água: <font color="#FF0000">*</font></strong></td>
				...
				<tr>
					...
					<td><strong> <html:radio property="indicadorPermissaoCorteEsgoto"
						value="<%=""+ConstantesSistema.SIM%>" /> <strong>Sim <html:radio
						property="indicadorPermissaoCorteEsgoto"
						value="<%=""+ConstantesSistema.NAO%>" /> Não</strong> </strong></td>
				</tr>
				<tr>
					<td>&nbsp;</td>
