...
public class InformarDadosConsultaNegativacaoActionForm extends ActionForm {
	...
	private String formatoRelatorioNegativacao;
	
	private static final long serialVersionUID = 1L;

	
	public InformarDadosConsultaNegativacaoActionForm(){
		this.formatoRelatorioNegativacao = TarefaRelatorio.TIPO_PDF+"";
	}
	...
	public String getFormatoRelatorioNegativacao() {
		return formatoRelatorioNegativacao;
	}

	public void setFormatoRelatorioNegativacao(String formatoRelatorioNegativacao) {
		this.formatoRelatorioNegativacao = formatoRelatorioNegativacao;
	}
