...
function limparForm(){
   	var form = document.forms[0];
    form.idImovelAnaliseMedicaoConsumo.value = "";
    consultarImovelAjax();          	 
...
function consultarImovelAjax(){
	...
	if(form.idImovelAnaliseMedicaoConsumo != null && form.idImovelAnaliseMedicaoConsumo.value != ""){
		$.ajax({
				   type: "POST",
				   url: "consultarImovelAjaxAction.do?idImovel="+form.idImovelAnaliseMedicaoConsumo.value,
				   data: "",
...
<body leftmargin="5" topmargin="5"
	onload="javascript:habilitaMatricula();setarFoco('idImovelAnaliseMedicaoConsumo');consultarImovelAjax();">
		...
		<tr>
			...
			<table width="100%" border="0">
					...
					<table align="center" bgcolor="#99ccff" border="0" width="100%">
						...
						<tr bgcolor="#cbe5fe">
							...
							<table border="0" width="100%">
								<tr>
									<td bordercolor="#000000" width="27%"><strong>Im&oacute;vel:<font
								...
								<logic:present name="situacaoExclusaoAguaEsgoto" scope="session">	
									<tr>
										<td height="10">
											<div class="style9"><strong>Situa&ccedil;&atilde;o de
											&Aacute;gua Anterior:</strong></div>
										</td>
										<td>
											<html:text property="situacaoAguaAnterior" readonly="true"
												style="background-color:#EFEFEF; border:0; color: #000000"
												size="15" maxlength="10" />									
										</td>
										
										<td height="10">
											<div class="style9"><strong>Situa&ccedil;&atilde;o Esgoto
											 Anterior:</strong></div>
										</td>
										<td>
											<html:text property="situacaoEsgotoAnterior" readonly="true"
												style="background-color:#EFEFEF; border:0; color: #000000"
												size="15" maxlength="10" />									
										</td>																	
									</tr>
									<tr>
										<td align="left">									
											<tr>
												<td ><p><strong>Observação da Exclusão:</strong></p></td>
											</tr>								
											<tr>											
												<td colspan="4" width="100%">
													<html:textarea style="width:100%;" readonly="true" property="observacaoExclusaoImovel" cols="30" rows="6"
														onkeyup="limitTextArea(document.forms[0].observacaoExclusaoImovel, 200, document.getElementById('utilizado'), document.getElementById('limite'));" />
												</td>
											</tr>																														
										</td>
									</tr>
				...
				<tr>
					...
					<table width="100%" bgcolor="#99CCFF">
						...
						<tr bgcolor="#99CCFF" class="styleFontePeqNegrito">
							...
							<td width="20%" align="center">Motivo Corte/Supressão</td>
						...
						<tr bgcolor="#FFFFFF" class="styleFontePequena">
							...
							&nbsp;</td>
							<td align="center">${sessionScope.consultarImovelActionForm.motivoCorteSupressaoAgua}
							&nbsp;</td>
				...
				<tr>
					...
					<table width="100%" bgcolor="#99CCFF">
						<tr>
							<td colspan="5" bgcolor="#79bbfd" align="center"><strong>Dados do
							Hidr&ocirc;metro da Ligação de Água</strong></td>

						</tr>
						<!--header da tabela interna -->
						<tr bgcolor="#99CCFF" class="styleFontePeqNegrito">
							<td width="22%" align="center">Tipo de Medi&ccedil;&atilde;o</td>
							<td width="20%" align="center">Hidr&ocirc;metro</td>
							<td width="26%" align="center">Número do Hidr&ocirc;metro</td>
							<td width="16%" align="center">Dt Instala&ccedil;&atilde;o</td>
							<td width="23%" align="center">Capacidade</td>
						</tr>

						<tr bgcolor="#FFFFFF" class="styleFontePequena">
							<td align="center">${sessionScope.consultarImovelActionForm.tipoMedicao}
							&nbsp;</td>
							<td align="center">${sessionScope.consultarImovelActionForm.hidrometro}
							&nbsp;</td>
						...
						<tr bgcolor="#99CCFF" class="styleFontePeqNegrito">
							...
							<td align="center" colspan="2">Di&acirc;metro</td>
						...
						<tr bgcolor="#FFFFFF" class="styleFontePequena">
							...
							<td align="center" colspan="2">${sessionScope.consultarImovelActionForm.diametroHidrometro}
							&nbsp;</td>
						</tr>

						<tr bgcolor="#99CCFF" class="styleFontePeqNegrito">
							<td colspan="2" align="center">Prote&ccedil;&atilde;o</td>
							<td align="center">Cavalete</td>
							<td align="center" colspan="2">Ano de Fabrica&ccedil;&atilde;o</td>
						...
						<tr bgcolor="#FFFFFF" class="styleFontePequena">
							...
							&nbsp;</td>
							<td align="center" colspan="2">${sessionScope.consultarImovelActionForm.anoFabricacao}
							&nbsp;</td>
						</tr>
						<!--header da tabela interna -->
						<tr bgcolor="#99CCFF" class="styleFontePeqNegrito">
							...
							<td align="center" colspan="2">Número Lacre Instalação</td>
						</tr>
						...
						<tr bgcolor="#FFFFFF" class="styleFontePequena">
							...
							&nbsp;</td>
							<td align="center" colspan="2">${sessionScope.consultarImovelActionForm.numeroLacreInstalacao}
							&nbsp;</td>
						</tr>
						<tr bgcolor="#99CCFF" class="styleFontePeqNegrito">
							<td align="center">Tombamento</td>
							<td colspan="2" align="center">Erro do Macromedidor</td>
							<td align="center" colspan="2">Classe de Pressão</td>
						</tr>

						<tr bgcolor="#FFFFFF" class="styleFontePequena">
							<td align="center">${sessionScope.consultarImovelActionForm.tombamento}
							&nbsp;</td>
							<td colspan="2" align="center">${sessionScope.consultarImovelActionForm.hidrometroClassePressao}
							&nbsp;</td>
							<td align="center" colspan="2">${sessionScope.consultarImovelActionForm.hidrometroFatorCorrecao}
							&nbsp;</td>
						</tr>
				...
				<tr>
					...
					<table width="100%" bgcolor="#99CCFF">
						...
						<tr bgcolor="#FFFFFF" class="styleFontePequena">
							...
							&nbsp;</td>
							<td align="center">${sessionScope.consultarImovelActionForm.dataCorteEsgoto}
							&nbsp;</td>
							<td align="center">${sessionScope.consultarImovelActionForm.motivoCorteSupressaoEsgoto}
							&nbsp;</td>
							<td align="center">${sessionScope.consultarImovelActionForm.dataReligacaoEsgoto}
							&nbsp;</td>
							<td align="center">${sessionScope.consultarImovelActionForm.dataSupressaoEsgoto}
							&nbsp;</td>
							<td align="center">${sessionScope.consultarImovelActionForm.dataRestabelecimentoEsgoto}
							&nbsp;</td>
						</tr>
						
						<!--header da tabela interna -->
						<tr bgcolor="#99CCFF" class="styleFontePeqNegrito">
							<td colspan="2" align="center" width="33%">Diametro</td>
							<td colspan="2" align="center" width="33%">Material</td>
							<td colspan="2" align="center" width="33%">Perfil de Ligação</td>
						</tr>

						<tr bgcolor="#FFFFFF" class="styleFontePequena">
							<td colspan="2" align="center">${sessionScope.consultarImovelActionForm.descricaoLigacaoEsgotoDiametro}
							&nbsp;</td>
							<td colspan="2" align="center">${sessionScope.consultarImovelActionForm.descricaoLigacaoEsgotoMaterial}
							&nbsp;</td>
						...
						<tr  bgcolor="#99CCFF" class="styleFontePeqNegrito">
							...
							<td colspan="1" align="center" width="15%">Percentual de Esgoto</td>
							<td colspan="2" align="center" width="15%">Percentual de Coleta</td>
						...
						<tr bgcolor="#FFFFFF" class="styleFontePequena">
							...
							&nbsp;</td>
							<td colspan="1" align="center">${sessionScope.consultarImovelActionForm.percentualEsgoto}
							&nbsp;</td>
							<td colspan="2" align="center">${sessionScope.consultarImovelActionForm.percentualAguaConsumidaColetada}&nbsp;</td>
						...
						<table width="100%">
						<tr bgcolor="#99CCFF" class="styleFontePeqNegrito">
							<td colspan="2" align="center" width="25%">Condição Esgotamento</td>
							<td align="center" width="25%">Sistema de Caixa de Inspeção</td>
							<td colspan="2" align="center" width="25%">Destino dos Dejetos</td>
							<td align="center" width="25%">Destino das Águas Pluviais</td>
						</tr>
						<tr bgcolor="#FFFFFF" class="styleFontePequena">
							<td colspan="2" align="center">${sessionScope.consultarImovelActionForm.condicaoEsgotamento}
							&nbsp;</td>
							<td align="center">${sessionScope.consultarImovelActionForm.sistemaCaixaInspecao}&nbsp;</td>
							<td colspan="2" align="center">${sessionScope.consultarImovelActionForm.destinoDejetos}&nbsp;</td>
					...
					<table width="100%" border="0" bgcolor="#99CCFF">
						...
						<tr>
							...
							<table width="100%" border="0" cellpadding="0" cellspacing="0">
								<tr>
									<td colspan="10" bgcolor="#79bbfd" align="center"><strong>Hist&oacute;rico
									de Medi&ccedil;&atilde;o</strong></td>
								</tr>

								<tr bgcolor="#90c7fc" class="styleFontePeqNegrito">
									<td width="9%" align="center">M&ecirc;s/Ano</td>
									<td width="7%" align="center">Leit. Coletada</td>
									<td width="11%" align="center">Dt. Leit. Inform.</td>
									<td width="7%" align="center">Leit. Inform.</td>
									<td width="11%" align="center">Dt. Leit. Fat.</td>
									<td width="8%" align="center">Leit. Fat.</td>
									<td width="7%" align="center">Cons. Médio</td>
									<td width="12%" align="center">Anorm. Informada</td>
									<td width="11%" align="center">Anorm. Faturada</td>
							...
							%>
												<tr bgcolor="#FFFFFF" class="styleFontePequena">
													...
													<font color="#000000"
													 ...
													 &nbsp; <label title="${medicaoHistorico.hint}" id="anoMes">${medicaoHistorico.mesAno}</label></font>
													...
													<td width="7%" align="center"><font color="#000000"
														style="font-size:9px"
														face="Verdana, Arial, Helvetica, sans-serif">
														${medicaoHistorico.leituraCampo} &nbsp;</font></td>
													...
													<td width="12%" align="center"><font color="#000000" style="font-size:9px"
														...
														<a title="${medicaoHistorico.leituraAnormalidadeInformada.descricao}" 
													     href="javascript:abrirPopup('exibirConsultarFotoMicroMedicaoPopupAction.do?id=${sessionScope.consultarImovelActionForm.idImovelAnaliseMedicaoConsumo}&anoMes=${medicaoHistorico.mesAno}&metp=<%=LigacaoTipo.LIGACAO_AGUA%>', 450, 550);">
 															${medicaoHistorico.leituraAnormalidadeInformada.id}
														</a>
													&nbsp;</font></td>
													
													<td width="11%" align="center"><font color="#000000" style="font-size:9px"
														face="Verdana, Arial, Helvetica, sans-serif">
													...
													<td width="17%"><font color="#000000" style="font-size:9px"
														face="Verdana, Arial, Helvetica, sans-serif">
							...
							%>
												<tr bgcolor="#FFFFFF" class="styleFontePequena">
													...
													<td width="12%" align="center"><font color="#000000" style="font-size:9px"
														face="Verdana, Arial, Helvetica, sans-serif">
													    <a title="${medicaoHistorico.leituraAnormalidadeInformada.descricao}" 
													     href="javascript:abrirPopup('exibirConsultarFotoMicroMedicaoPopupAction.do?id=${sessionScope.consultarImovelActionForm.idImovelAnaliseMedicaoConsumo}&anoMes=${medicaoHistorico.mesAno}&metp=<%=LigacaoTipo.LIGACAO_ESGOTO%>', 450, 550);">
 															 ${medicaoHistorico.leituraAnormalidadeInformada.id}
 														</a>
													</font></td>
													<td width="12%" align="center"><font color="#000000" style="font-size:9px"
