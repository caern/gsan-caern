				...
				<tr>
					...
					<td colspan="4">
						<html:text  property="codigoImovel" 
									maxlength="9" 
									size="9" 
									onkeyup="validaEnterImovel(event, 'exibirConsultarDebitoAction.do', 'codigoImovel'), limparOrigem('imovel');" 
					...
					<a href="javascript:habilitarPesquisaImovel(document.forms[0]);" title="Pesquisar Imóvel">
						...
						<logic:present name="corImovel">
							<logic:equal name="corImovel" value="exception">
								<html:text property="inscricaoImovel" size="43"	readonly="true"
						...
						<logic:notPresent name="corImovel">
							<logic:empty name="ConsultarDebitoActionForm"	property="codigoImovel">
								<html:text property="inscricaoImovel" size="43" value="" readonly="true"
									style="background-color:#EFEFEF; border:0; color: #000000" />
							</logic:empty>
				...
				<tr>
					...
					<td colspan="4">
						<html:text  property="codigoClienteSuperior" 
									maxlength="9" 
									size="9" 
									onkeyup="return validaEnterClienteSuperior(event, 'exibirConsultarDebitoAction.do', 'codigoClienteSuperior'), limparOrigem('clienteSuperior');  " 
									onkeypress="return isCampoNumerico(event);"/>
						...
						<logic:present name="corClienteSuperior">
							<logic:equal name="corClienteSuperior" value="exception">
								<html:text property="nomeClienteSuperior" size="43"	readonly="true"
									style="background-color:#EFEFEF; border:0; color: #ff0000" />
							</logic:equal>
						...
						<logic:notPresent name="corClienteSuperior">
							<logic:empty name="ConsultarDebitoActionForm" property="codigoClienteSuperior">
								<html:text property="nomeClienteSuperior" size="43" value="" readonly="true"
									style="background-color:#EFEFEF; border:0; color: #ff0000" />
							</logic:empty>
				...
				<tr>
					...
					<td colspan="4">
						<html:text  property="codigoCliente" 
									maxlength="9" 
									size="9" 
									onkeyup="return validaEnterCliente(event, 'exibirConsultarDebitoAction.do', 'codigoCliente'), limparOrigem('cliente'); " 
									onkeypress="return isCampoNumerico(event);" />
						...
						<logic:present name="corCliente">
							<logic:equal name="corCliente" value="exception">
								<html:text property="nomeCliente" size="43"	readonly="true"
									style="background-color:#EFEFEF; border:0; color: #ff0000" />
							</logic:equal>
						...
						<logic:notPresent name="corCliente">
							<logic:empty name="ConsultarDebitoActionForm"	property="codigoCliente">
								<html:text property="nomeCliente" size="43" value="" readonly="true"
									style="background-color:#EFEFEF; border:0; color: #ff0000" />
							</logic:empty>
			  ...
			  <tr> 
				...
				<tr>
					...
					<html:text property="dataVencimentoInicial" size="10"
						...
						onkeypress="return isCampoNumerico(event);"/> 
							<a href="javascript:abrirCalendarioReplicando('ConsultarDebitoActionForm', 'dataVencimentoInicial', 'dataVencimentoFinal')">
					<img border="0"
