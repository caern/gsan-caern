 ...
 */
public class ConsultarLogDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements gcom.integracao.webservice.neurotech.gateway.webservices.fachada.ConsultarLogDocument
{
     ...
     */
    public gcom.integracao.webservice.neurotech.gateway.webservices.fachada.ConsultarLogDocument.ConsultarLog getConsultarLog()
    {
        synchronized (monitor())
        {
            check_orphaned();
            gcom.integracao.webservice.neurotech.gateway.webservices.fachada.ConsultarLogDocument.ConsultarLog target = null;
            target = (gcom.integracao.webservice.neurotech.gateway.webservices.fachada.ConsultarLogDocument.ConsultarLog)get_store().find_element_user(CONSULTARLOG$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setConsultarLog(gcom.integracao.webservice.neurotech.gateway.webservices.fachada.ConsultarLogDocument.ConsultarLog consultarLog)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (gcom.integracao.webservice.neurotech.gateway.webservices.fachada.ConsultarLogDocument.ConsultarLog)get_store().add_element_user(CONSULTARLOG$0);
            }
     ...
     */
    public gcom.integracao.webservice.neurotech.gateway.webservices.fachada.ConsultarLogDocument.ConsultarLog addNewConsultarLog()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     * This is a complex type.
     */
    public static class ConsultarLogImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements gcom.integracao.webservice.neurotech.gateway.webservices.fachada.ConsultarLogDocument.ConsultarLog
    {
