	...
	<td width="610" valign="top" class="centercoltext">
	  ...
	  <tr>
		...
		<html:text maxlength="3"
			...
			onkeypress="javascript:validaEnter(event, 'atualizarComandoNegativacaPorCriterioWizardAction.do?action=exibirAtualizarComandoNegativacaoLocalizacaoAction', 'idLocalidadeInicial');" 
		...
		<img width="23" height="21" border="0"
			...
			<logic:empty name="AtualizarComandoNegativacaoPorCriterioActionForm"
				property="idLocalidadeInicial">
				<html:text property="localidadeDescricaoInicial" value=""
					size="40" readonly="true"
					style="background-color:#EFEFEF; border:0; color: #ff0000" />
			</logic:empty>
			<logic:notEmpty name="AtualizarComandoNegativacaoPorCriterioActionForm"
				property="idLocalidadeInicial">
				<html:text property="localidadeDescricaoInicial" size="40"
					readonly="true"
					style="background-color:#EFEFEF; border:0; color: #000000" />
	  ...
	  <tr>
		...
		<html:text maxlength="3"
			...
			onkeypress="javascript:validaEnterDependencia(event, 'atualizarComandoNegativacaPorCriterioWizardAction.do?action=exibirAtualizarComandoNegativacaoLocalizacaoAction', this, document.forms[0].idLocalidadeInicial.value, 'Localidade');"
			
			onkeyup="javascript:desabilitarGrupoCobranca();" /> 
	  ...
	  <tr>
		...
		<html:text maxlength="3"
			...
			onkeypress="javascript:validaEnter(event, 'atualizarComandoNegativacaPorCriterioWizardAction.do?action=exibirAtualizarComandoNegativacaoLocalizacaoAction', 'idLocalidadeFinal');" 
	  ...
	  <tr>
		...
		<html:text maxlength="3"
			...
			onkeypress="javascript:return validaEnterDependencia(event, 'atualizarComandoNegativacaPorCriterioWizardAction.do?action=exibirAtualizarComandoNegativacaoLocalizacaoAction', this, document.forms[0].idLocalidadeFinal.value, 'Localidade');"
...
<script>
document.getElementById('botaoConcluir').onclick = function() { botaoAvancarTelaEspera('/gsan/atualizarComandoNegativacaPorCriterioWizardAction.do?concluir=true&action=atualizarComandoNegativacaoLocalizacaoAction'); }
</script>
