...
public class FiltroImovelPerfil extends Filtro implements Serializable {
    ...
    public final static String INDICADOR_FILTRAR_ATUALIZAR_PERFIL = "indicadorNegativacaoDoCliente";
    
    public final static String INDICADOR_CORPORATIVO = "indicadorCorporativo";
