 ...
 * @date 15/05/2006
 */
public class ResumoFaturamentoSituacaoEspecial {
	...
	public ResumoFaturamentoSituacaoEspecial(Integer id, Integer codigoSetorComercial, Integer numeroQuadra, Integer anoMesInicioSituacaoEspecial, Integer anoMesFinalSituacaoEspecial, Integer quantidadeImovel, GerenciaRegional gerenciaRegional, Localidade localidade, SetorComercial setorComercial, Rota rota, Quadra quadra, ImovelPerfil perfilImovel, LigacaoAguaSituacao ligacaoAguaSituacao, LigacaoEsgotoSituacao ligacaoEsgotoSituacao, Categoria categoria, EsferaPoder esferaPoder, FaturamentoSituacaoTipo faturamentoSituacaoTipo, FaturamentoSituacaoMotivo faturamentoSituacaoMotivo) {
		...
		this.rota = rota;
		this.quadra = quadra;
		this.imovelPerfil = perfilImovel;
		this.ligacaoAguaSituacao = ligacaoAguaSituacao;
		this.ligacaoEsgotoSituacao = ligacaoEsgotoSituacao;
		this.categoria = categoria;
		this.esferaPoder = esferaPoder;
	...
	public ResumoFaturamentoSituacaoEspecial() {
	...
	/**
	 * @return Retorna o campo faturamentoSituacaoMotivo.
	 */
	public FaturamentoSituacaoMotivo getFaturamentoSituacaoMotivo() {
		return faturamentoSituacaoMotivo;
	}
	/**
	 * @param faturamentoSituacaoMotivo O faturamentoSituacaoMotivo a ser setado.
	 */
	...
	/**
	 * @return Retorna o campo faturamentoSituacaoTipo.
	 */
	public FaturamentoSituacaoTipo getFaturamentoSituacaoTipo() {
		return faturamentoSituacaoTipo;
	}
	/**
	 * @param faturamentoSituacaoTipo O faturamentoSituacaoTipo a ser setado.
	 */
