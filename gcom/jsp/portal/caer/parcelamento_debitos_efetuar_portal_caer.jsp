...
<html:html>
	<head>
		...
		<logic:present name="valorEntradaInvalido" scope="request">
			<script type="text/javascript">
				$(document).ready(function(){
					showMessage('Não é permitido efetuar o parcelamento com o valor da entrada, tente pagar à vista ou vá a um dos postos de atendimento da Caer.');
				});
			</script>
		</logic:present>
		...
		<script type="text/javascript">
			...
			function recalcularParcelmamento(){
				...
				if(form.cpfCliente.value.length != 0){
					form.action = "exibirEfetuarParcelamentoDebitosPortalCaerAction.do?method=pesquisarCliente&mudancaIndicadorRestabelecimento=SIM";
					form.submit();
				}
			}
			...
			function calcularOpcaoParcelamento(){
				var form = document.forms[0];
				form.action = "exibirEfetuarParcelamentoDebitosPortalCaerAction.do?calcularParcelas=SIM";
				form.submit();
			}
			...
			function gerarDocumentoExtrato(){
				window.location.href='<html:rewrite page="/gerarRelatorioExtratoDebitoAction.do?parcelamentoPortal=CAER&parcelamento=1&indicadorContasRevisao=1&RD="/><bean:write name="EfetuarParcelamentoDebitosPortalCaerActionForm" property="resolucaoDiretoria"/>'
			}
			
			function gerarDocumentosParcelamento(){
				window.location.href='gerarRelatorioDocumentosParcelamentoPortalCaerAction.do'
			}

			function exibirEfetuarParcelamento(){
				var form = document.forms[0];
				form.action = "exibirEfetuarParcelamentoDebitosPortalCaerAction.do?method=pesquisarCliente";
				form.submit();
			}
		</script>
	</head>
		...
		<div id="container">
			...
			<div id="content">
				...
				<div id="parc-debito" class="serv-int">
	                ...
	                <p>Endereço do imóvel: <em id="enderecoImovel">${EfetuarParcelamentoDebitosPortalCaerActionForm.enderecoImovel}</em></p>
	                <p class="info-2">Para efetuar o parcelamento informe o CPF do cliente responsável pelo débito.</p>

	            	<html:form action="/efetuarParcelamentoDebitosPortalCaerAction.do"
						name="EfetuarParcelamentoDebitosPortalCaerActionForm"
						type="gcom.gui.portal.caer.EfetuarParcelamentoDebitosPortalCaerAction" method="post">
						...
						<fieldset>
							...
							<div>
								...
								<logic:present name="exibirDetalhesDebito" scope="request">
									<p class="nome-cliente">${EfetuarParcelamentoDebitosPortalCaerActionForm.nomeCliente}</p>
								</logic:present>
							...
							<logic:present name="exibirDetalhesDebito" scope="request">
								...
								<ul class="lista-resumo">
									<li>
				                		<h6>Contas:</h6>
				                		R$<bean:write name="EfetuarParcelamentoDebitosPortalCaerActionForm" property="valorTotalContaValores" />
				                	</li>
				                	<li>
				                		<h6>Guias de pagamento:</h6>
				                		R$<bean:write name="EfetuarParcelamentoDebitosPortalCaerActionForm" property="valorGuiasPagamento" />
				                	</li>
		                			<li>
				                		<h6>Acréscimos por impontualidade:</h6>
				                		<logic:notEqual name="EfetuarParcelamentoDebitosPortalCaerActionForm" 
											property="valorAcrescimosImpontualidade" value="0,00">
											R$<bean:write name="EfetuarParcelamentoDebitosPortalCaerActionForm"
												property="valorAcrescimosImpontualidade" formatKey="money.format" />
										</logic:notEqual>
										<logic:equal name="EfetuarParcelamentoDebitosPortalCaerActionForm"
											property="valorAcrescimosImpontualidade" value="0,00">
											R$<bean:write name="EfetuarParcelamentoDebitosPortalCaerActionForm"
												property="valorAcrescimosImpontualidade" formatKey="money.format" />
										</logic:equal>
				                	...
				                	<li>
				                		...
				                		<logic:notEqual name="EfetuarParcelamentoDebitosPortalCaerActionForm" 
											...
											R$<bean:write name="EfetuarParcelamentoDebitosPortalCaerActionForm" property="valorDebitoACobrarServico"  formatKey="money.format"/>
										</logic:notEqual>
										<logic:equal name="EfetuarParcelamentoDebitosPortalCaerActionForm" 
											property="valorDebitoACobrarServico" value="0,00">
											R$<bean:write name="EfetuarParcelamentoDebitosPortalCaerActionForm" property="valorDebitoACobrarServico" formatKey="money.format" />
				                		...
				                		<logic:notEqual name="EfetuarParcelamentoDebitosPortalCaerActionForm" 
											...
											<a href="javascript:abrirPopup('exibirConsultarDebitoACobrarAction.do?imovelID=
												<bean:define name="EfetuarParcelamentoDebitosPortalCaerActionForm" property="matriculaImovel" id="imovel" />
												<bean:write name="EfetuarParcelamentoDebitosPortalCaerActionForm" property="matriculaImovel" />&parcelamentoID=', 600, 800);">
												R$<bean:write name="EfetuarParcelamentoDebitosPortalCaerActionForm" property="valorDebitoACobrarParcelamento"  formatKey="money.format"/>
											</a>
										</logic:notEqual>
										<logic:equal name="EfetuarParcelamentoDebitosPortalCaerActionForm" 
											property="valorDebitoACobrarParcelamento" value="0,00">
				                	...
				                	<li>
				                		...
				                		<logic:notEqual name="EfetuarParcelamentoDebitosPortalCaerActionForm" 
											...
											<a href="javascript:abrirPopup('exibirConsultarCreditoARealizarAction.do?imovelID=<bean:define name="EfetuarParcelamentoDebitosPortalCaerActionForm" property="matriculaImovel" id="imovel" />
												<bean:write name="EfetuarParcelamentoDebitosPortalCaerActionForm" property="matriculaImovel" />&parcelamentoID=', 600, 800);">
												R$<bean:write name="EfetuarParcelamentoDebitosPortalCaerActionForm" property="valorCreditoARealizar" formatKey="money.format"/>
											</a>
										</logic:notEqual>
										<logic:equal name="EfetuarParcelamentoDebitosPortalCaerActionForm" 
											property="valorCreditoARealizar" value="0,00">
				                	...
				                	<li>
				                		...
				                		R$<bean:write name="EfetuarParcelamentoDebitosPortalCaerActionForm" property="valorDebitoTotalAtualizado" />
				                		<br />&nbsp;
				                	</li>
				                	<li>
								...
								<div id="pagto">
									...
									<ul class="lista-resumo">
										...
										<li>
											...
											R$<bean:write name="EfetuarParcelamentoDebitosPortalCaerActionForm" property="valorTotalImpostos" 
												formatKey="money.format"/>
											<br />
										</li>
										<li>
					                		<h6>Valor do desconto:</h6>
											R$<bean:write name="EfetuarParcelamentoDebitosPortalCaerActionForm" property="valorDescontoPagamentoAVista" 
												formatKey="money.format"/>
											<br />
										</li>
										<li>
					                		<h6>Valor pagamento à vista:</h6>
											R$<bean:write name="EfetuarParcelamentoDebitosPortalCaerActionForm" property="valorPagamentoAVista" 
												formatKey="money.format"/>
										</li>
									</ul>
				                	<table>
