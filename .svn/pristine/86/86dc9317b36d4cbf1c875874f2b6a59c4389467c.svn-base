	...
	<td width="625" valign="top" class="centercoltext">
      ...
      <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          ...
          <td class="parabg"><font style="font-size: 9px;">ICN - Por Critério - Dados dos Débitos</font></td>
	  ...
	  <tr>
		...
		<a
			href="javascript:abrirCalendarioReplicando('InserirComandoNegativacaoActionForm', 'dataVencimentoInicial', 'dataVencimentoFinal');" >
		<img border="0"
		...
		a <html:text property="dataVencimentoFinal" size="10"
			...
			href="javascript:abrirCalendario('InserirComandoNegativacaoActionForm', 'dataVencimentoFinal')">
		<img border="0"
			src="<bean:message key="caminho.imagens"/>calendario.gif"
			width="20" border="0" align="absmiddle" alt="Exibir Calendário" /></a>
		dd/mm/aaaa</td>
	  ...
	  <tr>
		...
		<td><html:text property="valorDebitoInicial" 
				size="17" maxlength="17" onkeyup="formataValorMonetario(this, 13)"/>a <html:text property="valorDebitoFinal" 
				size="17" maxlength="17" onkeyup="formataValorMonetario(this, 13)"/></td>
	  </tr>
	  <tr>
		<td height="10" width="35%">
		...
		<td><html:text property="numeroContasInicial" 
				size="9" maxlength="9" onkeypress="return isCampoNumerico(event);"/>a <html:text property="numeroContasFinal"
				size="9" maxlength="9" onkeypress="return isCampoNumerico(event);"/></td>
	  </tr>      
      <tr>
