...
<logic:present scope="request" name="exibirTextoPersonalizado">
	...
	$(document).ready(function(){
		...
		$('#botaoSMS').bind("click",function(){
			var theForm = $("form[name=AcaoCobrancaAtualizarActionForm]");
			var params = theForm.serialize();
			var actionURL = 'exibirAtualizarAcaoCobrancaAction.do?action=validarTextoSMS';
			$.ajax({
			    type:"POST",
				url:actionURL,
				data:params,
		...
		$('#botaoEmail').bind("click",function(){
			...
			if(textoAInserir != null && textoAInserir != -1){
				var theForm = $("form[name=AcaoCobrancaAtualizarActionForm]");
				var params = theForm.serialize();
				var actionURL = 'exibirAtualizarAcaoCobrancaAction.do?action=validarTextoEmail';
				$.ajax({
				    type:"POST",
					url:actionURL,
					data:params,
	...
	<logic:present scope="request" name="exibirTextoPersonalizado">
	    ...
	    verificarindicadorEnviarSmsEmail(); habilitarCamposValidarItem();">
	   
	</logic:present>

	<logic:notPresent scope="request" name="exibirTextoPersonalizado">

	    <body leftmargin="5" topmargin="5" onload="setarFoco('${requestScope.nomeCampo}');habilitaNumeroDiasAcaoPredecessora(); habilitarCamposValidarItem();">
	        ...
	        <tr>
	            ...
	            <table width="100%" border="0">
	             ...
	             <tr>
	                ...
	                <td width="25%">
	                    <html:select property="idTipoDocumentoGerado" tabindex="5" onchange="redirecionarSubmit('exibirAtualizarAcaoCobrancaAction.do?action=pesquisarDocumentoTipo');">
	                            <html:option value="">&nbsp;</html:option>
	              ...
	              <tr>
	                ...
	                <td>
	                   <html:text maxlength="4" property="idCobrancaCriterio" size="4" tabindex="8"
	                     onkeypress="javascript:validaEnterComMensagem(event, 'exibirAtualizarAcaoCobrancaAction.do?action=pesquisarCriterioCobranca', 'idCobrancaCriterio', 'Critério de Cobrança');document.forms[0].descricaoCobrancaCriterio.value = '';" />
	                        ...
	                        <logic:notEmpty name="AcaoCobrancaAtualizarActionForm" property="idCobrancaCriterio">
	                            <html:text property="descricaoCobrancaCriterio" size="25" maxlength="36" readonly="true"
	              ...
	              <tr>
	                ...
	                <td>
	                   <html:text maxlength="4" property="idServicoTipo" size="4" tabindex="9"
	                     onkeypress="javascript:validaEnterComMensagem(event, 'exibirAtualizarAcaoCobrancaAction.do?action=pesquisarTipoServico', 'idServicoTipo', 'Tipo de Serviço');document.forms[0].descricaoServicoTipo.value = '';" />
	                        ...
	                        <logic:notEmpty name="AcaoCobrancaAtualizarActionForm" property="idServicoTipo">
	                            <html:text property="descricaoServicoTipo" size="25" maxlength="36" readonly="true"
	                                    style="background-color:#EFEFEF; border:0; color: #000000" />
	                        </logic:notEmpty>
	              ...
	              <tr>
	                 ...
	                 <tr>
	                 	...
	                 	<td>
				  			<html:text property="ordemCronograma" size="4" maxlength="4" tabindex="4" styleClass="radioSim" disabled="true" onkeypress="return isCampoNumerico(event);"/>
	                 	</td>
	                 </tr>
	                 <tr> 
	                ...
	                <tr>
		                 <td><strong>Validar por item cobrado:<font color="#FF0000">*</font></strong></td>
		                 <td>
			                 <html:radio property="icValidarItem" value="1" tabindex="40" styleClass="radioSim" onchange="habilitarCamposValidarItem();"/><strong>Sim</strong>
			                 <html:radio property="icValidarItem" value="2" tabindex="41" styleClass="radioNao" onchange="habilitarCamposValidarItem();"/><strong>N&atilde;o</strong>
		                 </td>
	                 </tr>	                
                 <tr>
                 ...
                 <tr>
	                 ...
	                 <td>
	                 	<html:text property="numeroDiasMaximoCobranca" size="6"
							maxlength="6" tabindex="44"/>
		             </td>
                 </tr>
	                 <tr>
		                 <td width="45%"><strong>Efetuar Ação para CPF/CNPJ Válido:<font color="#FF0000">*</font></strong></td>
		                 <td>
							            ...
							            <html:select property="dadosTexto" size="7" styleId="dadosTexto">
								            ...
								            <logic:notEmpty name="colecaoDadosTexto" scope="session">
								            	<logic:iterate name="colecaoDadosTexto" id="dados">
										        	<html:option value="${dados.id}">${dados.descricaoColuna} - ${dados.tamanhoColuna} posições</html:option>
										        </logic:iterate>
										    </logic:notEmpty>
							            </html:select>					         
					            	</td>          
							...
							<table width="100%" border="0">
								<tr>
									<td valign="top">
										...
										<input name="button" type="button" class="bottonRightCol"
										value="Desfazer"
										onclick="window.location.href='/gsan/exibirAtualizarAcaoCobrancaAction.do?idRegistroAtualizar=${AcaoCobrancaAtualizarActionForm.id}'">
