 ...
 * @date 20/04/2006
 */
public class ResumoFaturamentoImpostosHelper {
...
//	}	
	...
	public boolean equals(Object obj) {
        ...
        ResumoFaturamentoImpostosHelper resumoTemp = (ResumoFaturamentoImpostosHelper) obj;
        ...
        .append(this.getIndicadorHidrometro().intValue(), resumoTemp.getIndicadorHidrometro().intValue())
        .append(this.getImpostoTipo(), resumoTemp.getImpostoTipo())
	...
	public ResumoFaturamentoImpostosHelper(Integer idImovel,
	...
	public ResumoFaturamentoImpostosHelper(Integer idImovel, Integer idGerenciaRegional, Integer idLocalidade, Integer idSetorComercial, Integer idRota, Integer idQuadra, Integer codigoSetorComercial, Integer numeroQuadra, Integer idPerfilImovel, Integer idSituacaoLigacaoAgua, Integer idSituacaoLigacaoEsgoto, Integer idEsfera) {
		super();
		// TODO Auto-generated constructor stub
		this.idImovel = idImovel;
		this.idGerenciaRegional = idGerenciaRegional;
	...
	public Integer getImpostoTipo() {
		return impostoTipo;
	}

	public void setImpostoTipo(Integer impostoTipo) {
