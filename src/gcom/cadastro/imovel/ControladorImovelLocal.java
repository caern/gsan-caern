...
public interface ControladorImovelLocal extends javax.ejb.EJBLocalObject {
	 ...
	 * @throws ControladorException
	 */
	public void removerImovel(String[] ids, Usuario usuarioLogado, Boolean sitAguaEsgotoCancel) throws ControladorException;
	...
	public Collection gerarRelatorioImovelOutrosCriterios(
			...
			String sequencialRotaFinal, String indicadorNivelEsgotamento, String indicadorCpfCnpjInformado)
			throws ControladorException;
	...
	public Integer obterQuantidadaeRelacaoImoveisDebitos(
			...
			String cdRotaFinal, String sequencialRotaInicial,
			String sequencialRotaFinal, String indicadorNivelEsgotamento) throws ControladorException;
...
//	
	 ...
	 * @throws ControladorException
	 */
	public void verificarExistenciaAlteracaoInscricaoPendenteImovel(Imovel imovel) throws ControladorException;
	 ...
	 * @throws ControladorException
	 */
	public void atualizarImovelExcluido(Imovel imovelNovaSituacao, Usuario usuario) throws ControladorException;
	
	/**
	 * Transferir Cliente e Registrar a Transação
	 * 
	 ...
	 * @throws ControladorException
	 */
	public boolean verificarClienteImovelVivaAguaPermissao(Integer idImovel, Usuario usuario)
			throws ControladorException; 
	 ...
	 * @date 27/08/2014
	 */
	public Integer verificaExistenciaImovelAtualizacaoCadastralDM(Integer idImovel, Integer idParametro) 
		throws ControladorException;
	 ...
	 * @throws ControladorException
	 */
	public void atualizarImovelAtualizacaoCadastralPreGsan(
			String idImovelAtlzCadastral, String acaoSelecionada, String matriculaGsan) throws ControladorException;
