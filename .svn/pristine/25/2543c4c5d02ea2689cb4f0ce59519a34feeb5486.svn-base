	...
	<td width="610" valign="top" class="centercoltext">
      ...
      <tr>
      	<td width="35%"><strong>Quantidade de Dias:</strong></td>
       	<td>
			<html:text property="quantidadeDias" size="15" maxlength="15" tabindex="1" readonly="true"
	  ...
	  <tr>
       ...
       <tr> 
        ...
        <td colspan="6"><span class="style2"><strong>
		  <html:select property="motivoRetorno" style="width: 350px; height:100px;" multiple="true" disabled="true">
...
<script>
document.getElementById('botaoConcluir').onclick = function() { botaoAvancarTelaEspera('/gsan/atualizarComandoNegativacaPorCriterioWizardAction.do?concluir=true&action=atualizarComandoNegativacaoExclusaoAction'); }
</script>
