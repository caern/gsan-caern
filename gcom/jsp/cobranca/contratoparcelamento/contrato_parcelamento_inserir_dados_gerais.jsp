      ...
      <tr>
       ...
       <table border="0">
        ...
        <tr>
          ...
          <td colspan="5">
          	<html:text onkeypress="return isCampoNumerico(event);" onkeyup="mascaraAnoMes(this, event);" value="${contratoCadastrar.anoMesDebitoInicioFormatado}" property="anoMesDebitoInicio" size="7"  maxlength="7" />
            <strong> a</strong>
            <html:text onkeypress="return isCampoNumerico(event);" onkeyup="mascaraAnoMes(this, event);" value="${contratoCadastrar.anoMesDebitoFinalFormatado}" property="anoMesDebitoFinal" size="7"  maxlength="7" />
            (mm/aaaa) </td>
        </tr>
        <tr>
