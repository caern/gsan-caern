	...
	public void executarCargaLigacoesEconomiasPorAno(
		...
		*/		
		...
		try {
			...
			System.out.println("Iniciou Carga Ligações Economias Por Ano");
			repositorioGerencialArrecadacao.executarCargaLigacoesEconomiasPorAno();
			System.out.println("Finalizou Carga Ligações Economias Por Ano");
	...
	public void executarCargaIndicadorLigacaoEconomiaPorAno(
		...
		*/		
		...
		try {
			...
			System.out.println("Iniciou Carga Indicador Ligação Economia Por Ano");
			repositorioGerencialArrecadacao.executarCargaIndicadorLigacaoEconomiaPorAno();
			System.out.println("Finalizou Carga Indicador Ligação Economia Por Ano");
