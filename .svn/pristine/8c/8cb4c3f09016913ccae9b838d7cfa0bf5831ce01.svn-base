...
public class Relatorio implements Serializable {
	...
	public static final int RELATORIO_BOLETIM_MEDICAO_COMANDO_OS_SELETIVA_ARQUIVO_TXT = 208;
	
	public static final int RELATORIO_BOLETIM_MEDICAO_COMANDO_OS_SELETIVA = 209;
	
	public static final int RELATORIO_DOCUMENTO_VISITA_COBRANCA = 210;
	
	public static final int RELATORIO_ACOMPANHAMENTO_COMANDOS_COBRANCA = 211;
	
	public static final int GERAR_RELATORIO_DEBITOS_COBRANCA_IMOVEL = 212;
	
	public static final int GERAR_RELATORIO_TIPOS_SERVICO = 213;

	public static final int GERAR_RELATORIO_IMOVEIS_CLIENTES_CORPORATIVO = 215;
	
	public static final int CONTAS_NAO_IMPRESSAS = 214;
	
	public static final int RELATORIO_IMOVEIS_CONTAS_RETIRADOS_EMPRESAS_COBRANCA = 216;
	
	public static final int RELATORIO_COBRANCA_ATIVIDADE_MANTER = 217;
	
	public static final int RELATORIO_IMPOSTOS_CLIENTE_RESPONSAVEL = 223;
	
	public static final int RELATORIO_FILTRAR_DOCUMENTO_COBRANCA = 226;
	
	public static final int RELATORIO_HISTORICO_IMOVEIS_PROGRAMA_ESPECIAL = 229;
	
	public static final int RELATORIO_PAGAMENTO_BAIXA_AUTOMATICA_ANALITICO = 232;
	
	public static final int RELATORIO_PAGAMENTO_BAIXA_AUTOMATICA_SINTETICO = 233;
	
	public static final int RELATORIO_CLIENTE_CPF_CNPJ_VALIDADOS_MOBILE = 236;
