...
<SCRIPT LANGUAGE="JavaScript">
	...
	function IntegerValidations () { 
    	this.aa = new Array("numeroRA", "Número RA deve ser numérico(a).", new Function ("varName", " return this[varName];"));
    	this.ab = new Array("numeroProtocoloAtendimento", "Número Protocolo de Atendimento deve ser numérico(a).", new Function ("varName", " return this[varName];"));
    	this.ac = new Array("numeroRAManual", "Número RA manual deve ser numérico(a).", new Function ("varName", " return this[varName];"));
    	this.ad = new Array("quantidadeRAReiteradasInicial", "Quantidade RA Reiteiradas Inicial deve ser numérico(a).", new Function ("varName", " return this[varName];"));
    	this.ae = new Array("quantidadeRAReiteradasFinal", "Quantidade RA Reiteiradas Final deve ser numérico(a).", new Function ("varName", " return this[varName];"));
    	this.af = new Array("matriculaImovel", "Matrícula do Imóvel deve ser numérico(a).", new Function ("varName", " return this[varName];"));
    	this.ag = new Array("codigoCliente", "Código do Cliente deve ser numérico(a).", new Function ("varName", " return this[varName];"));
    	this.ah = new Array("unidadeAtendimentoId", "Unidade de Atendimento deve ser numérico(a).", new Function ("varName", " return this[varName];"));
    	this.ai = new Array("unidadeAtualId", "Unidade Atual deve ser numérico(a).", new Function ("varName", " return this[varName];"));
    	this.aj = new Array("unidadeSuperiorId", "Unidade Superior deve ser numérico(a).", new Function ("varName", " return this[varName];"));
    	this.ak = new Array("unidadeAnteriorId", "Unidade Anterior deve ser numérico(a).", new Function ("varName", " return this[varName];"));
    	this.al = new Array("municipioId", "Município deve ser numérico(a).", new Function ("varName", " return this[varName];"));
    	this.am = new Array("bairroCodigo", "Bairro deve ser numérico(a).", new Function ("varName", " return this[varName];"));
    	this.an = new Array("logradouroId", "Logradouro deve ser numérico(a).", new Function ("varName", " return this[varName];"));
    }
	...
	function validaForm(){
		...
		if(validateFiltrarRegistroAtendimentoActionForm(form)){
    		...
    		var cliente = trim(form.codigoCliente.value);
    		var imovel = trim(form.matriculaImovel.value);
    		if (cliente != '' && imovel != ''){
    			alert('Informe apenas o cliente Solicitante ou Imóvel');
    			return false;
    		}
...
<body leftmargin="5" topmargin="5" onload="setarFoco('${requestScope.nomeCampo}');habilitaImovel();habilitaCliente();">
<div id="formDiv">
              ...
              <tr> 
                ...
                <td colspan="6"><span class="style2"><strong>
					<html:text property="matriculaImovel" size="9" maxlength="9" 
							   ...
							   onkeyup="limparPeriodoAtendimento();habilitaCliente();"/>
					...
					<a href="javascript:limparFormImovel();habilitaCliente();">
						<img border="0" title="Apagar" src="<bean:message key='caminho.imagens'/>limparcampo.gif" /></a>
                  </strong></span></td>
              </tr>
              <tr>
              	<td><strong><span class="style2">C&oacute;digo do Cliente Solicitante</span>:</strong>
              	<td colspan="6"><span class="style2"><strong>
              		<html:text  property="codigoCliente" size="9" maxlength="7" 
              					onkeypress="javascript:validaEnterComMensagem(event, 'exibirFiltrarRegistroAtendimentoAction.do?validaCliente=true', 'codigoCliente', 'Código do Cliente');return isCampoNumerico(event);" 
              					onkeyup="limparPeriodoAtendimento();habilitaImovel();" />
              		
              		<a href="javascript:chamarPopup('exibirPesquisarClienteAction.do', 'cliente', null, null, 275, 480, '', document.forms[0].codigoCliente);">
              			<img src="<bean:message key='caminho.imagens'/>pesquisa.gif" width="23"	height="21" name="imagem" alt="Pesquisar" border="0" title="Pesquisar Cliente"></a>
              		...
              		<a href="javascript:limparFormCliente();habilitaImovel();">
                ...
                <td colspan="6"><span class="style2"><strong> 
					<logic:equal name="FiltrarRegistroAtendimentoActionForm" property="situacao" value="2">
						<html:text property="periodoAtendimentoInicial" 
								...
								readonly="true" 
								value=""/>
						<img border="0" src="<bean:message key='caminho.imagens'/>calendario.gif" width="16" height="15" border="0" title="Exibir Calendário" tabindex="4"/>
					...
					<logic:notEqual name="FiltrarRegistroAtendimentoActionForm" property="situacao" value="2">
						<html:text property="periodoAtendimentoInicial" 
								...
								onkeypress="return isCampoNumerico(event);"/>
						<a href="javascript:abrirCalendarioReplicando('FiltrarRegistroAtendimentoActionForm', 'periodoAtendimentoInicial', 'periodoAtendimentoFinal');">
                ...
                <td colspan="6"><span class="style2"><strong> 
					...
					<logic:notEqual name="FiltrarRegistroAtendimentoActionForm" property="situacao" value="1">
						<html:text property="periodoEncerramentoInicial" 
							...
							<a href="javascript:abrirCalendarioReplicando('FiltrarRegistroAtendimentoActionForm', 'periodoEncerramentoInicial', 'periodoEncerramentoFinal');">
							<img border="0" src="<bean:message key='caminho.imagens'/>calendario.gif" width="16" height="15" border="0" title="Exibir Calendário" tabindex="4"/></a>
						a <html:text property="periodoEncerramentoFinal" 
									size="11" 
									maxlength="10" 
               ...
               <tr> 
                ...
                <td colspan="6"><span class="style2"><strong> 
						<html:text property="periodoTramitacaoInicial" 
							...
							<a href="javascript:abrirCalendarioReplicando('FiltrarRegistroAtendimentoActionForm', 'periodoTramitacaoInicial', 'periodoTramitacaoFinal');">
							<img border="0" src="<bean:message key='caminho.imagens'/>calendario.gif" width="16" height="15" border="0" title="Exibir Calendário" tabindex="5"/></a>
