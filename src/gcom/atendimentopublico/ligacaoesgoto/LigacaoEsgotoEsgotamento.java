...
public class LigacaoEsgotoEsgotamento extends TabelaAuxiliar{
    ...
    private Short indicadorPermissaoEspecialUso;
	...
	public Short getIndicadorPermissaoEspecialUso() {
		return indicadorPermissaoEspecialUso;
	}

	public void setIndicadorPermissaoEspecialUso(Short indicadorPermissaoEspecialUso) {
		this.indicadorPermissaoEspecialUso = indicadorPermissaoEspecialUso;
	}
