...
public class ConstantesRelatorios {
	...
	public static final String RELATORIO_ANALISE_FATURAMENTO_PERIODO = "/relatorioAnaliseFaturamentoPeriodo.jasper";
	...
	public static final String RELATORIO_2_VIA_CONTA_SAAE = "/relatorio2ViaContaSaae.jasper";
	...
	public static final String RELATORIO_CONSULTAR_DEBITOS_ACRESCIMOS_DETALHADO = "/relatorioConsultarDebitosAcrescimosDetalhado.jasper";
	...
	public static final String RELATORIO_ACOMPANHAMENTO_CLIENTES_NEGATIVADOS_PDF = "/relatorioAcompanhamentoClientesNegativadosPdf.jasper";
	
	public static final String RELATORIO_ACOMPANHAMENTO_CLIENTES_NEGATIVADOS_EXCEL = "/relatorioAcompanhamentoClientesNegativadosExcel.jasper";
	...
	public static final String RELATORIO_IMPOSTOS_POR_CLIENTE_RESPONSAVEL_ANALITICO_ARRECADACAO = "/relatorioRelacaoImpostosPorClienteResponsavelAnaliticoArrecadacao.jasper";
	...
	public static final String RELATORIO_CONTAS_SAAE = "/relatorioConta2SAAE.jasper";
	
	public static final String RELATORIO_CONTAS_COSAMA = "/relatorioConta2COSAMA.jasper";
	...
	public static final String RELATORIO_MANTER_ANORMALIDADE_LEITURA = "/relatorioManterAnormalidadesLeitura.jasper";
	...
	public static final String RELATORIO_CERTIDAO_NEGATIVA_CLIENTE_REDUZIDA_CAEMA = "/relatorioCertidaoNegativaClienteReduzidaCaema.jasper";
	...
	public static final String RELATORIO_ACOMPANHAMENTO_CLIENTES_NEGATIVADOS_SINTETICO_PDF = "/relatorioAcompanhamentoClientesNegativadosSinteticoPdf.jasper";
	
	public static final String RELATORIO_ACOMPANHAMENTO_CLIENTES_NEGATIVADOS_SINTETICO_EXCEL = "/relatorioAcompanhamentoClientesNegativadosSinteticoExcel.jasper";
	...
	public static final String RELATORIO_DEBITOS_COBRADOS_IMOVEL = "/relatorioDebitosCobradosImovel.jasper";
	
	public static final String RELATORIO_TIPOS_SERVICO = "/relatorioTiposServico.jasper";
	...
	public static final String RELATORIO_ACESSO_LOJA_VIRTUAL = "/relatorioAcessoLojaVirtual.jasper";
	...
	public static final String RELATORIO_DOCUMENTOS_PARCELAMENTO_LOJA_VIRTUAL_CAER = "/relatorioDocumentosParcelamentoLojaVirtualCaer.jasper";
	...
	public static final String RELATORIO_BOLETIM_MEDICAO_COMANDO_OS_SELETIVA_ARQUIVO_TXT = "RelatorioBoletimMedicaoComandoOSSeltivaTxt";
	
	public static final String RELATORIO_BOLETIM_MEDICAO_COMANDO_OS_SELETIVA = "/relatorioBoletimMedicaoComandoOSSeltiva.jasper";
	
	public static final String RELATORIO_QUANTITATIVO_IMOVEIS_OS_SELETIVA = "/relatorioQuatImovOSSeletiva.jasper";
	
	public static final String RELATORIO_BOLETIM_MEDICAO_RECUPERACAO_CREDITOS_PARCELADOS = "/relatorioBoletimMedicaoRecuperacaoCreditosParcelados.jasper";
	
	public static final String RELATORIO_BOLETIM_MEDICAO_RECUPERACAO_CREDITOS = "/relatorioBoletimMedicaoRecuperacaoCreditos.jasper";
	
	public static final String RELATORIO_ACOMPANHAMENTO_CREDITOS_PAGOS_A_VISTA = "/relatorioAcompanhamentoCreditosPagosAVista.jasper";
	
	public static final String RELATORIO_ACOMPANHAMENTO_PARCELAMENTOS_RECUPERACAO_CREDITOS = "/relatorioAcompanhamentoParcelamentosRecuperacaoCreditos.jasper";
	
	public static final String RELATORIO_ACOMPANHAMENTO_PARCELAMENTOS_ATRASOS_RECUPERACAO_CREDITOS = "/relatorioAcompanhamentoParcelamentosEmAtrasoRecuperacaoCreditos.jasper";
	
	public static final String RELATORIO_PENALIDADES_INDICE_ATUACAO_SUCESSO = "/relatorioPenalidadesIndiceAtuacaoSucessoFinanceiro.jasper";

	public static final String RELATORIO_ACOMPANHAMENTO_COMANDOS_COBRANCA = "/relatorioAcompanhamentoComandosCobranca.jasper";

	public static final String RELATORIO_ACOMPANHAMENTO_BOLETIM_MEDICAO_CONTRATO = "/relatorioAcompanhamentoBoletimMedicaoContrato.jasper";

	public static final String RELATORIO_IMOVEIS_CLIENTES_CORPORATIVO = "/relatorioImoveisClientesCorporativos.jasper";
	
	public static final String RELATORIO_CONTAS_NAO_IMPRESSAS = "/relatorioContasNaoImpressas.jasper";
	
	public static final String RELATORIO_IMOVEIS_CONTAS_RETIRADOS_EMPRESAS_COBRANCA = "/relatorioImoveisContasRetiradosEmpresasCobranca.jasper";
	
	public static final String RELATORIO_COBRANCA_ATIVIDADE_MANTER = "/relatorioCobrancaAtividadeManter.jasper";
	
	public static final String RELATORIO_MOVIMENTO_PROGRAMA_ESPECIAL = "/relatorioMovimentoProgramaEspecial.jasper";

	public static final String RELATORIO_ORDEM_FISCALIZACAO_CONSUMO_SUPERIOR = "/relatorioOrdemFiscalizacaoConsumoSuperior.jasper";
	
	public static final String RELATORIO_ORDEM_FISCALIZACAO_CONSUMO_INFERIOR = "/relatorioOrdemFiscalizacaoConsumoInferior.jasper";
	
	public static final String RELATORIO_EMITIR_HISTOGRAMA_ESGOTO_ECONOMIA_SUBCATEGORIA = "/relatorioHistogramaEsgotoEconomiaSubcategoria.jasper";
	
	public static final String RELATORIO_HISTORICO_IMOVEIS_PROGRAMA_ESPECIAL = "/relatorioHistoricoImoveisProgramaEspecial.jasper";
	
	public static final String RELATORIO_PAGAMENTO_BAIXA_AUTOMATICA_ANALITICO = "/relatorioAnaliticoPagamentosBaixadosAutomaticamente.jasper";
	
	public static final String RELATORIO_PAGAMENTO_BAIXA_AUTOMATICA_SINTETICO = "/relatorioSinteticoPagamentoBaixadosAutomaticamente.jasper";
	
	public static final String RELATORIO_CLIENTE_CPF_CNPJ_VALIDADOS_MOBILE = "/relatorioClienteCpfCnpjValidadosMobile.jasper";
	
	public static final String RELATORIO_DIVIDA_ATIVA_AMORTIZADA = "relatorioDividaAtivaAmortizada.jasper";
	
	public static final String RELATORIO_DIVIDA_ATIVA_PARCELADA = "relatorioDividaAtivaParcelada.jasper";
	
	public static final String RELATORIO_DEMONSTRATIVO_DIVIDA_ATIVA = "relatorioDemonstrativoDividaAtiva.jasper";
	
	public static final String RELATORIO_NEGATIVADOR_MOVIMENTO_REG_ITEM = "/relatorioNegativadorMovimentoRegItem.jasper";
	
	public static final String RELATORIO_CARNE_PARCELAMENTO = "/relatorioCarnePagamento.jasper";
