...
import gcom.relatorio.atendimentopublico.RelatorioResumoSolicitacoesRAPorUnidade;
 ...
 * @date 20/06/2008
 */
public class GerarRelatorioResumoSolicitacoesRAPorUnidadeAction extends ExibidorProcessamentoTarefaRelatorio {
	...
	public ActionForward execute(
		...
		// ------------------------------
		RelatorioResumoSolicitacoesRAPorUnidade relatorio = new RelatorioResumoSolicitacoesRAPorUnidade(usuario);
