...
function validarForm(form, retificar){
	...
	if (validateRetificarContaActionForm(form)){
		...
		var ATIVO = document.getElementById("ATIVO").value;
 		...
 		var vencimento;
 		if(form.novoVencimentoConta.value == '')
 			vencimento = form.vencimentoConta.value;
 		else
 			vencimento = form.novoVencimentoConta.value;
  	    
 		
 	   if(INDICADOR_CALCULA_VENCIMENTO != 2){ 
 	     if(form.indicadorDataAlterada == "sim"){  	  
 	  	   if (comparaData(vencimento, ">", ULTIMA_DATA_MES )){					
 				if (confirm(msgDataVencimentoUltimoDiaMes)){ 
 				    vencimento = ULTIMA_DATA_MES;	 			   
					form.novoVencimentoConta.focus();	
				}else{	
					//*******************************************
					// CRC3390
					// Por: Ivan Sergio
		...
		if ((vencimento.substring(6, 10) * 1) < (ANO_LIMITE * 1)){
			...
			return false;
		}else if (comparaData(vencimento, "<", DATA_ATUAL )){
		...
		else if (comparaData(vencimento, ">", DATA_ATUAL_60 )){
...
function consumoAguaRequerido(form){
 ...
 function removerTodosDebitosCobrado(){
 	var form = document.forms[0];
 	form.action = "/gsan/removerSelecaoDebitoCobradoActionRetificarConta.do?removerTodos=ok&mapeamento=exibirRetificarConta";
...
function checkDataVencimento(){
	...
	if(form.novoVencimentoConta.value != '')
		...
		form.indicadorDataAlterada = "nao";
}
...
<div id="formDiv">
<html:form action="/exibirRetificarContaAction"
	method="post" >
				...
				<tr bgcolor="#cbe5fe">
					<td width="100%" align="center">
						...
						<tr> 
				      		...
				      		<tr> 
					          	<td height="10"><strong>Data de Vencimento:</strong></td>
				      		...
				      		<tr> 
					          	<td height="10"><strong>Nova Data de Vencimento:</strong></td>
					          	<html:hidden property="vencimentoContaNaBase" />
					          	<td>
                    				<html:text property="novoVencimentoConta" 
                    						   size="11" 
                    						   maxlength="10" 
                    						   tabindex="4" 
                    						   onkeyup="mascaraData(this, event);" 
									...
									<a href="javascript:abrirCalendario('RetificarContaActionForm', 'novoVencimentoConta');checkDataVencimento();">
				...
				<tr bgcolor="#cbe5fe">
					<td width="100%" align="center">
						...
						<tr> 
							...
							<td>
								<html:text property="consumoAgua" size="10" maxlength="6" tabindex="6" style="text-align: right;" onkeypress="javascript:return isCampoNumerico(event);" onblur="somente_numero_zero_a_nove(this);"/>
							</td>
						...
						<tr>
							...
							<html:text property="leituraAnteriorAgua" size="10" maxlength="6"
								tabindex="6" style="text-align: right;" 
								 onkeypress="javascript:return isCampoNumerico(event);" onblur="somente_numero_zero_a_nove(this);"/>
							</td>
						...
						<tr> 
							...
							<td>
								<html:text property="consumoFaturadoPoco" 
										   ...
										   onkeyup="javascript:habilitaConsumoPoco();" onblur="somente_numero_zero_a_nove(this);"/>
							</td>
						</tr>
											...
											<%}%>
													...
													<logic:notEqual name="habilitaListaCategoriasEQuantidadesEconomias" value="2">
														<div align="center"><INPUT TYPE="text"
															...
															size="6" id="categoria" maxlength="4"
															value="<%="" + categoria.getQuantidadeEconomiasCategoria()%>"
															style="text-align: right;" onkeypress="javascript:return isCampoNumerico(event);" onblur="javascript:somente_numero_zero_a_nove(this);"/> 
 															</div>
													</logic:notEqual>
								...
								<tr>
									<td colspan="4">
										<table width="100%" cellpadding="0" cellspacing="0">
											...
											<logic:notEmpty name="colecaoDebitoCobrado">
											<tr>
												<td>
													<div style="width: 100%; height: 100; overflow: auto;">
													<table width="100%" align="center" bgcolor="#99CCFF">
													...
													<br />
														<input name="Button" type="button" class="bottonRightCol" value="Remover Todos" align="left"
														onclick="javascript:removerTodosDebitosCobrado();" />		
												</td>
											</tr>
											</logic:notEmpty>
										</table>
