		...
		while (iter.hasNext()) {
			...
			if (parmsQualidadeAgua != null) {
				...
				if(parmsQualidadeAgua[21] != null){
					indiceDurezaTotal = parmsQualidadeAgua[21].toString();
				}
			...
			// Qualidade de Água Padrão
			FiltroQualidadeAguaPadrao filtroQualidadeAguaPadrao = new FiltroQualidadeAguaPadrao();
			Collection<QualidadeAguaPadrao> colecao = getControladorUtil().pesquisar(filtroQualidadeAguaPadrao, QualidadeAguaPadrao.class.getName());
			QualidadeAguaPadrao qualidadeAguaPadrao = new QualidadeAguaPadrao();
			String corPadrao = "AUSENTE";
			String turbidezPadrao = "AUSENTE";
			String phPadrao = "AUSENTE";
			String durezaPadrao = "AUSENTE";
			String cloroPadrao = "AUSENTE";
			String cloriformePadrao = "AUSENTE";
			if(!Util.isVazioOrNulo(colecao)){
				qualidadeAguaPadrao = (QualidadeAguaPadrao) Util.retonarObjetoDeColecao(colecao);
				
				corPadrao = qualidadeAguaPadrao.getDescricaoPadraoCor();
				turbidezPadrao = qualidadeAguaPadrao.getDescricaoPadraoTurbidez();
				phPadrao = qualidadeAguaPadrao.getDescricaoPadraoPh();
				durezaPadrao = qualidadeAguaPadrao.getDescricaoDurezaTotal();
				cloroPadrao = qualidadeAguaPadrao.getDescricaoPadraoCloro();
				cloriformePadrao = qualidadeAguaPadrao.getDescricaoPadraoColiformesTotais();
			}
			
			emitirContaHelper.setCorPadrao(corPadrao);
			emitirContaHelper.setTurbidezPadrao(turbidezPadrao);
			emitirContaHelper.setPhPadrao(phPadrao);
			emitirContaHelper.setDurezaPadrao(durezaPadrao);
			emitirContaHelper.setCloroPadrao(cloroPadrao);
			emitirContaHelper.setCloriformePadrao(cloriformePadrao);
