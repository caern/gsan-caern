	...
	function limparCliente(){
   	...
   	function SubmitForm(){
		var formulario = document.forms[0]; 
	  	...
	  	formulario.action =  'atualizarComandoNegativacaPorCriterioWizardAction.do?action=exibirAtualizarComandoNegativacaoDadosImovelAction';
	  	formulario.submit();     
   	}
  	...
  	function atualizaListSubcategoria() {
		var formulario = document.forms[0]; 
	  	formulario.action =  'atualizarComandoNegativacaPorCriterioWizardAction.do?destino=3&action=atualizarComandoNegativacaoDadosDebitoAction&atualizaListSubcategoria=s';
		formulario.submit();
	}
  ...
  <tr>
	...
	<td width="610" valign="top" class="centercoltext">
	  ...
	  <tr>
		...
		<html:text property="idCliente" size="8"
			...
			onkeypress="validaEnterComMensagem(event, 'atualizarComandoNegativacaPorCriterioWizardAction.do?action=exibirAtualizarComandoNegativacaoDadosImovelAction', 'idCliente','Cliente');return isCampoNumerico(event);" />
	...
	<tr> 
      ...
      <tr>
        ...
        <td>
        	<logic:present name="desabilitar">
			<html:radio property="imovSitCobranca" value="1" tabindex="1" disabled="true" /><strong>Sim
			<html:radio property="imovSitCobranca" value="2" tabindex="2" disabled="true" />Não</strong>
			</logic:present>
			 <logic:notPresent name="desabilitar">
	...
	<tr> 
      ...
      <tr>
        ...
        <td>
			<html:radio property="indicadorBaixaRenda" value="1" tabindex="1" disabled="true" /><strong>Sim
			<html:radio property="indicadorBaixaRenda" value="2" tabindex="2" disabled="true" />Não</strong>
		</td>
      </tr>  
	  <tr>
	   <tr>
...
<script>
document.getElementById('botaoConcluir').onclick = function() { botaoAvancarTelaEspera('/gsan//atualizarComandoNegativacaPorCriterioWizardAction.do?concluir=true&action=atualizarComandoNegativacaoDadosImovelAction'); }
</script>
