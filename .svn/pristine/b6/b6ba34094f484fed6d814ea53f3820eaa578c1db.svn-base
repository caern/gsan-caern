...
public class RelatorioResumoSolicitacoesRAPorUnidade extends TarefaRelatorio {
	...
	public Object executar() throws TarefaException {
		...
		if (idMunicipio != null) {
			...
			Collection<Municipio> pesquisa = fachada.pesquisar(filtroMunicipio, Municipio.class.getName());
			if (pesquisa == null || pesquisa.isEmpty()) {
		...
		if (codigoBairro != null) {
			...
			Collection<Bairro> pesquisa = fachada.pesquisar(filtroBairro, Bairro.class.getName());
			if (pesquisa == null || pesquisa.isEmpty()) {
