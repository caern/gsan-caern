...
var bCancel = false;
   ...
   function caracteresespeciais () { 
	...
	function desfazer(){
		...
		var form = document.forms[0];
		redirecionarSubmit('exibirEncerrarOrdemServicoAction.do?desfazer=OK');
...
function adicionarArquivo(){
	...
	var form = document.forms[0];
	form.target = "";
	form.action = "exibirEncerrarOrdemServicoAction.do?addFoto=OK";
...
function removerArquivo(identificacao){
	...
	var form = document.forms[0];
	form.target = "";
	form.action = "exibirEncerrarOrdemServicoAction.do?removerFoto=" + identificacao;
...
function visualizarArquivo(identificacao){
	...
	var form = document.forms[0];
	form.target = "_new";
	form.action = "exibirEncerrarOrdemServicoAction.do?visualizarFoto=" + identificacao;
										...
										<!-- 			<logic:notEmpty name="EncerrarOrdemServicoActionForm"
												...
												<tr>
													...
													<tr>
														...
														<td>
															<html:file property="arquivoFoto" size="42" />														
														</td>
													</tr>													
													<tr>
													...
													<tr>
														...
														<table width="100%" bgcolor="#99CCFF">														
															<tr bordercolor="#000000">							
																...
																<td style="width:80%" bgcolor="#90c7fc" rowspan="2">
															...
															<logic:notEmpty name="colecaoOrdemServicoFoto">						
																...
																<logic:iterate name="colecaoOrdemServicoFoto" id="foto" type="OrdemServicoFoto">
																	...
																	<%}%>
																			...
																			<td align="center" width="10%" valign="middle">
																					<a href="exibirEncerrarOrdemServicoAction.do?visualizarFoto=<%="" + GcomAction.obterTimestampIdObjeto(foto) %>" title="Visualizar Arquivo" target="_blank">
																					<IMG SRC="<bean:message key="caminho.imagens"/>JPG.gif" width="35" height="35" BORDER="0" ALT="${foto.descricaoFoto}" title="Visualizar Arquivo ${foto.descricaoFoto}"></a>	
																			</td>
																			<td width="80%">
																				<% if (cont % 2 == 0) {%>
