...
var form = document.forms[0];
  ...
  function validateInserirContratoNegativadorActionForm() {                                                                   
     ...
     this.aj = new Array("numeroEntidade", "Informe o Número da Entidade.", new Function ("varName", " return this[varName];"));
     this.af = new Array("numeroAssociado", "Informe o Número do Associado.", new Function ("varName", " return this[varName];"));
    } 
