...
public class Operacao extends TabelaAuxiliarAbreviada {
	...
	/** ROTA ATUALIZAR */
	public static final Integer OPERACAO_ROTA_ATUALIZAR = new Integer(809);
	...
	public static final int OPERACAO_EFETUAR_RELIGACAO_AGUA_COM_INSTALACAO_HIDROMETRO_INT = 1145;
...
//	public static final Integer ATUALIZAR_IMPORTANCIA_LOGRADOURO = 1816;
	...
	public static final Integer ATUALIZAR_IMPORTANCIA_LOGRADOURO_BAIRRO = new Integer (1816);
	
	public static final Integer ATUALIZAR_IMPORTANCIA_TIPO_SERVICO = 1819;

	public static final Integer OPERACAO_CONSULTAR_DADOS_DA_OS_DE_VISITA = new Integer(1863);
	
	public static final Integer OPERACAO_ALTERAR_INSCRICAO = new Integer(1882);
	
	public static final Integer OPERACAO_ASSOCIAR_TARIFA_CONSUMO_IMOVEIS = new Integer(716);
	
	public static final Integer OPERACAO_SUBSTITUIR_CONSUMOS_ANTERIORES = 355;
	
	public static final int OPERACAO_ATUALIZAR_INDICADOR_CPF_CNPJ_POPUP = 2107;
	
	public static final Integer OPERACAO_ASSOCIAR_CONTA_NOVO_CLIENTE_RESPONSAVEL = new Integer(2127);
	
	public static final int REATIVAR_IMOVEIS_EXCLUIDO = 2130;	
	
	public static final Integer OPERACAO_ATUALIZAR_IMOVEL_ATUALIZACAO_CADASTRAL_BATCH = new Integer(2125);
