...
public class LigacaoEsgotoPerfil extends ObjetoTransacao {
	...
	private BigDecimal percentualMaximoColeta;
	
	public final static Integer CONVENCIONAL = new Integer("1");
	public final static BigDecimal CEM_PORCENTO = new BigDecimal(100);
	...
	public BigDecimal getPercentualMaximoColeta() {
		return percentualMaximoColeta;
	}

	public void setPercentualMaximoColeta(BigDecimal percentualMaximoColeta) {
		this.percentualMaximoColeta = percentualMaximoColeta;
	}
}
