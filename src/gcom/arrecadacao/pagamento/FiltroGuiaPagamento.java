...
public class FiltroGuiaPagamento extends Filtro implements Serializable {
    ...
    public final static String GERENCIA_REGIONAL_ID = "localidade.gerenciaRegional.id";
    
    public final static String UNIDADE_NEGOCIO_ID = "localidade.unidadeNegocio.id";
