	...
	<body>
	            ...
	            <ul id="lista-informacoes">
	                <li>
	                	...
	                	<div class="info-serv" style="text-align:justify;">
	                        <p>Este acesso permite solicitar a segunda via da sua conta, que poderá ser paga nos agentes recebedores da CAEMA. Para acessar este serviço, clique no assunto &quot;2ª Via de conta&quot; e digite o número da sua matrícula, e aguarde o término da impressão  para pagamento, ou se preferir dirija-se a uma loja de atendimento, ou entre em contato com o call center pelo número 0800 701 0195 ou pelo link fale conosco.</p>
	                        <p>A CAEMA disponibiliza mais este serviço sem custo adicional.</p>
	                        <span id="bottom">&nbsp;</span>
	                ...
	                <li id="serv-2">
	                	...
	                	<div class="info-serv" style="text-align:justify;">
	                        <p>Conforme determina o artigo 3º da lei federal 12.007 de 2009 a CAEMA disponibiliza para você a declaração de quitação anual de débitos. 
	                ...
	                <li id="serv-3">
	                	...
	                	<div class="info-serv" style="text-align:justify;">
	                        <p>A CAEMA disponibiliza para você a facilidade de receber suas faturas em seu e-mail, para acessar este serviço, 
		...
		<logic:present name="imovelSemQuitacaoAnual" scope="request">
			<div id="imovelSemQuitacaoAnual" style="display:none;cursor:default;">
		        ...
		        <p>
		        	Em caso de dúvidas, procure uma loja de atendimento mais próxima, ou entre em contato com o call center pelo 0800 701 0195
		        </p>
		        <a href="javascript:void(0);" class="ui-corner-all button confirm">OK</a>
			</div>
		</logic:present>
