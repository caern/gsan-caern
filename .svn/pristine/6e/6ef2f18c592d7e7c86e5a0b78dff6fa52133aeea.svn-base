					...
					<tr>
						...
						<td width="432">
							...
							<a href="javascript:abrirPopup('exibirPesquisarArrecadadorAction.do');">
								<img width="23" height="21" border="0" src="<bean:message key="caminho.imagens"/>pesquisa.gif" title="Pesquisar Arrecadador" /></a> 
											...
											<tr>
												...
												<td>
													...
													<a href="javascript:abrirCalendario('FiltrarMovimentoArrecadadoresActionForm', 'dataGeracaoMovimentoInicio');">
														<img align="absmiddle" src="<bean:message key='caminho.imagens'/>calendario.gif" width="20" border="0" alt="Exibir Calendário" tabindex="7" /></a>
													<strong>a</strong> 
													...
													<a href="javascript:abrirCalendario('FiltrarMovimentoArrecadadoresActionForm', 'dataGeracaoMovimentoFim')" onkeypress="return isCampoNumerico(event);">
														<img align="absmiddle" src="<bean:message key='caminho.imagens'/>calendario.gif" width="20" border="0" alt="Exibir Calendário" tabindex="9" /></a>
													dd/mm/aaaa
												</td>
											</tr>
											...
											<tr>
												...
												<td>
													...
													<a href="javascript:abrirCalendario('FiltrarMovimentoArrecadadoresActionForm', 'dataProcessamentoMovimentoInicio');">
														<img align="absmiddle" src="<bean:message key='caminho.imagens'/>calendario.gif" width="20" border="0" alt="Exibir Calendário" tabindex="11" /></a>
													...
													<a href="javascript:abrirCalendario('FiltrarMovimentoArrecadadoresActionForm', 'dataProcessamentoMovimentoFim')">
														<img align="absmiddle" src="<bean:message key='caminho.imagens'/>calendario.gif" width="20" border="0" alt="Exibir Calendário" tabindex="13" /></a>
													dd/mm/aaaa
												</td>
											</tr>
										</table>
								...
								<tr>
									<td>
										<input name="Submit22" class="bottonRightCol" value="Limpar" type="button" 
												onclick="window.location.href='/gsan/exibirFiltrarMovimentoArrecadadoresAction.do?menu=sim';">
