...
function validaClienteRelacaoTipo() {
	...
	if(form.idCliente.value == '' ){
		...
		form.clienteRelacaoTipo[3].checked = true;
					...
					<td colspan="4">
						<table width="100%" border="0">
							...
							<tr>
								...
								<td>
									...
									<html:text property="idCliente" size="9" maxlength="9" 
										...
										onkeypress="document.forms[0].nomeCliente.value='';return isCampoNumerico(event);" />
							...
							<tr>
								...
								<td colspan="3">
									<strong><html:radio property="clienteRelacaoTipo" value="1" />Proprietário</strong> 
			    					<strong><html:radio property="clienteRelacaoTipo" value="3" />Responsável</strong>
			    					<strong><html:radio property="clienteRelacaoTipo" value="2" />Usuário</strong>
