...
function validarForm(form){
	...
	if (verificaIndicadorTarifaCategoria.value != null && verificaIndicadorTarifaCategoria.value == 1){
		...
		if(objFatorLimiteConsumo.value == "" && objConsumoLimite.value != ""){
		   	retorno = false;
		   	alert('Informe Fator de Multiplicação do Limite Consumo');
		   	objFatorLimiteConsumo.focus();
		}else if(objConsumoLimite.value == "" && objFatorLimiteConsumo.value != ""){
		   	retorno = false;
		   	alert('Informe o Consumo de Referência para Limite Consumo');
		   	objConsumoLimite.focus();
		}else if(numeroNegativo(objConsumoLimite.value,objConsumoLimite,'Consumo de Referência do Limite Consumo')){
			retorno = false;
		}else if(numeroNegativo(objFatorLimiteConsumo.value,objFatorLimiteConsumo,'Fator de Multiplicação do Limite Consumo ')){
			retorno = false;
		}
	}
