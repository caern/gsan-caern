...
public class ConsultarParametrosSistemaActionForm extends ActionForm {
	...
	private String imagemResolucaoLargura;
	
	private String imagemResolucaoAltura;
	...
	private String diferencaMaximoBaixado;
	...
	public String getDiferencaMaximoBaixado() {
		return diferencaMaximoBaixado;
	}

	public void setDiferencaMaximoBaixado(String diferencaMaximoBaixado) {
	...
	public void setDescricaoLeiIndividualizacao(
			String descricaoLeiIndividualizacao) {
	...
	public void setIndicadorTotalDebito (
			String indicadorTotalDebito) {
	...
	public void setNumeroConvenioFichaCompensacao(
			String numeroConvenioFichaCompensacao) {
	...
	public String getImagemResolucaoLargura() {
		return imagemResolucaoLargura;
	}

	public void setImagemResolucaoLargura(String imagemResolucaoLargura) {
		this.imagemResolucaoLargura = imagemResolucaoLargura;
	}

	public String getImagemResolucaoAltura() {
		return imagemResolucaoAltura;
	}

	public void setImagemResolucaoAltura(String imagemResolucaoAltura) {
	...
	public void setIndicadorAlterarNomeClienteCpfCnpjValidado(String indicadorAlterarNomeClienteCpfCnpjValidado) {
		IndicadorAlterarNomeClienteCpfCnpjValidado = indicadorAlterarNomeClienteCpfCnpjValidado;
	}
