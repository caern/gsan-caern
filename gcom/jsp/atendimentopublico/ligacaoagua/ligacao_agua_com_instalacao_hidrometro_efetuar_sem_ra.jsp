									...
									<table border="0" width="100%">
										<tr>
											...
											<img src="<bean:message key='caminho.imagens'/>pesquisa.gif"
												width="23" height="21" name="imagem" title="Pesquisar Imóvel"
												...
												border="0" src="imagens/limparcampo.gif" height="21" title="Apagar"
												width="23"> </a></td>
										</tr>
									...
									<table border="0" width="100%">
										<tr>
											...
											<a
												...
												src="/gsan/imagens/pesquisa.gif" title="Pesquisar Hidrômetro" border="0"
										...
										<tr>
											<td height="10"><strong>Data da Instalação:</strong></td>
