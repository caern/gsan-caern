...
//					+ " cep.codigo, " // 16
			...
			if (numeroImovelInicial != null && !numeroImovelInicial.trim().equals("")
					&& numeroImovelFinal != null && !numeroImovelFinal.trim().equals("")) {
				consulta += " and RTRIM(LTRIM(translate(imovel.imov_nnimovel, '" + ConstantesSistema.CARACTERES_ALFANUMERICOS + "-º.''', ''))) <> '' and ";
				
				consulta += " to_number(RTRIM(LTRIM(translate(imovel.imov_nnimovel, '" + ConstantesSistema.CARACTERES_ALFANUMERICOS + "-º.', ''))), 99999) between '" + numeroImovelInicial.trim() + "' and '" + numeroImovelFinal.trim() + "'";
			}
