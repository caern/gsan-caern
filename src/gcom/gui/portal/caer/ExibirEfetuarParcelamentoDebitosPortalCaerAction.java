...
public class ExibirEfetuarParcelamentoDebitosPortalCaerAction extends GcomAction {
...
//		            }
	...
	private void calcularDebitos(ObterDebitoImovelOuClienteHelper debitos, Imovel imovel, EfetuarParcelamentoDebitosPortalCaerActionForm form,
	...
	//Metodo auxiliar que vai retornar o perfil do parcelamento
	private ParcelamentoPerfil obterPerfilParcelamentoImovel(Imovel imovel, 
			EfetuarParcelamentoDebitosPortalCaerActionForm form){
		Fachada fachada =  Fachada.getInstancia();
	...
	private void obterOpcaoParcelamento(Collection<ContaValoresHelper> colecaoContaValores, Collection<GuiaPagamentoValoresHelper> colecaoGuiaPagamento,
			Imovel imovel, EfetuarParcelamentoDebitosPortalCaerActionForm form, HttpSession sessao, HttpServletRequest request){
...
//		Integer resolucaoDiretoria = 14;
	...
	private boolean validarPerfilParcelamento(EfetuarParcelamentoDebitosPortalCaerActionForm form,
