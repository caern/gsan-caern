 ...
 * @date 15/03/2012
 */
public class ValidarCertidaoNegativaDebitoPortalCaerAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		ValidarCertidaoNegativaDebitoPortalCaerActionForm form = 
				(ValidarCertidaoNegativaDebitoPortalCaerActionForm) actionForm;
		...
		if (form.getMatriculaImovel() == null 
			...
			if (Util.isVazioOrNulo(colecaoCertidaoNegativaDebito)) {
