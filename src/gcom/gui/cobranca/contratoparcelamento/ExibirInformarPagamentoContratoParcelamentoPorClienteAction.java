	...
	private void pesquisarCamposEnter(
		...
		if (idCliente != null && !idCliente.trim().equals("")) {
			...
			if (colecaoCliente != null && !colecaoCliente.isEmpty()) {
				...
				Collection<InformarPagamentoContratoParcelamentoPorClienteHelper> colecaoHelper = new ArrayList<InformarPagamentoContratoParcelamentoPorClienteHelper>();
				
				Iterator<Object[]> iterator = colecaoDadosContrato.iterator();
		...
		if (idArrecadador != null
			...
			Collection<Arrecadador> colecaoArrecadador = this.getFachada().pesquisar(
