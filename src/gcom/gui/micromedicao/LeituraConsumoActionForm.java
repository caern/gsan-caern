...
public class LeituraConsumoActionForm extends ValidatorForm {
	...
	private String idGerenciaFiltro;
	
	private String idUnidadeFiltro;
	...
	private String indicadorOSFiscalizacaoAnalise;
	
	private String idRegistroAtendimento;
	
	private String idOrdemServico;
	
	private String observacaoHidden;
	...
	public String getIdGerenciaFiltro() {
		return idGerenciaFiltro;
	}

	public void setIdGerenciaFiltro(String idGerenciaFiltro) {
		this.idGerenciaFiltro = idGerenciaFiltro;
	}

	public String getIdUnidadeFiltro() {
		return idUnidadeFiltro;
	}

	public void setIdUnidadeFiltro(String idUnidadeFiltro) {
		this.idUnidadeFiltro = idUnidadeFiltro;
	}
	...
	/**
	 * @return the indicadorOSFiscalizacaoAnalise
	 */
	public String getIndicadorOSFiscalizacaoAnalise() {
		return indicadorOSFiscalizacaoAnalise;
	}

	/**
	 * @param indicadorOSFiscalizacaoAnalise the indicadorOSFiscalizacaoAnalise to set
	 */
	public void setIndicadorOSFiscalizacaoAnalise(String indicadorOSFiscalizacaoAnalise) {
		this.indicadorOSFiscalizacaoAnalise = indicadorOSFiscalizacaoAnalise;
	}

	/**
	 * @return the idRegistroAtendimento
	 */
	...
	/**
	 * @param idRegistroAtendimento the idRegistroAtendimento to set
	 */
	...
	/**
	 * @return the observacaoHidden
	 */
	public String getObservacaoHidden() {
		return observacaoHidden;
	}

	/**
	 * @param observacaoHidden the observacaoHidden to set
	 */
	public void setObservacaoHidden(String observacaoHidden) {
		this.observacaoHidden = observacaoHidden;
	}
