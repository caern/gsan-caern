...
public class ControladorGerencialFaturamentoSEJB implements SessionBean {
	...
	public Collection<ResumoFaturamentoSituacaoEspecialConsultaGerenciaRegHelper> recuperaResumoSituacaoEspecialFaturamento(
		...
		try {
			...
			for (ResumoFaturamentoSituacaoEspecialConsultaGerenciaRegHelper helperGerencia : resumoFaturamentoSituacaoEspecialConsultaGerenciaRegHelper) {
				...
				helperClone.setTipoRelatorio(helper.getTipoRelatorio());
	...
	private Collection<ResumoFaturamentoSituacaoEspecialConsultaMotivoHelper> pesquisarResumoFaturamentoSituacaoEspecialConsultaMotivoHelper(ConsultarResumoSituacaoEspecialHelper helper) {
		List<ResumoFaturamentoSituacaoEspecialConsultaMotivoHelper> retorno = new ArrayList<ResumoFaturamentoSituacaoEspecialConsultaMotivoHelper>();
		...
		try {
			...
			for (Object[] dados : colecaoDados) {
				...
				//Tratamento do relatorio analitico
				if(helper.getTipoRelatorio().equals(ConstantesSistema.ANALITICO)){
					
					String endereco = "";
					
					boolean imovelNulo = true;
					
					if((Integer) dados[5]!=null){
						imovelNulo = false;
					}
					
					try {
						if(!imovelNulo){
							endereco = getControladorEndereco().pesquisarEnderecoFormatado((Integer) dados[5]);
						}
					...
					if (retorno.contains(helperMotivo)) {
						
						int posicao = retorno.indexOf(helperMotivo);
						
						ResumoFaturamentoSituacaoEspecialConsultaMotivoHelper jaCadastrado 
							= (ResumoFaturamentoSituacaoEspecialConsultaMotivoHelper) retorno.get(posicao);
						
						Collection<ResumoFaturamentoSituacaoEspecialConsultaMotivoAnaliticoHelper> dadosAnalitico = 
								(Collection<ResumoFaturamentoSituacaoEspecialConsultaMotivoAnaliticoHelper>) 
								jaCadastrado.getResumoFaturamentoSituacaoEspecialConsultaMotivoAnaliticoHelper();
						
						if(!imovelNulo){
							
							ResumoFaturamentoSituacaoEspecialConsultaMotivoAnaliticoHelper rfsecmah 
								= new ResumoFaturamentoSituacaoEspecialConsultaMotivoAnaliticoHelper((Integer) dados[5], endereco);
						
							dadosAnalitico.add(rfsecmah);
							
							jaCadastrado.setResumoFaturamentoSituacaoEspecialConsultaMotivoAnaliticoHelper(dadosAnalitico);
						}
						
						
						dadosAnalitico = null;
						
						jaCadastrado.setQtParalisada(jaCadastrado
								.getQtParalisada() + 1);
						
						if (dados[2] != null) {
							if((Integer) dados[2] < jaCadastrado.getAnoMesInicio()){
								jaCadastrado.setAnoMesInicio((Integer) dados[2]);
							}
						}
						
						if (dados[3] != null) {
							if((Integer) dados[3] > jaCadastrado.getAnoMesFim()){
								jaCadastrado.setAnoMesFim((Integer) dados[3]);
							}
						}
	
					} else {
						
						Collection<ResumoFaturamentoSituacaoEspecialConsultaMotivoAnaliticoHelper> dadosAnaliticos 
							= new ArrayList<ResumoFaturamentoSituacaoEspecialConsultaMotivoAnaliticoHelper>();
						
						if(!imovelNulo){
							ResumoFaturamentoSituacaoEspecialConsultaMotivoAnaliticoHelper rfsecmah 
								= new ResumoFaturamentoSituacaoEspecialConsultaMotivoAnaliticoHelper((Integer) dados[5], endereco);
						
							dadosAnaliticos.add(rfsecmah);
							helperMotivo.setResumoFaturamentoSituacaoEspecialConsultaMotivoAnaliticoHelper(dadosAnaliticos);
						}
	...
	public void gerarResumoSituacaoEspecialFaturamento(int idLocalidade,
		...
		try {
			...
			this.repositorioGerencial
					.excluirTodosResumoFaturamentoSituacaoEspecialDetalhe(idLocalidade);
			...
			for (int i = 0; i < imoveisResumoLigacaoEconomias.size(); i++) {
				...
				if (obj instanceof Object[]) {
					...
					if (listaSimplificada.contains(helper)) {
						...
						ArrayList<Integer> idsImoveis = 
								(ArrayList<Integer>) jaCadastrado.getIdsImoveis();
						
						idsImoveis.add(idImovel);
						jaCadastrado.setIdsImoveis(idsImoveis);
						idsImoveis = null;
						...
						ArrayList<Integer> idsImoveis = new ArrayList<Integer>() ;
						idsImoveis.add(idImovel);
						helper.setIdsImoveis(idsImoveis);
			...
			for (int i = 0; i < listaSimplificada.size(); i++) {
				...
				ArrayList<Integer> idsImoveis = null;
				if (helper.getIdsImoveis() != null) {
					idsImoveis = helper.getIdsImoveis();
				}
				...
				ResumoFaturamentoSituacaoEspecial resumo = new ResumoFaturamentoSituacaoEspecial(
						...
						faturamentoSituacaoMotivo, idsImoveis);
...
//				 sessionContext.setRollbackOnly();
    ...
    * @throws ErroRepositorioException
    */
   public void gerarResumoReFaturamentoGuiaPagamentoNovo(int idSetor, int anoMes) throws ControladorException {
      
       try {

           System.out.println("Processando resumo refaturamento Guias de Pagamento para o setor:" + idSetor);   
  
           List<ResumoFaturamentoGuiaPagamentoNovoHelper> listaSimplificadaReFaturamentoGuiaPagamento = new ArrayList();
          
           List resumoGuiaPagamento = this.repositorioGerencialFaturamento.getPesquisaGuiaPagamentoRefaturamentoNovo(idSetor, anoMes);
           ...
           for (int y = 0; y < resumoGuiaPagamento.size(); y++) {
               ...
               if (objGuiaPagamento instanceof Object[]) {
                   ...
                   Integer idClienteGuiaPagamento = (Integer) retorno[19];
                  
                   if (idImovelGuiaPagamento != null){
                       ...
                       System.out.println("processando: " + reg + " de: " + total + " " +
                       "Guias de Pagamento do setor = " + idSetor + "  do  Cliente = " + idClienteGuiaPagamento);
                   }
                   ...
                   if (idImovelGuiaPagamento != null){
                       ...
                       //Verificar existência de cliente responsável
                       ...
                       if (categoriaGuiaPagamento != null) {
                           ...
                           //SUBCATEGORIA
                           ImovelSubcategoria subCategoriaGuiaPagamento = this.getControladorImovel()
                           .obterPrincipalSubcategoria(categoriaGuiaPagamento.getId(), idImovelGuiaPagamento);
                          
                           if (subCategoriaGuiaPagamento != null) {
                              
                               helperGuiaPagamento.setIdSubCategoria(subCategoriaGuiaPagamento
                               .getComp_id().getSubcategoria().getId());
                           }
                       }
                      
                       //INDICADOR EXISTÊNCIA DE HIDRÔMETRO
                       String indicadorHidrometroString = new Integer(getControladorImovel()
                       .obterIndicadorExistenciaHidrometroImovel(idImovelGuiaPagamento)).toString();
                       ...
                       // hidrômetro
                       if (indicadorHidrometro == null) {
                           indicadorHidrometro = ConstantesSistema.NAO;
                       }
                       ...
                       //ESFERA DE PODER
                       helperGuiaPagamento.setIdEsfera((Integer) retorno[21]);
                      
                       //TIPO DO CLIENTE
                       helperGuiaPagamento.setIdTipoClienteResponsavel((Integer) retorno[20]);
                      
                       //CATEGORIA
                       helperGuiaPagamento.setIdCategoria(Categoria.RESIDENCIAL);
                      
                       //SUBCATEGORIA
                       helperGuiaPagamento.setIdSubCategoria(Subcategoria.RESIDENCIAL);
                      
                       //INDICADOR EXISTÊNCIA DE HIDRÔMETRO
                       helperGuiaPagamento.setIndicadorHidrometro(ConstantesSistema.NAO);
                       
                       //Como a guia nao possue imovel atribuimos o primeiro setor comercial da localidade da guia
                       FiltroSetorComercial filtroSetorComercial = new FiltroSetorComercial();
                       filtroSetorComercial.adicionarParametro( new ParametroSimples( FiltroSetorComercial.ID_LOCALIDADE, (Integer) helperGuiaPagamento.getIdLocalidade() ) );
                       filtroSetorComercial.adicionarParametro( new ParametroSimples( FiltroSetorComercial.INDICADORUSO, ConstantesSistema.INDICADOR_USO_ATIVO ) );
                       filtroSetorComercial.setCampoOrderBy( FiltroSetorComercial.CODIGO_SETOR_COMERCIAL );
                       SetorComercial setorComercial =
                       (SetorComercial) Fachada.getInstancia().pesquisar( filtroSetorComercial, SetorComercial.class.getName() ).iterator().next();
                       ...
                       // Setamos o setor comercial no helper
                       helperGuiaPagamento.setIdSetorComercial( setorComercial.getId() );
                       helperGuiaPagamento.setCodigoSetorComercial( setorComercial.getCodigo() );
                   ...
                   if (listaSimplificadaReFaturamentoGuiaPagamento.contains(helperGuiaPagamento)) {
                       ...
                       ResumoFaturamentoGuiaPagamentoNovoHelper jaCadastradoGuiaPagamento =
                           (ResumoFaturamentoGuiaPagamentoNovoHelper) listaSimplificadaReFaturamentoGuiaPagamento.get(posicaoGuiaPagamento);
                       ...
                       helperGuiaPagamento.setVlGuiasCanceladas(vlGuiasCanceladas);

                       // Quantidade Guias Canceladas
                       helperGuiaPagamento.setQtdGuiasCanceladas(1);

                       listaSimplificadaReFaturamentoGuiaPagamento.add(helperGuiaPagamento);
                   }
               }// if instance of de debito a cobrar
           }// for de debito a cobrar
...
//            sessionContext.setRollbackOnly();
	 ...
	 * 
	 */
	public List consultarResumoAnaliseFaturamentoRelatorioPeriodo(InformarDadosGeracaoRelatorioConsultaPeriodoHelper 
			informarDadosGeracaoRelatorioConsultaPeriodoHelper) throws ControladorException{
		
		List retorno = null;
		
		try {
			retorno = repositorioGerencialFaturamento
				.consultarResumoAnaliseFaturamentoRelatorioPeriodo(informarDadosGeracaoRelatorioConsultaPeriodoHelper);
				...
				while(!flagTerminou) {
					...
					for (int i = 0; i < resumoReFaturamentoContas .size(); i++) {
						...
						if (obj instanceof Object[]) {
							...
							Integer contaCategoriaIdAnterior = 99999;
								...
								if (listaSimplificadaReFaturamento.contains(helper)) {
									...
									if (tipoConta == 1 || tipoContaAnt == 1) {
										...
										Object[] valoresContaRetificada = repositorioGerencialFaturamento.getValorAguaEsgotoIncluidoCanceladoCategoria(
												...
												if (contaCategoriaIdAnterior != contaCategoria.getComp_id().getCategoria().getId()){
		
													contaCategoriaIdAnterior = contaCategoria.getComp_id().getCategoria().getId();
										...
										Object[] valoresContaRetificada = repositorioGerencialFaturamento.getValorAguaEsgotoIncluidoCanceladoCategoria(
											...
											contaCategoria.getComp_id().getSubcategoria().getId().intValue());
													...
													if (contaCategoriaIdAnterior != contaCategoria.getComp_id().getCategoria().getId()){
														...
														jaCadastrado.setVlCanceladoOutro(jaCadastrado.getVlCanceladoOutro().add(valorDebitoCancelado));
														valorCanceladoServico2ou3.add(valorDebitoCancelado);
														jaCadastrado.setVlCanceladoCreditos(jaCadastrado.getVlCanceladoCreditos().add(valorCreditoCancelado));
													}
...
//										AnoMesReferencia
	...
	public List consultarResumoAnaliseFaturamentoPeriodo(
		...
		try {
			...
			// [FS0001] Verificar existência de dados para o periodo de
			// referência retornado
			String resumo = ResumoFaturamentoSimulacao.class.getName();
			Integer countResumoAnalise = repositorioGerencialCobranca.verificarExistenciaAnoMesReferenciaResumoPeriodo(
				informarDadosGeracaoRelatorioConsultaPeriodoHelper.getAnoMesInicialReferencia(), informarDadosGeracaoRelatorioConsultaPeriodoHelper.getAnoMesFinalReferencia(), resumo);
			if (countResumoAnalise == null || countResumoAnalise == 0) {
				throw new ControladorException("atencao.nao.existem.acoes.cobranca.resumo.periodo",null,
                	Util.formatarAnoMesParaMesAno(informarDadosGeracaoRelatorioConsultaPeriodoHelper.getAnoMesInicialReferencia()),
                	Util.formatarAnoMesParaMesAno(informarDadosGeracaoRelatorioConsultaPeriodoHelper.getAnoMesFinalReferencia()));
			}

			List retorno = repositorioGerencialFaturamento
					.consultarResumoAnaliseFaturamentoPeriodo(informarDadosGeracaoRelatorioConsultaPeriodoHelper);
	...
	public Collection consultarResumoAnaliseFaturamentoPeriodoDetalhe(
			InformarDadosGeracaoRelatorioConsultaPeriodoHelper consultarResumoAnaliseFaturamentoPeriodoDetalhe) 
            throws ControladorException{
		Collection retorno = null;
    	try {
			retorno = this.repositorioGerencialFaturamento.consultarResumoAnaliseFaturamentoPeriodoDetalhe(consultarResumoAnaliseFaturamentoPeriodoDetalhe);
		} catch (ErroRepositorioException e) {
			throw new ControladorException( e.getMessage(), e );
		}
    	return retorno;
	...
	public void gerarFaturamentoBrutoLiquido(int anoMesFaturamento, int idFuncionalidadeIniciada)	throws ControladorException {
		...
		*/
		...
		try {
			...
			System.out.println("Iniciou Gerar Faturamento Bruto Liquido");
			repositorioGerencialFaturamento.gerarFaturamentoBrutoLiquido();
			System.out.println("Finalizou Gerar Faturamento Bruto Liquido");
	 ...
	 * @throws ErroRepositorioException
	 */
	public void executarCargaRegistroAtendimentoPorAno(
			int idFuncionalidadeIniciada)	throws ControladorException {
		...
		*/		
		...
		try {
			...
			System.out.println("Iniciou Carga Registro Atendimento Por Ano");
			repositorioGerencialFaturamento.executarCargaRegistroAtendimentoPorAno();
			System.out.println("Finalizou Carga Registro Atendimento Por Ano");
	 ...
	 * @throws ErroRepositorioException
	 */
	public void executarCargaResumoFaturamentoPorAno(
			int idFuncionalidadeIniciada)	throws ControladorException {
		...
		*/		
		...
		try {
			...
			System.out.println("Iniciou Carga Resumo Faturamento Por Ano");
			repositorioGerencialFaturamento.executarCargaResumoFaturamentoPorAno();
			System.out.println("Finalizou Carga Resumo Faturamento Por Ano");
	 ...
	 * @throws ErroRepositorioException
	 */
	public void executarCargaIndicadoresDesempenhoFaturamentoPorAno(
			int idFuncionalidadeIniciada)	throws ControladorException {
		...
		*/		
		...
		try {
			...
			System.out.println("Iniciou Carga Indicadores Desempenho Faturamento Por Ano");
			repositorioGerencialFaturamento.executarCargaIndicadoresDesempenhoFaturamentoPorAno();
			System.out.println("Finalizou Carga Indicadores Desempenho Faturamento Por Ano");
	 ...
	 * @throws ErroRepositorioException
	 */
	public void executarCargaIndicadoresDesempenhoFaturamentoVariosAnos(
			int idFuncionalidadeIniciada)	throws ControladorException {
		...
		*/		
		...
		try {
			...
			System.out.println("Iniciou Carga Indicadores Desempenho Faturamento Varios Anos");
			repositorioGerencialFaturamento.executarCargaIndicadoresDesempenhoFaturamentoVariosAnos();
			System.out.println("Finalizou Carga Indicadores Desempenho Faturamento Varios Anos");
	 ...
	 * @throws ErroRepositorioException
	 */
	public void executarCargaColetaEsgotoPorAno(
			int idFuncionalidadeIniciada)	throws ControladorException {
		...
		*/		
		...
		try {
			...
			System.out.println("Iniciou Carga Coleta Esgoto Por Ano");
			repositorioGerencialFaturamento.executarCargaColetaEsgotoPorAno();
			System.out.println("Finalizou Carga Coleta Esgoto Por Ano");
	 ...
	 * @throws ErroRepositorioException
	 */
	public void executarCargaConsumoAguaPorAno(
			int idFuncionalidadeIniciada)	throws ControladorException {
		...
		*/		
		...
		try {
			...
			System.out.println("Iniciou Carga Consumo Agua Por Ano");
			repositorioGerencialFaturamento.executarCargaConsumoAguaPorAno();
			System.out.println("Finalizou Carga Consumo Agua Por Ano");
	 ...
	 * @throws ErroRepositorioException
	 */
	public void executarCargaLeituraAnormalidadePorAno(
			int idFuncionalidadeIniciada)	throws ControladorException {
		...
		*/		
		...
		try {
			...
			System.out.println("Iniciou Carga Leitura Anormalidade Por Ano");
			repositorioGerencialFaturamento.executarCargaLeituraAnormalidadePorAno();
			System.out.println("Finalizou Carga Leitura Anormalidade Por Ano");
	 ...
	 * @throws ErroRepositorioException
	 */
	public void executarCargaIndicadoresDesempenhoMicromedicaoVariosAnos(
			int idFuncionalidadeIniciada)	throws ControladorException {
		...
		*/		
		...
		try {
			...
			System.out.println("Iniciou Carga Indicadores Desempenho Micromedicao Varios Anos");
			repositorioGerencialFaturamento.executarCargaIndicadoresDesempenhoMicromedicaoVariosAnos();
			System.out.println("Finalizou Carga Indicadores Desempenho Micromedicao Varios Anos");
	 ...
	 * @throws ErroRepositorioException
	 */
	public void executarCargaIndicadoresDesempenhoMicromedicaoPorAno(
			int idFuncionalidadeIniciada)	throws ControladorException {
		...
		*/		
		...
		try {
			...
			System.out.println("Iniciou Carga Indicadores Desempenho Micromedicao Por Ano");
			repositorioGerencialFaturamento.executarCargaIndicadoresDesempenhoMicromedicaoPorAno();
			System.out.println("Finalizou Carga Indicadores Desempenho Micromedicao Por Ano");
