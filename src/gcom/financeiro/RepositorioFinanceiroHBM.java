	...
	public Collection pesquisarPagamentoGuiaResumoPagamentoConta(Date dataInicial, Date dataFinal)
		...
		try{
			consulta = "select "
					  ...
					  + " agencia.bnco_id as banco,"
					  + " aviso.arrc_id as arrecadadorId,"
					  + " CASE WHEN ( (clie.cltp_id is not null or clieGuia.cltp_id is not null) and (clie.cltp_id = " + ClienteTipo.RECEITA_INTRA + " or clieGuia.cltp_id = " + ClienteTipo.RECEITA_INTRA + ") ) THEN debitoTipo.cnct_idintra ELSE debitoTipo.cnct_id END as contaContabil "
