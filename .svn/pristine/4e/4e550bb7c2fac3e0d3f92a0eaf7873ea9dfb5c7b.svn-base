...
//			emitirContaHelper.setEnderecoClienteResponsavel(enderecoClienteResponsavel);
			...
			if(qualidadeAgua != null && qualidadeAgua.getQuantidadeCloroExigidas() != null){
				emitirContaHelper.setQuantidadeCloroExigidas(qualidadeAgua.getQuantidadeCloroExigidas().toString());
			}else{
				emitirContaHelper.setQuantidadeCloroExigidas("");
			}
			
			//Quantidade Cloro Analisadas
			if(qualidadeAgua != null && qualidadeAgua.getQuantidadeCloroAnalisadas() != null){
				emitirContaHelper.setQuantidadeCloroAnalisadas(qualidadeAgua.getQuantidadeCloroAnalisadas().toString());
			}else{
				emitirContaHelper.setQuantidadeCloroAnalisadas("");
			}
			
			//Quantidade Cloro Conforme
			if(qualidadeAgua != null && qualidadeAgua.getQuantidadeCloroConforme() != null){
				emitirContaHelper.setQuantidadeCloroConforme(qualidadeAgua.getQuantidadeCloroConforme().toString());
			}else{
				emitirContaHelper.setQuantidadeCloroConforme("");
			}
			
			//Quantidade Turbidez Exigidas
			if(qualidadeAgua != null && qualidadeAgua.getQuantidadeTurbidezExigidas() != null){
				emitirContaHelper.setQuantidadeTurbidezExigidas(qualidadeAgua.getQuantidadeTurbidezExigidas().toString());
			}else{
				emitirContaHelper.setQuantidadeTurbidezExigidas("");
			}
			
			//Quantidade Turbidez Analisadas
			if(qualidadeAgua != null && qualidadeAgua.getQuantidadeTurbidezAnalisadas() != null){
				emitirContaHelper.setQuantidadeTurbidezAnalisadas(qualidadeAgua.getQuantidadeTurbidezAnalisadas().toString());
			}else{
				emitirContaHelper.setQuantidadeTurbidezAnalisadas("");
			}
			
			//Quantidade Turbidez Conforme
			if(qualidadeAgua != null && qualidadeAgua.getQuantidadeTurbidezConforme() != null){
				emitirContaHelper.setQuantidadeTurbidezConforme(qualidadeAgua.getQuantidadeTurbidezConforme().toString());
			}else{
				emitirContaHelper.setQuantidadeTurbidezConforme("");
			}
			
			//Quantidade Cor Exigidas
			if(qualidadeAgua != null && qualidadeAgua.getQuantidadeCorExigidas() != null){
				emitirContaHelper.setQuantidadeCorExigidas(qualidadeAgua.getQuantidadeCorExigidas().toString());
			}else{
				emitirContaHelper.setQuantidadeCorExigidas("");
			}
			
			//Quantidade Cor Analisadas
			if(qualidadeAgua != null && qualidadeAgua.getQuantidadeCorAnalisadas() != null){
				emitirContaHelper.setQuantidadeCorAnalisadas(qualidadeAgua.getQuantidadeCorAnalisadas().toString());
			}else{
				emitirContaHelper.setQuantidadeCorAnalisadas("");
			}
			
			//Quantidade Cor Conforme
			if(qualidadeAgua != null && qualidadeAgua.getQuantidadeCorConforme() != null){
				emitirContaHelper.setQuantidadeCorConforme(qualidadeAgua.getQuantidadeCorConforme().toString());
			}else{
				emitirContaHelper.setQuantidadeCorConforme("");
			}
			
			//Quantidade Coliformes Totais Exigidas
			if(qualidadeAgua != null && qualidadeAgua.getQuantidadeColiformesTotaisExigidas() != null){
				emitirContaHelper.setQuantidadeColiformesTotaisExigidas(qualidadeAgua.getQuantidadeColiformesTotaisExigidas().toString());
			}else{
				emitirContaHelper.setQuantidadeColiformesTotaisExigidas("");
			}
			
			//Quantidade Coliformes Totais Analisadas
			if(qualidadeAgua != null && qualidadeAgua.getQuantidadeColiformesTotaisAnalisadas() != null){
				emitirContaHelper.setQuantidadeColiformesTotaisAnalisadas(qualidadeAgua.getQuantidadeColiformesTotaisAnalisadas().toString());
			}else{
				emitirContaHelper.setQuantidadeColiformesTotaisAnalisadas("");
			}
			
			//Quantidade Coliformes Totais Conforme
			if(qualidadeAgua != null && qualidadeAgua.getQuantidadeColiformesTotaisConforme() != null){
				emitirContaHelper.setQuantidadeColiformesTotaisConforme(qualidadeAgua.getQuantidadeColiformesTotaisConforme().toString());
			}else{
				emitirContaHelper.setQuantidadeColiformesTotaisConforme("");
			}
			
			//Quantidade Coliformes Termotolerantes Exigidas
			if(qualidadeAgua != null && qualidadeAgua.getQuantidadeColiformesTermotolerantesExigidas() != null){
				emitirContaHelper.setQuantidadeColiformesTermotolerantesExigidas(qualidadeAgua.getQuantidadeColiformesTermotolerantesExigidas().toString());
			}else{
				emitirContaHelper.setQuantidadeColiformesTermotolerantesExigidas("");
			}
			
			//Quantidade Coliformes Termotolerantes Analisadas
			if(qualidadeAgua != null && qualidadeAgua.getQuantidadeColiformesTermotolerantesAnalisadas() != null){
				emitirContaHelper.setQuantidadeColiformesTermotolerantesAnalisadas(qualidadeAgua.getQuantidadeColiformesTermotolerantesAnalisadas().toString());
			}else{
				emitirContaHelper.setQuantidadeColiformesTermotolerantesAnalisadas("");
			}
			
			//Quantidade Coliformes Termotolerantes Conforme
			if(qualidadeAgua != null && qualidadeAgua.getQuantidadeColiformesTermotolerantesConforme() != null){
				emitirContaHelper.setQuantidadeColiformesTermotolerantesConforme(qualidadeAgua.getQuantidadeColiformesTermotolerantesConforme().toString());
			}else{
				emitirContaHelper.setQuantidadeColiformesTermotolerantesConforme("");
			}
									...
									while (iteratorConta.hasNext()) {
										...
										while (situacao < 2) {
											...
											if (emitirContaHelper != null) {
												...
												//RM8679 - Vivianne Sousa - 08/01/2013 -------------------------------
												Object[] parmsQualidadeAgua = null;
												parmsQualidadeAgua = pesquisarParmsQualidadeAgua(emitirContaHelper);

												//92 - Nº de amostras exigidas de Cloro
												String numeroExigidasCloro = "";
												//93 - Nº de amostras realizadas de Cloro
												String numeroRealizadasCloro = "";
												//94 - Nº de amostras em conformidade de Cloro
												String numeroConformidadeCloro = "";
												//95 - Nº de amostras exigidas de Turbidez
												String numeroExigidasTurbidez = "";
												//96 - Nº de amostras realizadas de Turbidez
												String numeroRealizadasTurbidez = "";
												//97 - Nº de amostras em conformidade de Turbidez
												String numeroConformidadeTurbidez = "";
												//98 - Nº de amostras exigidas de Cor
												String numeroExigidasCor = "";
												//99 - Nº de amostras realizadas de Cor
												String numeroRealizadasCor = "";
												//100 - Nº de amostras em conformidade de Cor
												String numeroConformidadeCor = "";
												//101 - Nº de amostras exigidas de Coliformes Totais
												String numeroExigidasColiformes = "";
												//102 - Nº de amostras realizadas de Coliformes Totais
												String numeroRealizadasColiformes = "";
												//103 - Nº de amostras em conformidade de Coliformes Totais
												String numeroConformidadeColiformes = "";
												//104 - Nº de amostras exigidas de Escherichia Coli
												String numeroExigidasEscherichia = "";
												//105 - Nº de amostras realizadas de Escherichia Coli
												String numeroRealizadasEscherichia = "";
												//106 - Nº de amostras em conformidade de Escherichia Coli
												String numeroConformidadeEscherichia = "";
												
												if (parmsQualidadeAgua != null) {
	
													if (parmsQualidadeAgua[5] != null) {
														numeroExigidasCloro = ((Integer) parmsQualidadeAgua[5]).toString();
													}
													if (parmsQualidadeAgua[6] != null) {
														numeroRealizadasCloro = ((Integer)  parmsQualidadeAgua[6]).toString();
													}
													if (parmsQualidadeAgua[7] != null) {
														numeroConformidadeCloro = ((Integer)  parmsQualidadeAgua[7]).toString();
													}
													if (parmsQualidadeAgua[8] != null) {
														numeroExigidasTurbidez = ((Integer)  parmsQualidadeAgua[8]).toString();
													}
													if (parmsQualidadeAgua[9] != null) {
														numeroRealizadasTurbidez = ((Integer)  parmsQualidadeAgua[9]).toString();
													}
													if (parmsQualidadeAgua[10] != null) {
														numeroConformidadeTurbidez = ((Integer)  parmsQualidadeAgua[10]).toString();
													}
													if (parmsQualidadeAgua[11] != null) {
														numeroExigidasCor = ((Integer) parmsQualidadeAgua[11]).toString();
													}
													if (parmsQualidadeAgua[12] != null) {
														numeroRealizadasCor = ((Integer) parmsQualidadeAgua[12]).toString();
													}
													if (parmsQualidadeAgua[13] != null) {
														numeroConformidadeCor = ((Integer) parmsQualidadeAgua[13]).toString();
													}
													if (parmsQualidadeAgua[14] != null) {
														numeroExigidasColiformes = ((Integer) parmsQualidadeAgua[14]).toString();
													}
													if (parmsQualidadeAgua[15] != null) {
														numeroRealizadasColiformes = ((Integer) parmsQualidadeAgua[15]).toString();
													}
													if (parmsQualidadeAgua[16] != null) {
														numeroConformidadeColiformes = ((Integer) parmsQualidadeAgua[16]).toString();
													}
													if (parmsQualidadeAgua[17] != null) {
														numeroExigidasEscherichia = ((Integer) parmsQualidadeAgua[17]).toString();
													}
													if (parmsQualidadeAgua[18] != null) {
														numeroRealizadasEscherichia = ((Integer) parmsQualidadeAgua[18]).toString();
													}
													if (parmsQualidadeAgua[19] != null) {
														numeroConformidadeEscherichia = ((Integer) parmsQualidadeAgua[19]).toString();
													}
												}
												
												contaTxt.append(Util.completaString(numeroExigidasCloro , 3));
												contaTxt.append(Util.completaString(numeroRealizadasCloro , 3));
												contaTxt.append(Util.completaString(numeroConformidadeCloro , 3));
												contaTxt.append(Util.completaString(numeroExigidasTurbidez , 3));
												contaTxt.append(Util.completaString(numeroRealizadasTurbidez , 3));
												contaTxt.append(Util.completaString(numeroConformidadeTurbidez , 3));
												contaTxt.append(Util.completaString(numeroExigidasCor , 3));
												contaTxt.append(Util.completaString(numeroRealizadasCor , 3));
												contaTxt.append(Util.completaString(numeroConformidadeCor , 3));
												contaTxt.append(Util.completaString(numeroExigidasColiformes , 3));
												contaTxt.append(Util.completaString(numeroRealizadasColiformes , 3));
												contaTxt.append(Util.completaString(numeroConformidadeColiformes , 3));
												contaTxt.append(Util.completaString(numeroExigidasEscherichia , 3));
												contaTxt.append(Util.completaString(numeroRealizadasEscherichia , 3));
												contaTxt.append(Util.completaString(numeroConformidadeEscherichia , 3));
...
//			emitirContaHelper.setEnderecoClienteResponsavel(enderecoClienteResponsavel);
			...
			Short quantidadeEconomiaConta = 0;
			quantidadeEconomiaConta = obterQuantidadeEconomiasConta(emitirContaHelper.getIdConta(), false);
			emitirContaHelper.setQuantidadeEconomiaConta(quantidadeEconomiaConta != null ? "" + quantidadeEconomiaConta : null);
			// Fim Chamar Sub-Fluxo
