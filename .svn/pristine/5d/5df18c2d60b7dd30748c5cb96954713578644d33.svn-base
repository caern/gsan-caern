 ...
 */
public class ConsultarGatewayComparacaoFonetica2DocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements gcom.integracao.webservice.neurotech.gateway.webservices.fachada.ConsultarGatewayComparacaoFonetica2Document
{
    
    public ConsultarGatewayComparacaoFonetica2DocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName CONSULTARGATEWAYCOMPARACAOFONETICA2$0 = 
        new javax.xml.namespace.QName("http://fachada.webservices.gateway.neurotech.com.br", "consultarGatewayComparacaoFonetica2");
    
    
    /**
     * Gets the "consultarGatewayComparacaoFonetica2" element
     */
    public gcom.integracao.webservice.neurotech.gateway.webservices.fachada.ConsultarGatewayComparacaoFonetica2Document.ConsultarGatewayComparacaoFonetica2 getConsultarGatewayComparacaoFonetica2()
    {
        synchronized (monitor())
        {
            check_orphaned();
            gcom.integracao.webservice.neurotech.gateway.webservices.fachada.ConsultarGatewayComparacaoFonetica2Document.ConsultarGatewayComparacaoFonetica2 target = null;
            target = (gcom.integracao.webservice.neurotech.gateway.webservices.fachada.ConsultarGatewayComparacaoFonetica2Document.ConsultarGatewayComparacaoFonetica2)get_store().find_element_user(CONSULTARGATEWAYCOMPARACAOFONETICA2$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setConsultarGatewayComparacaoFonetica2(gcom.integracao.webservice.neurotech.gateway.webservices.fachada.ConsultarGatewayComparacaoFonetica2Document.ConsultarGatewayComparacaoFonetica2 consultarGatewayComparacaoFonetica2)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (gcom.integracao.webservice.neurotech.gateway.webservices.fachada.ConsultarGatewayComparacaoFonetica2Document.ConsultarGatewayComparacaoFonetica2)get_store().add_element_user(CONSULTARGATEWAYCOMPARACAOFONETICA2$0);
            }
            target.set(consultarGatewayComparacaoFonetica2);
        }
    }
     ...
     */
    public gcom.integracao.webservice.neurotech.gateway.webservices.fachada.ConsultarGatewayComparacaoFonetica2Document.ConsultarGatewayComparacaoFonetica2 addNewConsultarGatewayComparacaoFonetica2()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     * This is a complex type.
     */
    public static class ConsultarGatewayComparacaoFonetica2Impl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements gcom.integracao.webservice.neurotech.gateway.webservices.fachada.ConsultarGatewayComparacaoFonetica2Document.ConsultarGatewayComparacaoFonetica2
    {
        
        public ConsultarGatewayComparacaoFonetica2Impl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType);
        }
