...
public class RetificarContaActionForm extends ActionForm {
	...
	private String novoVencimentoConta;
	...
	public String getNovoVencimentoConta() {
		return novoVencimentoConta;
	}

	public void setNovoVencimentoConta(String novoVencimentoConta) {
		this.novoVencimentoConta = novoVencimentoConta;
	}
