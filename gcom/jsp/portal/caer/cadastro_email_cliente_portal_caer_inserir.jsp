			...
			<script type="text/javascript">
				$(document).ready(function(){
					...
					$('#voltar').click(function(){
						window.location.href = '/gsan/exibirServicosPortalCaerAction.do?method=voltarServico';
					});
				});
			</script>
		</logic:present>
		...
		<script type="text/javascript">
			$(document).ready(function(){
				...
				$('#emailConfirmado').click(function(){
					window.location = '/gsan/exibirServicosPortalCaerAction.do?menu=sim';
				});
			...
			function validateInserirCadastroEmailClientePortalCaerActionForm(form) {                                                                   
				if (bCancel) 
			    	return true; 
			   	else 
			...
			function validarForm(form){
				...
				if(validateInserirCadastroEmailClientePortalCaerActionForm(form)){
			...
			function enviarConfirmacao(){
				...
				if (enviarEmailConfirmacao == "OK"){
					...
					if (confirm("Confirma alteração do cadastro de email do cliente? ")) {
						...
						form.action = "/gsan/inserirCadastroEmailClientePortalCaerAction.do?ok=sim&enviarEmail=sim";
		...
		<div id="container">
			...
			<div id="content">
				...
				<div id="fatura-email" class="serv-int">
	            	...
	            	<html:form action="/inserirCadastroEmailClientePortalCaerAction.do?ok=sim&enviarEmail=sim"
						name="InserirCadastroEmailClientePortalCaerActionForm"
						type="gcom.gui.portal.caer.InserirCadastroEmailClientePortalCaerActionForm" 
						method="post"
						onsubmit="return validateInserirCadastroEmailClientePortalCaerActionForm(this);">
