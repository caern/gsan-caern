...
function limparForm(){
   	var form = document.forms[0];
   	form.idImovelDadosCadastrais.value ="";
   	consultarImovelAjax();
...
function pesquisarImovel() {
	...
	function visualizarCoordenadas(){
		var form = document.forms[0];
		
		abrirPopup('exibirVisualizarCoordenadasImpressaoSimultaneaPopupAction.do?idImovel=' + form.idImovelDadosCadastrais.value , 600, 620);
	}

function consultarImovelAjax(){
	var form = document.forms[0];

	if(form.idImovelDadosCadastrais != null && form.idImovelDadosCadastrais.value != ""){
		$.ajax({
				   type: "POST",
				   url: "consultarImovelAjaxAction.do?idImovel="+form.idImovelDadosCadastrais.value,
				   data: "",
...
<body leftmargin="5" topmargin="5" onload="javascript:habilitaMatricula();setarFoco('idImovelDadosCadastrais');consultarImovelAjax();">
	...
	<table width="770" border="0" cellspacing="5" cellpadding="0">
		<tr>
													...
													<logic:equal name="ConsultarImovelActionForm" property="indicadorValidaCPFCNPJ" value="1">
														<logic:equal name="imovelCliente" property="cliente.indicadorValidaCpfCnpj" value="1">
															<td width="20%" align="right"><font color="#000000"
																...
																<a href="javascript:abrirPopup('exibirAtualizarIndicadorCpfCnpjClientePopupAction.do?aba=1&idCliente=<bean:write name="imovelCliente" property="cliente.id"/>&indicadorCpfCnpj=<bean:write name="imovelCliente" property="cliente.indicadorValidaCpfCnpj"/>', 320, 350);">
																	<font color="#008000"><bean:write name="imovelCliente"
																		property="cliente.cpfFormatado" /></font>
																</a> 
															</logic:notEmpty> <logic:notEmpty name="imovelCliente"
																property="cliente.cnpj">
																<a href="javascript:abrirPopup('exibirAtualizarIndicadorCpfCnpjClientePopupAction.do?aba=1&idCliente=<bean:write name="imovelCliente" property="cliente.id"/>&indicadorCpfCnpj=<bean:write name="imovelCliente" property="cliente.indicadorValidaCpfCnpj"/>', 320, 350);">
																	<font color="#008000"><bean:write name="imovelCliente"
																		property="cliente.cnpjFormatado" /></font>
																</a>
														...
														<logic:equal name="imovelCliente" property="cliente.indicadorValidaCpfCnpj" value="2">
															<td width="20%" align="right"><font color="#000000"
																...
																name="imovelCliente" property="cliente.cpf">
																<a href="javascript:abrirPopup('exibirAtualizarIndicadorCpfCnpjClientePopupAction.do?aba=1&idCliente=<bean:write name="imovelCliente" property="cliente.id"/>&indicadorCpfCnpj=<bean:write name="imovelCliente" property="cliente.indicadorValidaCpfCnpj"/>', 320, 350);">
																	<font color="#FF0000"><bean:write name="imovelCliente"
																		property="cliente.cpfFormatado" /></font>
																</a> 
															</logic:notEmpty> <logic:notEmpty name="imovelCliente"
																property="cliente.cnpj">
			...
			%>
						...
						<tr>
							<td height="10" align="left">
							<div class="style9"><strong>Coordenada X:</strong></div>
							</td>
							<td align="left">
							<div class="style9"><html:textarea rows="2"
								property="coordenadaXDadosCadastrais" readonly="true"
								style="background-color:#EFEFEF; border:0; color: #000000;width:133px;max-width:133px;min-width:133px;max-height:80px;min-height:30px"
								 /></div>
							</td>
							<td align="left"><strong>Coordenada Y:</strong></td>
							<td align="left"><html:textarea rows="2" property="coordenadaYDadosCadastrais"
								readonly="true"
								style="background-color:#EFEFEF; border:0; color: #000000;width:133px;max-width:133px;min-width:133px;max-height:80px;"
								/></td>
						</tr>
						<logic:present name="exibirVisualizarCoordenadas" scope="session">
							<tr>
								<td height="10" align="left" colspan="3" >
									<a href="javascript:visualizarCoordenadas();">
										<strong>Visualizar Coordenadas (Impressão Simultânea):</strong>
									</a>
								</td>		
							</tr>
						</logic:present>
