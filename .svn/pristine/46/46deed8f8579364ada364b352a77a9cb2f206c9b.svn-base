...
public class AtualizarHidrometroAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		if (atualizarHidrometroActionForm.getIdHidrometroFatorCorrecao() != null
			...
			hidrometroFatorCorrecao.setId(new Integer(atualizarHidrometroActionForm
		...
		if (atualizarHidrometroActionForm.getIdHidrometroClassePressao() != null
			...
			hidrometroClassePressao.setId(new Integer(atualizarHidrometroActionForm
		...
		if (atualizarHidrometroActionForm.getTombamento() != null 
			...
			Integer quantidadeOcorrencia = fachada
					.pesquisarQuantidadeHidrometroExistente(
						atualizarHidrometroActionForm.getTombamento(), hidrometro.getId());
		...
		hidrometro.setAnoFabricacao(new Short(atualizarHidrometroActionForm
				.getAnoFabricacao()));
		hidrometro.setIndicadorOperacional(new Short(atualizarHidrometroActionForm
