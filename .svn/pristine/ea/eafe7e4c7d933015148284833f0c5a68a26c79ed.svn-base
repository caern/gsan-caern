...
//                "    inner join imov.quadra qdra " +
	...
	/***
	 * Carrega os dados do resumo da arrecadação do gerencial
	 * 
	 * @author Erivan Sousa
	 * @date 19/04/2012
	 * 
	...
	public void executarCargaResumoArrecadacaoGerencialPorAno()
		...
		String sql = "";
		try {
			System.out.println("Iniciando procedure");
			con = session.connection();
			sql = "select arrecadacao.sp_un_resumo_arrec_ref_ano(null)";
	 ...
	 * @throws ErroRepositorioException
	 */
	public void executarCargaLigacoesEconomiasPorAno() throws ErroRepositorioException, SQLException {
		...
		try {
			con = session.connection();
			sql = " select cadastro.sp_un_res_lig_econ_ref_ano(null) ";
			PreparedStatement pstm = con.prepareStatement(sql); 
			pstm.executeQuery();
	 ...
	 * @throws ErroRepositorioException
	 */
	public void executarCargaIndicadorLigacaoEconomiaPorAno() throws ErroRepositorioException, SQLException {
		...
		try {
			con = session.connection();
			sql = " select cadastro.sp_un_resi_lig_eco_ref_ano(null) ";
			PreparedStatement pstm = con.prepareStatement(sql); 
			pstm.executeQuery();
	 ...
	 * @throws ErroRepositorioException
	 */
	public void executarCargaResumoParcelamentoPorAno() throws ErroRepositorioException, SQLException {
		...
		try {
			con = session.connection();
			sql = " select cobranca.sp_un_res_parcel_ref_ano(null) ";
			PreparedStatement pstm = con.prepareStatement(sql); 
			pstm.executeQuery();
	 ...
	 * @throws ErroRepositorioException
	 */
	public void executarCargaResumoPendenciaPorAno() throws ErroRepositorioException, SQLException {
		...
		try {
			con = session.connection();
			sql = " select cobranca.sp_un_res_pend_ref_ano(null) ";
			PreparedStatement pstm = con.prepareStatement(sql); 
			pstm.executeQuery();
	 ...
	 * @throws ErroRepositorioException
	 */
	public void executarCargaPendenciaSemQuadraVariosAnos() throws ErroRepositorioException, SQLException {
		...
		try {
			con = session.connection();
			sql = " select cobranca.sp_un_res_pend_sqd(null) ";
			PreparedStatement pstm = con.prepareStatement(sql); 
			pstm.executeQuery();
	...
	public void gerarResumoArrecadacao() throws ErroRepositorioException, SQLException {
		...
		try {
			con = session.connection();
			sql = " select arrecadacao.sp_un_resumo_arrecadacao(null) ";
			PreparedStatement pstm = con.prepareStatement(sql); 
			pstm.executeQuery();
