 ...
 */
public class ConsultarDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements gcom.integracao.webservice.neurotech.gateway.webservices.fachada.ConsultarDocument
{
    
    public ConsultarDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName CONSULTAR$0 = 
        new javax.xml.namespace.QName("http://fachada.webservices.gateway.neurotech.com.br", "consultar");
    
    
    /**
     * Gets the "consultar" element
     */
    public gcom.integracao.webservice.neurotech.gateway.webservices.fachada.ConsultarDocument.Consultar getConsultar()
    {
        synchronized (monitor())
        {
            check_orphaned();
            gcom.integracao.webservice.neurotech.gateway.webservices.fachada.ConsultarDocument.Consultar target = null;
            target = (gcom.integracao.webservice.neurotech.gateway.webservices.fachada.ConsultarDocument.Consultar)get_store().find_element_user(CONSULTAR$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setConsultar(gcom.integracao.webservice.neurotech.gateway.webservices.fachada.ConsultarDocument.Consultar consultar)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (gcom.integracao.webservice.neurotech.gateway.webservices.fachada.ConsultarDocument.Consultar)get_store().add_element_user(CONSULTAR$0);
            }
            target.set(consultar);
        }
    }
     ...
     */
    public gcom.integracao.webservice.neurotech.gateway.webservices.fachada.ConsultarDocument.Consultar addNewConsultar()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     * This is a complex type.
     */
    public static class ConsultarImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements gcom.integracao.webservice.neurotech.gateway.webservices.fachada.ConsultarDocument.Consultar
    {
        
        public ConsultarImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType);
        }
