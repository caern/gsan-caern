...
public interface IRepositorioMicromedicao {
	 ...
	 * @throws ErroRepositorioException
	 */
	public void atualizarArquivoTextoEnviadoPorRota(Integer idRota, int situacaoAnterior, int situacaoNova, int referencia) throws ErroRepositorioException;
...
//	public byte[] baixarArquivoTextoAtualizacaoCadastral(long imei) throws ErroRepositorioException;
	 ...
	 * 
	 * @author Vivianne Sousa
	 * @param indicadorValidarRetificacao 
	 * @date 17/12/2009
	 * 
	 * @return Collection
	 * @throws ErroRepositorioException
	...
	public ConsumoAnormalidadeAcao pesquisarConsumoAnormalidadeAcao(
			Integer idConsumoAnormalidade, Integer idCategoria, Integer idPerfilImovel, Short indicadorValidarRetificacao)
			throws ErroRepositorioException;
	 ...
	 * @throws ErroRepositorioException
	 */
	public Integer pesquisarConsumoMedioImovelLigacao(Integer idImovel,
			Integer idLigacao) throws ErroRepositorioException;
