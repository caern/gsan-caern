...
public interface IControladorFaturamento {
	...
	public void gerarContas(RelatorioConta relatorio, int funcionalidadeIniciadade) throws ControladorException;
	...
	public Collection<GerarRelatorioAnormalidadeConsumoHelper> pesquisarDadosRelatorioAnormalidadeConsumo(
			...
			Integer idCategoria, Integer idSituacaoLigacaoAgua) throws ControladorException;
	...
	*/
	 ...
	 */
	public ArrayList<ConsultarEstruturaTarifariaPortalCaemaHelper> pesquisarEstruturaTarifaria(Integer idCategoria, Integer idSubCategoriaMinima , Integer idSubCategoriaNormal)
			throws ControladorException;
	...
	*/
	 ...
	 * @date: 14/08/2012
	 */
	public void gerarFaturaProgramaEspecial(int idFuncionalidadeIniciada) throws ControladorException;
	 ...
	 * @throws ControladorException
	 */
	public void gerarCreditoARealizarPagamentoDuplicidadeVivaAgua(int idFuncionalidadeIniciada) throws ControladorException;
	 ...
	 * @throws ErroRepositorioException
	 */
	public Integer pesquisarFaturaItemCount(Filtro filtro) throws ControladorException;
	 ...
	 * @throws ErroRepositorioException
	 */
	public boolean existeFaturaItem(Integer imovId, Integer anoMes)throws ControladorException;
	...
	public Boolean verificarExistenciaContasNaoPagasDeclaracaoQuitacao(
			Integer idImovel, String ano) throws ControladorException;
	 ...
	 * @throws ControladorException
	 */
	public void calcularValorSimuladoHistogramaEsgotoEconomiaSemQuadra(Integer anoMesFaturamento) 
			throws ControladorException;
	...
	/**
	 * Verificar exist̻ncia de rotas no Gerar Arquivo a mais que o Faturar grupo
	 * 
	 * @author Rodrigo Cabral
	 * @date 03/05/2013
	 */
	public Collection<Integer> verificarRotasGerarArquivosComFaturarGrupo(
			FaturamentoGrupo faturamentoGrupo) throws ControladorException ;
	 ...
	 * @date 30/07/2013
	 */
	public Short pesquisarIndicadorBloqueioAlteracaoContaMotivoRevisao(Integer idContaMotivoRevisao) throws ControladorException;
	...
	public void retificarContasIndevidasCaern(
			Imovel imovel, int idFuncionalidadeIniciada);
