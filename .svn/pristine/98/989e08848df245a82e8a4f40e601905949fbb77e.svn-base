...
import gcom.relatorio.arrecadacao.pagamento.RelatorioPagamentosBaixadosAutomaticamenteAnaliticoBean;
import gcom.relatorio.arrecadacao.pagamento.RelatorioPagamentosBaixadosAutomaticamenteSinteticoBean;
...
public interface IControladorArrecadacao {
	...
	public void transferirPagamentoParaHistorico(
			Collection<Pagamento> colecaoPagamentos, Integer anoMesReferenciaArrecadacao)
			throws ControladorException;
	 ...
	 */
	 ...
	 /**
		 ...
		 * @throws ControladorException
		 */
		public void verificaPagamentoDebitoACobrarParcelamento(Integer idDebitoACobrar, Integer numeroParcelasAntecipadas, Usuario usuarioLogado) 
			throws ControladorException ;
		 ...
		 * @date 22/11/2011
		 */
		public void gerarDebitoACobrarContratoDemandaImovelResidencial(Integer anoMesReferenciaArrecadacao, Integer idLocalidade, int idFuncionalidadeIniciada) 
				throws ControladorException ;
		 ...
		 * @throws ControladorException
		 */
		public void gerarResumoArrecadacaoAnaliticoDados(int idFuncionalidadeIniciada) throws ControladorException;
		 ...
		 * @throws ControladorException
		 */
		public void gerarResumoArrecadacaoAnaliticoTotais1(int idFuncionalidadeIniciada) throws ControladorException;
		 ...
		 * @throws ControladorException
		 */
		public void gerarResumoArrecadacaoAnaliticoTotais2(int idFuncionalidadeIniciada) throws ControladorException;
		
		/**
		 * [UC0629] Consultar Arquivo Texto Leitura
		 * [FS0017] Verificar possibilidade de finalizar arquivo subdividido 
		 * 
		 ...
		 * @date 20/03/2012
		 */
		public boolean verificarSituacaoRotaSudividida(
				Integer idArquivoTextoRoteiroEmpresaDivisao)throws ControladorException;
		 ...
		 * @date 21/03/2012
		 */
		public boolean verificarExistenciaRotaSudividida(
				Integer idArquivoTextoRoteiroEmpresaDivisao)throws ControladorException;
		 ...
		 * @date 21/03/2012
		 */
		public boolean pesquisarArquivoTextoRoteiroEmpresaCount(Integer idArquivoTexto) throws ControladorException ;
		 ...
		 * 
		 */
		public Map<Banco, Collection<DebitoAutomaticoMovimentoParcelamentoCliente>> pesquisaDebitoAutomaticoMovimentoParcelamentoCliente(Date dataParcelas) throws ControladorException;
		 ...
		 * @date 29/06/2012
		 */
		public void gerarMovimentoDebitoAutomaticoParcCliente(
		 ...
		 * @date 13/07/2012
		 */
		public void regerarArquivoTxtMovimentoDebitoAutomaticoParcelamentoCliente(
				ArrecadadorMovimento arrecadadorMovimento, String envioBanco,
				Usuario usuario) throws ControladorException;
		...
		public DebitoAutomaticoMovimentoParcelamentoCliente obterDebitoAutomaticoMovParcCliente(Integer idMovimento) throws ControladorException;
		 ...
		 * @date 24/10/2012
		 */
		public Collection <MovimentoRoteiroEmpresaFoto> pesquisarFotoAnormalidadeImovel(Integer idImovel, Integer anoMesReferencia, Integer idTipoMedicao) 
				throws ControladorException;
		 ...
		 * @date 08/07/2013
		 */
		public void baixaAutomaticaPagamentosNaoClassificados(int idFuncionalidadeIniciada, Rota rota) throws ControladorException;
		
		/**
		 * [ UC 1518 ] - Gerar Relatório dos Pagamentos Baixados Automaticamente
		 * [ SB 0002 ] - Relatório Analitico
		 * 
		 * @author Davi Menezes
		 * @date 11/07/2013
		 */
		public Collection<RelatorioPagamentosBaixadosAutomaticamenteAnaliticoBean> pesquisarRelatorioAnaliticoPagamentosBaixadosAutomaticamente
				(PagamentosBaixadosAutomaticamenteRelatorioHelper helper) throws ControladorException;
		 ...
		 * @date 12/07/2013
		 */
		public Collection<RelatorioPagamentosBaixadosAutomaticamenteSinteticoBean> pesquisarRelatorioSinteticoPagamentosBaixadosAutomaticamente
				(PagamentosBaixadosAutomaticamenteRelatorioHelper helper) throws ControladorException;
		 ...
		 * 
		 * Pesquisa a guia de pagamento do imovel informado pelo usuario
		 * 
		 * Verificar existencia da guia de pagamento
		 * 
		 * @author Rodrigo Cabral
		 * @date 16/09/2013
		 * 
		 ...
		 * @throws ControladorException
		 */
		public GuiaPagamento pesquisarGuiaPagamentoDigitadaRegistrarMovimento(String idImovel,
				String idGuiaPagamento)
				throws ControladorException;
		 ...
		 * @date 13/11/2013
		 */
		public Integer verificarExistenciaContaDebitoCarteiraMovimento(Integer idConta)
				throws ControladorException;
		
		/**
		 * RN2013108067 Mudanca dos boletos bancarios: da carteira 18 para carteira 17
		 ...
		 *
		 */
		public Collection pesquisaDebitoAutomaticoCarteira17(Collection colecaoIdsFaturamentoGrupo,
			Integer anoMesReferenciaFaturamento, String bancoId) throws ControladorException;
		 ...
		 * @date 14/11/2013
		 */
		public void gerarArquivoCarteira17(int idFuncionalidadeIniciada, Collection colecaoGrupoFaturamento,
		 ...
		 * @throws ErroRepositorioException
		 */
		public Integer pesquisarQuantidadeDevolucoesPorCreditoARealizar(
