...
<html:javascript staticJavascript="false"
	formName="AtualizarLigacaoAguaSituacaoActionForm" />

<SCRIPT LANGUAGE="JavaScript">
<!--

function validarForm(formulario){
	if(validateAtualizarLigacaoAguaSituacaoActionForm(formulario)){
...
<html:form action="/atualizarLigacaoAguaSituacaoAction.do" method="post">

	<INPUT TYPE="hidden" name="removerLigacaoAguaSituacao">
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Atualizar Situa&ccedil;&atilde;o de Liga&ccedil;&atilde;o de &Aacute;gua</td>
					<td width="11"><img border="0"
			...
			<table width="100%" border="0">
				<tr>
					<td colspan="2">Para Atualizar uma liga&ccedil;&atilde;o de &aacute;gua, informe os
					dados abaixo:</td>
				<tr>
					<td><strong>C&oacute;digo:</strong></td>
					<td><html:hidden property="id" /> <bean:write
						name="AtualizarLigacaoAguaSituacaoActionForm" property="id" /></td>
				</tr>
				...
				<tr>
					...
					<td><html:radio property="indicadorAbastecimento" value="1" tabindex="5" /> <strong>Sim 
					<html:radio property="indicadorAbastecimento" value="2" tabindex="6" /> Não</strong>
					</td>
				</tr>
				
				<tr>
					<td><strong>Indicador de Permissão para Corte de Esgoto: <font	color="#FF0000">*</font></strong></td>
					<td><html:radio property="indicadorPermissaoCorteEsgoto" value="1" tabindex="5" /> <strong>Sim 
					<html:radio property="indicadorPermissaoCorteEsgoto" value="2" tabindex="6" /> Não</strong>
					</td>
				</tr>
