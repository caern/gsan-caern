												...
												<table border="0" width="100%">
													...
													<tr>
														<td width="25%" align="left"><strong>Unidade
																Organizacional da Presidência:</strong>
														</td>
													...
													<tr>
														<td><strong>Diretor Comercial:</strong>
														</td>
														<td><html:text maxlength="9" tabindex="1"
													...
													<tr>
														<td width="25%" align="left"><strong>Fax:</strong>
														</td>
													...
													<tr>
														<td width="25%" align="left"><strong>Site:</strong>
														</td>
													...
													<tr>
														<td width="25%" align="left"><strong>Número
																do Telefone de Atendimento:</strong>
														</td>
													...
													<tr>
														...
														<td><strong> <html:radio
																	...
																	disabled="true" /> N&atilde;o </strong>
														</td>
													</tr>

													<tr>
														<td colspan="2" align="center"><strong>Parâmetros
																para Relatório:</strong>
														</td>
													</tr>
													...
													<tr>
														<td width="25%" align="left"><strong>Caminho
																Imagem do Relat&oacute;rio:</strong>
														</td>
														<td><html:text maxlength="30"
													...
													<tr>
														<td width="25%" align="left"><strong>Execução
																do Resumo de Negativação:</strong>
														</td>
													...
													<tr>
														<td width="40%"><strong>Consulta ao SPC:</strong>
														</td>
														<td><strong> <html:radio
													...
													<tr>
														<td width="40%"><strong>Mensagem de Vencimento da Guia de Pagamento Referente a Entrada de Parcelamento:</strong>
														</td>
														<td><html:text maxlength="100"
																property="msgVencimentoGuiaEntradaParc" size="60"
																readonly="true"
																style="background-color:#EFEFEF; border:0; color: #000000" />
														</td>
													</tr>
													...
													<tr>
														<td width="40%"><strong>Valor para Emissão
																de Extrato Tipo Ficha de Compensação:</strong>
														</td>
													...
													<tr>
														<td><strong>Perfil Programa Especial:</strong>
														</td>
													...
													<tr>
														<td width="40%" align="left"><strong>Número
																de Dias Bloqueio Celular:</strong>
														</td>
													...
													<tr>
														<td width="40%" align="left"><strong>Percentual
																de Convergência da Repavimentação:</strong>
														</td>
														<td><html:text
													...
													<tr>
														<td width="40%"><strong>Indicador de Uso do
																...
																Nome Abreviado nas Telas Inserir e Manter Cliente:</strong>
														</td>
														<td><strong> <html:radio
													...
													<tr>
														<td width="40%"><strong>Bloquear alterar o nome do cliente
														        com CPF ou CNPJ validado</strong>
														</td>
														<td><strong><html:radio
																	property="indicadorAlterarNomeClienteCpfCnpjValidado" value="1"
																	disabled="true" /> Sim <html:radio
																	property="indicadorAlterarNomeClienteCpfCnpjValidado" value="2"
																	disabled="true" /> N&atilde;o </strong>
													   	</td>
													</tr>
													...
													<tr>
														<td><strong>Cliente Fictício para Associar
																os Pagamentos Não Identíficados:</strong>
														</td>
														<td><html:text maxlength="9" tabindex="1"
													...
													<tr>
														<td width="40%">
															<strong>Indicador de Validar CPF/CNPJ: </strong>
														</td>
														<td><strong> 
															<html:radio property="indicadorValidaCpfCnpj" value="1" disabled="true" />Sim
															<html:radio property="indicadorValidaCpfCnpj" value="2" disabled="true" />N&atilde;o 
																</strong>
														</td>
													</tr>
													...
													<tr>
														<td width="40%">
															<strong>Indicador de Imprimir Nome Cliente Atual na Segunda Via de Conta: </strong>
														</td>
														<td><strong> 
															<html:radio property="indicadorNomeClienteAtualConta" value="1" disabled="true" />Sim
															<html:radio property="indicadorNomeClienteAtualConta" value="2" disabled="true" />N&atilde;o 
									 						</strong>
														</td>
													</tr>
													...
													<tr>
														<td width="25%" align="left">
															<strong>Tamanho Máximo Mensagem via SMS: </strong>
														</td>
														<td>
															<html:text property="tamanhoMaximoMensagemSms" maxlength="3" size="3" 
												...
												<table border="0" width="100%">
													...
													<tr>
														<td width="40%" align="left"><strong>Menor
																Consumo para ser Grande Usuário:</strong>
														</td>
													...
													<tr>
														<td width="40%" align="left"><strong>Menor
																Valor para Emissão de Contas:</strong>
														</td>
													...
													<tr>
														<td width="40%" align="left"><strong>Valor
																para Emissão de Conta no Formato Ficha de Compensação:</strong>
														</td>
														<td><html:text maxlength="13"
													...
													<tr>
														<td width="40%" align="left"><strong> Qtde
																de Economias para ser Grande Usuário:</strong>
														</td>
													...
													<tr>
														<td width="40%" align="left"><strong> Meses
																para Cálculo de Média de Consumo:</strong>
														</td>
														<td width="87%"><html:text
													...
													<tr>
														<td width="40%" align="left"><strong>Dias
																Mínimo para Calcular Vencimento:</strong>
														</td>
													...
													<tr>
														<td width="40%" align="left"><strong>Número
																de meses para validade da Conta:</strong>
														</td>
													...
													<tr>
														<td width="40%" align="left"><strong>Número
																de meses para alteração de um vencimento para outro:</strong>
														</td>
														<td><html:text
													...
													<tr>
														<td width="40%" align="left"><strong>Número
																máximo de meses para retroagir o calculo da media:</strong>
														</td>
														<td><html:text
													...
													<tr>
														<td width="40%" align="left"><strong>Número
																de meses para calcular correção monetária:</strong>
														</td>
													...
													<tr>
														<td width="40%"><strong>Indicador Alteração
																do Vencimento Mais de uma Vez:</strong>
														</td>
														<td><strong> <html:radio
													...
													<tr>
														<td width="40%"><strong>Indicador Calculo
																feito pelo Sistema por Sugestão:</strong>
														</td>
														<td><strong> <html:radio
													...
													<tr>
														<td width="40%" align="left"><strong>Quantidade
																de dias de variação de consumo:</strong>
														</td>
													...
													<tr>
														<td width="40%" align="left"><strong>Código
																de Tipo de Cálculo de Não Medido:</strong>
														</td>
														<td><html:text maxlength="15" tabindex="1"
													...
													<tr>
														<td width="40%" align="left"><strong>Número
																de meses para retificar uma conta:</strong>
														</td>
													...
													<tr>
														<td width="40%" align="left"><strong>Área
																Máxima do Imóvel para a Tarifa:</strong>
														</td>
													...
													<tr>
														<td width="40%" align="left"><strong>Consumo
																de Energia Máxima para a Tarifa:</strong>
														</td>
													...
													<tr>
														<td width="40%" align="left"><strong>Número
																de vezes com consumo até 10m³ para suspender leitura:</strong>
														</td>
													...
													<tr>
														<td width="40%" align="left"><strong>Número
																de meses para manter leitura suspensa:</strong>
														</td>
													...
													<tr>
														<td width="40%"><strong>Utiliza Tarifa de Simulação para Histograma:</strong>
														</td>
														<td><strong> <html:radio
																	property="indicadorUtilizaTarifaSimulacao" value="1"
																	disabled="true" /> Sim <html:radio
																	property="indicadorUtilizaTarifaSimulacao" value="2"
																	disabled="true" /> N&atilde;o </strong>
														</td>
													</tr>
										...
										<tr bgcolor="#cbe5fe">
											<td>
												<table border="0" width="100%">
													...
													<tr>
														<td width="40%" align="left"><strong>Código
																da Empresa para FEBRABAN:</strong>
														</td>
														<td><html:text maxlength="4"
													...
													<tr>
														<td width="40%" align="left"><strong>Identificador
																da Conta Bancária para Devolução:</strong>
														</td>
														<td><html:text maxlength="4"
													...
													<tr>
														<td width="40%" align="left"><strong>Número
																meses para pesquisa de imóveis com ramais suprimidos:</strong>
														</td>
														<td><html:text maxlength="3"
													...
													<tr>
														<td width="40%"><strong>Contas parceladas
																para declaração de quitação de débitos: </strong>
														</td>
														<td><strong> <html:radio
													...
													<tr>
														<td width="40%"><strong>Contas em cobrança
																judicial para declaração de quitação de débitos: </strong>
														</td>
														<td><strong> <html:radio
													...
													<tr>
														<td width="40%"><strong>Indicador do valor
																do movimento arrecadador: </strong>
														</td>
														<td><strong> <html:radio
													...
													<tr>
														<td width="40%" align="left"><strong>N&uacute;mero
																Conv&ecirc;nio Ficha Compensa&ccedil;&atilde;o:</strong>
														</td>
													...
													<tr>
														<td width="40%" align="left">
															<strong> Baixa Automática de Pagamentos: </strong>
														</td>
													</tr>			
													
													<tr>
														<td width="40%" align="left">
															<strong>Valor Máximo a ser Baixado:</strong>
														</td>					
														<td>
													...
													<tr>
														<td width="40%" align="left">
															<strong>Diferença Máxima para Baixa:</strong>
														</td>
														<td>
															<html:text property="diferencaMaximoBaixado" 
																size="13" maxlength="13"
																onkeyup="javascript:formataValorMonetario(this, 13);"
																readonly="true"
																style="background-color: #EFEFEF; border:0; color: #000000"	/>
													...
													<tr>
														<td width="40%"><strong>Indicador Contrato Bancário da Carteira 17:</strong>
														</td>
														<td><strong> <html:radio property="indicadorCarteira17" value="1"
																	disabled="true" /> Sim 
																	<html:radio property="indicadorCarteira17" value="2"
																	disabled="true" /> N&atilde;o </strong>
														</td>
													</tr>
													...
													<tr>
														<td width="40%" align="left"><strong>
																Percentual de Entrada Mínima para Financiamento:</strong>
														</td>
													...
													<tr>
														<td width="40%" align="left"><strong>Máximo
																de Parcelas para um Financiamento:</strong>
														</td>
													...
													<tr>
														<td width="40%" align="left"><strong>Percentual
																Máximo para Abatimento de um Serviço:</strong>
														</td>
														<td><html:text maxlength="5"
													...
													<tr>
														<td width="40%" align="left"><strong>Percentual
																de Taxa de Juros para Financiamento:</strong>
														</td>
														<td><html:text maxlength="5"
													...
													<tr>
														<td width="40%" align="left"><strong>Número
																Máximo para Parcela de Crédito:</strong>
														</td>
													...
													<tr>
														<td width="40%" align="left"><strong>Percentual
																da Média do Índice para Cálculo do Parcelamento:</strong>
														</td>
														<td><html:text maxlength="5"
										...
										<tr bgcolor="#cbe5fe">
											<td>
												<table border="0" width="100%">
													...
													<tr>
														<td width="40%" align="left"><strong>Menor
																Capacidade de Hidrômetro para ser Grande Usuário:</strong>
														</td>
													...
													<tr>
														...
														<td><strong> <html:radio
																	...
																	disabled="true" /> De acordo com a Rota </strong>
														</td>
													</tr>
													<tr>
														<td width="40%"><strong>Indicador do
																Percentual para Geração de Faixa Falsa:</strong>
														</td>
														<td><strong> <html:radio
																	property="indicadorPercentualGeracaoFaixaFalsa"
																	value="1" disabled="true" /> Percentual Parâmetro <html:radio
																	property="indicadorPercentualGeracaoFaixaFalsa"
																	value="2" disabled="true" /> Percentual da Rota </strong>
														</td>
													</tr>
													<tr>
														<td width="40%" align="left"><strong>
																Percentual de Geração de Faixa Falsa:</strong>
														</td>
													...
													<tr>
														<td width="40%"><strong>Indicador de Geração
																de Fiscalização de Leitura :</strong>
														</td>
														<td><strong> <html:radio
																	...
																	property="indicadorGeracaoFiscalizacaoLeitura"
																	value="3" disabled="true" /> De acordo com a Rota </strong>
														</td>
													...
													<tr>
														<td width="40%"><strong>Indicador do
																Percentual Geração de Fiscalização de Leitura :</strong>
														</td>
														<td><strong> <html:radio
													...
													<tr>
														<td width="40%" align="left"><strong>Percentual
																de Geração de Fiscalização de Leitura:</strong>
														</td>
														<td><html:text
													...
													<tr>
														<td width="40%" align="left"><strong>Incremento
																Máximo de Consumo por economia em Rateio:</strong>
														</td>
														<td width="87%"><html:text
													...
													<tr>
														<td width="40%" align="left"><strong>Percentual
																de Tolerância para o Rateio do Consumo: </strong>
														</td>
														<td width="87%"><html:text
													...
													<tr>
														<td width="40%" align="left"><strong>Número
																de Dias entre o Vencimento e o Início da Cobrança:</strong>
														</td>
														<td><html:text maxlength="2"
													...
													<tr>
														<td width="40%" align="left"><strong>Número
																Máximo de Meses de Sanções:</strong>
														</td>
														<td><html:text maxlength="2"
													...
													<tr>
														<td width="40%"><strong>Indicador de
																Cobrança da Taxa de Extrato :</strong>
														</td>
														<td><strong> <html:radio
													...
													<tr>
														<td width="40%" align="left"><strong>Código
																da Periodicidade da Negativaç&atilde;o:</strong>
														</td>
														<td><html:text maxlength="2"
													...
													<tr>
														<td width="40%" align="left"><strong>Número
																de Dias para Calculo de Adicionais de Impontualidade:</strong>
														</td>
														<td><html:text maxlength="2"
													...
													<tr>
														<td width="40%" align="left"><strong>Número
																de Dias de Validade do Extrato de Débito:</strong>
														</td>
														<td><html:text maxlength="2"
													...
													<tr>
														<td width="40%" align="left"><strong>Número
																...
																possui Permissão Especial:</strong>
														</td>
														<td><html:text maxlength="2"
													...
													<tr>
														<td width="40%" align="left"><strong>Número
																...
																Entrada de Parcelamento:</strong>
														</td>
														<td><html:text maxlength="2"
													...
													<tr>
														<td width="40%"><strong>Indicador
																Parcelamento Confirmado :</strong>
														</td>
														<td><strong> <html:radio
													...
													<tr>
														<td width="40%" align="left"><strong>Número
																...
																encerrada por Decurso de Prazo:</strong>
														</td>
														<td><html:text maxlength="2"
													...
													<tr>
														<td width="40%"><strong>Indicador Cálculo
																Juros Pela Tabela Price :</strong>
														</td>
														<td><strong> <html:radio
													...
													<tr>
														<td width="40%"><strong>Criticar
																...
																Negativa&ccedil;&atilde;o Confirmado :</strong>
														</td>
														<td><strong> <html:radio
													...
													<tr>
														<td width="40%"><strong>Calcular Acréscimo por Impontualidade para Guia de Pagamento na tela Extrato de Débitos:</strong>
														</td>
														<td><strong> <html:radio
																	property="indicadorCalcAcresImpontGuiaPagamento"
																	value="<%=ConstantesSistema.SIM.toString()%>"
																	disabled="true" /> Sim <html:radio
																	property="indicadorCalcAcresImpontGuiaPagamento"
																	value="<%=ConstantesSistema.NAO.toString()%>"
													...
													<tr>
														<td width="40%"><strong>Remoção da Restrição do Cliente no SPC/SERASA após o pagamento da entrada do parcelamento:</strong>
														</td>
														<td><strong> <html:radio
																	property="indicadorExcluirNegativacaoAposPgmto"
																	value="<%=ConstantesSistema.SIM.toString()%>"
																	disabled="true" /> Sim <html:radio
																	property="indicadorExcluirNegativacaoAposPgmto"
																	value="<%=ConstantesSistema.NAO.toString()%>"
													...
													<tr>
														<td width="40%"><strong>Retirar Contas
																...
																Débito do Imóvel ou do Cliente?</strong> <font color="#FF0000">*</font>
														</td>
														<td><strong> <html:radio
													...
													<tr>
														<td width="40%"><strong>Bloquear Contas
																...
																Conta?</strong> <font color="#FF0000">*</font>
														</td>
														<td><strong> <html:radio
													...
													<tr>
														<td width="40%"><strong>Bloquear Guias de
																...
																Contrato de Parcelamento na tela de Manter Guia?</strong> <font
															color="#FF0000">*</font>
														</td>
														<td><strong> <html:radio
													...
													<tr>
														<td width="40%"><strong>Indicador para
																...
																do débito:</strong> <font color="#FF0000">*</font>
														</td>
														<td><strong> <html:radio
													...
													<tr>
														<td width="40%"><strong> Conta com vencimento alterado excluir da negativação?</strong> <font color="#FF0000">*</font>
														</td>
														<td><strong> <html:radio
																	property="indicadorCanceNegatContaVencAlter"
																	value="1" disabled="true" /> Sim <html:radio
																	property="indicadorCanceNegatContaVencAlter"
																	value="2" disabled="true" /> N&atilde;o </strong>
														</td>
													...
													<tr>
														<td width="40%"><strong> Incluir contas fora
																do vencimento para cobrança:</strong> <font color="#FF0000">*</font>
														</td>
														<td><strong> <html:radio
													...
													<tr>
														<td width="40%" align="left"><strong>Número de Dias de validade da certidão negativa de débito:</strong>
														</td>
														<td><html:text maxlength="3"
																property="quantidadeDiasValidadeCerticaoNegativa" size="2"
																readonly="true"
																style="background-color:#EFEFEF; border:0; color: #000000" />
														</td>
													...
													<tr>
														<td width="40%" align="left"><strong>N&uacute;mero de dias &uacute;teis para vencimento das contas da entrada de parcelamento:</strong>
														</td>
														<td><html:text maxlength="3"
																property="numeroDiasVencContaEntradaParcelamento" size="2"
																readonly="true"
																style="background-color:#EFEFEF; border:0; color: #000000" />
														</td>
													</tr>
													...
													<tr>
														<td width="40%" align="left"><strong>N&uacute;mero de dias &uacute;teis para cancelamento da entrada de parcelamento:</strong>
														</td>
														<td><html:text maxlength="3"
																property="numeroDiasCancelamentoEntradaParcelamento" size="2"
																readonly="true"
																style="background-color:#EFEFEF; border:0; color: #000000" />
														</td>
													</tr>
													...
													<tr>
														<td width="40%"><strong>Indicador para verificar a 
														ação predecessora para os imóveis do arquivo texto:</strong>
														<font color="#FF0000">*</font>
														</td>
														<td><strong> <html:radio
																	property="indicadorAcaoPredecessoraImoveisArquivoTexto"
																	value="1" disabled="true" /> Sim <html:radio
																	property="indicadorAcaoPredecessoraImoveisArquivoTexto"
																	value="2" disabled="true" /> N&atilde;o </strong>
														</td>
													...
													<tr>
														<td width="40%"><strong>Indicador de Permissão 
															de Alteração de Dados ou Vínculo de Cliente Negativado</strong>
															<font color="#FF0000">*</font>
														</td>
														<td>
															<strong>
																<html:radio property="indicadorPermissaoAlteracaoClienteNegativado" 
																			value="1" disabled="true" /> Sim
																<html:radio property="indicadorPermissaoAlteracaoClienteNegativado"
																			value="2" disabled="true" /> N&atilde;o																			
															</strong>
														</td>
													</tr>
													...
													<tr>
														<td></td>
														<td><font color="#FF0000">*</font>Campo
										...
										<tr bgcolor="#cbe5fe">
											...
											<td>
												<table border="0" width="100%">
													...
													<tr>
														<td width="40%"><strong>Indicador de
																Controle de Autorização para a Tramitação do RA:</strong></td>
														<td><strong> <html:radio
													...
													<tr>
														<td width="40%" align="left"><strong>Dias
																Máximo para Reativar RA:</strong>
														</td>
														<td width="87%"><html:text
													...
													<tr>
														<td width="40%" align="left"><strong>Número
																de Dias para Encerramento da OS: </strong>
														</td>
													...
													<tr>
														<td width="40%" align="left"><strong>Número
																de Dias para Encerramento da OS Seletiva: </strong>
														</td>
													...
													<tr>
														<td width="40%" align="left"><strong>Quantidade
																de dias de prorrogação do vencimento na retificação: </strong>
														</td>
													...
													<tr>
														<td width="40%" align="left"><strong>Situação de Água na Exclusão de Imóvel:</strong>
														</td>

														<td width="87%"><html:text
																property="situacaoAguaExclusaoImovel"
																size="35" maxlength="35" readonly="true"
																style="background-color:#EFEFEF; border:0; color: #000000" />
														</td>
													</tr>
													
													<tr>
														<td width="40%" align="left"><strong>Situação de Esgoto na Exclusão de Imóvel:</strong>
														</td>

														<td width="87%"><html:text
																property="situacaoEsgotoExclusaoImovel"
																size="35" maxlength="35" readonly="true"
																style="background-color:#EFEFEF; border:0; color: #000000" />
														</td>
													</tr>
													...
													<tr>
														<td width="40%" align="left"><strong>Prazo
																para Revisão de Conta(nº dias após vencimento): </strong>
														</td>
													...
													<tr>
														<td width="40%" align="left"><strong>Último
																ID Utilizado para Geração do RA Manual: </strong>
														</td>
														<td width="87%"><html:text
													...
													<tr>
														<td width="40%"><strong>Indicador Certidão
																Negativa com Efeito Positivo:</strong>
														</td>
														<td><strong> <html:radio
													...
													<tr>
														<td width="40%"><strong>Indicador Cálculo
																Juros Pela Tabela Price :</strong></td>
														<td><strong> <html:radio
																	property="indicadorTabelaPrice" value="1"
																	disabled="true" /> Sim <html:radio
																	property="indicadorTabelaPrice" value="2"
													...
													<tr>
														<td width="40%"><strong>Bloquear Contas
																Vinculadas a Contrato de Parcelamento na tela de Manter
																Conta?</strong> <font color="#FF0000">*</font></td>
														<td><strong> <html:radio
																	property="indicadorBloqueioContasContratoParcelManterConta"
																	value="1" disabled="true" /> Sim <html:radio
																	property="indicadorBloqueioContasContratoParcelManterConta"
													...
													<tr>
														<td width="25%" align="left"><strong>Número dias de
																Vencimento para gerar Certidão Negativa:</strong>
														</td>
														<td><html:text maxlength="3"
													...
													<tr>
														<td width="40%"><strong>Indicador de Documento
																obrigatório para 2ª via da Conta:</strong></td>
														<td><strong> <html:radio
																	property="indicadorDocumentoValido" value="1" disabled="true" />
																Sim <html:radio property="indicadorDocumentoValido" value="2"
																	disabled="true" /> N&atilde;o </strong>
														</td>
													</tr>
													...
													<tr>
														<td width="25%" align="left"><strong>Último dia do
																Vencimento Alternativo:</strong>
														</td>
														<td><html:text maxlength="3"
													...
													<tr>
														<td width="25%" align="left"><strong>Número de dias
																para validade ordem de fiscalização:</strong>
														</td>
														<td><html:text maxlength="2"
													...
													<tr>
														<td width="25%" align="left"><strong>Número máximo
																de dias para uma ordem de serviço ser fiscalizada:</strong>
														</td>
														<td><html:text maxlength="2"
													...
													<tr>
														...
														<td><html:text maxlength="2"
																property="qtdeDiasEnvioEmailConta" size="3" readonly="true"
																style="background-color:#EFEFEF; border:0; color: #000000" />
														</td>
													</tr>
													<tr>
														<td width="40%" align="left"><strong>Quantidade de dias para guardar ocorrências de paralisação:</strong></td>
														<td><html:text maxlength="2"
													...
													<tr>
														<td colspan="2" align="center"><strong>Documento Obrigatório:</strong></td>
													</tr>
													<tr>
														<td>&nbsp;</td>
													</tr>	
													<tr>
														...
														<td><strong> <html:radio
																	property="indicadorDocObrAtendimentoOperacional" value="1" disabled="true"/> Sim <html:radio
																	property="indicadorDocObrAtendimentoOperacional" value="2" disabled="true"/> N&atilde;o </strong></td>
													</tr>
													<tr>
														<td width="40%"><strong>Atendimento Comercial:</strong>
														</td>
														<td><strong> <html:radio
																	property="indicadorDocObrAtendimentoComercial" value="1" disabled="true"/> Sim <html:radio
																	property="indicadorDocObrAtendimentoComercial" value="2" disabled="true"/> N&atilde;o </strong></td>
													</tr>
													<tr>
														<td width="40%"><strong>Informação:</strong>
														</td>
														<td><strong> <html:radio
																	property="indicadorDocObrInformacao" value="1" disabled="true"/> Sim <html:radio
																	property="indicadorDocObrInformacao" value="2" disabled="true"/> N&atilde;o </strong></td>
													</tr>
													<tr>
														<td width="40%"><strong>Reiteração:</strong>
														</td>
														<td><strong> <html:radio
																	property="indicadorDocObrReiteracao" value="1" disabled="true"/> Sim <html:radio
																	property="indicadorDocObrReiteracao" value="2" disabled="true"/> N&atilde;o </strong></td>
													</tr>
													...
													<tr>
														...
														<td><strong> <html:radio
																	property="indicadorLoginUnico" value="0" disabled="true" />
																V&aacute;rios Acessos <html:radio
																	property="indicadorLoginUnico" value="1" disabled="true" />
													...
													<tr>
														...
														<td><html:text maxlength="2"
																property="diasMaximoExpirarAcesso" size="2" readonly="true"
																style="background-color:#EFEFEF; border:0; color: #000000" />
														</td>
													</tr>
													...
													<tr>
														<td width="40%" align="left"><strong>Dias para
																Começar Aparecer a Mensagem de Expiração de Senha:</strong></td>
														<td><html:text maxlength="2"
																property="diasMensagemExpiracaoSenha" size="2" readonly="true"
																style="background-color:#EFEFEF; border:0; color: #000000" />
														</td>
													</tr>
													...
													<tr>
														<td width="40%" align="left"><strong>Número Máximo
																de Favoritos no Menu do Sistema:</strong>
														</td>
														<td><html:text maxlength="2"
																property="numeroMaximoFavoritosMenu" size="2" readonly="true"
																style="background-color:#EFEFEF; border:0; color: #000000" />
														</td>
													</tr>
													...
													<tr>
														<td width="40%"><strong>Indicador de controle de
																dias de expiração de senha por Grupo:</strong></td>
														<td><strong> <html:radio
													...
													<tr>
														<td width="40%"><strong>Indicador de controle de
																bloqueio de senhas usadas anteriormente:</strong></td>
														<td><strong> <html:radio
													...
													<tr>
														<td width="40%"><strong>Indicador de controle de
																senha forte:</strong></td>
														<td><strong> <html:radio
																	property="indicadorSenhaForte" value="1" disabled="true" />
																Sim <html:radio property="indicadorSenhaForte" value="2"
																	disabled="true" /> N&atilde;o </strong>
														</td>
													</tr>
																							...
																							<logic:present name="arquivoDecreto" scope="request">
																								<tr bgcolor="#cbe5fe">
																									<td align="center" width="10%" valign="middle"><a
																										...
																										title="Visualizar Arquivo" target="_blank"> <IMG
																											SRC="<bean:message key="caminho.imagens"/>PDF.gif"
																											width="35" height="35" BORDER="0" ALT=""> </a>
																									</td>
							
																									<td width="80%"><bean:write
																											property="descricaoDecreto"
																											name="ConsultarParametrosSistemaActionForm" /></td>
																								</tr>
																							</logic:present>
																							...
																							<logic:present name="arquivoLeiNormaMedicao" scope="request">
																								<tr bgcolor="#cbe5fe">
																									...
																									<td width="80%"><bean:write
																											...
																											property="descricaoLeiIndividualizacao" />
																									</td>
																								</tr>
																							</logic:present>
