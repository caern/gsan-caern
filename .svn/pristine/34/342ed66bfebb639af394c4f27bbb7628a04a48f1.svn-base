...
public class ConsultarImovelActionForm extends ValidatorActionForm {
	...
	private String indicadorClienteCPFCNPJValidado;
	...
	private String observacaoExclusaoImovel;
	private String motivoCorteSupressaoAgua;
	...
	private String hidrometroClassePressao;
	private String hidrometroFatorCorrecao;
    ...
    //dados auxiliar
    private String exibePopupComDadosRaContasRevisao;
	...
	public String getHint2() {
        ...
        if ( imovId != null && !imovId.equals( "" ) ){
        	...
        	this.indicadorClienteCPFCNPJValidado = "2";
        }
	...
	public String getObservacaoExclusaoImovel() {
		return observacaoExclusaoImovel;
	}


	public void setObservacaoExclusaoImovel(String observacaoExclusaoImovel) {
		this.observacaoExclusaoImovel = observacaoExclusaoImovel;
	}


	public String getMotivoCorteSupressaoAgua() {
		return motivoCorteSupressaoAgua;
	}


	public void setMotivoCorteSupressaoAgua(String motivoCorteAgua) {
		this.motivoCorteSupressaoAgua = motivoCorteAgua;
	}	
	...
	public void setMotivoCorteSupressaoEsgoto(String motivoCorteEsgoto) {
		this.motivoCorteSupressaoEsgoto = motivoCorteEsgoto;
	}
	...
	public String getHidrometroClassePressao() {
		return hidrometroClassePressao;
	}


	public void setHidrometroClassePressao(String hidrometroClassePressao) {
		this.hidrometroClassePressao = hidrometroClassePressao;
	}


	public String getHidrometroFatorCorrecao() {
		return hidrometroFatorCorrecao;
	}


	public void setHidrometroFatorCorrecao(String hidrometroFatorCorrecao) {
	...
	public String getIndicadorClienteCPFCNPJValidado() {
		return indicadorClienteCPFCNPJValidado;
	}


	public void setIndicadorClienteCPFCNPJValidado(String indicadorClienteCPFCNPJValidado) {
		this.indicadorClienteCPFCNPJValidado = indicadorClienteCPFCNPJValidado;
	}


	public String getExibePopupComDadosRaContasRevisao() {
		return exibePopupComDadosRaContasRevisao;
	}


	public void setExibePopupComDadosRaContasRevisao(
			String exibePopupComDadosRaContasRevisao) {
		this.exibePopupComDadosRaContasRevisao = exibePopupComDadosRaContasRevisao;
	}
