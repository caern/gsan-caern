...
public class ExibirInserirLigacaoAguaSituacaoAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		inserirLigacaoAguaSituacaoActionForm.setIndicadorPermissaoCorteEsgoto("" + ConstantesSistema.INDICADOR_USO_DESATIVO);
		...
		if ((httpServletRequest.getParameter("desfazer") != null && httpServletRequest
			...
			inserirLigacaoAguaSituacaoActionForm.setIndicadorPermissaoCorteEsgoto("");
