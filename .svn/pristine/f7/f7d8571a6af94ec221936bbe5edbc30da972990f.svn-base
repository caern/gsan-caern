...
public class ContaContabil implements Serializable {
	...
	public static int RECEITA_AGUA_INTRA = 26;
	public static int RECEITA_ESGOTO_INTRA = 30;
	public static int RECEITA_CREDITO_INTRA = 35;
	public static int RECEITA_IMPOSTOS_INTRA = 36;
	public static int OUTRAS_RECEITAS_INTRA = 37;
	public static int PAGAMENTO_NAO_CLASSIFICADO_INTRA = 38;
	public static int HISTORICO_PAG_NAO_CLASSIFICADO_INTRA = 39;
	public static int DEVOLUCAO_AVISO_BANCARIO_INTRA = 40;
	public static int PAG_HISTORICO_SEM_CORRESPONDENTE_INTRA = 41;
