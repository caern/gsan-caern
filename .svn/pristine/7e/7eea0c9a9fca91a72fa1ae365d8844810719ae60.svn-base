...
public interface ControladorRegistroAtendimentoLocal extends
	 ...
	 * 
	 */
	public RegistroAtendimento pesquisarRegistroAtendimentoPorRA(Integer id) throws ControladorException;
	 ...
	 * 
	 */
	public Object[] pesquisarDadosRASolicitante(Integer idRegistroAtendimento) throws ControladorException;
	...
	public Collection<ArquivoProcedimentoOperacionalPadrao> pesquisarArquivoProcedimentoOperacionalPadrao(
			FiltrarArquivoProcedimentoOperacionalPadraoHelper helper) throws ControladorException;;
