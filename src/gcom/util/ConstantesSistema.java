...
public interface ConstantesSistema {
	...
	//TIPO_PAGAMENTO - DOCUMENTO COBRAN�A CLIENTE RESPONSAVEL CAER
	...
	String TIPO_PAGAMENTO_AVISO_DEBITO_LEGADO_CAEMA = "AVISO DE D�BITO";
	...
	String DESCRICAO_MOVIMENTO_EXCLUSAO = "EXCLUS�O";

	Integer CODIGO_MOVIMENTO_INCLUSAO = 2;
	String DESCRICAO_MOVIMENTO_INCLUSAO = "INCLUS�O";

	Integer CODIGO_MOVIMENTO_DEBITO_NORMAL = 0;
	String DESCRICAO_MOVIMENTO_DEBITO_NORMAL = "D�BITO NORMAL";
	...
	/**
	 * Vari�veis para definir tamanho m�ximo das tabelas que precisam do scroll
	 * 
	...
	/**
	 * Informa os dados para gera��o de relat�rio ou consulta
	 * 
	 * [UC0304] Informar Dados para Gera��o de Relat�rio ou Consulta
	 * 
	 * Vari�veis para definir op��es de totaliza��o
	 * 
	...
	String ESTADO_GERENCIA_REGIONAL = "ESTADO POR GER�NCIA REGIONAL";

	int CODIGO_ESTADO_ELO_POLO = 4;
	String ESTADO_ELO_POLO = "ESTADO POR ELO P�LO";
	...
	String GERENCIA_REGIONAL_ELO_POLO = "GER�NCIA REGIONAL POR ELO P�LO";

	int CODIGO_GERENCIA_REGIONAL_LOCALIDADE = 9;
	String GERENCIA_REGIONAL_LOCALIDADE = "GER�NCIA REGIONAL POR LOCALIDADE";

	int CODIGO_ELO_POLO = 10;
	String ELO_POLO = "ELO P�LO";

	int CODIGO_ELO_POLO_LOCALIDADE = 11;
	String ELO_POLO_LOCALIDADE = "ELO P�LO POR LOCALIDADE";

	int CODIGO_ELO_POLO_SETOR_COMERCIAL = 12;
	String ELO_POLO_SETOR_COMERCIAL = "ELO P�LO POR SETOR COMERCIAL";
	...
	String ESTADO_UNIDADE_NEGOCIO = "ESTADO POR UNIDADE DE NEG�CIO";
	
	int CODIGO_GERENCIA_REGIONAL_UNIDADE_NEGOCIO = 23;
	String GERENCIA_REGIONAL_UNIDADE_NEGOCIO = "GER�NCIA REGIONAL POR UNIDADE DE NEG�CIO";
	...
	/**
	 * Comandos para a diferen�a dos relatorios de [UC0164] Filtrar Imovel
	 * Outros Criterios
	 * 
	 */
	...
	// Constante para o caso de uso [UC0440] Consultar Programa��o de
	// Abastecimento e Manuten��o
	...
	// Constante para o caso de uso [UC0455] Exibir Calend�rio para Elabora��o
	 ...
	 * Permite tamb�m gera��o do relat�rio dos pagamentos de um intervalo de
	 * localidades
	 * 
	...
	/**
	 * Permite a consulta de devolu��es e/ou devolu��es hist�rico de um im�vel
	 * ou de um cliente ou de um aviso banc�rio ou de um movimento arrecadador.
	 * Permite tamb�m gera��o do relat�rio dos pagamentos de um intervalo de
	 * localidades
	 * 
	...
	/**
	 * Permite que o usu�rio seleciona qual a origem dos servi�os das OS da
	 * pesquisa, podendo ser Solicitados ou Seletivos
	 * 
	 * [UC0492] - Gerar Relat�rio Acompanhamento Execu��o da OS
	 * 
	 * Vari�veis para definir a origem dos Servi�os
	 * 
	...
	//[UC0494] Gerar Numera��o de RA Manual Autor: Raphael Rossiter
	Integer LIMITE_QUANTIDADE_GERACAO_MANUAL = 90;
	
	//[UC0302] Gerar D�bitos a Cobrar de Acr�scimos por Impontualidade Autor: Pedro Alexandre
	Short ENCERRAMENTO_ARRECADACAO = new Short("3");
	
//	 Iniciando cria��o de constantes para [UC00538] Filtrar RAs na Agencia Reguladora  
	...
	// Finalizando cria��o de constantes para [UC00538] Filtrar RAs na Agencia Reguladora  
	// Author: Kassia Albuquerque Data:02/05/2007
    ...
    String CODIGO_AGENTE_JA_CADASTRADO = "C�DIGO DO AGENTE J� CADASTRADO";
...
//  Constantes usadas no caso de uso [UC0658] Filtrar Negativador
    ...
    String CODIGO_AGENTE_NAO_CADASTRADO = "C�DIGO DO AGENTE N�O CADASTRADO";
    //fim se constantes para caso de uso [UC0656] Inserir Negativador
    
    //Constantes usadas no caso de uso [UC0655] Filtrar Comando de Negativa��o
    //Author: Thiago Vieira
    //Date: 27/12/2007
    ...
    //fim de constantes para caso de uso [UC0655] Filtrar Comando de Negativa��o
    ...
    String CODIGO_MOTIVO_JA_CADASTRADO = "C�DIGO DO MOTIVO J� CADASTRADO";
    String CODIGO_MOTIVO_INEXISTENTE = "C�DIGO DO MOTIVO INEXISTENTE";
    //fim de Constantes usadas no caso de uso [UC0662] Inserir motivo de Retorno do Registro do Negativador
    
    // Constantes utilizadas no caso de uso [UC0654] Consultar Comandos de Negativa��o Por Crit�rio
    // Author: Thiago Vieira
    // Date: 09/01/2007
    ...
    // Constantes utilizadas no caso de uso [UC0691] Consultar Comandos de Negativa��o
    // Author: Thiago Vieira
    // Date: 09/01/2007
    String CODIGO_SETOR_COMERCIAL_INEXISTENTE = "C�DIGO DO SETOR COMERCIAL INEXISTENTE";
    // Fim de Constantes utilizadas no caso de uso [UC0691] Consultar Comandos de Negativa��o
    ...
    //Constantes usadas no caso de uso [UC0677] Informar Dados para Consulta da Negativa��o
    //Author: Thiago Vieira
    //Date: 28/01/2008
    String CODIGO_ELO_POLO_INEXISTENTE = "C�DIGO DO ELO P�LO INEXISTENTE";
    String CODIGO_QUADRA_INEXISTENTE = "C�DIGO DA QUADRA INEXISTENTE";
    ...
    //Constantes utilizadas no caso de uso [UC0675] Excluir Negativa��o OnLine
    //Author: Yara Taciane
    //Date: 05/03/2008
    ...
    //Constantes utilizadas no caso de uso [UC0726] Gerar Relat�rio das Contas Baixadas Contabilmente
    //Author: Vivianne Sousa
    //Date: 07/04/2008
