	...
	<td width="625" valign="top" class="centercoltext">
      ...
      <tr>
        ...
        <td colspan="2">
			...
			<html:radio property="simular" value="2" tabindex="2" onclick="redirecionarSubmit('atualizarComandoNegativacaPorCriterioWizardAction.do?action=exibirAtualizarComandoNegativacaoDadosGeraisAction&determinarData=ok');"/>Não</strong>
		</td>
      </tr>
      ...
      <logic:present name="habilitarExecutarSimulacao">
        ...
        <td colspan="2">
			...
			<html:radio property="executarSimulacao" value="2" tabindex="2" onclick="javascript:desabilitarBotaoPesquisar();"/>Não</strong>
		</td>
      </tr>  
      <tr>
      	<td HEIGHT="30" width="35%"><strong>Indicador de Imóvel Categoria Público:</strong></td>
        <td colspan="2">
			<html:radio property="indicadorOrgaoPublico" value="1" disabled="true" /><strong>Sim
			<html:radio property="indicadorOrgaoPublico" value="2" disabled="true" />Não</strong>
		</td>
      </tr>
      <tr>
        ...
        <td colspan="2">
	        <c:choose>
	        	<c:when test="${sessionScope.alterarSoCPFCNPJValidos}">
					...
					<html:radio property="indicadorCpfCnpjValido" value="2" tabindex="2" />Não</strong>
	        	</c:when>
	        	<c:otherwise>
	        		<html:radio property="indicadorCpfCnpjValido" value="1" tabindex="1" disabled="true"/><strong>Sim
					<html:radio property="indicadorCpfCnpjValido" value="2" tabindex="2" disabled="true"/>Não</strong>
	        	</c:otherwise>
	        </c:choose>
		</td>
      </tr>
