									...
									<table width="100%" border="0" align="center">
										...
										<tr>
											...
											<td><span class="style2"> <html:text
												...
												onkeypress="validaEnterComMensagem(event, 'exibirEfetuarReligacaoAguaComInstalacaoHidrometroAction.do', 'idOrdemServico','Ordem de Serviço');return isCampoNumerico(event);"
													...
													<table border="0" width="100%">
														<tr>
															...
															<td width="58%"><html:text property="numeroHidrometro"
																...
																onkeypress="validaEnterString(event, 'exibirEfetuarReligacaoAguaComInstalacaoHidrometroAction.do?objetoConsulta=1', 'numeroHidrometro','Número do Hidrômetro'); return validarCaracteresEspeciais(event); "
	                                                            														 
															 />
															<a
																href="javascript:abrirPopup('exibirPesquisarHidrometroAction.do',600,640);"><img
																src="/gsan/imagens/pesquisa.gif" alt="Pesquisar" title="Pesquisar Hidrômetro"
