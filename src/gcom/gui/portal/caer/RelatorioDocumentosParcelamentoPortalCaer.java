 ...
 * @since 11/07/2011
 */
public class RelatorioDocumentosParcelamentoPortalCaer extends TarefaRelatorio {

	private static final long serialVersionUID = 1L;

	public RelatorioDocumentosParcelamentoPortalCaer(Usuario usuario) {
	...
	public Object executar() throws TarefaException {
		...
		List<RelatorioDocumentosParcelamentoPortalCaerBean> relatorioParcelamentosBeans = new ArrayList<RelatorioDocumentosParcelamentoPortalCaerBean>();

		Fachada fachada = Fachada.getInstancia();

		RelatorioDocumentosParcelamentoPortalCaerBean relatorioParcelamentoBean = null;
		...
		if (parcelamentoRelatorioHelper != null) {
			...
			relatorioParcelamentoBean = new RelatorioDocumentosParcelamentoPortalCaerBean(
	...
	private RelatorioDocumentosParcelamentoPortalCaerBean inicializarBeanRelatorio(Collection<GuiaPagamentoRelatorioHelper> dadosRelatorio,
			RelatorioDocumentosParcelamentoPortalCaerBean relatorio) {
