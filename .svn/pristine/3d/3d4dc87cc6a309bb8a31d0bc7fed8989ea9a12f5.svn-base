 ...
 * @date 23/04/2010
 */
public class RelatorioExtratoDebitoClienteServicosDetailBean implements RelatorioBean {
	...
	private String valorAcrescimoImpontualidade;
	
	public RelatorioExtratoDebitoClienteServicosDetailBean(String descricaoServico, 
			String referenciaServico, String parcelasServico, String valorServico,String vencimentoServico, String valorAcrescimoImpontualidade) {
		super();
	...
	public String getValorAcrescimoImpontualidade() {
		return valorAcrescimoImpontualidade;
	}
	public void setValorAcrescimoImpontualidade(String valorAcrescimoImpontualidade) {
		this.valorAcrescimoImpontualidade = valorAcrescimoImpontualidade;
	}
