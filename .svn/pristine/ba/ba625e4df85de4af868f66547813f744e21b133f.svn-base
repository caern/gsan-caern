...
public class Imovel extends ObjetoTransacao {
	...
	public static final int OPERACAO_CONSULTAR_DADOS_DA_OS_DE_VISITA = 1863;
	public static final int ATRIBUTOS_ALTERAR_INSCRICAO = 1882;
	public static final int ASSOCIAR_TARIFA_CONSUMO_IMOVEIS = 716;
	public static final int REATIVAR_IMOVEL_EXCLUIDO = 2130; 
	 ...
	 * persistent field
	 */
	@ControleAlteracao(funcionalidade={ATRIBUTOS_IMOVEL_INSERIR,ATRIBUTOS_IMOVEL_ATUALIZAR,ATRIBUTOS_IMOVEL_REMOVER, ATRIBUTOS_ALTERAR_INSCRICAO})
	private short lote;
...
//			funcionalidade={ATRIBUTOS_IMOVEL_ATUALIZAR,ATRIBUTOS_IMOVEL_REMOVER})
	...
	@ControleAlteracao(value=FiltroImovel.LIGACAO_ESGOTO_SITUACAO,
			funcionalidade={ATRIBUTOS_IMOVEL_INSERIR, LigacaoEsgoto.ATRIBUTOS_EFETUAR_LIGACAO_ESGOTO, 
				...
				REATIVAR_IMOVEL_EXCLUIDO})	
	private LigacaoEsgotoSituacao ligacaoEsgotoSituacao;
	
	@ControleAlteracao(value=FiltroImovel.LIGACAO_ESGOTO_SITUACAO,
			funcionalidade={REATIVAR_IMOVEL_EXCLUIDO})	
	private LigacaoEsgotoSituacao ligacaoEsgotoSituacaoAnterior;
	...
	@ControleAlteracao(value=FiltroImovel.IMOVEL_PERFIL,
			funcionalidade={OPERACAO_ATUALIZAR_DADOS_IMOVEL_ATUALIZACAO_CADASTRAL,ATRIBUTOS_IMOVEL_ATUALIZAR, REATIVAR_IMOVEL_EXCLUIDO})
	private gcom.cadastro.imovel.ImovelPerfil imovelPerfil;
	
	
	//@ControleAlteracao(funcionalidade={REATIVAR_IMOVEL_EXCLUIDO})	
	private gcom.cadastro.imovel.ImovelPerfil imovelPerfilAnterior;
	...
	@ControleAlteracao(value=FiltroImovel.LOCALIDADE,
			funcionalidade={ATRIBUTOS_IMOVEL_INSERIR,ATRIBUTOS_IMOVEL_ATUALIZAR,ATRIBUTOS_IMOVEL_REMOVER, ATRIBUTOS_ALTERAR_INSCRICAO})
	...
	@ControleAlteracao(value=FiltroImovel.LIGACAO_AGUA_SITUACAO,
			funcionalidade={REATIVAR_IMOVEL_EXCLUIDO})
	private LigacaoAguaSituacao ligacaoAguaSituacaoAnterior;
...
//	@ControleAlteracao(FiltroImovel.CLIENTES_IMOVEIS)
	...
	public gcom.cadastro.imovel.ImovelPerfil getImovelPerfilAnterior() {
		return imovelPerfilAnterior;
	}

	public void setImovelPerfilAnterior(gcom.cadastro.imovel.ImovelPerfil imovelPerfilAnterior) {
	...
	public LigacaoAguaSituacao getLigacaoAguaSituacaoAnterior() {
		return ligacaoAguaSituacaoAnterior;
	}

	public void setLigacaoAguaSituacaoAnterior(LigacaoAguaSituacao ligacaoAguaSituacaoAnterior) {
		this.ligacaoAguaSituacaoAnterior = ligacaoAguaSituacaoAnterior;
	}

	public LigacaoEsgotoSituacao getLigacaoEsgotoSituacaoAnterior() {
		return ligacaoEsgotoSituacaoAnterior;
	}

	public void setLigacaoEsgotoSituacaoAnterior(LigacaoEsgotoSituacao ligacaoEsgotoSituacaoAnterior) {
		this.ligacaoEsgotoSituacaoAnterior = ligacaoEsgotoSituacaoAnterior;
	}
...
//				.adicionarCaminhoParaCarregamentoEntidade("tarifaSocialDado");
		...
		filtroImovel
		.adicionarCaminhoParaCarregamentoEntidade("ligacaoEsgotoSituacaoAnterior");
		filtroImovel
		.adicionarCaminhoParaCarregamentoEntidade("ligacaoAguaSituacaoAnterior");
		filtroImovel
		.adicionarCaminhoParaCarregamentoEntidade("imovelPerfilAnterior");
		filtroImovel
