...
public interface IControladorMicromedicao {
	...
	public void atualizarArquivoTextoEnviadoPorRota(Integer idRota, int situacaoAnterior,
			int situacaoNova, int referencia) throws ControladorException;
	 ...
	 * @throws ControladorException
	 */
	public void atualizarArquivoTextoEnviadoPorRota(Integer idRota, int situacaoNova, int referencia) throws ControladorException;
...
//	caso de uso [UC0543] Associar Conjunto de Rotas a Criterio de Cobranca
	 ...
	 * @throws ControladorException
	 */
	public Integer obterConsumoNaoMedido(Integer idImovel, Integer anoMesReferencia) 
		throws ControladorException;
...
//			Integer anoMesFaturamento)throws ControladorException;
   ...
   /** < <Descrição do método>>
	 ...
	 * @throws ControladorException
	 */
	public Object[] baixarArquivoTextoParaLeituristaImpressaoSimulaneaAndroid(long imei)
		throws ControladorException;
	/**
	...
	public ConsumoAnormalidadeAcao verificaAcaoASerTomada(Integer idConsumoAnormalidade, 
			Integer idCategoria, Integer idPerfilImovel, Short indicadorValidarRetificacao) throws ControladorException;
	 ...
	 * @throws ControladorException
	 */
	public void atualizarListaArquivoTextoDivisao(Vector<Integer> ids, Integer situacaoNova,  Collection colecaoArquivoTextoRoteiroEmpresaDivisao) 
		throws ControladorException;
   ...
   public boolean releituraJaRealizada( String matricula )
	 ...
	 * @throws ErroRepositorioException
	 */
	public Integer obterConsumoMedioEmConsumoHistoricoUltimoMes(Integer idImovel,
			Integer idLigacaoTipo) throws ControladorException;
	...
	/**
	 * [UC0101] - Consistir Leitura e Calcular Consumo
	 * 
	 * @author Sávio Luiz
	 * @date 06/10/2011
	 * 
	 */
	public int obterConsumoMinimoLigacaoNaoMedido(SistemaParametro sistemaParametro,Imovel imovel) throws ControladorException;
	
	public Map<Integer, String[]> validarAnormalidades(DadosMovimentacao dado) throws ControladorException;
	
	/**Metodo que insere medição histórico registrando transação
	 ...
	 * @throws ErroRepositorioException
	 */
	public void inserirMedicaoHistorico(MedicaoHistorico medicaoHistorico,
			Usuario usuarioLogado) throws ControladorException;
	 ...
	 * @throws ControladorException
	 */
	public LigacaoAguaSituacao obterDadosSituacaoLigacaoAgua(Imovel imovel)throws ControladorException ;
	
	/**
	 * Proposta: RN2011071073 - 08/11/2011 - Sávio Luiz - RM1073 - CAERN
	 * (Calcular o mínimo quando a leitura atual for menor que a leitura projetada).
	 * 
	 * [UC0101] - Consistir Leituras e Calcular Consumos
	 * [SB0024] - Recuperar Dados da Tabela de Consumo Anormalidade Ação
	 * 
	 * @since 10/11/2011
	 ...
	 * @throws ControladorException
	 */
	public void recuperarDadosConsumoAnormalidadeAcao(
			Imovel imovel, FaturamentoGrupo faturamentoGrupo, MedicaoTipo medicaoTipo,
			ConsumoHistorico consumoHistorico, int[] consumoMedioHidrometro, 
			MedicaoHistorico medicaoHistorico, Collection<?> colecaoCategoria,
			Integer consumoAnormalidadeTipo) throws ControladorException;
	 ...
	 * Data: 01/12/2011
	 */
	public boolean verificarAnormalidadeConsumoConta(Imovel imovel,
			FaturamentoGrupo faturamentoGrupo,
			Collection colecaoCategoriaOUSubcategoria, Integer anoMes,Usuario usuarioLogado) throws ControladorException;
	 ...
	 * @date 23/12/2011
	 */
	public Collection pesquisarNumeroHidrometroTombamento(String tombamento, Short indicadorMacromedidor) 
			throws ControladorException;
	...
	public Collection pesquisarNumeroHidrometroMacroMedidorRelatorio(
			String tombamento) throws ControladorException;
	 ...
	 * @throws ControladorException
	 */
	public Rota buscarRotaPorMatriculaImovel(Integer idImovel)throws ControladorException;
	 ...
	 * @date 17/07/2012
	 */
	public void inserirFotoMovimentoRoteiroEmpresa(int numeroImovel,
			int idLeituraAnormalidade, int anoMesReferencia, int tipoFoto,int tipoMedicao, byte[] bytesFoto) throws ControladorException;
	 ...
	 * @throws ControladorException
	 */
	public Integer pesquisarConsumoMedioImovelLigacao(Integer idImovel,Integer idLigacao)	throws ControladorException;
	
	
	/**
	 * 
	 * Obter rota do imovel através do id do imóvel
	 * 
	 ...
	 * @throws ControladorException
	 */
	public Integer pesquisarTipoLeituraMovimentoRoteiroEmpresa(Integer anoMesReferencia, Integer idImovel) throws ControladorException;
	 ...
	 * @throws ControladorException
	 */
	public void verificarComandoNaoRealizadoParaRota(Integer idFaturamentoGrupo) throws ControladorException;
	 ...
	 * @date 12/11/2013
	 */
	public Collection pesquisarRotasPorGrupoFaturamento(Collection colecaoGrupoFaturamento) throws ControladorException;
	 ...
	 * @throws ControladorException
	 */
	public void vincularConsumoImovelMicro(Collection<MovimentoContaPrefaturada> colContaPreFaturada, Imovel imovel) throws ControladorException;
	 ...
	 */
	public Object[] baixarArquivoTextoLiberadoParaLeituristaAtualizacaoCadastral(String imei, String login)
			throws ControladorException;
}