...
public class Processo extends ObjetoGcom {
	...
	public static final int ENCERRAR_OS_ORDEM_VISITA = 269;
	
	public static final int PROCESSAR_ATUAL_ORDENS_SERVICO_ARQ_TXT = 270;
	
	public static final int CANCELAR_GRUPO_FATURAMENTO = 272;
	
	public static final int GERAR_AVISO_CORTE = 273;
	
	public static final int GERAR_RELATORIO_ACOMPANHAMENTO_COMANDOS_COBRANCA = 274;
	
	public static final int RETIRAR_IMOVEIS_CONTAS_EMPRESAS_COBRANCA = 275;
	
	public static final int GERAR_RELATORIO_IMOVEIS_CONTAS_RETIRADOS_EMPRESAS_COBRANCA = 277;
	
	public static final int GERAR_RELATORIO_COBRANCA_ATIVIDADE_MANTER = 278;
	
	public static final int RETIRAR_CONTAS_REVISAO_EXTRATO_ENTRADA_PARCELAMENTO = 292;
	
	public static final int GERAR_RELATORIO_DOCUMENTO_COBRANCA = 299;
	
	public static final int GERAR_ARQUIVO_BANCO_CARTEIRA_17 = 328;
	
	public static final int REGISTRAR_MOVIMENTO_ARRECADADORES = 329;
	
	public static final int GERAR_ROTEIRO_DISPOSITIVO_MOVEL = 306;
	
	public static final int GERAR_RELATORIO_CONTAS = 333;
	
	public static final int GERAR_RELATORIO_ANALITICO_FATURAMENTO = 334;
