 ...
 */
public class ConsultarGatewayComparacaoFoneticaDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements gcom.integracao.webservice.neurotech.gateway.webservices.fachada.ConsultarGatewayComparacaoFoneticaDocument
{
    
    public ConsultarGatewayComparacaoFoneticaDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName CONSULTARGATEWAYCOMPARACAOFONETICA$0 = 
        new javax.xml.namespace.QName("http://fachada.webservices.gateway.neurotech.com.br", "consultarGatewayComparacaoFonetica");
    
    
    /**
     * Gets the "consultarGatewayComparacaoFonetica" element
     */
    public gcom.integracao.webservice.neurotech.gateway.webservices.fachada.ConsultarGatewayComparacaoFoneticaDocument.ConsultarGatewayComparacaoFonetica getConsultarGatewayComparacaoFonetica()
    {
        synchronized (monitor())
        {
            check_orphaned();
            gcom.integracao.webservice.neurotech.gateway.webservices.fachada.ConsultarGatewayComparacaoFoneticaDocument.ConsultarGatewayComparacaoFonetica target = null;
            target = (gcom.integracao.webservice.neurotech.gateway.webservices.fachada.ConsultarGatewayComparacaoFoneticaDocument.ConsultarGatewayComparacaoFonetica)get_store().find_element_user(CONSULTARGATEWAYCOMPARACAOFONETICA$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setConsultarGatewayComparacaoFonetica(gcom.integracao.webservice.neurotech.gateway.webservices.fachada.ConsultarGatewayComparacaoFoneticaDocument.ConsultarGatewayComparacaoFonetica consultarGatewayComparacaoFonetica)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (gcom.integracao.webservice.neurotech.gateway.webservices.fachada.ConsultarGatewayComparacaoFoneticaDocument.ConsultarGatewayComparacaoFonetica)get_store().add_element_user(CONSULTARGATEWAYCOMPARACAOFONETICA$0);
            }
            target.set(consultarGatewayComparacaoFonetica);
        }
    }
     ...
     */
    public gcom.integracao.webservice.neurotech.gateway.webservices.fachada.ConsultarGatewayComparacaoFoneticaDocument.ConsultarGatewayComparacaoFonetica addNewConsultarGatewayComparacaoFonetica()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     * This is a complex type.
     */
    public static class ConsultarGatewayComparacaoFoneticaImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements gcom.integracao.webservice.neurotech.gateway.webservices.fachada.ConsultarGatewayComparacaoFoneticaDocument.ConsultarGatewayComparacaoFonetica
    {
        
        public ConsultarGatewayComparacaoFoneticaImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType);
        }
