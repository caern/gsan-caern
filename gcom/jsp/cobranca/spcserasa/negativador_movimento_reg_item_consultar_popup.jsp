          ...
          <td height="364"> 
            <table width="100%" border="0" dwcopytype="CopyTableRow">
              ...
              <tr>
               ...
               <% Integer totalQtdContas = (Integer)session.getAttribute("totalQtdContas"); %>
               <% BigDecimal totalValorNegativadoConta = (BigDecimal)session.getAttribute("totalValorNegativadoConta"); %>
               <% BigDecimal totalValorConta = (BigDecimal)session.getAttribute("totalValorConta"); %>
              <tr>
                <td colspan="4"><hr></td>
              </tr>
              <tr>
							...
							<logic:iterate name="collNegativadorMovimentoRegItem" id="negativadorMovimentoRegItem">
								...
								<tr bordercolor="#90c7fc">
			                      <td colspan="3" bgcolor="#90c7fc">
			                      	<strong>Total de Contas: <%=totalQtdContas %></strong>		                      
			                      </td>
			                      <td colspan="4" bgcolor="#90c7fc">
			                      	<strong>Total de Valor Conta: <%=Util.formatarMoedaReal(totalValorConta) %> </strong>
			                      </td>		                      
			                      <td colspan="3" bgcolor="#90c7fc">
			                      	<strong>Total de Valor Negativa: <%=Util.formatarMoedaReal(totalValorNegativadoConta) %> </strong>
			                      </td>		                   
			                    </tr>
							</table>
							</div>
              ...
              <!-- ######################################################################################################################### -->
              <% Integer totalQtdGuias = (Integer)session.getAttribute("totalQtdGuias"); %>
               <% BigDecimal totalValorNegativadoGuia = (BigDecimal)session.getAttribute("totalValorNegativadoGuia"); %>
               <% BigDecimal totalValorGuia = (BigDecimal)session.getAttribute("totalValorGuia"); %>
              <tr>
                <td colspan="4"><div align="center">
                  <table width="100%" border="0">
					...
					<tr>
						...
						<logic:present name="collNegativadorMovimentoRegItem2">
							...
							<tr bordercolor="#90c7fc">
		                      ...
		                      <tr bordercolor="#90c7fc">
			                      <td colspan="3" bgcolor="#90c7fc">
			                      	<strong>Total de Guias: <%=totalQtdGuias %></strong>			                      
			                      </td>
			                      <td colspan="4" bgcolor="#90c7fc">
			                      	<strong>Total de Valor Guia: <%=Util.formatarMoedaReal(totalValorGuia)  %> </strong>	
			                      </td>		                      
			                      <td colspan="4" bgcolor="#90c7fc">
			                      	<strong>Total de Valor Negativa: <%=Util.formatarMoedaReal(totalValorNegativadoGuia)  %> </strong>	
			                      </td>		                   
			                    </tr>
		            ...
		            <tr>		                    
	                    <td>
	                    	<strong>Total de Documentos: <%=totalQtdContas+totalQtdGuias %></strong>
	                    </td>
                    </tr>
                    <tr>
	                    <td>
	                    <strong>Total do Valor dos Documentos: <%=Util.formatarMoedaReal(totalValorConta.add(totalValorGuia))  %></strong>
	                    </td>
                    </tr>
                    <tr>
                    	<td>
                    		<strong>Total do Valor dos Documentos Negativados: <%=Util.formatarMoedaReal(totalValorNegativadoConta.add(totalValorNegativadoGuia))%>
                    	</td>
                    </tr>        
					<td align="right">
						  <div align="right">
...
<jsp:include
		page="/jsp/relatorio/escolher_tipo_relatorio.jsp?relatorio=gerarRelatorioNegativadorMovimentoRegItemAction.do" />
