...
public interface ControladorOrdemServicoLocal extends javax.ejb.EJBLocalObject {
	...
	public Collection pesquisarOSGerarRelatorioAcompanhamentoExecucao(
			...
			String idEquipeExecucao, String tipoOrdenacao) //String clienteUsuario,String clienteFonePadrao
			throws ControladorException;
...
//			throws ControladorException;
	 ...
	 * [UC 1232] - Registrar Retorno Arquivo Texto da Visita de Campo
	 * 
	 * Método responsável por finalizar a leitura das ordens de serviços da Fiscalização de Anormalidade.
	 * 
	 * @author Davi Menezes
	 * @date 23/09/2011
	 * 
	...
	public Collection<Object[]> pesquisarDadosComandoOSSeletivaResumido(
			...
			Integer matriculaImovel, Integer idOrdemServico) throws ControladorException;
	/**
	 * [UC1249] – Filtro OS Encerradas por Acompanhamento de Serviço
	 * 
	 * Filtra OSs encerradas por Acompanhamento de Serviço
	 * 
