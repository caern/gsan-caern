...
<script language="JavaScript">
	...
	function validaForm(form) {
		...
		if ( validateInserirConsumoAnormalidadeAcaoActionForm( form ) ){
	...
	function limparForm() {
		var form = document.InserirConsumoAnormalidadeAcaoActionForm;
	...
	function reload() {
		var form = document.InserirConsumoAnormalidadeAcaoActionForm;
		form.action = "/gsan/exibirInserirConsumoAnormalidadeAcaoAction.do";
		form.submit();
	}  
...
<html:form action="/inserirConsumoAnormalidadeAcaoAction"
	name="InserirConsumoAnormalidadeAcaoActionForm"
	type="gcom.gui.micromedicao.InserirConsumoAnormalidadeAcaoActionForm"
	method="post"
	onsubmit="return validateInserirConsumoAnormalidadeAcaoActionForm(this);">
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Inserir Consumo Anormalidade e Ação</td>
			...
			<table width="100%" border="0">
				<tr>
					<td colspan="3">Para adicionar o consumo anormalidade e Ação, informe os dados abaixo:</td>
				</tr>
				...
				<tr>
					...
					<td>	
						<html:text maxlength="4" 
							...
							size="5"
							onkeypress="javascript:validaEnterComMensagem(event, 'exibirInserirConsumoAnormalidadeAcaoAction.do?objetoConsulta=1','idServicoTipoMes1','Tipo de Serviço');return isCampoNumerico(event);"/>
				...
				<tr>
					...
					<td>	
						<html:text maxlength="4" 
							...
							size="5"
							onkeypress="javascript:validaEnterComMensagem(event, 'exibirInserirConsumoAnormalidadeAcaoAction.do?objetoConsulta=2','idServicoTipoMes2','Tipo de Serviço');return isCampoNumerico(event);habilitaSolicitacao();"/>
				...
				<tr>
					...
					<td>	
						<html:text maxlength="4" 
							...
							size="5"
							onkeypress="javascript:validaEnterComMensagem(event, 'exibirInserirConsumoAnormalidadeAcaoAction.do?objetoConsulta=3','idServicoTipoMes3','Tipo de Serviço');return isCampoNumerico(event);habilitaSolicitacao();"/>
		 	...
		 	<table>		
				...
				<tr>
					<td align="left"><input name="Button" type="button"
						...
						onclick="window.location.href='<html:rewrite page="/exibirInserirConsumoAnormalidadeAcaoAction.do?desfazer=S"/>'">
					<input type="button" name="ButtonCancelar" class="bottonRightCol"
						value="Cancelar"
						onClick="javascript:window.location.href='/gsan/telaPrincipal.do'">
					</td>
					<td colspan="2" align="right"><input name="Button" type="button"
						class="bottonRightCol" value="Inserir" onclick="validaForm(document.forms[0]);"></td>
				</tr>
			</table>
			</td>
		</tr>
