...
function removerArquivo(identificacao){	
	...
	function validaTodosRadioButton(){
		...
		if(validaRadioButton(form.indicadorUrgencia,"Indicador de Urgência Obrigatório?") != ""){
			mensagem = mensagem + validaRadioButton(form.indicadorMatriculaImovel,"Indicador de Urgência Obrigatório?")+"\n";
		}
	...
	function validaIndicadorGerarOrdemServico(){
		...
		if (form.indicadorGeraOrdemServico[0].checked && 
			...
			alert("O Tipo de Serviço deve ser informado!");
			return false;
			}
	...
	<table width="615" border="0" cellspacing="5" cellpadding="0">
		<tr>
			...
			<table width="100%" border="0">
		        ...
		        <td>
					<html:text property="idDebitoTipo" size="4" maxlength="4" tabindex="24" onkeypress="validaEnterComMensagem(event, 'exibirAtualizarAdicionarSolicitacaoEspecificacaoAction.do?objetoConsulta=1', 'idDebitoTipo', 'Tipo de Débito');"
		       ...
		       <tr>
				...
				<tr>				
					<td><strong>Documento Obrigatório:</strong></td>
				 ...
				 <tr>
				<td><strong>Indica se Tipo Especificação Será Listada no Popup Consultar Imóvel :<font color="#FF0000">*</font></strong></td>
				...
				<tr>
					<td width="40%"><strong>Observações:</strong></td>
					<td><html:textarea 
						property="observacao" 
						cols="40" 
						rows="7"
				...
				<tr>
					...
					<img width="23" height="21" border="0"
						...
						title="Pesquisar Unidade Inicial de Tramitação" /></a> <logic:present
				...
				<tr>
					...
					<img width="23" height="21" border="0"
						src="<bean:message key="caminho.imagens"/>pesquisa.gif"
						title="Pesquisar Tipo do Serviço OS Obrigatória" /></a> <logic:present
