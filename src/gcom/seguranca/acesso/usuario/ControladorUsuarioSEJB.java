...
//			}
	 ...
	 * [UC1252] - Alterar Usuário Logado no Banco de Dados
	 * 
	 * [FS-0001] - Validar usuário da base para usuário logado
	 * 
	 * @author Thúlio Araújo
	 * @since 22/11/2011
	 * 
	 ...
	 * [FS0001] - Verificar existência do registro
	...
	public boolean verificarExistenciaAcessoLojaVirtual(String ip, String codigoTipoAtendimento, Short indicadorServicoExecutado) throws ControladorException {
		...
		try {
			if(indicadorServicoExecutado.equals(AcessoLojaVirtual.INDICADOR_SERVICO_NAO_EXECUTADO)){
				...
				//No momento que o usuário executa o serviço o sistema atualiza o indicador de serviço 
				//executado ACLJ_ICSERVICOEXECUTADO = 1. O sistema seleciona o registro onde 
				//ACLJ_IPACESSO = ip usado no acesso e ACLJ_NNCODIGOATENDIMENTO = código do 
