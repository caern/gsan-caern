 ...
 * @date 13/05/2011
 */
public class ExibirServicosPortalCaemaAction extends GcomAction {

	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
			HttpServletResponse httpServletResponse) {

		String retorno = "exibirServicosPortalCaemaAction";

		ExibirServicosPortalCaemaActionForm form = (ExibirServicosPortalCaemaActionForm) actionForm;
							...
							if (isValidCpfOrCnpj) {
								...
								for (ClienteImovel clienteImovel : colecaoClienteImovel) {
									...
									if (form.getCpfCnpjSolicitante().equals(clienteImovel.getCliente().getCpf())
										...
										retorno = "servicosPortalCaemaAction";
	...
	private void pesquisarAnosImovel(Integer idImovel, HttpServletRequest httpServletRequest,
			ExibirServicosPortalCaemaActionForm form) {
