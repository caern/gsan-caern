...
/**
 * Classe responsável por ajudar o Gerar Resumo da Pendencia Por Ano
 *
 * @author Fernando Fontelles Filho
 * @date 26/03/2010
 * 
 */
public class ResumoPendenciaDebitosACobrarGerencialPorAnoHelper {	
	 ...
	 */
	public ResumoPendenciaDebitosACobrarGerencialPorAnoHelper(
			...
			BigDecimal valorPendenteDebito//13
			) {			
		this.idGerenciaRegional = idGerenciaRegional;
		this.idUnidadeNegocio = idUnidadeNegocio;
		this.idElo = idElo;
    ...
    */
	public boolean equals( Object obj ){
		...
		if ( !( obj instanceof ResumoPendenciaDebitosACobrarGerencialPorAnoHelper ) ){
			return false;			
		} else {
			ResumoPendenciaDebitosACobrarGerencialPorAnoHelper resumoTemp = 
				( ResumoPendenciaDebitosACobrarGerencialPorAnoHelper ) obj;
