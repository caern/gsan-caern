 ...
 * @date 08/07/2011
 */
public class RelatorioDocumentosParcelamentoPortalCaerBean implements RelatorioBean {
	 ...
	 */
	public RelatorioDocumentosParcelamentoPortalCaerBean(String matriculaImovel,
			String nomeCliente,
			String endereco, 
			String cpfCnpj,
			String telefone, 
