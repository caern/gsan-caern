    ...
    public void atualizarUnidadeOrganizacional(UnidadeOrganizacional unidadeOrganizacional)
		...
		try {
			update = " update gcom.cadastro.unidade.UnidadeOrganizacional"
				   ...
				   + " unid_iccentralatendimento = :indicadorCentralAtendimento ";
			...
			.setDate("datahoracorrente", new Date()).setInteger("id", unidadeOrganizacional.getId())
			.setInteger("indicadorCentralAtendimento", unidadeOrganizacional.getIndicadorCentralAtendimento())
			.executeUpdate();
