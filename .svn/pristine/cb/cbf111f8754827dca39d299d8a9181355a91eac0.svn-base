...
<head>
	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
			...
			//se o botão esc for pressionado
			$(window).keydown(function(g){if(g.keyCode==27){$('#mask, .window').hide(); janelaAberta = false;}});
	...
	<script language="JavaScript">
		...
		function consultarImovelAjax(){
			...
			if(form.idImovelDadosComplementares != null && form.idImovelDadosComplementares.value != ""){
				$.ajax({
						   type: "POST",
						   url: "consultarImovelAjaxAction.do?idImovel="+form.idImovelDadosComplementares.value,
						   data: "",
								...
								<tr bgcolor="#cbe5fe">
									...
									<td width="10%">
										...
										<font color="#000000" style="font-size:9px" face="Verdana, Arial, Helvetica, sans-serif"> 											
											...
											<logic:notEmpty name="imovelCobrancaSituacaoHelper" property="contasEnviadasCobrancaHelper" >
												<a href="#dialog" name="modal"><bean:write name="imovelCobrancaSituacaoHelper" property="dataImplantacaoCobranca" formatKey="date.format"/></a>
												<div id="boxes">												
												<div id="dialog" class="window">
												<a href="#" class="close"><b>Fechar [X]</b></a>
												<br />												  
													<table width="100%" align="center" bgcolor="#90c7fc" border="0">
													<tr bordercolor="#79bbfd">
														...
														<logic:iterate id="helperContasEnviadas" name="imovelCobrancaSituacaoHelper" property="contasEnviadasCobrancaHelper">
															...
															<tr bgcolor="#cbe5fe">
																<%}%>
																<td>
																	<bean:write name="helperContasEnviadas" property="mesAno" />
																</td>
																<td>
																	<bean:write name="helperContasEnviadas" property="valorConta" />
																</td>
																<td>
																	<bean:write name="helperContasEnviadas" property="situacao" />
																</td>
															</tr>
														</logic:iterate>
									...
									<td width="10%">
										...
										<logic:notEmpty name="imovelCobrancaSituacaoHelper" property="contasPagasCobrancaHelper">										
											<a href="#dialog1" name="modal"><bean:write name="imovelCobrancaSituacaoHelper" property="dataRetiradaCobranca" formatKey="date.format"/></a>	
											<div id="boxes">												
													...
													<tr bordercolor="#79bbfd">
														...
														<logic:iterate id="helperContasPagas" name="imovelCobrancaSituacaoHelper" property="contasPagasCobrancaHelper">
															...
															<tr bgcolor="#cbe5fe">
																<%}%>
																<td>
																	<bean:write name="helperContasPagas" property="mesAno" />
																</td>
																<td>
																	<bean:write name="helperContasPagas" property="valorConta" />
																</td>
																<td>
																	<bean:write name="helperContasPagas" property="situacao" />
																</td>
															</tr>
														</logic:iterate>
					...
					<tr>
						...
						<table bgcolor="#90c7fc" width="100%" border="0">
							...
							<tr bgcolor="#90c7fc">
								...
								<div class="style9"><font style="font-size: 9px;" color="#000000"
									face="Verdana, Arial, Helvetica, sans-serif"> <strong>M&ecirc;s Seguinte
									</strong> </font></div>
								</td>
	
								<td acolspan="1" align="center" bgcolor="#90c7fc">
								<div class="style9"><font style="font-size: 9px;" color="#000000"
									face="Verdana, Arial, Helvetica, sans-serif"> <strong>Data
