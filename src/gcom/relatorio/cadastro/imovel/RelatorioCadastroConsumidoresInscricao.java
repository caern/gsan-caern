	...
	public Object executar() throws TarefaException {
		...
		Collection imoveisRelatoriosHelper = fachada
				.gerarRelatorioCadastroConsumidoresInscricao(imovelCondominioID,
						...
						sequencialRotaInicial, sequencialRotaFinal, ordenacao, pocoTipoListIds, indicadorCpfCnpjInformado);
		...
		if (imoveisRelatoriosHelper != null
			...
			while (imovelRelatorioIterator.hasNext()) {
				...
				//Armazena o valor do documento (CPF ou CNPJ) do usuario cliente
				
				String cpfOuCnpjClienteUsuario = "";
				
				if ((imovelRelatorioHelper.getCpfClienteUsuario() != null) && 
						(!imovelRelatorioHelper.getCpfClienteUsuario().equals(""))){
					cpfOuCnpjClienteUsuario = imovelRelatorioHelper.getCpfClienteUsuario();
					cpfOuCnpjClienteUsuario = Util.formatarCpf(cpfOuCnpjClienteUsuario);
				} else 
					if ((imovelRelatorioHelper.getCnpjClienteUsuario() != null) && 
							(!imovelRelatorioHelper.getCnpjClienteUsuario().equals(""))){
						cpfOuCnpjClienteUsuario = imovelRelatorioHelper.getCnpjClienteUsuario();
						cpfOuCnpjClienteUsuario = Util.formatarCnpj(cpfOuCnpjClienteUsuario);
					} else {
				...
				relatorioBean = new RelatorioCadastroConsumidoresInscricaoBean(
						...
						//CPF Ou CNPJ cliente usuario		
						cpfOuCnpjClienteUsuario,
						
						//Tipo de Habitacao		
						imovelRelatorioHelper.getTipoHabitacao() == null ? ""
								: imovelRelatorioHelper.getTipoHabitacao().toString()
	...
	public int calcularTotalRegistrosRelatorio() {
		...
		retorno = Fachada
				...
				.gerarRelatorioCadastroConsumidoresInscricaoCount(imovelCondominioID,
						...
						numeroMoradoresFinal, areaConstruidaFaixa,
						idUnidadeNegoio, cdRotaInicial, cdRotaFinal,
						sequencialRotaInicial, sequencialRotaFinal, pocoTipoListIds, indicadorCpfCnpjInformado);
