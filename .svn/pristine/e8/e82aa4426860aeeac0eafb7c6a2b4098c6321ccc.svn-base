...
if (form.mesAno.value != "" && validaMesAno(form)){
	var opcao = '';
	...
	<table width="770" border="0" cellpadding="0" cellspacing="5">
		<tr>
			...
			<table width="100%" border="0">
				<tr>
					<td colspan="3">Para gerar o relatório resumo da arrecadação, informe os dados abaixo:</td>
				</tr>
				<tr>
					<td width="26%"><strong>Mês/Ano da Arrecadação:<font
				...
				<tr>
					...
					<td align="left">
						<html:text property="codigoLocalidade" size="4" maxlength="3"
							onkeypress="validaEnter(event, 'exibirGerarRelatorioResumoArrecadacaoAction.do?pesquisarLocalidade=OK', 'codigoLocalidade');" />
				...
				<tr>
					...
					<td align="left">
						<html:text property="codigoMunicipio" size="4" maxlength="4" 
							onkeypress="validaEnter(event, 'exibirGerarRelatorioResumoArrecadacaoAction.do?pesquisarMunicipio=OK', 'codigoMunicipio');" />
