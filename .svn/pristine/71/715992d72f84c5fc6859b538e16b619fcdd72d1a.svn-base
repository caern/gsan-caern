...
public class ExibirManterImovelAction extends GcomAction {
    ...
    public ActionForward execute(ActionMapping actionMapping,
        ...
        //FiltroClienteImovel filtroClienteImovel = (FiltroClienteImovel) sessao
        ...
        if (imoveis != null && !imoveis.isEmpty()) {
            ...
            while (iteratorImoveis.hasNext()) {
            	clienteImovel = (ClienteImovel) iteratorImoveis
                        .next();
                //if (!imoveisSemDuplicar.contains(clienteImovel)) {
            	...
            	if(imoveisLista.size() == 1){
            	  if (httpServletRequest.getAttribute("atualizar") != null) {
					retorno = actionMapping
							.findForward("atualizarImovel");
					ClienteImovel imovelUnico = (ClienteImovel) imoveisLista
							.iterator().next();
					
					httpServletRequest
	                .setAttribute("idRegistroAtualizacao",imovelUnico.getImovel().getId().toString());
					httpServletRequest
