...
public class UC0745GerarArquivoTextoFaturamento {
    ...
    public static UC0745GerarArquivoTextoFaturamento getInstancia(IRepositorioFaturamento repositorioFaturamento,
            SessionContext sessionContext, IRepositorioCobranca repositorioCobranca) {

        if (instancia == null) {
            instancia = new UC0745GerarArquivoTextoFaturamento(repositorioFaturamento,
                                                               sessionContext,
                                                               repositorioCobranca);
        }
        return instancia;
     ...
     * @throws ControladorException
     */
    public Object[] gerarArquivoTexto(Imovel imovel, Conta conta, Integer anoMesReferencia, Rota rota,
        ...
        // REGISTRO_TIPO_01
        arquivoTexto.append(this.gerarArquivoTextoRegistroTipo01(imovel, conta, anoMesReferencia, rota, faturamentoGrupo, sistemaParametro, cobrancaDocumento));
        quantidadeLinhas = quantidadeLinhas + 1;

        // REGISTRO_TIPO_02
        Object[] tipo2 = this.gerarArquivoTextoRegistroTipo02(imovel, conta, sistemaParametro);
        arquivoTexto.append(tipo2[0]);
        int quantidadeTipo2 = (Integer) tipo2[1];
        quantidadeLinhas = quantidadeLinhas + quantidadeTipo2;

        // REGISTRO_TIPO_03
        Object[] tipo3 = this.gerarArquivoTextoRegistroTipo03(imovel, anoMesReferencia);
        ...
        // REGISTRO_TIPO_07
        Object[] tipo7 = this.gerarArquivoTextoRegistroTipo07(imovel, sistemaParametro, cobrancaDocumento);
        arquivoTexto.append(tipo7[0]);
        int quantidadeTipo7 = (Integer) tipo7[1];
        quantidadeLinhas = quantidadeLinhas + quantidadeTipo7;

        // REGISTRO_TIPO_08
        Object[] tipo8 = this.gerarArquivoTextoRegistroTipo08(imovel, anoMesReferencia, sistemaParametro);
        ...
        Object[] registroTipo9e10 = gerarArquivoTextoRegistroDadosTarifa09(imovel, sistemaParametro, anoMesReferencia, faturamentoGrupo, conta);
    ...
    public StringBuilder gerarArquivoTextoRegistroTipo01(Imovel imovel, Conta conta, Integer anoMesReferencia, Rota rota,
        ...
        // MATRÍCULA DO IMÓVEL
        arquivoTextoRegistroTipo01.append(Util.adicionarZerosEsquedaNumero(9, imovel.getId()
                                                                                    .toString()));
        ...
        if (imovel.getNomeImovel() != null) {
            arquivoTextoRegistroTipo01.append(Util.completaString(imovel.getNomeImovel(), 30));
        } else {
            /*
            ...
            arquivoTextoRegistroTipo01.append(Util.completaString(nomeCliente, 30));
        }
        ...
        if (clienteResponsavel != null) {
            ...
            arquivoTextoRegistroTipo01.append(Util.adicionarZerosEsquedaNumero(9, clienteResponsavel.getId()
                                                                                                    .toString()));
        ...
        if (imovel.getImovelCondominio() != null) {
            ...
            arquivoTextoRegistroTipo01.append(Util.adicionarZerosEsquedaNumero(9, imovel.getImovelCondominio()
                                                                                        .getId()
                                                                                        .toString()));
        } else {
        ...
        // IMOVEL_PERFIL
        arquivoTextoRegistroTipo01.append(idImovelPerfil);
        ...
        if (imovel.getLigacaoAgua() != null && imovel.getLigacaoAgua()
                ...
                && !imovel.getLigacaoAgua()
                          ...
                          .equals("")) {
            arquivoTextoRegistroTipo01.append(Util.adicionarZerosEsquedaNumero(6, imovel.getLigacaoAgua()
                                                                                        .getNumeroConsumoMinimoAgua()
                                                                                        .toString()));
        } else {
        ...
        if (imovel.getLigacaoEsgoto() != null && imovel.getLigacaoEsgoto()
            ...
            arquivoTextoRegistroTipo01.append(Util.adicionarZerosEsquedaNumero(6, Util.formatarBigDecimalComPonto(imovel.getLigacaoEsgoto()
        ...
        if (conta != null) {
            arquivoTextoRegistroTipo01.append(Util.adicionarZerosEsquedaNumero(6, Util.formatarBigDecimalComPonto(conta.getPercentualEsgoto())));
        } else {
            arquivoTextoRegistroTipo01.append(Util.adicionarZerosEsquedaNumero(6, "0"));
        }
        ...
        if (imovel.getPocoTipo() != null) {
            arquivoTextoRegistroTipo01.append(imovel.getPocoTipo()
                                                    .getId()
                                                    .toString());
        } else {
        ...
        // CONSUMO_TARIFA
        arquivoTextoRegistroTipo01.append(Util.adicionarZerosEsquedaNumero(2, imovel.getConsumoTarifa()
                                                                                    .getId()
                                                                                    .toString()));
        ...
        // FATURAMENTO_GRUPO
        arquivoTextoRegistroTipo01.append(Util.adicionarZerosEsquedaNumero(3, faturamentoGrupo.getId()
                                                                                              .toString()));

        // CODIGO_ROTA
        arquivoTextoRegistroTipo01.append(Util.adicionarZerosEsquedaNumero(7, rota.getCodigo()
                                                                                  .toString()));

        // CÓDIGO DA CONTA
        if (conta != null) {

            arquivoTextoRegistroTipo01.append(Util.adicionarZerosEsquedaNumero(9, conta.getId()
                                                                                       .toString()));
        } else {
        ...
        if (sistemaParametro.getNomeEmpresa() != null && sistemaParametro.getNomeEmpresa()
        ...
        arquivoTextoRegistroTipo01 = arquivoTextoRegistroTipo01.append(gerarArquivoTextoQualidadeAgua(idLocalidade, idSetorComercial, anoMesReferenciaQualidadeAgua));

        // consumo mínimo do imóvel
        ...
        if (imovel.getLigacaoAguaSituacao() != null && !imovel.getLigacaoAguaSituacao()
                                                              .equals("")) {
            arquivoTextoRegistroTipo01.append(Util.completaString(imovel.getLigacaoAguaSituacao()
                                                                        .getIndicadorAbastecimento() + "", 1));
        } else {
            arquivoTextoRegistroTipo01.append(Util.completaString("", 1));
        }
        ...
        if (imovel.getLigacaoEsgoto() != null && imovel.getLigacaoEsgoto()
            ...
            arquivoTextoRegistroTipo01.append(Util.adicionarZerosEsquedaNumero(6, imovel.getLigacaoEsgoto()
        ...
        arquivoTextoRegistroTipo01.append(Util.adicionarZerosEsquedaNumero(6, String.valueOf(consumoMedioLigacaoEsgoto[0])));
        ...
        if (imovel.getLigacaoAguaSituacao()
            ...
            arquivoTextoRegistroTipo01.append(String.valueOf(imovel.getLigacaoAguaSituacao()
        ...
        if (imovel.getLigacaoAguaSituacao()
            ...
            arquivoTextoRegistroTipo01.append(Util.adicionarZerosEsquedaNumero(2, String.valueOf(imovel.getLigacaoAguaSituacao()
                                                                                                       .getNumeroDiasCorte())));
        } else {
        ...
        if (imovel.getLigacaoAgua() != null && !imovel.getLigacaoAgua()
                                                      .equals("") && imovel.getLigacaoAgua()
                                                                           .getDataCorte() != null) {
            arquivoTextoRegistroTipo01.append(Util.formatarDataAAAAMMDD(imovel.getLigacaoAgua()
                                                                              .getDataCorte()));
        } else {
            arquivoTextoRegistroTipo01.append(Util.completaString("", 8));
        }
        
        int consumoMinimoLigacaoCalculado = getControladorMicromedicao().obterConsumoMinimoLigacaoNaoMedido(sistemaParametro,imovel);

        //CONSUMO_MINIMO_ESGOTO CALCULADO
		arquivoTextoRegistroTipo01.append(Util.adicionarZerosEsquedaNumero(6, String.valueOf(consumoMinimoLigacaoCalculado)));

		
		//RM3071 - Exibir na terceira linha da conta a mensagem de quitação dos débitos
		String indMsgQuitacao = "2";
		...
		FaturamentoGrupo faturamentoGR = (FaturamentoGrupo) Util.retonarObjetoDeColecao(colecaoFatGrupo);
		if (faturamentoGR.getIndicadorMensagemQuitacao().intValue()==1){
			...
			filtroExtratoQuitacao.adicionarParametro(new ParametroSimples(FiltroExtratoQuitacao.ANO_MES_MENSAGEM_CONTA,
					faturamentoGR.getAnoMesReferencia()));
		...
		arquivoTextoRegistroTipo01.append(indMsgQuitacao);
		//Fim RM3071
     ...
     * @throws ControladorException
     */
    public Object[] gerarArquivoTextoRegistroTipo02(Imovel imovel, Conta conta, SistemaParametro sistemaParametro)
                                                                                                                  throws ControladorException {
        ...
        if (icTarifaCategoria == SistemaParametro.INDICADOR_TARIFA_CATEGORIA) {
            ...
            if (colecaoCategoria != null && !colecaoCategoria.isEmpty()) {
                ...
                while (iterator.hasNext()) {
                    ...
                    // MATRÍCULA DO IMÓVEL
                    arquivoTextoRegistroTipo02.append(Util.adicionarZerosEsquedaNumero(9, imovel.getId()
                                                                                                .toString()));
                    ...
                    // DESCRICAO_CATEGORIA
                    arquivoTextoRegistroTipo02.append(Util.completaString(categoria.getDescricao(), 15));

                    // CODIGO_SUBCATEGORIA
                    arquivoTextoRegistroTipo02.append(Util.adicionarZerosEsquedaNumero(3, "0"));
                    ...
                    arquivoTextoRegistroTipo02.append(Util.completaString(categoria.getDescricaoAbreviada(), 3));

                    // DESCRICAO_ABREVIADA_SUBCATEGORIA
                    arquivoTextoRegistroTipo02.append(Util.completaString("", 20));
                    ...
                    arquivoTextoRegistroTipo02.append(Util.completaString(fatorEconomias, 2));
            ...
            if (colecaoSubcategoria != null && !colecaoSubcategoria.isEmpty()) {
                ...
                while (iterator.hasNext()) {
                    ...
                    // CODIGO_CATEGORIA
                    arquivoTextoRegistroTipo02.append(subcategoria.getCategoria()
                                                                  .getId()
                                                                  .toString());

                    // DESCRICAO_CATEGORIA
                    arquivoTextoRegistroTipo02.append(Util.completaString(subcategoria.getCategoria()
                                                                                      .getDescricao(), 15));

                    // CODIGO_SUBCATEGORIA
                    arquivoTextoRegistroTipo02.append(Util.adicionarZerosEsquedaNumero(3, subcategoria.getId()
                                                                                                      .toString()));

                    // DESCRICAO_SUBCATEGORIA
                    arquivoTextoRegistroTipo02.append(Util.completaString(subcategoria.getDescricao(), 50));
                    ...
                    // DESCRICAO_ABREVIADA_SUBCATEGORIA
                    arquivoTextoRegistroTipo02.append(Util.completaString(subcategoria.getDescricaoAbreviada(), 20));
     ...
     * @throws ControladorException
     */
    public Object[] gerarArquivoTextoRegistroTipo03(Imovel imovel, Integer anoMesReferencia) throws ControladorException {
        ...
        if (colecaoConsumoHistorico != null && !colecaoConsumoHistorico.isEmpty()) {
            ...
            while (iterator.hasNext()) {
                ...
                // MATRÍCULA DO IMÓVEL
                arquivoTextoRegistroTipo03.append(Util.adicionarZerosEsquedaNumero(9, imovel.getId()
                                                                                            .toString()));

                // LICAGAO_TIPO
                arquivoTextoRegistroTipo03.append(String.valueOf(consumoHistorico.getLigacaoTipo()
                                                                                 .getId()
                                                                                 .toString()));

                // ANO_MES_FATURAMENTO
                arquivoTextoRegistroTipo03.append(String.valueOf(consumoHistorico.getReferenciaFaturamento()));

                // CONSUMO_FATURADO_MES
                if (consumoHistorico.getNumeroConsumoFaturadoMes() != null) {
                    arquivoTextoRegistroTipo03.append(Util.adicionarZerosEsquedaNumero(6, consumoHistorico.getNumeroConsumoFaturadoMes()
                                                                                                          .toString()));
                } else {
                    arquivoTextoRegistroTipo03.append(Util.adicionarZerosEsquedaNumero(6, "0"));
                }
                ...
                if (idLeituraAnormalidadeFaturamento != null) {
                    arquivoTextoRegistroTipo03.append(Util.adicionarZerosEsquedaNumero(2, idLeituraAnormalidadeFaturamento.toString()));
                } else {
                    arquivoTextoRegistroTipo03.append(Util.adicionarZerosEsquedaNumero(2, "0"));
                }

                // ANORMALIDADE_CONSUMO
                if (consumoHistorico.getConsumoAnormalidade() != null) {
                    arquivoTextoRegistroTipo03.append(Util.adicionarZerosEsquedaNumero(2, consumoHistorico.getConsumoAnormalidade()
                                                                                                          .getId()
                                                                                                          .toString()));
                } else {
                    arquivoTextoRegistroTipo03.append(Util.adicionarZerosEsquedaNumero(2, "0"));
     ...
     * @throws ControladorException
     */
    public Object[] gerarArquivoTextoRegistroTipo04(Conta conta) throws ControladorException {
        ...
        if (conta != null) {
            ...
            if (!Util.isVazioOrNulo(colecaoDebitoCobradoDeParcelamento)) {
	            ...
	            for (Object[] debitoCobradoDeParcelamento : colecaoDebitoCobradoDeParcelamento) {
	                ...
	                // MATRÍCULA DO IMÓVEL
	                arquivoTextoRegistroTipo04.append(Util.adicionarZerosEsquedaNumero(9, conta.getImovel()
	                                                                                           .getId()
	                                                                                           .toString()));
	
	                // DESCRICAO_SERVICO_PARCELAMENTO
	                arquivoTextoRegistroTipo04.append(Util.completaStringComEspacoADireitaCondicaoTamanhoMaximo("PARCELAMENTO DE DEBITOS PARCELA "
	                        + Util.adicionarZerosEsquedaNumero(2, String.valueOf(debitoCobradoDeParcelamento[0]))
	                        + "/"
	                        + Util.adicionarZerosEsquedaNumero(2, String.valueOf(debitoCobradoDeParcelamento[1])), 90));
	
	                // VALOR_SERVICO_PARCELAMENTO
	                arquivoTextoRegistroTipo04.append(Util.adicionarZerosEsquedaNumero(14, Util.formatarBigDecimalComPonto((BigDecimal) debitoCobradoDeParcelamento[2])));
	
	                arquivoTextoRegistroTipo04.append(Util.completaString((debitoCobradoDeParcelamento[3] != null ? debitoCobradoDeParcelamento[3] : "")
	                        + "", 6));
                ...
                while (iterator.hasNext()) {
                    ...
                    if (debitoCobradoAnterior == null) {
                        ...
                        if (debitoCobradoAnterior.getAnoMesReferenciaDebito() != null) {
                            ...
                            arquivoTextoRegistroTipo04.append(this.obterDadosServicosParcelamentosParteII(conta, debitoCobradoAnterior, 1, "", debitoCobradoAnterior.getValorPrestacao()));
                        ...
                        if (qtdAnoMesDistintos > 0) {
                            ...
                            // GERANDO - [SB0002] - Obter dados dos serviços e
                            // parcelamento - PARTE II
                            arquivoTextoRegistroTipo04.append(this.obterDadosServicosParcelamentosParteII(conta, debitoCobradoAnterior, qtdAnoMesDistintos, anoMesAcumulado, valorPrestacaoAcumulado));
                        }
     ...
     * @throws ControladorException
     */
    public StringBuilder obterDadosServicosParcelamentosParteII(Conta conta, DebitoCobrado debitoCobrado,
        ...
        if (qtdAnoMesDistintos > 1) {
            ...
            if (qtdAnoMesDistintos > 5) {
                ...
                // DESCRICAO_SERVICO_PARCELAMENTO
                arquivoTextoRegistroTipo04.append(Util.completaString(debitoCobrado.getDebitoTipo()
                ...
                // DESCRICAO_SERVICO_PARCELAMENTO
                arquivoTextoRegistroTipo04.append(Util.completaString(debitoCobrado.getDebitoTipo()
                                                                                   .getDescricao() + " " + anoMesAcumulado, 90));
            }

            // VALOR_SERVICO_PARCELAMENTO
            arquivoTextoRegistroTipo04.append(Util.adicionarZerosEsquedaNumero(14, Util.formatarBigDecimalComPonto(valorPrestacaoAcumulado)));
            ...
            if (anoMesAcumulado == null || anoMesAcumulado.equals("")) {
                ...
                arquivoTextoRegistroTipo04.append(Util.completaString(debitoCobrado.getDebitoTipo()
                        ...
                        + "/" + Util.adicionarZerosEsquedaNumero(2, String.valueOf(debitoCobrado.getNumeroPrestacao())), 90));
            ...
            // VALOR_SERVICO_PARCELAMENTO
            arquivoTextoRegistroTipo04.append(Util.adicionarZerosEsquedaNumero(14, Util.formatarBigDecimalComPonto(debitoCobrado.getValorPrestacao())));
     ...
     * @throws ControladorException
     */
    public Object[] gerarArquivoTextoRegistroTipo05(Conta conta) throws ControladorException {
                ...
                while (iterator.hasNext()) {
                    ...
                    if (creditoRealizadoAnterior == null) {
                        ...
                        if (creditoRealizadoAnterior.getAnoMesReferenciaCredito() != null) {
                            ...
                            // realizados
                            arquivoTextoRegistroTipo05.append(this.obterDadosCreditosRealizados(conta, creditoRealizadoAnterior, 1, "", creditoRealizadoAnterior.getValorCredito()));
                        }
                        ...
                        if (qtdAnoMesDistintos > 0) {
                            ...
                            // GERANDO - [SB0003] - Obter dados dos créditos
                            // realizados
                            arquivoTextoRegistroTipo05.append(this.obterDadosCreditosRealizados(conta, creditoRealizadoAnterior, qtdAnoMesDistintos, anoMesAcumulado, valorCreditoAcumulado));
                        }
     ...
     * @throws ControladorException
     */
    public StringBuilder obterDadosCreditosRealizados(Conta conta, CreditoRealizado creditoRealizado,
        ...
        // MATRÍCULA DO IMÓVEL
        arquivoTextoRegistroTipo05.append(Util.adicionarZerosEsquedaNumero(9, conta.getImovel()
                                                                                   .getId()
                                                                                   .toString()));
        ...
        if (qtdAnoMesDistintos > 1) {
            ...
            if (qtdAnoMesDistintos > 5) {
                ...
                // DESCRICAO_CREDITO
                arquivoTextoRegistroTipo05.append(Util.completaString(creditoRealizado.getCreditoTipo()
                                                                                      .getDescricao() + " "
            	...
            	if ( creditoRealizado.getCreditoTipo().getCodigoConstante() != null && creditoRealizado.getCreditoTipo().getCodigoConstante().intValue() == CreditoTipo.CODIGO_CONSTANTE_CONTRATO_DEMANDA ){
                	...
                	if ( colConsumoMinimoPercentualEsg != null && colConsumoMinimoPercentualEsg.size() > 0 ){
                		...
                		// DESCRICAO_CREDITO
                		arquivoTextoRegistroTipo05.append(Util.completaString(creditoRealizado.getCreditoTipo()
                                                                                          .getDescricao() + " " + valores[1] + "% " + anoMesAcumulado, 90));
                	}
                } else {
            		// DESCRICAO_CREDITO
            		arquivoTextoRegistroTipo05.append(Util.completaString(creditoRealizado.getCreditoTipo()
            ...
            // VALOR_CREDITO
            arquivoTextoRegistroTipo05.append(Util.adicionarZerosEsquedaNumero(14, Util.formatarBigDecimalComPonto(valorCreditoAcumulado)));
            ...
            if (anoMesAcumulado == null || anoMesAcumulado.equals("")) {
                ...
                arquivoTextoRegistroTipo05.append(Util.completaString(creditoRealizado.getCreditoTipo()
                        ...
                        + "/" + Util.adicionarZerosEsquedaNumero(2, String.valueOf(creditoRealizado.getNumeroPrestacao())), 90));
            ...
            // VALOR_CREDITO
            arquivoTextoRegistroTipo05.append(Util.adicionarZerosEsquedaNumero(14, Util.formatarBigDecimalComPonto(creditoRealizado.getValorCredito())));
     ...
     * @throws ControladorException
     */
    public Object[] gerarArquivoTextoRegistroTipo06(Conta conta) throws ControladorException {
        ...
        if (conta != null) {
            ...
            if (colecaoImpostosRetidos != null && !colecaoImpostosRetidos.isEmpty()) {
                ...
                while (iterator.hasNext()) {
                    ...
                    // MATRÍCULA DO IMÓVEL
                    arquivoTextoRegistroTipo06.append(Util.adicionarZerosEsquedaNumero(9, conta.getImovel()
                                                                                               .getId()
                                                                                               .toString()));

                    // ID_IMPOSTO_TIPO
                    arquivoTextoRegistroTipo06.append(String.valueOf(arrayImpostos[3]));

                    // DESCRICAO_IMPOSTO
                    arquivoTextoRegistroTipo06.append(Util.completaString(String.valueOf(arrayImpostos[0]), 15));

                    // PERCENTUAL_ALIQUOTA
                    arquivoTextoRegistroTipo06.append(Util.adicionarZerosEsquedaNumero(6, Util.formatarBigDecimalComPonto((BigDecimal) arrayImpostos[1])));
     ...
     * @throws ControladorException
     */
    public Object[] gerarArquivoTextoRegistroTipo07(Imovel imovel, SistemaParametro sistemaParametro,
        ...
        Object[] retorno = new Object[2];
        if (cobrancaDocumento != null && !cobrancaDocumento.equals("")) {
            retorno = formatarCobrancaDocumentoItemParaImpressaoSimultanea(imovel.getId(), cobrancaDocumento, 17);
        } else {
     ...
     * @throws ControladorException
     */
    public Object[] gerarArquivoTextoRegistroTipo08(Imovel imovel, Integer anoMesReferencia,
        ...
        if (colecaoDadosMedicaoHistorico != null && !colecaoDadosMedicaoHistorico.isEmpty()) {
            ...
            while (iterator.hasNext()) {
                ...
                // MATRÍCULA DO IMÓVEL
                arquivoTextoRegistroTipo08.append(Util.adicionarZerosEsquedaNumero(9, imovel.getId()
                                                                                            .toString()));
                ...
                if (arrayMedicaoHistorico[0] != null) {
                    ...
                    arquivoTextoRegistroTipo08.append(Util.completaString(hidrometro.getNumero(), 11));
                } else {
                    arquivoTextoRegistroTipo08.append(Util.completaString("", 11));
                }

                // DATA INSTALAÇÃO HIDRÔMETRO
                if (arrayMedicaoHistorico[2] != null) {
                    arquivoTextoRegistroTipo08.append(Util.formatarDataAAAAMMDD((Date) arrayMedicaoHistorico[2]));
                } else {
                    arquivoTextoRegistroTipo08.append(Util.completaString("", 8));
                }
                ...
                if (arrayMedicaoHistorico[1] != null) {
                    ...
                    arquivoTextoRegistroTipo08.append(hidrometro.getNumeroDigitosLeitura()
                                                                .toString());
                } else {
                    arquivoTextoRegistroTipo08.append(Util.completaString("", 1));
                }
                ...
                arquivoTextoRegistroTipo08.append(Util.adicionarZerosEsquedaNumero(7, leituraAnteriorFaturada.toString()));

                // DATA DA LEITURA ANTERIOR FATURADA
                if (dataLeituraAnteriorFaturamento != null && !dataLeituraAnteriorFaturamento.equals("")) {
                    arquivoTextoRegistroTipo08.append(Util.formatarDataAAAAMMDD(dataLeituraAnteriorFaturamento));
                } else {
                    if (arrayMedicaoHistorico[4] != null) {
                        arquivoTextoRegistroTipo08.append(Util.formatarDataAAAAMMDD((Date) arrayMedicaoHistorico[4]));
                    } else {
                        arquivoTextoRegistroTipo08.append(Util.completaString("", 8));
                    }
                }
                ...
                arquivoTextoRegistroTipo08.append(Util.adicionarZerosEsquedaNumero(7, faixaLeitura[0].toString()));

                // LIMITE SUPERIOR FAIXA LEITURA ESPERADA
                arquivoTextoRegistroTipo08.append(Util.adicionarZerosEsquedaNumero(7, faixaLeitura[1].toString()));

                // CONSUMO MÉDIO HIDRÔMETRO
                arquivoTextoRegistroTipo08.append(Util.adicionarZerosEsquedaNumero(6, String.valueOf(consumoMedioHidrometro[0])));

                // DESCRIÇÂO LOCAL INSTALAÇÂO DO HIDROMETRO
                if (arrayMedicaoHistorico[9] != null) {
                    arquivoTextoRegistroTipo08.append(Util.completaString("" + arrayMedicaoHistorico[9], 20));
                } else {
                    arquivoTextoRegistroTipo08.append(Util.completaString("", 20));
                }

                // LEITURA ANTERIOR INFORMADA
                if (leituraAnteriorInformada != null) {
                    arquivoTextoRegistroTipo08.append(Util.adicionarZerosEsquedaNumero(7, leituraAnteriorInformada.toString()));
                } else {
                    arquivoTextoRegistroTipo08.append(Util.completaString("", 7));
                }
                ...
                if (arrayMedicaoHistorico[12] != null) {
                    arquivoTextoRegistroTipo08.append(Util.adicionarZerosEsquedaNumero(7, arrayMedicaoHistorico[12].toString()));
                } else {
                    arquivoTextoRegistroTipo08.append(Util.completaString("", 7));
                }
                ...
                arquivoTextoRegistroTipo08.append(indicadorParalisacaoLeituraHidrometroAgua);
                ...
                if (imovel.getIndicadorImovelAreaComum() != null
                    ...
                    arquivoTextoRegistroTipo08.append(imovel.getIndicadorImovelAreaComum());
                } else {
                ...
                // Consumo mínimo de contrato de demanda
                if ( imovel.getLigacaoAguaSituacao() != null && 
                	...
                	if ( colConsumoMinimoPercentualEsg != null && colConsumoMinimoPercentualEsg.size() > 0 ){
                		...
                		arquivoTextoRegistroTipo08.append( Util.adicionarZerosEsquedaNumero( 6, ""+valores[0] ) );
                		arquivoTextoRegistroTipo08.append( Util.adicionarZerosEsquedaNumero( 2, ""+valores[1] ) );
                	} else {
                		arquivoTextoRegistroTipo08.append( Util.completaString( "", 6 ) );
                		arquivoTextoRegistroTipo08.append( Util.completaString( "", 2 ) );                		
                	}
                } else {
            		arquivoTextoRegistroTipo08.append( Util.completaString( "", 6 ) );
            		arquivoTextoRegistroTipo08.append( Util.completaString( "", 2 ) );
    ...
    public Integer[] obterDadosLimiteLeituraEsperada(Imovel imovel, Hidrometro hidrometro, Integer consumoMedioHidrometro,
        ...
        if (hidrometro == null) {
            ...
            int[] faixaLeituraEsperada = faixaLeituraEsperada = this.getControladorMicromedicao()
     ...
     * @throws ControladorException
     */
    public Object[] gerarArquivoTextoRegistroDadosTarifa09(Imovel imovel, SistemaParametro sistemaParametro,
            Integer anoMesReferencia, FaturamentoGrupo faturamentoGrupo) throws ControladorException {
        ...
        filtroTarifaTipoCalculo.adicionarParametro(new ParametroSimples(FiltroTarifaTipoCalculo.INDICADOR_USO,
                                                                        ConstantesSistema.INDICADOR_USO_ATIVO));
        Collection collTarifaTipoCalculo = getControladorUtil().pesquisar(filtroTarifaTipoCalculo, TarifaTipoCalculo.class.getName());

        TarifaTipoCalculo tarifaTipoCalculo = (TarifaTipoCalculo) Util.retonarObjetoDeColecao(collTarifaTipoCalculo);

        Short indicadorTarifaCategoria = sistemaParametro.getIndicadorTarifaCategoria();
        ...
        try {
            ...
            if (indicadorTarifaCategoria.equals(SistemaParametro.INDICADOR_TARIFA_CATEGORIA)) {
                ...
                while (ite.hasNext()) {
                    ...
                    if (idCategoriaAnterior == null || idCategoriaAnterior.equals((Integer) dadosCatSub[0])) {
            ...
            if (tarifaTipoCalculo != null && tarifaTipoCalculo.getId()
                                                              .equals(TarifaTipoCalculo.CALCULO_POR_REFERENCIA)) {
                Date dataFaturamento = Util.criarData(1, Util.obterMes(anoMesReferencia), Util.obterAno(anoMesReferencia));

                Collection<Object[]> colecaoDadosMaiorTarifa = repositorioFaturamento.pesquisarDadosConsumoMaiorTarifaVigenciaPorTarifa(dataFaturamento, imovel.getConsumoTarifa()
                                                                                                                                                               .getId());

                if (colecaoDadosMaiorTarifa != null && !colecaoDadosMaiorTarifa.equals("")) {
                    for (Object[] dadosTarifaMaior : colecaoDadosMaiorTarifa) {
                        if (dadosTarifaMaior[0] != null && dadosTarifaMaior[1] != null) {
                            Iterator ite = colecaoCatSub.iterator();
                            Collection<Object[]> colecaoDadosTarifaPartes = null;
                            while (ite.hasNext()) {
                                Object[] dadosCatSub = (Object[]) ite.next();
                                colecaoDadosTarifaPartes = repositorioFaturamento.pesquisarDadosConsumoTarifaVigencia((Date) dadosTarifaMaior[1], (Integer) dadosTarifaMaior[0], (Integer) dadosCatSub[0], (Integer) dadosCatSub[1]);
                                if (colecaoDadosTarifaPartes == null || colecaoDadosTarifaPartes.isEmpty()) {
                                    colecaoDadosTarifaPartes = repositorioFaturamento.pesquisarDadosConsumoTarifaVigencia((Date) dadosTarifaMaior[1], (Integer) dadosTarifaMaior[0], (Integer) dadosCatSub[0], 0);
                                }
                                    ...
                                    for (Object[] dadosTarifaCategoria : colecaoDadosTarifa) {
                                        ...
                                        if (colecaoDadosTarifaPartes != null && !colecaoDadosTarifaPartes.isEmpty()) {
                                            for (Object[] dadosTarifaCategoriaPartes : colecaoDadosTarifaPartes) {
                                                ...
                                                if (idConsumoTarifaCategoria.equals(idConsumoTarifaCategoriaPartes)) {
                                ...
                                if (!mesmoConsumoTarifaCategoria) {
                                    colecaoDadosTarifa.addAll(colecaoDadosTarifaPartes);
                                }
                            }
                ...
                Date dataLeituraAnterior = this.getControladorMicromedicao()
                                               .pesquisarMaiorDataLeituraImoveis(imovel.getId(), anoMesReferenciaAnterior);

                // caso não tenha a data de leitura anterior, pegar a data
                // prevista do cronograma anterior
                if (dataLeituraAnterior == null || dataLeituraAnterior.equals("")) {
                ...
                while (ite.hasNext()) {
                    ...
                    // atual
                    colecaoDadosTarifaProporcional = repositorioFaturamento.pesquisarDadosConsumoTarifaVigenciaProporcional(dataLeituraAnterior, imovel.getConsumoTarifa()
                                                                                                                                                       .getId(), (Integer) dadosCatSub[0], (Integer) dadosCatSub[1]);
                    // caso exista e a data de leitura anterior não seja igual a
                    // data de vigencia
                    // não procura mais tarifa para esse imóvel
                    if (colecaoDadosTarifaProporcional != null && !colecaoDadosTarifaProporcional.isEmpty()) {

                        Iterator iteProporcional = colecaoDadosTarifaProporcional.iterator();
                        while (iteProporcional.hasNext()) {
                            Object[] dadosProporcional = (Object[]) iteProporcional.next();

                            if (dadosProporcional[2] != null) {
                                Date dataVigencia = (Date) dadosProporcional[2];
                                if (Util.compararData(dataLeituraAnterior, dataVigencia) == 0) {
                        ...
                        if (colecaoDadosTarifaProporcional == null || colecaoDadosTarifaProporcional.isEmpty()
                            ...
                            Collection<Object[]> colecaoDadosMaiorTarifa = repositorioFaturamento.pesquisarDadosConsumoMaiorTarifaVigenciaPorTarifa(dataLeituraAnterior, imovel.getConsumoTarifa()
                                                                                                                                                                               .getId());
                        ...
                        // de vigencia
                        if (colecaoDadosTarifaProporcional != null && !colecaoDadosTarifaProporcional.isEmpty()) {
                            colecaoDadosTarifa.addAll(colecaoDadosTarifaProporcional);
                        }
                    } else {
                        // Caso não tenha encontrado nenhuma tarifa proporcional
                        // ou a data de vigencia da tarifa
            ...
            if (colecaoDadosTarifa != null && !colecaoDadosTarifa.isEmpty()) {
                for (Object[] dadosTarifa : colecaoDadosTarifa) {
                    ...
                    if (dadosTarifa[1] != null) {
                        arquivoTextoRegistroDadosTarifa09.append(Util.adicionarZerosEsquedaNumero(2, "" + dadosTarifa[1]));
                    } else {
                        arquivoTextoRegistroDadosTarifa09.append(Util.adicionarZerosEsquedaNumero(2, ""));
                    }
                    // Data de Vigencia
                    if (dadosTarifa[2] != null) {
                        Date dataVigencia = (Date) dadosTarifa[2];
                        arquivoTextoRegistroDadosTarifa09.append(Util.formatarDataAAAAMMDD(dataVigencia));
                    } else {
                        arquivoTextoRegistroDadosTarifa09.append(Util.adicionarZerosEsquedaNumero(8, ""));
                    }
                    // Código da Categoria
                    if (dadosTarifa[3] != null) {
                        arquivoTextoRegistroDadosTarifa09.append(Util.adicionarZerosEsquedaNumero(1, "" + dadosTarifa[3]));
                    } else {
                        arquivoTextoRegistroDadosTarifa09.append(Util.adicionarZerosEsquedaNumero(1, ""));
                    }
                    // Código da Subcategoria
                    if (indicadorTarifaCategoria.equals(ConstantesSistema.NAO) && dadosTarifa[4] != null) {
                        arquivoTextoRegistroDadosTarifa09.append(Util.adicionarZerosEsquedaNumero(3, "" + dadosTarifa[4]));
                    } else {
                        arquivoTextoRegistroDadosTarifa09.append(Util.completaString("", 3));
                    }
                    // Consumo mínimo
                    if (dadosTarifa[5] != null) {
                        arquivoTextoRegistroDadosTarifa09.append(Util.adicionarZerosEsquedaNumero(6, "" + dadosTarifa[5]));
                    } else {
                        arquivoTextoRegistroDadosTarifa09.append(Util.adicionarZerosEsquedaNumero(6, ""));
                    }
                    // Tarifa mínima
                    if (dadosTarifa[6] != null) {
                        arquivoTextoRegistroDadosTarifa09.append(Util.adicionarZerosEsquedaNumero(14, Util.formatarBigDecimalComPonto((BigDecimal) dadosTarifa[6])));
                    } else {
                        arquivoTextoRegistroDadosTarifa09.append(Util.adicionarZerosEsquedaNumero(14, ""));
                    }
                ...
                Object[] tarifaFaixa10 = gerarArquivoTextoRegistroDadosTarifaFaixa10(idsConsumoTarifaCategoria, indicadorTarifaCategoria);
                ...
                quantidadeLinhas = quantidadeLinhas + quantidadeLinhasRegistroTipo10;
            }
     ...
     * @throws ControladorException
     */
    public Object[] gerarArquivoTextoRegistroDadosTarifaFaixa10(Collection idsConsumoTarifaCategoria,
            Short indicadorTarifaCategoria) throws ControladorException {
        ...
        try {
            ...
            colecaoDadosTarifaFaixa = repositorioFaturamento.pesquisarDadosConsumoTarifaFaixa(idsConsumoTarifaCategoria);
        ...
        if (colecaoDadosTarifaFaixa != null && !colecaoDadosTarifaFaixa.isEmpty()) {
            ...
            for (Object[] dadosTarifa : colecaoDadosTarifaFaixa) {
                ...
                // Código da Tarifa
                if (dadosTarifa[0] != null) {
                    arquivoTextoRegistroDadosTarifaFaixa10.append(Util.adicionarZerosEsquedaNumero(2, "" + dadosTarifa[0]));
                } else {
                    arquivoTextoRegistroDadosTarifaFaixa10.append(Util.adicionarZerosEsquedaNumero(2, ""));
                }
                // Data de Vigencia
                if (dadosTarifa[1] != null) {
                    Date dataVigencia = (Date) dadosTarifa[1];
                    arquivoTextoRegistroDadosTarifaFaixa10.append(Util.formatarDataAAAAMMDD(dataVigencia));
                } else {
                    arquivoTextoRegistroDadosTarifaFaixa10.append(Util.adicionarZerosEsquedaNumero(8, ""));
                }
                // Código da Categoria
                if (dadosTarifa[2] != null) {
                    arquivoTextoRegistroDadosTarifaFaixa10.append(Util.adicionarZerosEsquedaNumero(1, "" + dadosTarifa[2]));
                } else {
                    arquivoTextoRegistroDadosTarifaFaixa10.append(Util.adicionarZerosEsquedaNumero(1, ""));
                }
                // Código da Subcategoria
                if (indicadorTarifaCategoria.equals(ConstantesSistema.NAO) && dadosTarifa[3] != null) {
                    arquivoTextoRegistroDadosTarifaFaixa10.append(Util.adicionarZerosEsquedaNumero(3, "" + dadosTarifa[3]));
                } else {
                    arquivoTextoRegistroDadosTarifaFaixa10.append(Util.completaString("", 3));
                }
                // Limite Inicial da Faixa
                if (dadosTarifa[4] != null) {
                    arquivoTextoRegistroDadosTarifaFaixa10.append(Util.adicionarZerosEsquedaNumero(6, "" + dadosTarifa[4]));
                } else {
                    arquivoTextoRegistroDadosTarifaFaixa10.append(Util.adicionarZerosEsquedaNumero(6, ""));
                }
                // Limite Final da Faixa
                if (dadosTarifa[5] != null) {
                    arquivoTextoRegistroDadosTarifaFaixa10.append(Util.adicionarZerosEsquedaNumero(6, "" + dadosTarifa[5]));
                } else {
                    arquivoTextoRegistroDadosTarifaFaixa10.append(Util.adicionarZerosEsquedaNumero(6, ""));
                }
                // Valor do m3 na Faixa
                if (dadosTarifa[6] != null) {
                    arquivoTextoRegistroDadosTarifaFaixa10.append(Util.adicionarZerosEsquedaNumero(14, Util.formatarBigDecimalComPonto((BigDecimal) dadosTarifa[6])));
                } else {
                    arquivoTextoRegistroDadosTarifaFaixa10.append(Util.adicionarZerosEsquedaNumero(14, ""));
                }

                if (count != 0) {
                    arquivoTextoRegistroDadosTarifaFaixa10.append(System.getProperty("line.separator"));
                }
     ...
     * @throws ControladorException
     */
    public StringBuilder gerarArquivoTextoQualidadeAgua(Integer idLocalidade, Integer idSetor, Integer anoMesReferencia)
                                                                                                                        throws ControladorException {
        ...
        colecaoQualidadeAguaPadrao = getControladorUtil().pesquisar(filtroQualidadeAguaPadrao, QualidadeAguaPadrao.class.getName());

        if (colecaoQualidadeAguaPadrao != null && !colecaoQualidadeAguaPadrao.isEmpty()) {
            QualidadeAguaPadrao qualidadeAguaPadrao = (QualidadeAguaPadrao) colecaoQualidadeAguaPadrao.iterator()
                                                                                                      .next();
            if (qualidadeAguaPadrao != null) {
                // Turbidez
                if (qualidadeAguaPadrao.getDescricaoPadraoTurbidez() != null) {
                    arquivoTextoQualidadeAgua.append(Util.completaString(qualidadeAguaPadrao.getDescricaoPadraoTurbidez(), 20));
                } else {
                    arquivoTextoQualidadeAgua.append(Util.completaString("", 20));
                }
                // PH
                if (qualidadeAguaPadrao.getDescricaoPadraoPh() != null) {
                    arquivoTextoQualidadeAgua.append(Util.completaString(qualidadeAguaPadrao.getDescricaoPadraoPh(), 20));
                } else {
                    arquivoTextoQualidadeAgua.append(Util.completaString("", 20));
                }
                // Cor
                if (qualidadeAguaPadrao.getDescricaoPadraoCor() != null) {
                    arquivoTextoQualidadeAgua.append(Util.completaString(qualidadeAguaPadrao.getDescricaoPadraoCor(), 20));
                } else {
                    arquivoTextoQualidadeAgua.append(Util.completaString("", 20));
                }
                // Cloro
                if (qualidadeAguaPadrao.getDescricaoPadraoCloro() != null) {
                    arquivoTextoQualidadeAgua.append(Util.completaString(qualidadeAguaPadrao.getDescricaoPadraoCloro(), 20));
                } else {
                    arquivoTextoQualidadeAgua.append(Util.completaString("", 20));
                }
                // Fluor
                if (qualidadeAguaPadrao.getDescricaoPadraoFluor() != null) {
                    arquivoTextoQualidadeAgua.append(Util.completaString(qualidadeAguaPadrao.getDescricaoPadraoFluor(), 20));
                } else {
                    arquivoTextoQualidadeAgua.append(Util.completaString("", 20));
                }
                // Ferro
                if (qualidadeAguaPadrao.getDescricaoPadraoFerro() != null) {
                    arquivoTextoQualidadeAgua.append(Util.completaString(qualidadeAguaPadrao.getDescricaoPadraoFerro(), 20));
                } else {
                    arquivoTextoQualidadeAgua.append(Util.completaString("", 20));
                }
                // Coliformes Totais
                if (qualidadeAguaPadrao.getDescricaoPadraoColiformesTotais() != null) {
                    arquivoTextoQualidadeAgua.append(Util.completaString(qualidadeAguaPadrao.getDescricaoPadraoColiformesTotais(), 20));
                } else {
                    arquivoTextoQualidadeAgua.append(Util.completaString("", 20));
                }
                // Coliformes Fecais
                if (qualidadeAguaPadrao.getDescricaoPadraoColiformesFecais() != null) {
                    arquivoTextoQualidadeAgua.append(Util.completaString(qualidadeAguaPadrao.getDescricaoPadraoColiformesFecais(), 20));
                } else {
                    arquivoTextoQualidadeAgua.append(Util.completaString("", 20));
                }
                // Nitrato
                if (qualidadeAguaPadrao.getDescricaoNitrato() != null) {
                    arquivoTextoQualidadeAgua.append(Util.completaString(qualidadeAguaPadrao.getDescricaoNitrato(), 20));
                } else {
                    arquivoTextoQualidadeAgua.append(Util.completaString("", 20));
                }
                // Coliformes Termo Tolerantes
                if (qualidadeAguaPadrao.getDescricaoPadraoColiformesTermotolerantes() != null) {
                    arquivoTextoQualidadeAgua.append(Util.completaString(qualidadeAguaPadrao.getDescricaoPadraoColiformesTermotolerantes(), 20));
                } else {
                    arquivoTextoQualidadeAgua.append(Util.completaString("", 20));
                }
            } else {
        ...
        if (colecaoQualidadeAgua != null && !colecaoQualidadeAgua.isEmpty()) {
            ...
            QualidadeAgua qualidadeAgua = (QualidadeAgua) colecaoQualidadeAgua.iterator()
                                                                              .next();

            // mês e ano de referência
            if (qualidadeAgua.getAnoMesReferencia() != null) {
                arquivoTextoQualidadeAgua.append(Util.completaString(Util.formatarAnoMesParaMesAnoSemBarra(qualidadeAgua.getAnoMesReferencia()), 6));
            } else {
                arquivoTextoQualidadeAgua.append(Util.completaString("", 6));
            }
            // cloro
            if (qualidadeAgua.getNumeroCloroResidual() != null && !qualidadeAgua.getNumeroCloroResidual()
                                                                                .equals(0)) {
                arquivoTextoQualidadeAgua.append(Util.completaString(qualidadeAgua.getNumeroCloroResidual()
                                                                                  .toString(), 5));
            } else {
                arquivoTextoQualidadeAgua.append(Util.completaString("", 5));
            }
            // turbidez
            if (qualidadeAgua.getNumeroIndiceTurbidez() != null && !qualidadeAgua.getNumeroIndiceTurbidez()
                                                                                 .equals(0)) {
                arquivoTextoQualidadeAgua.append(Util.completaString(qualidadeAgua.getNumeroIndiceTurbidez()
                                                                                  .toString(), 5));
            } else {
                arquivoTextoQualidadeAgua.append(Util.completaString(" ", 5));
            }
            // ph
            if (qualidadeAgua.getNumeroIndicePh() != null && !qualidadeAgua.getNumeroIndicePh()
                                                                           .equals(0)) {
                arquivoTextoQualidadeAgua.append(Util.completaString(qualidadeAgua.getNumeroIndicePh()
                                                                                  .toString(), 5));
            } else {
                arquivoTextoQualidadeAgua.append(Util.completaString(" ", 5));
            }
            // Cor
            if (qualidadeAgua.getNumeroIndiceCor() != null && !qualidadeAgua.getNumeroIndiceCor()
                                                                            .equals(0)) {
                arquivoTextoQualidadeAgua.append(Util.completaString(qualidadeAgua.getNumeroIndiceCor()
                                                                                  .toString(), 5));
            } else {
                arquivoTextoQualidadeAgua.append(Util.completaString(" ", 5));
            }
            // fluor
            if (qualidadeAgua.getNumeroIndiceFluor() != null && !qualidadeAgua.getNumeroIndiceFluor()
                                                                              .equals(0)) {
                arquivoTextoQualidadeAgua.append(Util.completaString(qualidadeAgua.getNumeroIndiceFluor()
                                                                                  .toString(), 5));
            } else {
                arquivoTextoQualidadeAgua.append(Util.completaString(" ", 5));
            }
            // ferro
            if (qualidadeAgua.getNumeroIndiceFerro() != null && !qualidadeAgua.getNumeroIndiceFerro()
                                                                              .equals(0)) {
                arquivoTextoQualidadeAgua.append(Util.completaString(qualidadeAgua.getNumeroIndiceFerro()
                                                                                  .toString(), 5));
            } else {
                arquivoTextoQualidadeAgua.append(Util.completaString(" ", 5));
            }
            // Coliformes Totais
            if (qualidadeAgua.getNumeroIndiceColiformesTotais() != null && !qualidadeAgua.getNumeroIndiceColiformesTotais()
                                                                                         .equals(0)) {
                arquivoTextoQualidadeAgua.append(Util.completaString(qualidadeAgua.getNumeroIndiceColiformesTotais()
                                                                                  .toString(), 5));
            } else {
                arquivoTextoQualidadeAgua.append(Util.completaString(" ", 5));
            }
            // Coliformes Fecais
            if (qualidadeAgua.getNumeroIndiceColiformesFecais() != null && !qualidadeAgua.getNumeroIndiceColiformesFecais()
                                                                                         .equals(0)) {
                arquivoTextoQualidadeAgua.append(Util.completaString(qualidadeAgua.getNumeroIndiceColiformesFecais()
                                                                                  .toString(), 5));
            } else {
                arquivoTextoQualidadeAgua.append(Util.completaString(" ", 5));
            }
            // nitrato
            if (qualidadeAgua.getNumeroNitrato() != null && !qualidadeAgua.getNumeroNitrato()
                                                                          .equals(0)) {
                arquivoTextoQualidadeAgua.append(Util.completaString(qualidadeAgua.getNumeroNitrato()
                                                                                  .toString(), 5));
            } else {
                arquivoTextoQualidadeAgua.append(Util.completaString(" ", 5));
            }
            ...
            if (qualidadeAgua.getNumeroIndiceColiformesTermotolerantes() != null
                    && !qualidadeAgua.getNumeroIndiceColiformesTermotolerantes()
                                     .equals(0)) {
                arquivoTextoQualidadeAgua.append(Util.completaString(qualidadeAgua.getNumeroIndiceColiformesTermotolerantes()
                                                                                  .toString(), 5));
            } else {
                arquivoTextoQualidadeAgua.append(Util.completaString(" ", 5));
            }
            ...
            if (qualidadeAgua.getFonteCaptacao() != null) {
                arquivoTextoQualidadeAgua.append(Util.completaString(qualidadeAgua.getFonteCaptacao()
                                                                                  .getDescricao(), 30));
            } else {
            ...
            if (qualidadeAgua.getQuantidadeTurbidezExigidas() != null) {
                arquivoTextoQualidadeAgua.append(Util.completaString(qualidadeAgua.getQuantidadeTurbidezExigidas() + "", 6));
            } else {
                arquivoTextoQualidadeAgua.append(Util.completaString(" ", 6));
            }
            if (qualidadeAgua.getQuantidadeCorExigidas() != null) {
                arquivoTextoQualidadeAgua.append(Util.completaString(qualidadeAgua.getQuantidadeCorExigidas() + "", 6));
            } else {
                arquivoTextoQualidadeAgua.append(Util.completaString(" ", 6));
            }
            if (qualidadeAgua.getQuantidadeCloroExigidas() != null) {
                arquivoTextoQualidadeAgua.append(Util.completaString(qualidadeAgua.getQuantidadeCloroExigidas() + "", 6));
            } else {
                arquivoTextoQualidadeAgua.append(Util.completaString(" ", 6));
            }
            if (qualidadeAgua.getQuantidadeFluorExigidas() != null) {
                arquivoTextoQualidadeAgua.append(Util.completaString(qualidadeAgua.getQuantidadeFluorExigidas() + "", 6));
            } else {
                arquivoTextoQualidadeAgua.append(Util.completaString(" ", 6));
            }
            if (qualidadeAgua.getQuantidadeColiformesTotaisExigidas() != null) {
                arquivoTextoQualidadeAgua.append(Util.completaString(qualidadeAgua.getQuantidadeColiformesTotaisExigidas()
                        + "", 6));
            } else {
                arquivoTextoQualidadeAgua.append(Util.completaString(" ", 6));
            }
            if (qualidadeAgua.getQuantidadeColiformesFecaisExigidas() != null) {
                arquivoTextoQualidadeAgua.append(Util.completaString(qualidadeAgua.getQuantidadeColiformesFecaisExigidas()
                        + "", 6));
            } else {
                arquivoTextoQualidadeAgua.append(Util.completaString(" ", 6));
            }
            if (qualidadeAgua.getQuantidadeColiformesTermotolerantesExigidas() != null) {
                arquivoTextoQualidadeAgua.append(Util.completaString(qualidadeAgua.getQuantidadeColiformesTermotolerantesExigidas()
                        + "", 6));
            } else {
                arquivoTextoQualidadeAgua.append(Util.completaString(" ", 6));
            }
            ...
            if (qualidadeAgua.getQuantidadeTurbidezAnalisadas() != null) {
                arquivoTextoQualidadeAgua.append(Util.completaString(qualidadeAgua.getQuantidadeTurbidezAnalisadas() + "", 6));
            } else {
                arquivoTextoQualidadeAgua.append(Util.completaString(" ", 6));
            }
            if (qualidadeAgua.getQuantidadeCorAnalisadas() != null) {
                arquivoTextoQualidadeAgua.append(Util.completaString(qualidadeAgua.getQuantidadeCorAnalisadas() + "", 6));
            } else {
                arquivoTextoQualidadeAgua.append(Util.completaString(" ", 6));
            }
            if (qualidadeAgua.getQuantidadeCloroAnalisadas() != null) {
                arquivoTextoQualidadeAgua.append(Util.completaString(qualidadeAgua.getQuantidadeCloroAnalisadas() + "", 6));
            } else {
                arquivoTextoQualidadeAgua.append(Util.completaString(" ", 6));
            }
            if (qualidadeAgua.getQuantidadeFluorAnalisadas() != null) {
                arquivoTextoQualidadeAgua.append(Util.completaString(qualidadeAgua.getQuantidadeFluorAnalisadas() + "", 6));
            } else {
                arquivoTextoQualidadeAgua.append(Util.completaString(" ", 6));
            }
            if (qualidadeAgua.getQuantidadeColiformesTotaisAnalisadas() != null) {
                arquivoTextoQualidadeAgua.append(Util.completaString(qualidadeAgua.getQuantidadeColiformesTotaisAnalisadas()
                        + "", 6));
            } else {
                arquivoTextoQualidadeAgua.append(Util.completaString(" ", 6));
            }
            if (qualidadeAgua.getQuantidadeColiformesFecaisAnalisadas() != null) {
                arquivoTextoQualidadeAgua.append(Util.completaString(qualidadeAgua.getQuantidadeColiformesFecaisAnalisadas()
                        + "", 6));
            } else {
                arquivoTextoQualidadeAgua.append(Util.completaString(" ", 6));
            }
            if (qualidadeAgua.getQuantidadeColiformesTermotolerantesAnalisadas() != null) {
                arquivoTextoQualidadeAgua.append(Util.completaString(qualidadeAgua.getQuantidadeColiformesTermotolerantesAnalisadas()
                        + "", 6));
            } else {
                arquivoTextoQualidadeAgua.append(Util.completaString(" ", 6));
            }
            ...
            if (qualidadeAgua.getQuantidadeTurbidezConforme() != null) {
                arquivoTextoQualidadeAgua.append(Util.completaString(qualidadeAgua.getQuantidadeTurbidezConforme() + "", 6));
            } else {
                arquivoTextoQualidadeAgua.append(Util.completaString(" ", 6));
            }
            if (qualidadeAgua.getQuantidadeCorConforme() != null) {
                arquivoTextoQualidadeAgua.append(Util.completaString(qualidadeAgua.getQuantidadeCorConforme() + "", 6));
            } else {
                arquivoTextoQualidadeAgua.append(Util.completaString(" ", 6));
            }
            if (qualidadeAgua.getQuantidadeCloroConforme() != null) {
                arquivoTextoQualidadeAgua.append(Util.completaString(qualidadeAgua.getQuantidadeCloroConforme() + "", 6));
            } else {
                arquivoTextoQualidadeAgua.append(Util.completaString(" ", 6));
            }
            if (qualidadeAgua.getQuantidadeFluorConforme() != null) {
                arquivoTextoQualidadeAgua.append(Util.completaString(qualidadeAgua.getQuantidadeFluorConforme() + "", 6));
            } else {
                arquivoTextoQualidadeAgua.append(Util.completaString(" ", 6));
            }
            if (qualidadeAgua.getQuantidadeColiformesTotaisConforme() != null) {
                arquivoTextoQualidadeAgua.append(Util.completaString(qualidadeAgua.getQuantidadeColiformesTotaisConforme()
                        + "", 6));
            } else {
                arquivoTextoQualidadeAgua.append(Util.completaString(" ", 6));
            }
            if (qualidadeAgua.getQuantidadeColiformesFecaisConforme() != null) {
                arquivoTextoQualidadeAgua.append(Util.completaString(qualidadeAgua.getQuantidadeColiformesFecaisConforme()
                        + "", 6));
            } else {
                arquivoTextoQualidadeAgua.append(Util.completaString(" ", 6));
            }
            if (qualidadeAgua.getQuantidadeColiformesTermotolerantesConforme() != null) {
                arquivoTextoQualidadeAgua.append(Util.completaString(qualidadeAgua.getQuantidadeColiformesTermotolerantesConforme()
                        + "", 6));
            } else {
                arquivoTextoQualidadeAgua.append(Util.completaString(" ", 6));
            }
    ...
    private Object[] formatarCobrancaDocumentoItemParaImpressaoSimultanea(Integer idImovel,
        ...
        if (cobrancaDocumento != null && !cobrancaDocumento.equals("")) {
            ...
            if (colecaoCobrancaDocumentoItemConta != null && !colecaoCobrancaDocumentoItemConta.isEmpty()) {
                ...
                if (colecaoCobrancaDocumentoItemConta.size() > quantidadeContas) {
                    ...
                    // MATRÍCULA DO IMÓVEL
                    arquivoTextoRegistroTipo07.append(Util.adicionarZerosEsquedaNumero(9, idImovel.toString()));

                    // ANO/MES DE REFERENCIA DA CONTA
                    arquivoTextoRegistroTipo07.append("DB.ATE");

                    // VALOR DA CONTA
                    arquivoTextoRegistroTipo07.append(Util.adicionarZerosEsquedaNumero(14, Util.formatarBigDecimalComPonto(contaValoresHelper.getValorAnterior())));

                    // DATA DE VENCIMENTO
                    arquivoTextoRegistroTipo07.append(Util.formatarDataAAAAMMDD(contaValoresHelper.getDataVencimentoAnterior()));

                    // VALOR ACRÉSCIMOS IMPONTUALIDADE
                    arquivoTextoRegistroTipo07.append(Util.adicionarZerosEsquedaNumero(14, Util.formatarBigDecimalComPonto(contaValoresHelper.getValorAcrescimosAnterior())));
                ...
                if (countImpressao <= 1) {
                    ...
                    while (iteratorColecaoCobrancaDocumentoItem.hasNext()) {
                        ...
                        // ANO/MES DE REFERENCIA DA CONTA
                        arquivoTextoRegistroTipo07.append(cobrancaDocumentoItem.getContaGeral()
                                                                               .getConta()
                                                                               .getReferencia());

                        // VALOR DA CONTA
                        arquivoTextoRegistroTipo07.append(Util.adicionarZerosEsquedaNumero(14, Util.formatarBigDecimalComPonto(cobrancaDocumentoItem.getValorItemCobrado())));

                        // DATA DE VENCIMENTO
                        arquivoTextoRegistroTipo07.append(Util.formatarDataAAAAMMDD(cobrancaDocumentoItem.getContaGeral()
                                                                                                         .getConta()
                                                                                                         .getDataVencimentoConta()));

                        // VALOR ACRÉSCIMOS IMPONTUALIDADE
                        arquivoTextoRegistroTipo07.append(Util.adicionarZerosEsquedaNumero(14, Util.formatarBigDecimalComPonto(cobrancaDocumentoItem.getValorAcrescimos())));
     ...
     * @throws ControladorException
     */
    public StringBuilder gerarArquivoTextoRegistroTipo11(SistemaParametro sistemaParametro, Imovel imovel)
                                                                                                          throws ControladorException {
        ...
        arquivoTextoRegistroTipo11.append(Util.formatarDataAAAAMMDD(dataReferenciaArrecadacao));
        ...
        if (sistemaParametro.getCnpjEmpresa() != null) {
            arquivoTextoRegistroTipo11.append(Util.adicionarZerosEsquedaNumero(14, sistemaParametro.getCnpjEmpresa()));
        } else {
        ...
        if (sistemaParametro.getInscricaoEstadual() != null) {
            arquivoTextoRegistroTipo11.append(Util.adicionarZerosEsquedaNumero(20, sistemaParametro.getInscricaoEstadual()));
        } else {
            arquivoTextoRegistroTipo11.append(Util.adicionarZerosEsquedaNumero(20, ""));
        }

        // VALOR MÍNIMO EMISSÃO CONTA
        arquivoTextoRegistroTipo11.append(Util.adicionarZerosEsquedaNumero(14, Util.formatarBigDecimalComPonto(sistemaParametro.getValorMinimoEmissaoConta())));

        // PERCENTUAL TOLERÂNCIA PARA RATEIO
        arquivoTextoRegistroTipo11.append(Util.adicionarZerosEsquedaNumero(4, Util.formatarBigDecimalComPonto(sistemaParametro.getPercentualToleranciaRateio())));
        ...
        if (rota != null && rota.getLeiturista() != null && rota.getLeiturista()
            ...
            if (usuario.getLogin() != null && !usuario.getLogin()
                                                      .equals("")) {
                // LOGIN LEITURISTA
                arquivoTextoRegistroTipo11.append(Util.completaString(usuario.getLogin(), 11));

                // SENHA LEITURISTA
                String senhaCriptografada = usuario.getSenha();
                if (senhaCriptografada != null && !senhaCriptografada.equals("")) {
                    arquivoTextoRegistroTipo11.append(Util.completaString(senhaCriptografada, 40));
                } else {
                    arquivoTextoRegistroTipo11.append(Util.completaString("", 40));
                }
            } else {
                // LOGIN LEITURISTA
        ...
        if (rota != null) {
            ...
            if (rota.getDataAjusteLeitura() != null && !rota.getDataAjusteLeitura()
                                                            .equals("")) {
                arquivoTextoRegistroTipo11.append(Util.formatarDataAAAAMMDD(rota.getDataAjusteLeitura()));
            } else {
            ...
            if (rota.getIndicadorAjusteConsumo() != null && !rota.getIndicadorAjusteConsumo()
                                                                 .equals("")) {
                arquivoTextoRegistroTipo11.append(rota.getIndicadorAjusteConsumo());
            } else {
            ...
            if (rota.getIndicadorTransmissaoOffline() != null && !rota.getIndicadorTransmissaoOffline()
                                                                      .equals("")) {
                arquivoTextoRegistroTipo11.append(rota.getIndicadorTransmissaoOffline());
            } else {
                arquivoTextoRegistroTipo11.append(Util.completaString("", 1));
            }
        } else {
        ...
        if (sistemaParametro.getVersaoCelular() != null && !sistemaParametro.getVersaoCelular()
                                                                            .equals("")) {
            arquivoTextoRegistroTipo11.append(Util.completaString(sistemaParametro.getVersaoCelular(), 10));
        } else {
            arquivoTextoRegistroTipo11.append(Util.completaString("", 10));
        }
        ...
        if (rota.getIndicadorSequencialLeitura() == null) {
            arquivoTextoRegistroTipo11.append(Util.adicionarZerosEsquedaNumero(1, "" + ConstantesSistema.NAO));
        } else {
            arquivoTextoRegistroTipo11.append(Util.adicionarZerosEsquedaNumero(1, "" + rota.getIndicadorSequencialLeitura()));
        }

        // QUANTIDADE DE DIAS DE CONSUMO
        if (rota.getNumeroDiasConsumoAjuste() == null || rota.getNumeroDiasConsumoAjuste()
                                                             .equals("")) {
            arquivoTextoRegistroTipo11.append(Util.completaString("", 2));
        } else {
            arquivoTextoRegistroTipo11.append(Util.adicionarZerosEsquedaNumero(2, "" + rota.getNumeroDiasConsumoAjuste()));
        }
        ...
        arquivoTextoRegistroTipo11.append(Util.completaString("" + moduloVerificador, 2));
        ...
        arquivoTextoRegistroTipo11.append(Util.formatarDataAAAAMMDD(dataInicioBloqueio));

        // DATA FIM PARA BLOQUEIO
        Date dataFimBloqueio = Util.adicionarNumeroDiasDeUmaData(new Date(), diasBloqueioCelular);
        arquivoTextoRegistroTipo11.append(Util.formatarDataAAAAMMDD(dataFimBloqueio));

        //24. Indicador de rateio de  consumo para imóveis com situação de não faturar
        arquivoTextoRegistroTipo11.append(sistemaParametro.getIndicadorRateioAreaComumImovelNaoFat());
        
        return arquivoTextoRegistroTipo11;
    }

    private StringBuilder gerarDadosSituacaoEspecialFaturamento(Imovel imovel, FaturamentoGrupo faturamentoGrupo)
                                                                                                                 throws ControladorException {
        ...
        if (imovel.getFaturamentoSituacaoTipo() != null && imovel.getFaturamentoSituacaoTipo()
            ...
            if (faturamentoSituacaoHistorico != null
                ...
                arquivoTextoRegistroTipo01.append(Util.completaString("" + imovel.getFaturamentoSituacaoTipo()
     ...
     * @throws ControladorException
     */
    public Object[] gerarArquivoTextoRegistroTipo12() throws ControladorException {
        ...
        filtroConsumoAnormalidadeAcao.adicionarParametro(new ParametroSimples(FiltroConsumoAnormalidadeAcao.INDICADOR_USO,
                                                                              ConstantesSistema.INDICADOR_USO_ATIVO));
        Collection colecaoConsumoAnormalidadeAcao = getControladorUtil().pesquisar(filtroConsumoAnormalidadeAcao, ConsumoAnormalidadeAcao.class.getName());
        ...
        if (colecaoConsumoAnormalidadeAcao != null && !colecaoConsumoAnormalidadeAcao.isEmpty()) {
            ...
            while (itConsumoAnormalidadeAcao.hasNext()) {
                ...
                ConsumoAnormalidadeAcao consumoAnormalidadeAcao = (ConsumoAnormalidadeAcao) itConsumoAnormalidadeAcao.next();
                ...
                if (consumoAnormalidadeAcao.getConsumoAnormalidade() != null
                        && consumoAnormalidadeAcao.getConsumoAnormalidade()
                                                  .getId() != null) {
                    arquivoTextoRegistroTipo12.append(Util.adicionarZerosEsquedaNumero(2, ""
                            + consumoAnormalidadeAcao.getConsumoAnormalidade()
                                                     .getId()));
                } else {
                    arquivoTextoRegistroTipo12.append(Util.adicionarZerosEsquedaNumero(2, ""));
                ...
                // Id da categoria
                if (consumoAnormalidadeAcao.getCategoria() != null && consumoAnormalidadeAcao.getCategoria()
                                                                                             .getId() != null
                    ...
                    arquivoTextoRegistroTipo12.append(Util.completaString("", 2));
                }

                // Id do imóvel perfil
                if (consumoAnormalidadeAcao.getImovelPerfil() != null && consumoAnormalidadeAcao.getImovelPerfil()
                                                                                                .getId() != null
                ...
                if (consumoAnormalidadeAcao.getLeituraAnormalidadeConsumoMes1() != null
                        && consumoAnormalidadeAcao.getLeituraAnormalidadeConsumoMes1()
                                                  .getId() != null) {
                    arquivoTextoRegistroTipo12.append(Util.adicionarZerosEsquedaNumero(2, ""
                            + consumoAnormalidadeAcao.getLeituraAnormalidadeConsumoMes1()
                                                     .getId()));
                ...
                if (consumoAnormalidadeAcao.getLeituraAnormalidadeConsumoMes2() != null
                        && consumoAnormalidadeAcao.getLeituraAnormalidadeConsumoMes2()
                                                  .getId() != null) {
                    arquivoTextoRegistroTipo12.append(Util.adicionarZerosEsquedaNumero(2, ""
                            + consumoAnormalidadeAcao.getLeituraAnormalidadeConsumoMes2()
                                                     .getId()));
                ...
                if (consumoAnormalidadeAcao.getLeituraAnormalidadeConsumoMes3() != null
                        && consumoAnormalidadeAcao.getLeituraAnormalidadeConsumoMes3()
                                                  .getId() != null) {
                    arquivoTextoRegistroTipo12.append(Util.adicionarZerosEsquedaNumero(2, ""
                            + consumoAnormalidadeAcao.getLeituraAnormalidadeConsumoMes3()
                                                     .getId()));
                ...
                if (consumoAnormalidadeAcao.getNumerofatorConsumoMes1() != null
                        && !consumoAnormalidadeAcao.getNumerofatorConsumoMes1()
                                                   .equals("")) {
                    arquivoTextoRegistroTipo12.append(Util.adicionarZerosEsquedaNumero(4, ""
                            + consumoAnormalidadeAcao.getNumerofatorConsumoMes1()));
                } else {
                    arquivoTextoRegistroTipo12.append(Util.adicionarZerosEsquedaNumero(4, ""));
                }
                ...
                if (consumoAnormalidadeAcao.getDescricaoContaMensagemMes1() != null
                        && !consumoAnormalidadeAcao.getDescricaoContaMensagemMes1()
                                                   .equals("")) {
                    arquivoTextoRegistroTipo12.append(Util.completaString(consumoAnormalidadeAcao.getDescricaoContaMensagemMes1(), 120));
                } else {
                    arquivoTextoRegistroTipo12.append(Util.completaString("", 120));
                }
                ...
                if (consumoAnormalidadeAcao.getDescricaoContaMensagemMes2() != null
                        && !consumoAnormalidadeAcao.getDescricaoContaMensagemMes2()
                                                   .equals("")) {
                    arquivoTextoRegistroTipo12.append(Util.completaString(consumoAnormalidadeAcao.getDescricaoContaMensagemMes2(), 120));
                } else {
                    arquivoTextoRegistroTipo12.append(Util.completaString("", 120));
                }
                ...
                if (consumoAnormalidadeAcao.getDescricaoContaMensagemMes3() != null
                        && !consumoAnormalidadeAcao.getDescricaoContaMensagemMes3()
                                                   .equals("")) {
                    arquivoTextoRegistroTipo12.append(Util.completaString(consumoAnormalidadeAcao.getDescricaoContaMensagemMes3(), 120));
                } else {
                    arquivoTextoRegistroTipo12.append(Util.completaString("", 120));
                }
     ...
     * @throws ControladorException
     */
    public Object[] gerarArquivoTextoRegistroTipo13() throws ControladorException {
        ...
        if (colecaoConsumoAnormalidade != null && !colecaoConsumoAnormalidade.isEmpty()) {
            ...
            while (itConsumoAnormalidade.hasNext()) {
                ...
                if (consumoAnormalidade.getId() != null && !consumoAnormalidade.getId()
                                                                               .equals("")) {
                    arquivoTextoRegistroTipo13.append(Util.adicionarZerosEsquedaNumero(2, "" + consumoAnormalidade.getId()));
                } else {
                    arquivoTextoRegistroTipo13.append(Util.adicionarZerosEsquedaNumero(2, ""));
                }

                // mensagem consumo Anormalidade
                if (consumoAnormalidade.getMensagemConta() != null && !consumoAnormalidade.getMensagemConta()
                                                                                          .equals("")) {
                    arquivoTextoRegistroTipo13.append(Util.completaString("" + consumoAnormalidade.getMensagemConta(), 120));
                } else {
                    arquivoTextoRegistroTipo13.append(Util.completaString("", 120));
                }
     ...
     * @throws ControladorException
     */
    public Object[] gerarArquivoTextoRegistroTipo14() throws ControladorException {
        ...
        if (colecaoLeituraAnormalidade != null && !colecaoLeituraAnormalidade.isEmpty()) {
            ...
            while (itLeituraAnormalidade.hasNext()) {
                ...
                if (leituraAnormalidade.getId() != null && !leituraAnormalidade.getId()
                                                                               .equals("")) {
                    arquivoTextoRegistroTipo14.append(Util.adicionarZerosEsquedaNumero(3, "" + leituraAnormalidade.getId()));
                } else {
                    arquivoTextoRegistroTipo14.append(Util.adicionarZerosEsquedaNumero(3, ""));
                }

                // descrição da leitura Anormalidade
                if (leituraAnormalidade.getDescricao() != null && !leituraAnormalidade.getDescricao()
                                                                                      .equals("")) {
                    arquivoTextoRegistroTipo14.append(Util.completaString("" + leituraAnormalidade.getDescricao(), 25));
                } else {
                    arquivoTextoRegistroTipo14.append(Util.completaString("", 25));
                }

                // INDICADOR ACEITA LEITURA
                if (leituraAnormalidade.getIndicadorLeitura() != null && !leituraAnormalidade.getIndicadorLeitura()
                                                                                             .equals("")) {
                    arquivoTextoRegistroTipo14.append(Util.completaString("" + leituraAnormalidade.getIndicadorLeitura(), 1));
                } else {
                    arquivoTextoRegistroTipo14.append(Util.completaString("", 1));
                }
                ...
                if (leituraAnormalidade.getLeituraAnormalidadeConsumoComleitura() != null
                    ...
                    arquivoTextoRegistroTipo14.append(Util.completaString("", 2));
                }
                ...
                if (leituraAnormalidade.getIndicadorUso() != null && !leituraAnormalidade.getIndicadorUso()
                                                                                         .equals("")) {
                    arquivoTextoRegistroTipo14.append(Util.completaString("" + leituraAnormalidade.getIndicadorUso(), 1));
                } else {
                    arquivoTextoRegistroTipo14.append(Util.completaString("", 1));
                }
                ...
                if (leituraAnormalidade.getNumeroFatorSemLeitura() != null
                        && !leituraAnormalidade.getNumeroFatorSemLeitura()
                                               .equals("")) {
                    arquivoTextoRegistroTipo14.append(Util.completaString(""
                            + leituraAnormalidade.getNumeroFatorSemLeitura(), 4));
                } else {
                    arquivoTextoRegistroTipo14.append(Util.completaString("", 4));
                }
                ...
                if (leituraAnormalidade.getNumeroFatorComLeitura() != null
                        && !leituraAnormalidade.getNumeroFatorComLeitura()
                                               .equals("")) {
                    arquivoTextoRegistroTipo14.append(Util.completaString(""
                            + leituraAnormalidade.getNumeroFatorComLeitura(), 4));
                } else {
                    arquivoTextoRegistroTipo14.append(Util.completaString("", 4));
                }

                
               //Indicador de exibir mensagem para os hidrômetros cadastrados na calçada e 
                ...
                if (leituraAnormalidade.getIndicadorExibirMensagemHidrometrosCalcada() != null
                        && !leituraAnormalidade.getIndicadorExibirMensagemHidrometrosCalcada()
                                               .equals("")) {
                    arquivoTextoRegistroTipo14.append(Util.completaString(""
                            + leituraAnormalidade.getIndicadorExibirMensagemHidrometrosCalcada(), 1));
                } else {
                    arquivoTextoRegistroTipo14.append(Util.completaString("", 1));
                }
                ...
                //Indicador de exibir mensagem para os hidrômetros substituídos e 
                //que o leiturista informe uma anormalidade  
                if (leituraAnormalidade.getIndicadorExibirMensagemHidrometrosSubstituidos() != null
                        && !leituraAnormalidade.getIndicadorExibirMensagemHidrometrosSubstituidos()
                                               .equals("")) {
                    arquivoTextoRegistroTipo14.append(Util.completaString(""
                            + leituraAnormalidade.getIndicadorExibirMensagemHidrometrosSubstituidos(), 1));
                } else {
                    arquivoTextoRegistroTipo14.append(Util.completaString("", 1));
                }
                
                // Indicador de não impressão da conta
                if (leituraAnormalidade.getIndicadorNaoImprimirConta() != null &&
                		!leituraAnormalidade.getIndicadorNaoImprimirConta()
                                               .equals("")){
                	 arquivoTextoRegistroTipo14.append(Util.completaString(""
                             + leituraAnormalidade.getIndicadorNaoImprimirConta(), 1));
                } else {
                    arquivoTextoRegistroTipo14.append(Util.completaString("", 1));
                }
     ...
     * [UC0745] - Gerar Arquivo Texto para Faturamento
     * 
     * [SB0001] - Gerar Arquivo Texto - Registro Tipo 15
     * 
     ...
     * @throws ControladorException
     */
    public Object[] gerarArquivoTextoRegistroTipo15() throws ControladorException {
        ...
        filtroConsumoTipo.adicionarParametro(new ParametroSimples(FiltroConsumoTipo.INDICADOR_USO,
                                                                          ConstantesSistema.INDICADOR_USO_ATIVO));
        filtroConsumoTipo.adicionarParametro(new ParametroSimples(FiltroConsumoTipo.INDICADOR_AJUSTE_MENSAL_CONSUMO,
            ConstantesSistema.INDICADOR_USO_DESATIVO));
        Collection<ConsumoTipo> colecaoConsumoTipo = getControladorUtil().pesquisar(filtroConsumoTipo, ConsumoTipo.class.getName());

        if (colecaoConsumoTipo != null && !colecaoConsumoTipo.isEmpty()) {

            int count = colecaoConsumoTipo.size();

            Iterator itConsumoTipo = colecaoConsumoTipo.iterator();
            while (itConsumoTipo.hasNext()) {

                quantidadeLinhas = quantidadeLinhas + 1;

                count--;

                ConsumoTipo consumoTipo = (ConsumoTipo) itConsumoTipo.next();

                // TIPO DO REGISTRO
                arquivoTextoRegistroTipo15.append("15");

                // Id do consumo Tipo
                if (consumoTipo.getId() != null && !consumoTipo.getId().equals("")) {
                    arquivoTextoRegistroTipo15.append(Util.adicionarZerosEsquedaNumero(2, "" + consumoTipo.getId()));
                } else {
                    arquivoTextoRegistroTipo15.append(Util.adicionarZerosEsquedaNumero(2, ""));
                }

                // descrição do consumo Tipo
                if (consumoTipo.getDescricao() != null && !consumoTipo.getDescricao().equals("")) {
                    arquivoTextoRegistroTipo15.append(Util.completaString("" + consumoTipo.getDescricao(), 20));
                } else {
                    arquivoTextoRegistroTipo15.append(Util.completaString("", 20));
                }

                if (count != 0) {
                    arquivoTextoRegistroTipo15.append(System.getProperty("line.separator"));
                }
        ...
        retorno[0] = arquivoTextoRegistroTipo15;
        retorno[1] = quantidadeLinhas;
     ...
     */
    public Object[] gerarArquivoTextoRegistroDadosTarifa09(Imovel imovel, SistemaParametro sistemaParametro,
            Integer anoMesReferencia, FaturamentoGrupo faturamentoGrupo,Conta conta) throws ControladorException {
        ...
        try {
        	...
        	// PESQUISANDO A PARTIR DA TABELA CONTA_CATEGORIA
        	if (conta != null){
        			dadosCategoria = this.getControladorImovel()
        								.pesquisarCategoriaSubcategoriaConta(conta.getId());
        	}
            
            
        	// PESQUISANDO A PARTIR DA TABELA IMOVEL_SUBCATEGORIA
        	if (dadosCategoria == null || dadosCategoria.isEmpty()){
        			dadosCategoria = this.getControladorImovel()
        								.pesquisarCategoriaSubcategoriaImovel(imovel.getId());
	        	}
